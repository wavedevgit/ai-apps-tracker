...
var i = class {
    constructor(e) {
        ...
        document.addEventListener("securitypolicyviolation", () => {
            ...
            t && t.data && t.data.name === "vscode-did-block-svg" && this._onCspWarning()
        })
    }
    setPoster(e) {
    ...
    _showCspWarning() {
        ...
        r.innerText = e.cspAlertMessageText, r.setAttribute("id", "code-csp-warning"), r.setAttribute("title", e.cspAlertMessageTitle), r.setAttribute("role", "button"), r.setAttribute("aria-label", e.cspAlertMessageLabel), r.onclick = () => {
...
var n = class {
    constructor() {
        ...
        window.addEventListener("DOMContentLoaded", () => {
            for (let t of document.getElementsByClassName("code-user-style")) t.dataset.source && (t.onerror = e)
        }), window.addEventListener("load", () => {
            this._unloadedStyles.length && (this._finishedLoading = !0, this._poster?.postMessage("previewStyleLoadError", {
                unloadedStyles: this._unloadedStyles
            }))
        })
    }
    setPoster(e) {
        this._poster = e, this._finishedLoading && e.postMessage("previewStyleLoadError", {
            unloadedStyles: this._unloadedStyles
        })
    }
};
