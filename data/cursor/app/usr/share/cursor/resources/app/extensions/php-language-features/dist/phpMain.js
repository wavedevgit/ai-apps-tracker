(() => {
    var e = {
            50: function(e, t, r) {
                ...
                var i, n = this && this.__createBinding || (Object.create ? function(e, t, r, i) {
                    ...
                    a = this && this.__importStar || (i = function(e) {
                        ...
                        var t = {};
                        if (null != e)
                            for (var r = i(e), a = 0; a < r.length; a++) "default" !== r[a] && n(t, e, r[a]);
                        return s(t, e), t
                    });
                ...
                t.default = class {
                    provideHover(e, t, r) {
                        if (!o.workspace.getConfiguration("php").get("suggest.basic", !0)) return;
                        const i = e.getWordRangeAtPosition(t);
                        if (!i) return;
                        const n = e.getText(i),
                            s = l.globalfunctions[n] || d.compiletimeconstants[n] || d.globalvariables[n] || d.keywords[n];
                        if (s && s.description) {
                            const e = n + (s.signature || ""),
                                t = [(0, c.textToMarkedString)(s.description), {
                                    language: "php",
                                    value: e
                                }];
                            return new o.Hover(t, i)
                        }
                    }
                }
            },
            96: (e, t, r) => {
                e.exports = n, n.sync = function(e, t) {
                ...
                function s(e, t) {
                    return e.isFile() && function(e, t) {
                        var r = e.mode,
                            ...
                            o = parseInt("100", 8),
                            c = parseInt("010", 8);
                        return r & parseInt("001", 8) || r & c && n === a || r & o && i === s || r & (o | c) && 0 === s
                    }(e, t)
                }
            },
            147: (e, t, r) => {
                ...
                function n(e, t, r) {
                    ...
                    i(e, t || {}, function(e, i) {
                        e && ("EACCES" === e.code || t && t.ignoreErrors) && (e = null, i = !1), r(e, i)
                    })
                }
                r(896), i = "win32" === process.platform || global.TESTING_WINDOWS ? r(438) : r(96), e.exports = n, n.sync = function(e, t) {
                    try {
                        return i.sync(e, t || {})
                    } catch (e) {
            ...
            303: (e, t) => {
                ...
                class i {
                    constructor(e) {
                        this.defaultDelay = e, this.timeout = null, this.completionPromise = null, this.onResolve = null, this.task = null
                    }
                    trigger(e, t = this.defaultDelay) {
                        return this.task = e, this.cancelTimeout(), this.completionPromise || (this.completionPromise = new Promise(e => {
                            this.onResolve = e
                        }).then(() => {
                    ...
                    cancel() {
                        this.cancelTimeout(), this.completionPromise && (this.completionPromise = null)
                    }
                    cancelTimeout() {
                        null !== this.timeout && (clearTimeout(this.timeout), this.timeout = null)
                    }
                }
                t.Delayer = i, t.ThrottledDelayer = class extends i {
                    constructor(e) {
                        super(e), this.throttler = new r
                    }
                    trigger(e, t) {
            ...
            319: function(e, t, r) {
                ...
                class m {
                    constructor(e = "utf8") {
                        this.stringDecoder = new d.StringDecoder(e), this.remaining = null
                    }
                    write(e) {
                        const t = [],
                            r = this.remaining ? this.remaining + this.stringDecoder.write(e) : this.stringDecoder.write(e);
                        if (r.length < 1) return t;
                        let i, n = 0;
                        for (; n < r.length && (13 === (i = r.charCodeAt(n)) || 10 === i);) n++;
                        let s = n;
                        for (; s < r.length;)
                            if (i = r.charCodeAt(s), 13 === i || 10 === i) {
                                for (t.push(r.substring(n, s)), s++; s < r.length && (13 === (i = r.charCodeAt(s)) || 10 === i);) s++;
                                n = s
                            } else s++;
                ...
                class $ {
                    constructor() {
                        this.documentListener = null, this.validationEnabled = !0, this.pauseValidation = !1, this.loadConfigP = this.loadConfiguration()
                    }
                    activate(e) {
                        this.diagnosticCollection = u.languages.createDiagnosticCollection(), e.push(this), e.push(u.workspace.onDidChangeConfiguration(() => this.loadConfigP = this.loadConfiguration())), u.workspace.onDidOpenTextDocument(this.triggerValidate, this, e), u.workspace.onDidCloseTextDocument(e => {
                            this.diagnosticCollection.delete(e.uri), this.delayers && delete this.delayers[e.uri.toString()]
                        }, null, e)
                    }
                    dispose() {
                        this.diagnosticCollection && (this.diagnosticCollection.clear(), this.diagnosticCollection.dispose()), this.documentListener && (this.documentListener.dispose(), this.documentListener = null)
                    }
                    async loadConfiguration() {
                        const e = u.workspace.getConfiguration(),
                            t = this.config?.executable;
                        this.validationEnabled = e.get("php.validate.enable", !0), this.config = await async function() {
                            const e = u.workspace.getConfiguration();
                            let t, r;
                            const i = e.inspect("php.validate.executablePath");
                            if (i && i.workspaceValue ? (t = i.workspaceValue, r = !1) : i && i.globalValue ? (t = i.globalValue, r = !0) : (t = void 0, r = void 0), t && !g.isAbsolute(t)) {
                                const e = u.workspace.workspaceFolders && u.workspace.workspaceFolders[0];
                                t = e ? u.Uri.joinPath(e.uri, t).fsPath : void 0
                            } else t || (t = await async function() {
                                try {
                                    return await (0, l.default)("php")
                                } catch (e) {
                                    return
                                }
                            }());
                            return {
                                executable: t,
                                executableIsUserDefined: r,
                                trigger: _.from(e.get("php.validate.run", _.strings.onSave))
                            }
                        }(), this.delayers = Object.create(null), this.pauseValidation && (this.pauseValidation = t === this.config.executable), this.documentListener && (this.documentListener.dispose(), this.documentListener = null), this.diagnosticCollection.clear(), this.validationEnabled && (this.config.trigger === _.onType ? this.documentListener = u.workspace.onDidChangeTextDocument(e => {
                            this.triggerValidate(e.document)
                        }) : this.documentListener = u.workspace.onDidSaveTextDocument(this.triggerValidate, this), u.workspace.textDocuments.forEach(this.triggerValidate, this))
                    }
                    async triggerValidate(e) {
                        if (await this.loadConfigP, "php" === e.languageId && !this.pauseValidation && this.validationEnabled && u.workspace.isTrusted) {
                            const t = e.uri.toString();
                            let r = this.delayers[t];
                            r || (r = new p.ThrottledDelayer(this.config?.trigger === _.onType ? 250 : 0), this.delayers[t] = r), r.trigger(() => this.doValidate(e))
                        }
                    }
                    doValidate(e) {
                        return new Promise(t => {
                            const r = this.config.executable;
                            if (!r) return this.showErrorMessage(u.l10n.t("Cannot validate since a PHP installation could not be found. Use the setting 'php.validate.executablePath' to configure the PHP executable.")), this.pauseValidation = !0, void t();
                            if (!g.isAbsolute(r)) return;
                            const i = new m,
                                n = [],
                                s = e => {
                                    const t = e.match($.MatchExpression);
                                    if (t) {
                                        const e = t[1],
                                            r = parseInt(t[3]) - 1,
                                            i = new u.Diagnostic(new u.Range(r, 0, r, 2 ** 31 - 1), e);
                                        n.push(i)
                                    }
                                },
                                a = u.workspace.workspaceFolders && u.workspace.workspaceFolders[0] ? {
                                    cwd: u.workspace.workspaceFolders[0].uri.fsPath
                                } : void 0;
                            let o;
                            this.config.trigger === _.onSave ? (o = $.FileArgs.slice(0), o.push(e.fileName)) : o = $.BufferArgs;
                            try {
                                const d = c.spawn(r, o, a);
                                d.on("error", e => {
                                    this.pauseValidation || (this.showError(e, r), this.pauseValidation = !0), t()
                                }), d.pid ? (this.config.trigger === _.onType && (d.stdin.write(e.getText()), d.stdin.end()), d.stdout.on("data", e => {
                                    i.write(e).forEach(s)
                                }), d.stdout.on("end", () => {
                                    const r = i.end();
                                    r && s(r), this.diagnosticCollection.set(e.uri, n), t()
                                })) : t()
                            } catch (e) {
                                this.showError(e, r)
                            }
                    ...
                    async showError(e, t) {
                        let r = null;
                        if (r = "ENOENT" === e.code ? this.config.executable ? u.l10n.t("Cannot validate since {0} is not a valid php executable. Use the setting 'php.validate.executablePath' to configure the PHP executable.", t) : u.l10n.t("Cannot validate since no PHP executable is set. Use the setting 'php.validate.executablePath' to configure the PHP executable.") : e.message ? e.message : u.l10n.t("Failed to run php using path: {0}. Reason is unknown.", t), r) return this.showErrorMessage(r)
                    }
                    async showErrorMessage(e) {
                        const t = u.l10n.t("Open Settings");
                        await u.window.showInformationMessage(e, t) === t && u.commands.executeCommand("workbench.action.openSettings", "php.validate.executablePath")
                    }
                }
                $.MatchExpression = /(?:(?:Parse|Fatal) error): (.*)(?: in )(.*?)(?: on line )(\d+)/, $.BufferArgs = ["-l", "-n", "-d", "display_errors=On", "-d", "log_errors=Off"], $.FileArgs = ["-l", "-n", "-d", "display_errors=On", "-d", "log_errors=Off", "-f"], t.default = $
            },
            398: e => {
                "use strict";
            ...
            425: function(e, t, r) {
                ...
                const o = r(398),
                    ...
                    d = a(r(633));
                t.default = class {
                    provideCompletionItems(e, t, r, i) {
                        const n = [];
                        if (!o.workspace.getConfiguration("php").get("suggest.basic", !0)) return Promise.resolve(n);
                        let s = e.getWordRangeAtPosition(t);
                        const a = s ? e.getText(s) : "";
                        if (s || (s = new o.Range(t, t)), ">" === i.triggerCharacter) {
                            const r = new o.Position(t.line, Math.max(0, t.character - 2));
                            if ("->" !== e.getText(new o.Range(r, t))) return Promise.resolve(n)
                        }
                        const l = {},
                            g = function(e, t, r) {
                                const i = new o.CompletionItem(t);
                                return i.kind = e, r && (r.description && (i.documentation = r.description), r.signature && (i.detail = r.signature)), i
                            },
                            u = e => 0 === a.length || e.length >= a.length && e.substr(0, a.length) === a;
                        if (u("php") && s.start.character >= 2) {
                            const r = new o.Position(s.start.line, s.start.character - 2);
                            if ("<?" === e.getText(new o.Range(r, s.start))) {
                                const e = g(o.CompletionItemKind.Class, "<?php", null);
                                return e.textEdit = new o.TextEdit(new o.Range(r, t), "<?php"), n.push(e), Promise.resolve(n)
                            }
                        }
                        for (const e in c.globalvariables) c.globalvariables.hasOwnProperty(e) && u(e) && (l[e] = !0, n.push(g(o.CompletionItemKind.Variable, e, c.globalvariables[e])));
                        for (const e in d.globalfunctions) d.globalfunctions.hasOwnProperty(e) && u(e) && (l[e] = !0, n.push(g(o.CompletionItemKind.Function, e, d.globalfunctions[e])));
                        for (const e in c.compiletimeconstants) c.compiletimeconstants.hasOwnProperty(e) && u(e) && (l[e] = !0, n.push(g(o.CompletionItemKind.Field, e, c.compiletimeconstants[e])));
                        for (const e in c.keywords) c.keywords.hasOwnProperty(e) && u(e) && (l[e] = !0, n.push(g(o.CompletionItemKind.Keyword, e, c.keywords[e])));
                        const p = e.getText();
                        if ("$" === a[0]) {
                            const e = /\$([a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*)/g;
                            let t = null;
                            for (; t = e.exec(p);) {
                                const e = t[0];
                                l[e] || (l[e] = !0, n.push(g(o.CompletionItemKind.Variable, e, null)))
                            }
                        }
                        const m = /function\s+([a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*)\s*\(/g;
                        let _ = null;
                        for (; _ = m.exec(p);) {
                            const e = _[1];
                            l[e] || (l[e] = !0, n.push(g(o.CompletionItemKind.Function, e, null)))
                        }
            ...
            438: (e, t, r) => {
                e.exports = s, s.sync = function(e, t) {
            ...
            633: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.globalfunctions = void 0, t.globalfunctions = {
                    debug_backtrace: {
            ...
            649: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.keywords = t.compiletimeconstants = t.globalvariables = void 0, t.globalvariables = {
                    $GLOBALS: {
            ...
            672: function(e, t, r) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    (new u.default).activate(e.subscriptions), e.subscriptions.push(c.languages.registerCompletionItemProvider("php", new d.default, ">", "$")), e.subscriptions.push(c.languages.registerHoverProvider("php", new l.default)), e.subscriptions.push(c.languages.registerSignatureHelpProvider("php", new g.default, "(", ","))
                };
                const c = a(r(398)),
                    d = o(r(425)),
                    l = o(r(50)),
            ...
            689: function(e, t, r) {
                ...
                class S {
                    constructor(e, t, r) {
                        this.lineNumber = r, this.offset = t, this.line = e.lineAt(this.lineNumber).text, this.model = e
                    }
                    hasNext() {
                        return this.lineNumber >= 0
                    }
                    next() {
                        if (this.offset < 0) return this.lineNumber > 0 ? (this.lineNumber--, this.line = this.model.lineAt(this.lineNumber).text, this.offset = this.line.length - 1, l) : (this.lineNumber = -1, 0);
                        const e = this.line.charCodeAt(this.offset);
                        return this.offset--, e
                    }
                }
                t.default = class {
                    provideSignatureHelp(e, t, r) {
                        if (!o.workspace.getConfiguration("php").get("suggest.basic", !0)) return null;
                        const i = new S(e, t.character - 1, t.line),
                            n = this.readArguments(i);
                        if (n < 0) return null;
                        const s = this.readIdent(i);
                        if (!s) return null;
                        const a = d.globalfunctions[s] || c.keywords[s];
                        if (!a || !a.signature) return null;
                        const l = a.signature.substring(0, a.signature.lastIndexOf(")") + 1),
                            g = new o.SignatureInformation(s + l, a.description),
                            u = /\w*\s+\&?\$[\w_\.]+|void/g;
                        let p = null;
                        for (; null !== (p = u.exec(l));) g.parameters.push({
                            label: p[0],
                            documentation: ""
                        });
                        const m = new o.SignatureHelp;
                        return m.signatures.push(g), m.activeSignature = 0, m.activeParameter = Math.min(n, g.parameters.length - 1), Promise.resolve(m)
                    }
                    readArguments(e) {
                        let t = 0,
                            r = 0,
                    ...
                    isIdentPart(e) {
                        return e === x || e >= k && e <= w || e >= C && e <= R || e >= P && e <= T || e >= 128 && e <= 65535
                    }
                    readIdent(e) {
                        let t = !1,
                            r = "";
                        for (; e.hasNext();) {
                            const i = e.next();
                            if (t || i !== u && i !== g && i !== l)
                                if (this.isIdentPart(i)) t = !0, r = String.fromCharCode(i) + r;
                                else if (t) return r
                        }
                        return r
                    }
            ...
            911: (e, t, r) => {
                const i = "win32" === process.platform || "cygwin" === process.env.OSTYPE || "msys" === process.env.OSTYPE,
                    n = r(928),
                    s = i ? ";" : ":",
                    a = r(147),
                    o = e => Object.assign(new Error(`not found: ${e}`), {
                        code: "ENOENT"
                    }),
                    c = (e, t) => {
                        const r = t.colon || s,
                            n = e.match(/\//) || i && e.match(/\\/) ? [""] : [...i ? [process.cwd()] : [], ...(t.path || process.env.PATH || "").split(r)],
                            a = i ? t.pathExt || process.env.PATHEXT || ".EXE;.CMD;.BAT;.COM" : "",
                            o = i ? a.split(r) : [""];
                        return i && -1 !== e.indexOf(".") && "" !== o[0] && o.unshift(""), {
                            pathEnv: n,
                            pathExt: o,
                            pathExtExe: a
                        }
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/a80ff7dfcaa45d7750f6e30be457261379c29b00/extensions/php-language-features/dist/phpMain.js.map