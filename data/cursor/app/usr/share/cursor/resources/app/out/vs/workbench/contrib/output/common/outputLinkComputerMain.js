...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "22ab5754-7b6c-5993-8199-75f7fcb28a7a")
    } catch (e) {}
}();
var V1 = function(e, t) {
...
export function __esDecorate(e, t, r, n, i, s) {
    ...
    for (var a = n.kind, u = a === "getter" ? "get" : a === "setter" ? "set" : "value", l = !t && e ? n.static ? e : e.prototype : null, h = t || (l ? Object.getOwnPropertyDescriptor(l, n.name) : {}), c, _ = !1, b = r.length - 1; b >= 0; b--) {
        var y = {};
        for (var S in n) y[S] = S === "access" ? {} : n[S];
        for (var S in n.access) y.access[S] = n.access[S];
        y.addInitializer = function(j) {
...
export function __asyncGenerator(e, t, r) {
    ...
    function o(b) {
        return function(y) {
            return Promise.resolve(y).then(b, c)
        }
    }
    ...
    function l(b) {
        b.value instanceof __await ? Promise.resolve(b.value.v).then(h, c) : _(s[0][2], b)
    }
    ...
    function _(b, y) {
        b(y), s.shift(), s.length && u(s[0][0], s[0][1])
    }
}
...
var At = Object.create ? (function(e, t) {
...
var Mn = _e() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0,
    c1 = "en",
    A1 = !1,
    E1 = !1,
    _1 = !1,
...
if (typeof q == "object") {
    ...
    ve = !0
} else typeof navigator == "object" && !Ot ? (G = navigator.userAgent, A1 = G.indexOf("Windows") >= 0, E1 = G.indexOf("Macintosh") >= 0, Pt = (G.indexOf("Macintosh") >= 0 || G.indexOf("iPad") >= 0 || G.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, _1 = G.indexOf("Linux") >= 0, Rt = G?.indexOf("Mobi") >= 0, H1 = !0, S1 = _e() || c1, x1 = navigator.language.toLowerCase(), pe = x1) : console.error("Unable to resolve platform.");
var be;
(function(e) {
    e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows"
})(be || (be = {}));
var K1 = 0;
E1 ? K1 = 1 : A1 ? K1 = 3 : _1 && (K1 = 2);
var i1 = A1,
    It = E1,
    Mt = _1,
    Dt = ve,
    Ut = H1,
    $t = H1 && typeof Y.importScripts == "function",
    jt = $t ? Y.origin : void 0,
    J = G,
    r1 = S1,
    we;
(function(e) {
...
if (typeof B1 < "u" && typeof B1.process < "u") {
...
} else typeof process < "u" && typeof process?.versions?.node == "string" ? s1 = {
    get platform() {
    ...
    get platform() {
        return i1 ? "win32" : It ? "darwin" : "linux"
    },
    get arch() {},
    get env() {
        return {}
...
function Gt(e, t) {
    if (e === null || typeof e != "object") throw new ye(t, "Object", e)
}
...
function k1(e, t, r, n) {
    ...
    for (let l = 0; l <= e.length; ++l) {
        ...
        if (n(u)) {
            if (!(o === l - 1 || a === 1))
                if (a === 2) {
                    if (i.length < 2 || s !== 2 || i.charCodeAt(i.length - 1) !== o1 || i.charCodeAt(i.length - 2) !== o1) {
                        if (i.length > 2) {
...
var I = {
        resolve(...e) {
            ...
            for (let i = e.length - 1; i >= -1; i--) {
                let s;
                if (i >= 0) {
                    if (s = e[i], O(s, `paths[${i}]`), s.length === 0) continue
                } else t.length === 0 ? s = P1() : (s = Ft[`=${t}`] || P1(), (s === void 0 || s.slice(0, 2).toLowerCase() !== t.toLowerCase() && s.charCodeAt(2) === F) && (s = `${t}\\`));
                const o = s.length;
                let a = 0,
                    u = "",
                    l = !1;
                ...
                if (o === 1) C(h) && (a = 1, l = !0);
                    ...
                    if (l = !0, C(s.charCodeAt(1))) {
                        ...
                        if (c < o && c !== _) {
                            const b = s.slice(_, c);
                            for (_ = c; c < o && C(s.charCodeAt(c));) c++;
                            if (c < o && c !== _) {
                                for (_ = c; c < o && !C(s.charCodeAt(c));) c++;
                                (c === o || c !== _) && (u = `\\\\${b}\\${s.slice(_,c)}`, a = c)
                            }
                        }
                    } else a = 1;
                else X(h) && s.charCodeAt(1) === Z && (u = s.slice(0, 2), a = 2, o > 2 && C(s.charCodeAt(2)) && (l = !0, a = 3));
                if (u.length > 0)
                    if (t.length > 0) {
        ...
        normalize(e) {
            ...
            else X(s) && e.charCodeAt(1) === Z && (n = e.slice(0, 2), r = 2, t > 2 && C(e.charCodeAt(2)) && (i = !0, r = 3));
            let o = r < t ? k1(e.slice(r), !i, "\\", C) : "";
        ...
        isAbsolute(e) {
            ...
            return C(r) || t > 2 && X(r) && e.charCodeAt(1) === Z && C(e.charCodeAt(2))
        },
        join(...e) {
        ...
        relative(e, t) {
            ...
            if (r.length !== e.length || n.length !== t.length) {
                const y = r.split("\\"),
                    S = n.split("\\");
                y[y.length - 1] === "" && y.pop(), S[S.length - 1] === "" && S.pop();
                const k = y.length,
                    j = S.length,
                    t1 = k < j ? k : j;
                let D;
                for (D = 0; D < t1 && y[D].toLowerCase() === S[D].toLowerCase(); D++);
                return D === 0 ? n : D === t1 ? j > t1 ? S.slice(D).join("\\") : k > t1 ? "..\\".repeat(k - 1 - D) + ".." : "" : "..\\".repeat(k - D) + S.slice(D).join("\\")
            }
            let i = 0;
            for (; i < e.length && e.charCodeAt(i) === F;) i++;
            let s = e.length;
            for (; s - 1 > i && e.charCodeAt(s - 1) === F;) s--;
            const o = s - i;
            let a = 0;
            ...
            let c = -1,
                _ = 0;
            for (; _ < h; _++) {
                const y = e.charCodeAt(i + _);
                if (y !== t.charCodeAt(a + _)) break;
                y === F && (c = _)
            }
            if (_ !== h) {
                if (c === -1) return n
                ...
                o > h && (e.charCodeAt(i + _) === F ? c = _ : _ === 2 && (c = 3)), c === -1 && (c = 0)
            }
            let b = "";
            for (_ = i + c + 1; _ <= s; ++_)(_ === s || e.charCodeAt(_) === F) && (b += b.length === 0 ? ".." : "\\..");
        ...
        dirname(e) {
            ...
            } else X(i) && e.charCodeAt(1) === Z && (r = t > 2 && C(e.charCodeAt(2)) ? 3 : 2, n = r);
            let s = -1,
                o = !0;
            for (let a = t - 1; a >= n; --a)
                if (C(e.charCodeAt(a))) {
        ...
        extname(e) {
            ...
            for (let a = e.length - 1; a >= t; --a) {
                ...
                i === -1 && (s = !1, i = a + 1), u === o1 ? r === -1 ? r = a : o !== 1 && (o = 1) : r !== -1 && (o = -1)
            }
        ...
        parse(e) {
            ...
            if (C(i)) {
                if (n = 1, C(e.charCodeAt(1))) {
                    ...
                    if (c < r && c !== _) {
                        for (_ = c; c < r && C(e.charCodeAt(c));) c++;
                        if (c < r && c !== _) {
                            for (_ = c; c < r && !C(e.charCodeAt(c));) c++;
                            c === r ? n = c : c !== _ && (n = c + 1)
                        }
            ...
            for (; l >= n; --l) {
                ...
                a === -1 && (u = !1, a = l + 1), i === o1 ? s === -1 ? s = l : h !== 1 && (h = 1) : s !== -1 && (h = -1)
            }
    ...
    E = {
        resolve(...e) {
            ...
            for (let n = e.length - 1; n >= 0 && !r; n--) {
                const i = e[n];
                O(i, `paths[${n}]`), i.length !== 0 && (t = `${i}/${t}`, r = i.charCodeAt(0) === $)
            }
            if (!r) {
                const n = Zt();
                t = `${n}/${t}`, r = n.charCodeAt(0) === $
            }
            return t = k1(t, !r, "/", Q1), r ? `/${t}` : t.length > 0 ? t : "."
        },
        normalize(e) {
            if (O(e, "path"), e.length === 0) return ".";
            const t = e.charCodeAt(0) === $,
                r = e.charCodeAt(e.length - 1) === $;
            return e = k1(e, !t, "/", Q1), e.length === 0 ? t ? "/" : r ? "./" : "." : (r && (e += "/"), t ? `/${e}` : e)
        },
        isAbsolute(e) {
        ...
        relative(e, t) {
            if (O(e, "from"), O(t, "to"), e === t || (e = E.resolve(e), t = E.resolve(t), e === t)) return "";
            const r = 1,
                n = e.length,
                i = n - r,
                s = 1,
        ...
        parse(e) {
            ...
            for (; u >= n; --u) {
                ...
                o === -1 && (a = !1, o = u + 1), h === o1 ? i === -1 ? i = u : l !== 1 && (l = 1) : i !== -1 && (l = -1)
            }
            if (o !== -1) {
                const h = s === 0 && r ? 1 : s;
...
E.win32 = I.win32 = I, E.posix = I.posix = E;
var Xt = V ? I.normalize : E.normalize,
    Vn = V ? I.isAbsolute : E.isAbsolute,
    er = V ? I.join : E.join,
    tr = V ? I.resolve : E.resolve,
    rr = V ? I.relative : E.relative,
    nr = V ? I.dirname : E.dirname,
    Hn = V ? I.basename : E.basename,
    Kn = V ? I.extname : E.extname,
    Bn = V ? I.format : E.format,
    Qn = V ? I.parse : E.parse,
    Jn = V ? I.toNamespacedPath : E.toNamespacedPath,
    R1 = V ? I.sep : E.sep,
    Gn = V ? I.delimiter : E.delimiter,
    ir = class {
        constructor() {
            this.listeners = [], this.unexpectedErrorHandler = function(e) {
                setTimeout(() => {
                    throw e.stack ? Y1.isErrorNoTelemetry(e) ? new Y1(e.message + `
...
function or(e) {
    return e instanceof ar ? !0 : e instanceof Error && e.name === G1 && e.message === G1
}
var ar = class extends Error {
        constructor() {
            if (super(G1), this.name = this.message, ur && typeof console < "u") {
                const e = new Error().stack ?? "";
                lr.some(t => e.includes(t)) && console.trace("[DebugCancellation] CancellationError created")
            }
        }
    },
    Y1 = class he extends Error {
        constructor(t) {
...
function fr(e, t, r = 0, n = e.length) {
    let i = r,
        s = n;
    for (; i < s;) {
...
var Se = class g1 {
        ...
        constructor(t, r) {
            if (this[Ae] = "ResourceMap", t instanceof g1) this.map = new Map(t.map), this.toKey = r ?? g1.defaultToKey;
            else if (vr(t)) {
                this.map = new Map, this.toKey = r ?? g1.defaultToKey;
                for (const [n, i] of t) this.set(n, i)
            } else this.map = new Map, this.toKey = t ?? g1.defaultToKey
        }
        set(t, r) {
    ...
    ei = class {
        constructor(e, t) {
            this[Ee] = "ResourceSet", !e || typeof e == "function" ? this._map = new Se(e) : (this._map = new Se(t), e.forEach(this.add, this))
        }
        get size() {
            return this._map.size
        }
...
var ti = class {
        constructor() {
            this[xe] = "LinkedMap", this._map = new Map, this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0
        }
        clear() {
...
(function(e) {
    ...
    function* a(g) {
        for (let L = g.length - 1; L >= 0; L--) yield g[L]
    }
    e.reverse = a;
    ...
    function* _(g, L) {
        for (const x of g) L(x) && (yield x)
    }
    e.filter = _;

    function* b(g, L) {
        let x = 0;
        for (const z of g) yield L(z, x++)
    }
    e.map = b;
    ...
    function* S(...g) {
        for (const L of g) gr(L) ? yield* L: yield L
    }
    e.concat = S;

    function k(g, L, x) {
        let z = x;
        for (const l1 of g) z = L(z, l1);
        return z
    }
    e.reduce = k;
    ...
    function* t1(g, L, x = g.length) {
        for (L < -g.length && (L = 0), L < 0 && (L += g.length), x < 0 ? x += g.length : x > g.length && (x = g.length); L < x; L++) yield g[L]
    }
    e.slice = t1;

    function D(g, L = Number.POSITIVE_INFINITY) {
        const x = [];
        if (L === 0) return [x, g];
        const z = g[Symbol.iterator]();
        for (let l1 = 0; l1 < L; l1++) {
            const y1 = z.next();
            if (y1.done) return [x, e.empty()];
            x.push(y1.value)
        }
        return [x, {
            [Symbol.iterator]() {
    ...
    async function F1(g) {
        const L = [];
        for await (const x of g) L.push(x);
...
`), u)
            ...
            for (const u of n.slice(0, t)) {
                ...
                for (let c = 0; c < l.length; c++) {
                    let _ = l[c];
                    _ = `(shared with ${s.get(l.slice(0,c+1).join(`
`)).size}/${n.length} leaks) at ${_}`;
                    const y = s.get(l.slice(0, c).join(`
`)),
                        S = cr([...y].map(k => i(k)[c]), k => k);
                    delete S[l[c]];
...
var re = class _t {
        ...
        add(t) {
            ...
            return te(t, this), this._isDisposed ? _t.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t
        }
        delete(t) {
            if (t) {
    ...
    Lr = class {
        ...
        _remove(e) {
            ...
            } else e.prev === T.Undefined && e.next === T.Undefined ? (this._first = T.Undefined, this._last = T.Undefined) : e.next === T.Undefined ? (this._last = this._last.prev, this._last.next = T.Undefined) : e.prev === T.Undefined && (this._first = this._first.next, this._first.prev = T.Undefined);
            this._size -= 1
        }*[Symbol.iterator]() {
            let e = this._first;
    ...
    Nr = globalThis.performance && typeof globalThis.performance.now == "function",
    Ar = class vt {
        static create(t) {
            return new vt(t)
        }
        constructor(t) {
            this._now = Nr && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1
        }
        stop() {
...
(function(e) {
    ...
    function n(v) {
        return (f, m = null, d) => {
            let p = !1,
                w;
            return w = v(A => {
                if (!p) return w ? w.dispose() : p = !0, f.call(m, A)
            }, null, d), p && w.dispose(), w
        }
    }
    e.once = n;
    ...
    function s(v, f, m) {
        return c((d, p = null, w) => v(A => d.call(p, f(A)), null, w), m)
    }
    e.map = s;

    function o(v, f, m) {
        return c((d, p = null, w) => v(A => {
            f(A), d.call(p, A)
        }, null, w), m)
    }
    e.forEach = o;
    ...
    function a(v, f, m) {
        return c((d, p = null, w) => v(A => f(A) && d.call(p, A), null, w), m)
    }
    e.filter = a;
    ...
    function l(...v) {
        return (f, m = null, d) => {
            const p = yr(...v.map(w => w(A => f.call(m, A))));
            return _(p, d)
        }
    }
    e.any = l;
    ...
    function b(v, f, m = 100, d = !1, p = !1, w, A) {
        ...
        A || t(me);
        const N1 = new B(me);
        return A?.add(N1), N1.event
    }
    e.debounce = b;

    function y(v, f = 0, m) {
        return e.debounce(v, (d, p) => d ? (d.push(p), d) : [p], f, void 0, !0, void 0, m)
    }
    e.accumulate = y;

    function S(v, f = (d, p) => d === p, m) {
        let d = !0,
            p;
        return a(v, w => {
            const A = d || !f(w, p);
    ...
    function k(v, f, m) {
        return [e.filter(v, f, m), e.filter(v, d => !f(d), m)]
    }
    e.split = k;
    ...
    class F1 {
        ...
        reduce(f, m) {
            let d = m;
            return this.steps.push(p => (d = f(d, p), d)), this
        }
        latch(f = (m, d) => m === d) {
            let m = !0,
                d;
    ...
    function g(v, f, m = d => d) {
        const d = (...U) => A.fire(m(...U)),
            p = () => v.on(f, d),
            w = () => v.removeListener(f, d),
            A = new B({
    ...
    function x(v, f, m = d => d) {
        const d = (...U) => A.fire(m(...U)),
            p = () => v.addEventListener(f, d),
            w = () => v.removeEventListener(f, d),
            A = new B({
                onWillAddFirstListener: p,
                onDidRemoveLastListener: w
            });
    ...
    function z(v, f) {
        return new Promise(m => n(v)(m, null, f))
    }
    e.toPromise = z;
    ...
    class wt {
        constructor(f, m) {
            ...
            m || t(d), this.emitter = new B(d), m && m.add(this.emitter)
        }
        beginUpdate(f) {
            this._counter++
        }
    ...
    function Ct(v, f) {
        return new wt(v, f).emitter.event
    }
    e.fromObservable = Ct;
    ...
    function yt(v) {
        return (f, m, d) => {
            ...
            const A = {
                ...
                endUpdate() {
                    p--, p === 0 && (v.reportChanges(), w && (w = !1, f.call(m)))
                },
            ...
            return d instanceof re ? d.add(U) : Array.isArray(d) && d.push(U), U
        }
    }
...
var xr = class fe {
        ...
        start(t) {
            this._stopWatch = new Ar, this.listenerCount = t
        }
        stop() {
            if (this._stopWatch) {
    ...
    Sr = class pt {
        ...
        constructor(t, r, n = (pt._idPool++).toString(16).padStart(3, "0")) {
...
`))
    ...
    B = class {
        constructor(e) {
            this._size = 0, this._options = e, this._leakageMon = Oe > 0 || this._options?.leakWarningThreshold ? new Sr(e?.onListenerError ?? T1, this._options?.leakWarningThreshold ?? Oe) : void 0, this._perfMon = this._options?._profName ? new xr(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue
        }
        dispose() {
            if (!this._disposed) {
            ...
            return this._event ??= (e, t, r) => {
                if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
                    ...
                    const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
                        l = new kr(`${a}. HINT: Stack shows most frequent listener (${u[1]}-times)`, u[0]);
                    return (this._options?.onListenerError || T1)(l), v1.None
                }
                if (this._disposed) return v1.None;
                t && (e = e.bind(t));
                const n = new M1(e);
                let i, s;
                this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (n.stack = ne.create(), i = this._leakageMon.check(n.stack, this._size + 1)), Te && (n.stack = s ?? ne.create()), this._listeners ? this._listeners instanceof M1 ? (this._deliveryQueue ??= new Ir, this._listeners = [this._listeners, n]) : this._listeners.push(n) : (this._options?.onWillAddFirstListener?.(this), this._listeners = n, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
                const o = Re(() => {
        ...
        fire(e) {
            if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners)
                if (this._listeners instanceof M1) this._deliver(this._listeners, e);
                else {
...
(function(e) {
    function t(r) {
        return r === e.None || r === e.Cancelled || r instanceof Mr ? !0 : !r || typeof r != "object" ? !1 : typeof r.isCancellationRequested == "boolean" && typeof r.onCancellationRequested == "function"
    }
...
var Mr = class {
    ...
    get onCancellationRequested() {
        return this._isCancelled ? Ie : (this._emitter || (this._emitter = new B), this._emitter.event)
    }
    dispose() {
...
var Ur = class {
        constructor(e, t) {
            this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = Dr) : (this._fn = t, this._computeKey = e.getCacheKey)
        }
        get(e) {
...
function De(e, ...t) {
    return t.length === 0 ? e : e.replace($r, function(r, n) {
...
var Fr = /(?:\x1b\[|\x9b)[=?>!]?[\d;:]*["$#'* ]?[a-zA-Z@^`{}|~]/,
    Vr = /(?:\x1b\]|\x9d).*?(?:\x1b\\|\x07|\x9c)/,
    Hr = /\x1b(?:[ #%\(\)\*\+\-\.\/]?[a-zA-Z0-9\|}~@])/,
    ni = new RegExp("(?:" + [Fr.source, Vr.source, Hr.source].join("|") + ")", "g"),
    ii = "\uFEFF",
    ze;
(function(e) {
...
var si = class b1 {
    ...
    static getInstance() {
        return b1._INSTANCE || (b1._INSTANCE = new b1), b1._INSTANCE
    }
    constructor() {
        this._data = Kr()
    }
...
var oi = class w1 {
        ...
        static {
            this.cache = new Ur({
                ...
                function r(h) {
                    const c = new Map;
                    for (let _ = 0; _ < h.length; _ += 2) c.set(h[_], h[_ + 1]);
                    return c
                }

                function n(h, c) {
                    const _ = new Map(h);
                    for (const [b, y] of c) _.set(b, y);
                    return _
                }
                ...
                function i(h, c) {
                    if (!h) return c;
                    const _ = new Map;
                    for (const [b, y] of h) c.has(b) && _.set(b, y);
                    return _
                }
        ...
        static getInstance(t) {
            return w1.cache.get(Array.from(t))
        }
        static {
            this._locales = new ie(() => Object.keys(w1.ambiguousCharacterData.value).filter(t => !t.startsWith("_")))
        }
        static getLocales() {
            return w1._locales.value
        }
        constructor(t) {
    ...
    ai = class C1 {
        ...
        static getData() {
            return this._data || (this._data = new Set([...Object.values(C1.getRawData())].flat())), this._data
        }
        static isInvisibleCharacter(t) {
            return C1.getData().has(t)
        }
        static containsInvisibleCharacter(t) {
            for (let r = 0; r < t.length; r++) {
                const n = t.codePointAt(r);
                if (typeof n == "number" && (C1.isInvisibleCharacter(n) || n === 32)) return !0
            }
            return !1
        }
...
var Br = "tkn",
    Qr = class {
        ...
        setServerRootPath(e, t) {
            this._serverRootPath = E.join(t ?? "/", Gr(e))
        }
        getServerRootPath() {
            return this._serverRootPath
        }
        get _remoteResourcesPath() {
            return E.join(this._serverRootPath, M.vscodeRemoteResource)
        }
        set(e, t, r) {
        ...
        rewrite(e) {
            ...
            return typeof i == "string" && (s += `&${Br}=${encodeURIComponent(i)}`), H.from({
                scheme: Ut ? this._preferredWebSchema : M.vscodeRemoteResource,
                authority: `${r}:${n}`,
...
var hi = new ie(() => new Uint8Array(256)),
    Xr = /^\w[\w\d+.-]*$/,
    en = /^\//,
    tn = /^\/\//;
...
function rn(e, t) {
    ...
    if (e.scheme && !Xr.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
    if (e.path) {
        if (e.authority) {
            if (!en.test(e.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')
        } else if (tn.test(e.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')
    }
}
...
var P = "",
    ...
    H = class z1 {
        ...
        constructor(t, r, n, i, s, o = !1) {
            typeof t == "object" ? (this.scheme = t.scheme || P, this.authority = t.authority || P, this.path = t.path || P, this.query = t.query || P, this.fragment = t.fragment || P) : (this.scheme = nn(t, o), this.authority = r || P, this.path = sn(this.scheme, n || P), this.query = i || P, this.fragment = s || P, rn(this, o))
        }
        get fsPath() {
            return U1(this, !1)
        }
        with(t) {
            ...
            return r === void 0 ? r = this.scheme : r === null && (r = P), n === void 0 ? n = this.authority : n === null && (n = P), i === void 0 ? i = this.path : i === null && (i = P), s === void 0 ? s = this.query : s === null && (s = P), o === void 0 ? o = this.fragment : o === null && (o = P), r === this.scheme && n === this.authority && i === this.path && s === this.query && o === this.fragment ? this : new f1(r, n, i, s, o)
        }
        static parse(t, r = !1) {
            const n = on.exec(t);
            return n ? new f1(n[2] || P, $1(n[4] || P), $1(n[5] || P), $1(n[7] || P), $1(n[9] || P), r) : new f1(P, P, P, P, P)
        }
        static file(t) {
            let r = P;
            if (i1 && (t = t.replace(/\\/g, Q)), t[0] === Q && t[1] === Q) {
                const n = t.indexOf(Q, 2);
                n === -1 ? (r = t.substring(2), t = Q) : (r = t.substring(2, n), t = t.substring(n) || Q)
            }
            return new f1("file", r, t, P, P)
        }
        static from(t, r) {
            return new f1(t.scheme, t.authority, t.path, t.query, t.fragment, r)
        }
        static joinPath(t, ...r) {
            if (!t.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
            let n;
            return i1 && t.scheme === "file" ? n = z1.file(I.join(U1(t, !0), ...r)).path : n = E.join(t.path, ...r), t.with({
                path: n
            })
        }
        toString(t = !1) {
...
function U1(e, t) {
    let r;
    return e.authority && e.path.length > 1 && e.scheme === "file" ? r = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === 47 && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && e.path.charCodeAt(2) === 58 ? t ? r = e.path.substr(1) : r = e.path[1].toLowerCase() + e.path.substr(2) : r = e.path, i1 && (r = r.replace(/\//g, "\\")), r
}
...
function Ge(e, t = E.sep) {
    ...
    if (n1(n)) {
        ...
        return t
    } else if (un(n) && e.charCodeAt(1) === 58) return n1(e.charCodeAt(2)) ? e.slice(0, 2) + t : e.slice(0, 2);
    let i = e.indexOf("://");
    if (i !== -1) {
        for (i += 3; i < r; i++)
            if (n1(e.charCodeAt(i))) return e.slice(0, i + 1)
    }
    return ""
}

function Ye(e, t, r, n = R1) {
    if (e === t) return !0;
...
var ae = class {
        ...
        isEqualOrParent(e, t, r = !1) {
            if (e.scheme === t.scheme) {
                if (e.scheme === M.file) return Ye(e1(e), e1(t), this._ignorePathCasing(e)) && e.query === t.query && (r || e.fragment === t.fragment);
                if (Ze(e.authority, t.authority)) return Ye(e.path, t.path, this._ignorePathCasing(e), "/") && e.query === t.query && (r || e.fragment === t.fragment)
            }
            return !1
        }
        joinPath(e, ...t) {
        ...
        dirname(e) {
            ...
            let t;
            return e.scheme === M.file ? t = H.file(nr(e1(e))).path : (t = E.dirname(e.path), e.authority && t.length && t.charCodeAt(0) !== 47 && (console.error(`dirname("${e.toString})) resulted in a relative path`), t = "/")), e.with({
                path: t
            })
        }
        normalizePath(e) {
            ...
            let t;
            return e.scheme === M.file ? t = H.file(Xt(e1(e))).path : t = E.normalize(e.path), e.with({
                path: t
            })
        }
        relativePath(e, t) {
            if (e.scheme !== t.scheme || !Ze(e.authority, t.authority)) return;
            if (e.scheme === M.file) {
                const i = rr(e1(e), e1(t));
                return i1 ? oe(i) : i
            }
            let r = e.path || "/";
            const n = t.path || "/";
        ...
        resolvePath(e, t) {
            if (e.scheme === M.file) {
                const r = H.file(tr(e1(e), t));
                return e.with({
                    authority: r.authority,
                    path: r.path
                })
            }
            return t = ln(t), e.with({
        ...
        hasTrailingPathSeparator(e, t = R1) {
            if (e.scheme === M.file) {
                const r = e1(e);
                return r.length > Ge(r).length && r[r.length - 1] === t
            } else {
                const r = e.path;
                return r.length > 1 && r.charCodeAt(r.length - 1) === 47 && !/^[a-zA-Z]:(\/$|\\$)/.test(e.fsPath)
            }
        }
        removeTrailingPathSeparator(e, t = R1) {
            return Xe(e, t) ? e.with({
                path: e.path.substr(0, e.path.length - 1)
            }) : e
        }
        addTrailingPathSeparator(e, t = R1) {
            let r = !1;
            if (e.scheme === M.file) {
                const n = e1(e);
                r = n !== void 0 && n.length === Ge(n).length && n[n.length - 1] === t
            } else {
                t = "/";
                const n = e.path;
                r = n.length === 1 && n.charCodeAt(n.length - 1) === 47
            }
            return !r && !Xe(e, t) ? e.with({
                path: e.path + "/"
            }) : e
        }
    },
    N = new ae(() => !1),
    fi = new ae(e => e.scheme === M.file ? !Mt : !0),
    di = new ae(e => !0),
    mi = N.isEqual.bind(N),
    _i = N.isEqualOrParent.bind(N),
    vi = N.getComparisonKey.bind(N),
    pi = N.basenameOrAuthority.bind(N),
    cn = N.basename.bind(N),
    gi = N.extname.bind(N),
    bi = N.dirname.bind(N),
    hn = N.joinPath.bind(N),
    wi = N.normalizePath.bind(N),
    Ci = N.relativePath.bind(N),
    yi = N.resolvePath.bind(N),
    Li = N.isAbsolutePath.bind(N),
    Ze = N.isEqualAuthority.bind(N),
    Xe = N.hasTrailingPathSeparator.bind(N),
    Ni = N.removeTrailingPathSeparator.bind(N),
    Ai = N.addTrailingPathSeparator.bind(N),
    et;
(function(e) {
...
`) - 1,
        ...
        delta(t) {
            return new R(this.startLineNumber + t, this.startColumn, this.endLineNumber + t, this.endColumn)
        }
        isSingleLine() {
...
var xi = class K {
        ...
        constructor(t, r) {
            this._state = 0, this._results = [], this._error = null, this._onReturn = r, this._onStateChanged = new B, queueMicrotask(async () => {
                const n = {
...
function mn(e = "") {
    let t = "(-?\\d*\\.\\d\\w*)|([^";
    for (const r of dn) e.indexOf(r) >= 0 || (t += "\\" + r);
...
function at(e, t, r, n, i) {
    if (t = st(t), i || (i = O1.first(ot)), r.length > i.maxLen) {
        let l = e - i.maxLen / 2;
        return l < 0 ? l = 0 : n += l, r = r.substring(l, e + i.maxLen / 2), at(e, t, r, n, i)
    }
    const s = Date.now(),
        o = e - 1 - n;
    let a = -1,
...
var pn = class {
        ...
        setValue(e, t) {
            return e = d1(e), t = d1(t), this.values[e] === t ? !1 : (this.values[e] = t, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0)
        }
        removeValues(e, t) {
            e = d1(e), t = d1(t);
            const r = this.values,
        ...
        getPrefixSum(e) {
            return e < 0 ? 0 : (e = d1(e), this._getPrefixSum(e))
        }
        _getPrefixSum(e) {
    ...
    bn = class {
        ...
        onEvents(e) {
            ...
            const t = e.changes;
            for (const r of t) this._acceptDeleteRange(r.range), this._acceptInsertText(new p1(r.range.startLineNumber, r.range.startColumn), r.text);
    ...
    Si = 60 * 1e3,
    wn = "workerTextModelSync",
    Cn = class {
        constructor() {
            this._models = Object.create(null)
        }
        bindToServer(e) {
            e.setChannel(wn, this)
        }
        getModel(e) {
        ...
        $acceptNewModel(e) {
            this._models[e.url] = new yn(H.parse(e.url), e.lines, e.EOL, e.versionId)
        }
    ...
    yn = class extends bn {
        ...
        getWordAtPosition(e, t) {
            const r = at(e.column, st(t), this._lines[e.lineNumber - 1], 0);
    ...
    Ln = class de {
        constructor(t) {
            this.workerTextModelSyncServer = new Cn, this.patterns = new Map, this.workerTextModelSyncServer.bindToServer(t)
        }
        $setWorkspaceFolders(t) {
            this.computePatterns(t)
        }
        computePatterns(t) {
            const r = t.sort((n, i) => i.length - n.length).map(n => H.parse(n));
            for (const n of r) {
                const i = de.createPatterns(n);
                this.patterns.set(n, i)
            }
        }
        getModel(t) {
        ...
        $computeLinks(t) {
            ...
            const n = [],
                i = $e(r.getValue());
            for (const [s, o] of this.patterns) {
                const a = {
                    toResource: u => typeof u == "string" ? hn(s, u) : null
                };
                for (let u = 0, l = i.length; u < l; u++) n.push(...de.detectLinks(i[u], u + 1, o, a))
            }
            return n
        }
        static createPatterns(t) {
            const r = [],
                n = t.scheme === M.file ? t.fsPath : t.path,
                i = [n];
            i1 && t.scheme === M.file && i.push(oe(n));
            for (const s of i) {
                const o = `[^\\s\\(\\):<>'"]`,
                    u = `${`(?:${o}| ${o})`}+\\.${o}+`,
                    l = `${o}+`;
                r.push(new RegExp(D1(s) + `(${u}) on line ((\\d+)(, column (\\d+))?)`, "gi")), r.push(new RegExp(D1(s) + `(${u}):line ((\\d+)(, column (\\d+))?)`, "gi")), r.push(new RegExp(D1(s) + `(${u})(\\s?\\((\\d+)(,(\\d+))?)\\)`, "gi")), r.push(new RegExp(D1(s) + `(${l})(:(\\d+))?(:(\\d+))?`, "gi"))
            }
            return r
        }
        static detectLinks(t, r, n, i) {
            const s = [];
            return n.forEach(o => {
                o.lastIndex = 0;
                let a, u = 0;
                for (;
                    (a = o.exec(t)) !== null;) {
                    const l = Ue(a[1], ".").replace(/\\/g, "/");
                    let h;
                    try {
                        const y = i.toResource(l);
                        y && (h = y.toString())
                    } catch {
                        continue
                    }
                    ...
                    if (s.some(y => tt.areIntersectingOrTouching(y.range, b))) return;
                    s.push({
                        range: b,
                        url: h
                    })
...
var En = class {
    ...
    kn = class {
        ...
        sendMessage(e, t, r) {
            ...
            return new Promise((i, s) => {
                this._pendingReplies[n] = {
                    resolve: i,
                    reject: s
                }, this._send(new En(this._workerId, n, e, t, r))
            })
        }
        listen(e, t, r) {
            let n = null;
            const i = new B({
                onWillAddFirstListener: () => {
                    n = String(++this._lastSentReq), this._pendingEmitters.set(n, i), this._send(new xn(this._workerId, n, e, t, r))
                },
                onDidRemoveLastListener: () => {
                    this._pendingEmitters.delete(n), this._send(new Pn(this._workerId, n)), n = null
                }
            });
            return i.event
        }
        ...
        createProxyToRemoteChannel(e, t) {
            const r = {
                get: (n, i) => (typeof i == "string" && !n[i] && (ft(i) ? n[i] = s => this.listen(e, i, s) : ht(i) ? n[i] = this.listen(e, i, void 0) : i.charCodeAt(0) === 36 && (n[i] = async (...s) => (await t?.(), this.sendMessage(e, i, s)))), n[i])
            };
        ...
        _handleRequestMessage(e) {
            ...
            this._handler.handleMessage(e.channel, e.method, e.args).then(n => {
                this._send(new ct(this._workerId, t, n, void 0))
            }, n => {
                n.detail instanceof Error && (n.detail = J1(n.detail)), this._send(new ct(this._workerId, t, void 0, J1(n)))
            })
        }
        _handleSubscribeEventMessage(e) {
            const t = e.req,
                r = this._handler.handleEvent(e.channel, e.eventName, e.arg)(n => {
                    this._send(new Sn(this._workerId, t, n))
                });
...
var Rn = class {
        ...
        _handleMessage(e, t, r) {
            if (e === ue && t === An) return this.initialize(r[0]);
...
function Tn(e) {
    ...
    ce = !0;
    const t = new Rn(r => globalThis.postMessage(r), r => e(r));
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/a80ff7dfcaa45d7750f6e30be457261379c29b00/core/vs/workbench/contrib/output/common/outputLinkComputerMain.js.map

//# debugId=22ab5754-7b6c-5993-8199-75f7fcb28a7a