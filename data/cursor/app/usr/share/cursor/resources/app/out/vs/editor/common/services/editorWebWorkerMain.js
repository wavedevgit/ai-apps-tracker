...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "b932c701-793b-592c-b893-a8215b4f0cbe")
    } catch (e) {}
}();
var Ki = function(e, t) {
...
var Vc = Object.create ? (function(e, t) {
...
var Gc = typeof SuppressedError == "function" ? SuppressedError : function(e, t, n) {
    var r = new Error(n);
    return r.name = "SuppressedError", r.error = e, r.suppressed = t, r
};
export function __disposeResources(e) {
    function t(r) {
        e.error = e.hasError ? new Gc(r, e.error, "An error was suppressed during disposal.") : r, e.hasError = !0
    }
...
function Yc(e) {
    return e instanceof $c ? !0 : e instanceof Error && e.name === ta && e.message === ta
}
var $c = class extends Error {
        constructor() {
            if (super(ta), this.name = this.message, jc && typeof console < "u") {
                const e = new Error().stack ?? "";
                zc.some(t => e.includes(t)) && console.trace("[DebugCancellation] CancellationError created")
            }
        }
    },
    na = class Ka extends Error {
        constructor(t) {
...
var D2 = class {
    ...
    constructor(e, t) {
        this.toKey = t, this._map = new Map, this[io] = "SetWithKey";
...
function ra(e, t, n = 0, r = e.length) {
    let s = n,
        i = r;
    for (; s < i;) {
        const o = Math.floor((s + i) / 2);
...
var M2 = class $i {
        ...
        filter(t) {
            return new $i(n => this.iterate(r => t(r) ? n(r) : !0))
        }
        map(t) {
            return new $i(n => this.iterate(r => n(t(r))))
        }
        some(t) {
            let n = !1;
        ...
        findLastMaxBy(t) {
            let n, r = !0;
            return this.iterate(s => ((r || sa.isGreaterThan(t(s, n))) && (r = !1, n = s), !0)), n
        }
    },
    uo, lo, co, s0 = class {
        constructor(e, t) {
...
var mo = class pn {
        ...
        constructor(t, n) {
            if (this[uo] = "ResourceMap", t instanceof pn) this.map = new Map(t.map), this.toKey = n ?? pn.defaultToKey;
            else if (i0(t)) {
        ...
        set(t, n) {
            return this.map.set(this.toKey(t), new s0(t, n)), this
        }
        get(t) {
    ...
    F2 = class {
        constructor(e, t) {
            this[lo] = "ResourceSet", !e || typeof e == "function" ? this._map = new mo(e) : (this._map = new mo(t), e.forEach(this.add, this))
        }
        get size() {
            return this._map.size
        }
...
var a0 = class {
        constructor() {
            this[co] = "LinkedMap", this._map = new Map, this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0
        }
        clear() {
        ...
        entries() {
            ...
            return r
        } [(co = Symbol.toStringTag, Symbol.iterator)]() {
            return this.entries()
        }
        trimOld(e) {
...
function l0(e, t = "Unreachable") {
    throw new Error(t)
}

function c0(e, t = "unexpected state") {
...
(function(e) {
    ...
    function* T(...L) {
        for (const I of L) h0(I) ? yield* I: yield I
    }
    e.concat = T;
...
var la = class kc {
        ...
        constructor() {
            this._toDispose = new Set, this._isDisposed = !1, aa(this)
        }
        dispose() {
            this._isDisposed || (oa(this), this._isDisposed = !0, this.clear())
        }
        get isDisposed() {
        ...
        add(t) {
            ...
            return ua(t, this), this._isDisposed ? kc.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t
        }
        delete(t) {
            if (t) {
        ...
        deleteAndLeak(t) {
            t && this._toDispose.has(t) && (this._toDispose.delete(t), ua(t, null))
        }
    },
    ut = class {
        static {
        ...
        constructor() {
            this._store = new la, aa(this), ua(this._store, this)
        }
        dispose() {
            oa(this), this._store.dispose()
        }
        _register(e) {
    ...
    ee = class zi {
        static {
            this.Undefined = new zi(void 0)
        }
        constructor(t) {
            this.element = t, this.next = zi.Undefined, this.prev = zi.Undefined
        }
    },
    w0 = class {
        constructor() {
    ...
    N0 = globalThis.performance && typeof globalThis.performance.now == "function",
    po = class Ac {
        static create(t) {
            return new Ac(t)
        }
        constructor(t) {
            this._now = N0 && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1
        }
        stop() {
...
(function(e) {
    ...
    function t(D) {
        if (b0) {
            ...
            let x = 0;
            D.onDidAddListener = () => {
                ++x === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), O.print()), P?.()
            }
        }
    }
    ...
    function r(D) {
        return (P, O = null, x) => {
            let F = !1,
                V;
            return V = D(j => {
                if (!F) return V ? V.dispose() : F = !0, P.call(O, j)
            }, null, x), F && V.dispose(), V
        }
    }
    e.once = r;
    ...
    function i(D, P, O) {
        return h((x, F = null, V) => D(j => x.call(F, P(j)), null, V), O)
    }
    e.map = i;

    function o(D, P, O) {
        return h((x, F = null, V) => D(j => {
            P(j), x.call(F, j)
        }, null, V), O)
    }
    e.forEach = o;
    ...
    function u(D, P, O) {
        return h((x, F = null, V) => D(j => P(j) && x.call(F, j), null, V), O)
    }
    e.filter = u;
    ...
    function c(...D) {
        return (P, O = null, x) => {
            const F = p0(...D.map(V => V(j => P.call(O, j))));
            return d(F, x)
        }
    }
    e.any = c;
    ...
    function g(D, P, O = 100, x = !1, F = !1, V, j) {
        let ue, fe, st, Qs = 0,
            Gt;
        const so = {
            ...
            onWillAddFirstListener() {
                ue = D(Cc => {
                    Qs++, fe = P(fe, Cc), x && !st && (Zs.fire(fe), fe = void 0), Gt = () => {
                        const qc = fe;
                        fe = void 0, st = void 0, (!x || Qs > 1) && Zs.fire(qc), Qs = 0
                    }, typeof O == "number" ? (clearTimeout(st), st = setTimeout(Gt, O)) : st === void 0 && (st = 0, queueMicrotask(Gt))
                })
            },
        ...
        j || t(so);
        const Zs = new Ne(so);
        return j?.add(Zs), Zs.event
    }
    e.debounce = g;

    function p(D, P = 0, O) {
        return e.debounce(D, (x, F) => x ? (x.push(F), x) : [F], P, void 0, !0, void 0, O)
    }
    e.accumulate = p;

    function T(D, P = (x, F) => x === F, O) {
        let x = !0,
            F;
        return u(D, V => {
            const j = x || !P(V, F);
    ...
    function _(D, P, O) {
        return [e.filter(D, P, O), e.filter(D, x => !P(x), O)]
    }
    e.split = _;

    function b(D, P = !1, O = [], x) {
        let F = O.slice(),
            V = D(fe => {
    ...
    class S {
        ...
        forEach(P) {
            return this.steps.push(O => (P(O), O)), this
        }
        filter(P) {
            return this.steps.push(O => P(O) ? O : y), this
        }
        reduce(P, O) {
            let x = O;
            return this.steps.push(F => (x = P(x, F), x)), this
        }
        latch(P = (O, x) => O === x) {
            let O = !0,
                x;
    ...
    function L(D, P, O = x => x) {
        const x = (...ue) => j.fire(O(...ue)),
            F = () => D.on(P, x),
            V = () => D.removeListener(P, x),
            j = new Ne({
    ...
    function R(D, P, O = x => x) {
        const x = (...ue) => j.fire(O(...ue)),
            F = () => D.addEventListener(P, x),
            V = () => D.removeEventListener(P, x),
            j = new Ne({
                onWillAddFirstListener: F,
                onDidRemoveLastListener: V
            });
    ...
    function A(D, P) {
        return new Promise(O => r(D)(O, null, P))
    }
    e.toPromise = A;
    ...
    class J {
        constructor(P, O) {
            ...
            O || t(x), this.emitter = new Ne(x), O && O.add(this.emitter)
        }
        beginUpdate(P) {
            this._counter++
        }
    ...
    function Jc(D) {
        return (P, O, x) => {
            ...
            const j = {
                ...
                endUpdate() {
                    F--, F === 0 && (D.reportChanges(), V && (V = !1, P.call(O)))
                },
            ...
            return x instanceof la ? x.add(ue) : Array.isArray(x) && x.push(ue), ue
        }
    }
    e.fromObservableLight = Jc
})(ti || (ti = {}));
var v0 = class eo {
        static {
            this.all = new Set
        ...
        constructor(t) {
            this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${eo._idPool++}`, eo.all.add(this)
        }
        start(t) {
            this._stopWatch = new po, this.listenerCount = t
        }
        stop() {
            if (this._stopWatch) {
    ...
    E0 = class Ic {
        ...
        constructor(t, n, r = (Ic._idPool++).toString(16).padStart(3, "0")) {
...
`))
    ...
    ni = class {
        constructor(e) {
            this.value = e, this.id = y0++
        }
    },
    L0 = 2,
    R0 = (e, t) => {
        if (e instanceof ni) t(e);
        else
    ...
    Ne = class {
        constructor(e) {
            this._size = 0, this._options = e, this._leakageMon = No > 0 || this._options?.leakWarningThreshold ? new E0(e?.onListenerError ?? Wt, this._options?.leakWarningThreshold ?? No) : void 0, this._perfMon = this._options?._profName ? new v0(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue
        }
        dispose() {
            if (!this._disposed) {
            ...
            return this._event ??= (e, t, n) => {
                if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
                    ...
                    const l = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
                        c = new _0(`${u}. HINT: Stack shows most frequent listener (${l[1]}-times)`, l[0]);
                ...
                const r = new ni(e);
                let s, i;
                this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (r.stack = ca.create(), s = this._leakageMon.check(r.stack, this._size + 1)), wo && (r.stack = i ?? ca.create()), this._listeners ? this._listeners instanceof ni ? (this._deliveryQueue ??= new k0, this._listeners = [this._listeners, r]) : this._listeners.push(r) : (this._options?.onWillAddFirstListener?.(this), this._listeners = r, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
                const o = ei(() => {
                    s?.(), this._removeListener(r)
                });
                return n instanceof la ? n.add(o) : Array.isArray(n) && n.push(o), o
            }, this._event
        }
        _removeListener(e) {
        ...
        fire(e) {
            if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners)
                if (this._listeners instanceof ni) this._deliver(this._listeners, e);
                else {
...
var I0 = bo() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
...
function vo(e, t) {
    ...
    }), I0 && (n = "\uFF3B" + n.replace(/[aouei]/g, "$&$&") + "\uFF3D"), n
}

function B(e, t, ...n) {
    return vo(typeof e == "number" ? S0(e, t) : t, n)
}
...
var _o = typeof de?.versions?.electron == "string",
    B0 = _o && de?.type === "renderer";
if (typeof de == "object") {
    ri = de.platform === "win32", si = de.platform === "darwin", zt = de.platform === "linux", P0 = zt && !!de.env.SNAP && !!de.env.SNAP_REVISION, x0 = _o, D0 = !!de.env.CI || !!de.env.BUILD_ARTIFACTSTAGINGDIRECTORY, ii = lt, ai = lt;
    const e = de.env.VSCODE_NLS_CONFIG;
    if (e) try {
        const t = JSON.parse(e);
        ii = t.userLocale, To = t.osLocale, ai = t.resolvedLanguage || lt, F0 = t.languagePack?.translationsConfigFile
    } catch {}
    Eo = !0
} else typeof navigator == "object" && !B0 ? (Me = navigator.userAgent, ri = Me.indexOf("Windows") >= 0, si = Me.indexOf("Macintosh") >= 0, O0 = (Me.indexOf("Macintosh") >= 0 || Me.indexOf("iPad") >= 0 || Me.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, zt = Me.indexOf("Linux") >= 0, M0 = Me?.indexOf("Mobi") >= 0, ma = !0, ai = bo() || lt, ii = navigator.language.toLowerCase(), To = ii) : console.error("Unable to resolve platform.");
var yo;
(function(e) {
    e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows"
})(yo || (yo = {}));
var ha = 0;
si ? ha = 1 : ri ? ha = 3 : zt && (ha = 2);
var ct = ri,
    U0 = si,
    J0 = zt,
    C0 = Eo,
    q0 = ma,
    V0 = ma && typeof Fe.importScripts == "function",
    G0 = V0 ? Fe.origin : void 0,
    Ie = Me,
    Ge = ai,
    Lo;
(function(e) {
...
var W0 = typeof Fe.postMessage == "function" && !Fe.importScripts,
    H0 = (() => {
        if (W0) {
            const e = [];
...
var Y0 = !!(Ie && Ie.indexOf("Chrome") >= 0),
    U2 = !!(Ie && Ie.indexOf("Firefox") >= 0),
    J2 = !!(!Y0 && Ie && Ie.indexOf("Safari") >= 0),
    C2 = !!(Ie && Ie.indexOf("Edg/") >= 0),
    q2 = !!(Ie && Ie.indexOf("Android") >= 0),
    V2 = de?.arch,
    G2 = de?.platform,
    W2 = de?.versions?.node,
    ko = Object.freeze(function(e, t) {
...
(function(e) {
    function t(n) {
        return n === e.None || n === e.Cancelled || n instanceof ui ? !0 : !n || typeof n != "object" ? !1 : typeof n.isCancellationRequested == "boolean" && typeof n.onCancellationRequested == "function"
    }
    e.isCancellationToken = t, e.None = Object.freeze({
        isCancellationRequested: !1,
        onCancellationRequested: ti.None
    }), e.Cancelled = Object.freeze({
        isCancellationRequested: !0,
        onCancellationRequested: ko
    })
})(oi || (oi = {}));
var ui = class {
        constructor() {
        ...
        get onCancellationRequested() {
            return this._isCancelled ? ko : (this._emitter || (this._emitter = new Ne), this._emitter.event)
        }
        dispose() {
    ...
    $0 = class {
        ...
        get token() {
            return this._token || (this._token = new ui), this._token
        }
        cancel() {
            this._token ? this._token instanceof ui && this._token.cancel() : this._token = oi.Cancelled
        }
        dispose(e = !1) {
            e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof ui && this._token.dispose() : this._token = oi.None
        }
    };
...
var j0 = class {
        constructor(e, t) {
            this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = z0) : (this._fn = t, this._computeKey = e.getCacheKey)
        }
        get(e) {
...
function em(e, t, n = 0, r = e.length, s = 0, i = t.length) {
    for (; n < r && s < i; n++, s++) {
...
function Io(e, t, n = 0, r = e.length, s = 0, i = t.length) {
    for (; n < r && s < i; n++, s++) {
        let l = e.charCodeAt(n),
            c = t.charCodeAt(s);
        if (l === c) continue;
        if (l >= 128 || c >= 128) return em(e.toLowerCase(), t.toLowerCase(), n, r, s, i);
        So(l) && (l -= 32), So(c) && (c -= 32);
        const f = l - c;
        if (f !== 0) return f
    }
...
function tm(e, t) {
    return e.length === t.length && Io(e, t) === 0
}

function nm(e, t) {
    const n = t.length;
    return t.length > e.length ? !1 : Io(e, t, 0, n) === 0
}
...
var om = /(?:\x1b\[|\x9b)[=?>!]?[\d;:]*["$#'* ]?[a-zA-Z@^`{}|~]/,
    um = /(?:\x1b\]|\x9d).*?(?:\x1b\\|\x07|\x9c)/,
    lm = /\x1b(?:[ #%\(\)\*\+\-\.\/]?[a-zA-Z0-9\|}~@])/,
    H2 = new RegExp("(?:" + [om.source, um.source, lm.source].join("|") + ")", "g"),
    Y2 = "\uFEFF",
    Do;
(function(e) {
...
var ga = class Nn {
        ...
        static {
            this._locales = new fa(() => Object.keys(Nn.ambiguousCharacterData.value).filter(t => !t.startsWith("_")))
        }
        static getLocales() {
...
var hm = class {
    ...
    pm = class {
        ...
        sendMessage(e, t, n) {
            ...
            return new Promise((s, i) => {
                this._pendingReplies[r] = {
                    resolve: s,
                    reject: i
                }, this._send(new hm(this._workerId, r, e, t, n))
            })
        }
        listen(e, t, n) {
            let r = null;
            const s = new Ne({
                onWillAddFirstListener: () => {
                    r = String(++this._lastSentReq), this._pendingEmitters.set(r, s), this._send(new fm(this._workerId, r, e, t, n))
                },
                onDidRemoveLastListener: () => {
                    this._pendingEmitters.delete(r), this._send(new gm(this._workerId, r)), r = null
                }
            });
            return s.event
        }
        ...
        createProxyToRemoteChannel(e, t) {
            const n = {
                get: (r, s) => (typeof s == "string" && !r[s] && (Jo(s) ? r[s] = i => this.listen(e, s, i) : Uo(s) ? r[s] = this.listen(e, s, void 0) : s.charCodeAt(0) === 36 && (r[s] = async (...i) => (await t?.(), this.sendMessage(e, s, i)))), r[s])
            };
        ...
        _handleRequestMessage(e) {
            ...
            this._handler.handleMessage(e.channel, e.method, e.args).then(r => {
                this._send(new Bo(this._workerId, t, r, void 0))
            }, r => {
                r.detail instanceof Error && (r.detail = ea(r.detail)), this._send(new Bo(this._workerId, t, void 0, ea(r)))
            })
        }
        _handleSubscribeEventMessage(e) {
            const t = e.req,
                n = this._handler.handleEvent(e.channel, e.eventName, e.arg)(r => {
                    this._send(new dm(this._workerId, t, r))
                });
...
var wm = class {
        constructor(e, t) {
            this._localChannels = new Map, this._remoteChannels = new Map, this._protocol = new pm({
                sendMessage: (n, r) => {
                    e(n, r)
                },
        ...
        _handleMessage(e, t, n) {
            if (e === wa && t === mm) return this.initialize(n[0]);
            const r = e === wa ? this.requestHandler : this._localChannels.get(e);
...
function Nm(e) {
    if (Na) throw new Error("WebWorker already initialized!");
    Na = !0;
    const t = new wm(n => globalThis.postMessage(n), n => e(n));
...
function vm(e, t) {
    t = Co(149417, t);
    for (let n = 0, r = e.length; n < r; n++) t = Co(e.charCodeAt(n), t);
    return t
}
var qo;
(function(e) {
...
var j2 = class Pc {
        ...
        _step() {
            const t = Pc._bigBlock32,
                n = this._buffDV;
            for (let h = 0; h < 64; h += 4) t.setUint32(h, n.getUint32(h, !1), !1);
            for (let h = 64; h < 320; h += 4) t.setUint32(h, ba(t.getUint32(h - 12, !1) ^ t.getUint32(h - 32, !1) ^ t.getUint32(h - 56, !1) ^ t.getUint32(h - 64, !1), 1), !1);
            let r = this._h0,
                s = this._h1,
                i = this._h2,
                o = this._h3,
                u = this._h4,
                l, c, f;
            for (let h = 0; h < 80; h++) h < 20 ? (l = s & i | ~s & o, c = 1518500249) : h < 40 ? (l = s ^ i ^ o, c = 1859775393) : h < 60 ? (l = s & i | s & o | i & o, c = 2400959708) : (l = s ^ i ^ o, c = 3395469782), f = ba(r, 5) + l + u + c + t.getUint32(h * 4, !1) & 4294967295, u = o, o = i, i = ba(s, 30), s = r, r = f;
...
function Em(e, t, n) {
    return new Ho(new Vo(e), new Vo(t)).ComputeDiff(n).changes
}
var mt = class {
        static Assert(e, t) {
    ...
    Ho = class Rt {
        ...
        static _getElements(t) {
            ...
            if (Rt._isStringArray(n)) {
                ...
                for (let s = 0, i = n.length; s < i; s++) r[s] = vm(n[s], 0);
                return [n, r, !0]
            }
        ...
        WALKTRACE(t, n, r, s, i, o, u, l, c, f, h, d, g, p, T, _, b, k) {
            ...
            if (y = L.getReverseChanges(), k[0]) {
                ...
                L = new Wo, I = o, R = u, A = g[0] - _[0] - l, C = 1073741824, W = b ? this.m_reverseHistory.length - 1 : this.m_reverseHistory.length - 2;
                do {
                    const H = A + i;
...
var Tm = class xc {
        constructor(t) {
            const n = $o(t);
            this._defaultValue = n, this._asciiMap = xc._createAsciiMap(n), this._map = new Map
        }
        ...
        for (let i = 1, o = t.getLineCount(); i <= o; i++) {
            ...
            for (; c < l;) {
                ...
                if (d === 13) {
                    ...
                    y === 1 && (s.push(to._createLink(r, u, i, f, c)), b = !0)
                } else if (d === 12) {
                    let y;
            ...
            d === 13 && s.push(to._createLink(r, u, i, f, l))
        }
        return s
    }
};
...
function Am(e) {
    return !e || typeof e.getLineCount != "function" || typeof e.getLineContent != "function" ? [] : km.computeLinks(e)
}
var Im = class Oc {
        constructor() {
...
var Ea = class {
    ...
    Ko = [],
    ya = [];
for (let e = 0; e <= 193; e++) Ko[e] = -1;
for (let e = 0; e <= 132; e++) ya[e] = -1;
(function() {
    const t = [
    ...
    for (const s of t) {
        ...
        if (r[o] || (r[o] = !0, xm[o] = u, Om[u] = o, Dm[u.toLowerCase()] = o, i && (Ko[o] = l, l !== 0 && l !== 3 && l !== 5 && l !== 4 && l !== 6 && l !== 57 && (ya[l] = o))), !n[l]) {
            if (n[l] = !0, !c) throw new Error(`String representation missing for key code ${l} around scan code ${u}`);
            ci.define(l, c), Ta.define(l, d || c), _a.define(l, g || d || c)
        }
        f && (Sm[f] = l), h && (Pm[h] = l)
    }
    ya[3] = 46
...
(function(e) {
    ...
    function s(u) {
        return _a.keyCodeToStr(u)
    }
    e.toUserSettingsGeneral = s;

    function i(u) {
        return Ta.strToKeyCode(u) || _a.strToKeyCode(u)
    }
...
var Q2 = 2091,
    Z2 = 2096,
    Xe, La = globalThis.vscode;
if (typeof La < "u" && typeof La.process < "u") {
    const e = La.process;
    Xe = {
        get platform() {
            return e.platform
    ...
    get platform() {
        return ct ? "win32" : U0 ? "darwin" : "linux"
    },
    get arch() {},
    get env() {
        return {}
...
var ie = {
        resolve(...e) {
            ...
            for (let s = e.length - 1; s >= -1; s--) {
                ...
                } else t.length === 0 ? i = mi() : (i = Fm[`=${t}`] || mi(), (i === void 0 || i.slice(0, 2).toLowerCase() !== t.toLowerCase() && i.charCodeAt(2) === pe) && (i = `${t}\\`));
                const o = i.length;
                let u = 0,
                    l = "",
                    c = !1;
        ...
        toNamespacedPath(e) {
            ...
            if (t.charCodeAt(0) === pe) {
                if (t.charCodeAt(1) === pe) {
                    ...
                    if (n !== Vm && n !== Qe) return `\\\\?\\UNC\\${t.slice(2)}`
                }
...
var Ym = we ? ie.normalize : X.normalize,
    e5 = we ? ie.isAbsolute : X.isAbsolute,
    $m = we ? ie.join : X.join,
    zm = we ? ie.resolve : X.resolve,
    jm = we ? ie.relative : X.relative,
    Xm = we ? ie.dirname : X.dirname,
    t5 = we ? ie.basename : X.basename,
    n5 = we ? ie.extname : X.extname,
    r5 = we ? ie.format : X.format,
    s5 = we ? ie.parse : X.parse,
    i5 = we ? ie.toNamespacedPath : X.toNamespacedPath,
    fi = we ? ie.sep : X.sep,
    a5 = we ? ie.delimiter : X.delimiter,
    ce;
(function(e) {
...
var Qm = "tkn",
    Zm = class {
        ...
        setServerRootPath(e, t) {
            this._serverRootPath = X.join(t ?? "/", eh(e))
        }
        getServerRootPath() {
        ...
        rewrite(e) {
            ...
            return typeof s == "string" && (i += `&${Qm}=${encodeURIComponent(s)}`), be.from({
                scheme: q0 ? this._preferredWebSchema : ce.vscodeRemoteResource,
                authority: `${n}:${r}`,
...
var th = "vscode-app",
    nh = class ji {
        ...
        uriToBrowserUri(t) {
            return t.scheme === ce.vscodeRemote ? Km.rewrite(t) : t.scheme === ce.file && (C0 || G0 === `${ce.vscodeFileResource}://${ji.FALLBACK_AUTHORITY}`) ? t.with({
        ...
        uriToFileUri(t) {
            return t.scheme === ce.vscodeFileResource ? t.with({
                scheme: ce.file,
                authority: t.authority !== ji.FALLBACK_AUTHORITY ? t.authority : null,
                query: null,
                fragment: null
            }) : t
        }
...
function ah(e, t) {
    ...
    if (e.scheme && !rh.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
    if (e.path) {
        if (e.authority) {
            if (!sh.test(e.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')
        } else if (ih.test(e.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')
    }
}
...
var Z = "",
    ...
    be = class Xi {
        static isUri(t) {
            return t instanceof Xi ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1
        }
        constructor(t, n, r, s, i, o = !1) {
            typeof t == "object" ? (this.scheme = t.scheme || Z, this.authority = t.authority || Z, this.path = t.path || Z, this.query = t.query || Z, this.fragment = t.fragment || Z) : (this.scheme = oh(t, o), this.authority = n || Z, this.path = uh(this.scheme, r || Z), this.query = s || Z, this.fragment = i || Z, ah(this, o))
        }
        get fsPath() {
            return di(this, !1)
        }
        ...
        static parse(t, n = !1) {
            const r = lh.exec(t);
            return r ? new dt(r[2] || Z, gi(r[4] || Z), gi(r[5] || Z), gi(r[7] || Z), gi(r[9] || Z), n) : new dt(Z, Z, Z, Z, Z)
        }
        static file(t) {
            let n = Z;
        ...
        static joinPath(t, ...n) {
            ...
            let r;
            return ct && t.scheme === "file" ? r = Xi.file(ie.join(di(t, !0), ...n)).path : r = X.join(t.path, ...n), t.with({
                path: r
            })
        }
        toString(t = !1) {
        ...
        static revive(t) {
            if (t) {
                ...
                {
                    const n = new dt(t);
                    return n._formatted = t.external ?? null, n._fsPath = t._sep === i1 ? t.fsPath ?? null : null, n
                }
            } else return t
    ...
    dt = class extends be {
        ...
        toString(e = !1) {
            return e ? ka(this, !0) : (this._formatted || (this._formatted = ka(this, !1)), this._formatted)
        }
        toJSON() {
            const e = {
                $mid: 1
            };
            return this._fsPath && (e.fsPath = this._fsPath, e._sep = i1), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e
        }
    },
    a1 = {
        58: "%3A",
...
function ch(e) {
    ...
    for (let n = 0; n < e.length; n++) {
        const r = e.charCodeAt(n);
        r === 35 || r === 63 ? (t === void 0 && (t = e.substr(0, n)), t += a1[r]) : t !== void 0 && (t += e[n])
    }
    return t !== void 0 ? t : e
}
...
function ka(e, t) {
    ...
    return u && (r += "?", r += n(u, !1, !1)), l && (r += "#", r += t ? l : o1(l, !1, !1)), r
}
...
function u1(e) {
    try {
        ...
        return e.length > 3 ? e.substr(0, 3) + u1(e.substr(3)) : e
    }
}
var l1 = /(%[0-9A-Za-z][0-9A-Za-z])+/g;

function gi(e) {
    return e.match(l1) ? e.replace(l1, t => u1(t)) : e
}
var c1;
(function(e) {
    e[e.LTR = 0] = "LTR", e[e.RTL = 1] = "RTL"
})(c1 || (c1 = {}));
var mh = class Ee extends U {
        constructor(t, n, r, s) {
...
var hh = {
        ...
        chevronDblRight: a("chevron-dbl-right", 62237),
    ...
    h1 = class {
        ...
        register(e, t) {
            return this._tokenizationSupports.set(e, t), this.handleChange([e]), ei(() => {
...
function _h(e, t, n, r, s) {
    return Eh(e, t, n, r, s) && Th(e, t, n, r, s)
}
var yh = class {
        constructor(e, t) {
        ...
        next(e) {
            ...
            do {
                ...
                if (r === this._prevMatchStartIndex && s === this._prevMatchLength) {
                    if (s === 0) {
                        sm(e, t, this._searchRegex.lastIndex) > 65535 ? this._searchRegex.lastIndex += 2 : this._searchRegex.lastIndex += 1;
                        continue
                    }
                    return null
                }
                if (this._prevMatchStartIndex = r, this._prevMatchLength = s, !this._wordSeparators || _h(this._wordSeparators, e, t, r, s)) return n
            } while (n);
            return null
        }
    },
...
function Rh(e = "") {
    let t = "(-?\\d*\\.\\d\\w*)|([^";
    for (const n of Lh) e.indexOf(n) >= 0 || (t += "\\" + n);
...
function Oa(e, t, n, r, s) {
    if (t = Cu(t), s || (s = Ks.first(qu)), n.length > s.maxLen) {
        let c = e - s.maxLen / 2;
...
var Ah = class {
    static computeUnicodeHighlights(e, t, n) {
        ...
        let u;
        o === "allNonBasicAscii" ? u = new RegExp("[^\\t\\n\\r\\x20-\\x7E]", "g") : u = new RegExp(`${Ih(Array.from(o))}`, "g");
        const l = new yh(null, u),
            c = [];
        let f = !1,
            h, d = 0,
            g = 0,
        ...
        e: for (let T = r, _ = s; T <= _; T++) {
            ...
            do
                if (h = l.next(b), h) {
                    ...
                    if (R !== 0) {
                        if (R === 3 ? d++ : R === 2 ? g++ : R === 1 ? p++ : l0(R), c.length >= 1e3) {
                            f = !0;
                            break e
                        }
        ...
        switch (n.shouldHighlightNonBasicASCII(e, null)) {
            ...
            case 3: {
                const s = e.codePointAt(0),
                    ...
                    o = ga.getLocales().filter(u => !ga.getInstance(new Set([...t.allowedLocales, u])).isAmbiguous(s));
                return {
                    kind: 0,
...
function Ih(e, t) {
    return `[${X0(e.map(r=>String.fromCodePoint(r)).join(""))}]`
}
var Vu;
(function(e) {
...
var Gu = class {
    constructor(e) {
        this.options = e, this.allowedCodePoints = new Set(e.allowedCodePoints), this.ambiguousCharacters = ga.getInstance(new Set(e.allowedLocales))
    }
    getCandidateCodePoints() {
        if (this.options.nonBasicASCII) return "allNonBasicAscii";
        const e = new Set;
        if (this.options.invisibleCharacters)
            for (const t of pa.codePoints) Wu(String.fromCodePoint(t)) || e.add(t);
        ...
        if (t)
            for (const i of t) {
                const o = i.codePointAt(0),
                    u = am(i);
                r = r || u, !u && !this.ambiguousCharacters.isAmbiguous(o) && !pa.isInvisibleCharacter(o) && (s = !0)
            }
        return !r && s ? 0 : this.options.invisibleCharacters && !Wu(e) && pa.isInvisibleCharacter(n) ? 2 : this.options.ambiguousCharacters && this.ambiguousCharacters.isAmbiguous(n) ? 3 : 0
    }
};
...
var Se = class {
    ...
    Sh = class Dc {
        ...
        flip() {
            return new Dc(this.lineRangeMapping.flip(), this.changes.map(t => t.flip()))
        }
    },
    $ = class Te {
        static fromTo(t, n) {
    ...
    q = class ge {
        ...
        static joinMany(t) {
            ...
            let n = new pi(t[0].slice());
            for (let r = 1; r < t.length; r++) n = n.getUnion(new pi(t[r].slice()));
            return n.ranges
        }
        static join(t) {
    ...
    pi = class kt {
        ...
        addRange(t) {
            if (t.length === 0) return;
            const n = ra(this._normalizedRanges, s => s.endLineNumberExclusive >= t.startLineNumber),
        ...
        subtractFrom(t) {
            const n = ra(this._normalizedRanges, o => o.endLineNumberExclusive >= t.startLineNumber),
...
` && (this.lineStartOffsetByLineIdx.push(t + 1), t > 0 && e.charAt(t - 1) === "\r" ? this.lineEndOffsetByLineIdx.push(t - 1) : this.lineEndOffsetByLineIdx.push(t));
    ...
    Ph = class At {
        ...
        constructor(t) {
            this.edits = t, $t(() => ia(t, (n, r) => n.range.getEndPosition().isBeforeOrEqual(r.range.getStartPosition())))
        }
        normalize() {
            const t = [];
        ...
        apply(t) {
            ...
            const s = wi(r, t.endPositionExclusive);
        ...
        equals(t) {
            return oo(this.edits, t.edits, (n, r) => n.equals(r))
        }
    },
    Ze = class vn {
...
var $u = class {
        ...
        getTransformer() {
            return this._transformer || (this._transformer = new Yu(this.getValue())), this._transformer
        }
        getLineAt(e) {
    ...
    xh = class extends $u {
        constructor(e, t) {
            c0(t >= 1), super(), this._getLineContent = e, this._lineCount = t
        }
        getValueOfRange(e) {
...
` + this._getLineContent(e.endLineNumber).substring(0, e.endColumn - 1), t
    ...
    Oh = class extends $u {
        constructor(e) {
            super(), this.value = e, this._t = new Yu(this.value)
        }
        getValueOfRange(e) {
    ...
    pt = class It {
        ...
        toRangeMapping() {
            ...
            if (this.original.startLineNumber === 1 || this.modified.startLineNumber === 1) {
                ...
                return new xe(new U(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new U(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1))
            } else return new xe(new U(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), new U(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER, this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER))
        }
        toRangeMapping2(t, n) {
            if (zu(this.original.endLineNumberExclusive, t) && zu(this.modified.endLineNumberExclusive, n)) return new xe(new U(this.original.startLineNumber, 1, this.original.endLineNumberExclusive, 1), new U(this.modified.startLineNumber, 1, this.modified.endLineNumberExclusive, 1));
            if (!this.original.isEmpty && !this.modified.isEmpty) return new xe(U.fromPositions(new Y(this.original.startLineNumber, 1), wt(new Y(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), U.fromPositions(new Y(this.modified.startLineNumber, 1), wt(new Y(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
            if (this.original.startLineNumber > 1 && this.modified.startLineNumber > 1) return new xe(U.fromPositions(wt(new Y(this.original.startLineNumber - 1, Number.MAX_SAFE_INTEGER), t), wt(new Y(this.original.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), t)), U.fromPositions(wt(new Y(this.modified.startLineNumber - 1, Number.MAX_SAFE_INTEGER), n), wt(new Y(this.modified.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER), n)));
            throw new me
        }
    };
...
var Pe = class Qi extends pt {
        ...
        flip() {
            return new Qi(this.modified, this.original, this.innerChanges?.map(t => t.flip()))
        }
        withInnerChangesFromLineRanges() {
            return new Qi(this.original, this.modified, [this.toRangeMapping()])
        }
    },
    xe = class St {
        static fromEdit(t) {
...
function ju(e, t, n, r = !1) {
    const s = [];
    for (const i of Kc(e.map(o => Dh(o, t, n)), (o, u) => o.original.overlapOrTouch(u.original) || o.modified.overlapOrTouch(u.modified))) {
        const o = i[0],
            u = i[i.length - 1];
        s.push(new Pe(o.original.join(u.original), o.modified.join(u.modified), i.map(l => l.innerChanges[0])))
    }
    return $t(() => !r && s.length > 0 && (s[0].modified.startLineNumber !== s[0].original.startLineNumber || n.length.lineCount - s[s.length - 1].modified.endLineNumberExclusive !== t.length.lineCount - s[s.length - 1].original.endLineNumberExclusive) ? !1 : ia(s, (i, o) => o.original.startLineNumber - i.original.endLineNumberExclusive === o.modified.startLineNumber - i.modified.endLineNumberExclusive && i.original.endLineNumberExclusive < o.original.startLineNumber && i.modified.endLineNumberExclusive < o.modified.startLineNumber)), s
}
    ...
    Fh = class {
        computeDiff(e, t, n) {
            ...
            for (const u of s.changes) {
                ...
                let f = new Pe(l, c, u.charChanges?.map(h => new xe(new U(h.originalStartLineNumber, h.originalStartColumn, h.originalEndLineNumber, h.originalEndColumn), new U(h.modifiedStartLineNumber, h.modifiedStartColumn, h.modifiedEndLineNumber, h.modifiedEndColumn))));
            ...
            return $t(() => ia(i, (u, l) => l.original.startLineNumber - u.original.endLineNumberExclusive === l.modified.startLineNumber - u.modified.endLineNumberExclusive && u.original.endLineNumberExclusive < l.original.startLineNumber && u.modified.endLineNumberExclusive < l.modified.startLineNumber)), new Se(i, [], s.quitEarly)
        }
    };

function Xu(e, t, n, r) {
    return new Ho(e, t, n).ComputeDiff(r)
}
var Qu = class {
        constructor(e) {
            const t = [],
                n = [];
            for (let r = 0, s = e.length; r < s; r++) t[r] = Ma(e[r], 1), n[r] = Fa(e[r], 1);
...
function Uh(e) {
    ...
    for (let r = 1, s = e.length; r < s; r++) {
        ...
        Math.min(o, u) < Mh ? (n.originalLength = i.originalStart + i.originalLength - n.originalStart, n.modifiedLength = i.modifiedStart + i.modifiedLength - n.modifiedStart) : (t.push(i), n = i)
    }
    return t
}
var Da = class Fc {
        ...
        static createFromDiffResult(t, n, r, s, i, o, u) {
            ...
            if (n.originalLength === 0 ? (l = r.getStartLineNumber(n.originalStart) - 1, c = 0) : (l = r.getStartLineNumber(n.originalStart), c = r.getEndLineNumber(n.originalStart + n.originalLength - 1)), n.modifiedLength === 0 ? (f = s.getStartLineNumber(n.modifiedStart) - 1, h = 0) : (f = s.getStartLineNumber(n.modifiedStart), h = s.getEndLineNumber(n.modifiedStart + n.modifiedLength - 1)), o && n.originalLength > 0 && n.originalLength < 20 && n.modifiedLength > 0 && n.modifiedLength < 20 && i()) {
                ...
                if (g.getElements().length > 0 && p.getElements().length > 0) {
                    let T = Xu(g, p, i, !0).changes;
                    u && (T = Uh(T)), d = [];
                    for (let _ = 0, b = T.length; _ < b; _++) d.push(bi.createFromDiffChange(T[_], g, p))
                }
            }
            return new Fc(l, c, f, h, d)
        }
    },
    Zu = class {
        constructor(e, t, n) {
            this.shouldComputeCharChanges = n.shouldComputeCharChanges, this.shouldPostProcessCharChanges = n.shouldPostProcessCharChanges, this.shouldIgnoreTrimWhitespace = n.shouldIgnoreTrimWhitespace, this.shouldMakePrettyDiff = n.shouldMakePrettyDiff, this.originalLines = e, this.modifiedLines = t, this.original = new Qu(e), this.modified = new Qu(t), this.continueLineDiff = Ku(n.maxComputationTime), this.continueCharDiff = Ku(n.maxComputationTime === 0 ? 0 : Math.min(n.maxComputationTime, 5e3))
        }
        computeDiff() {
            ...
            const e = Xu(this.original, this.modified, this.continueLineDiff, this.shouldMakePrettyDiff),
                t = e.changes,
                n = e.quitEarly;
            if (this.shouldIgnoreTrimWhitespace) {
                const o = [];
                for (let u = 0, l = t.length; u < l; u++) o.push(Da.createFromDiffResult(this.shouldIgnoreTrimWhitespace, t[u], this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges));
                return {
                    quitEarly: n,
                    changes: o
                }
            ...
            for (let o = -1, u = t.length; o < u; o++) {
                ...
                l && (r.push(Da.createFromDiffResult(this.shouldIgnoreTrimWhitespace, l, this.original, this.modified, this.continueCharDiff, this.shouldComputeCharChanges, this.shouldPostProcessCharChanges)), s += l.originalLength, i += l.modifiedLength)
            }
            return {
                quitEarly: n,
                changes: r
        ...
        _pushTrimWhitespaceCharChange(e, t, n, r, s, i, o) {
            ...
            let u;
            this.shouldComputeCharChanges && (u = [new bi(t, n, t, r, s, i, s, o)]), e.push(new Da(t, t, s, s, u))
        }
        _mergeTrimWhitespaceCharChange(e, t, n, r, s, i, o) {
            const u = e.length;
            if (u === 0) return !1;
            const l = e[u - 1];
            return l.originalEndLineNumber === 0 || l.modifiedEndLineNumber === 0 ? !1 : l.originalEndLineNumber === t && l.modifiedEndLineNumber === s ? (this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new bi(t, n, t, r, s, i, s, o)), !0) : l.originalEndLineNumber + 1 === t && l.modifiedEndLineNumber + 1 === s ? (l.originalEndLineNumber = t, l.modifiedEndLineNumber = s, this.shouldComputeCharChanges && l.charChanges && l.charChanges.push(new bi(t, n, t, r, s, i, s, o)), !0) : !1
        }
    };
...
var Oe = class no {
        static trivial(t, n) {
            return new no([new te($.ofLength(t.length), $.ofLength(n.length))], !1)
        }
        static trivialTimedOut(t, n) {
            return new no([new te($.ofLength(t.length), $.ofLength(n.length))], !0)
        }
        constructor(t, n) {
    ...
    Ke = class Zi {
        ...
        delta(t) {
            return t === 0 ? this : new Zi(this.offset1 + t, this.offset2 + t)
        }
        equals(t) {
...
`);
    ...
    Ch = class {
        compute(e, t, n = vi.instance, r) {
            ...
            return h !== void 0 && ((h.x !== Math.floor(c / 2) + 1 || h.y !== f) && l.push(new te(new $(Math.floor(c / 2) + 1, h.x), new $(f, h.y))), h = void 0), l.reverse(), new Oe(l, !1)
        }
    },
    qh = class {
        compute(e, t, n = vi.instance, r) {
            ...
            return f(-1, -1), u.reverse(), new Oe(u, !1)
        }
    },
    tl = class {
        compute(e, t, n = vi.instance) {
            if (e.length === 0 || t.length === 0) return Oe.trivial(e, t);
            const r = e,
                s = t;
            ...
            u.set(0, i(0, 0));
            const l = new Gh;
            l.set(0, u.get(0) === 0 ? null : new nl(null, 0, 0, u.get(0)));
            let c = 0;
            e: for (;;) {
                ...
                for (c = p; c <= T; c += 2) {
                    ...
                    if (l.set(c, L !== y ? new nl(I, y, S, L - y) : I), u.get(c) === r.length && u.get(c) - c === s.length) break e
                }
            }
            let f = l.get(c);
            const h = [];
    ...
    Ei = class {
        ...
        getBoundaryScore(e) {
            const t = al(e > 0 ? this.elements[e - 1] : -1),
                n = al(e < this.elements.length ? this.elements[e] : -1);
            if (t === 7 && n === 8) return 0;
            if (t === 8) return 150;
            let r = 0;
            return t !== n && (r += 10, t === 0 && n === 1 && (r += 1)), r += il(t), r += il(n), r
        }
        ...
        findSubWordContaining(e) {
            if (e < 0 || e >= this.elements.length || !Nt(this.elements[e])) return;
            let t = e;
            for (; t > 0 && Nt(this.elements[t - 1]) && !rl(this.elements[t]);) t--;
            let n = e;
            for (; n < this.elements.length && Nt(this.elements[n]) && !rl(this.elements[n]);) n++;
            return new $(t, n)
        }
        countLinesIn(e) {
        ...
        extendToFullLines(e) {
            const t = it(this.firstElementOffsetByLineIdx, r => r <= e.start) ?? 0,
                n = Zc(this.firstElementOffsetByLineIdx, r => e.endExclusive <= r) ?? this.elements.length;
            return new $(t, n)
        }
    };
...
function al(e) {
    return e === 10 ? 8 : e === 13 ? 7 : Ba(e) ? 6 : e >= 97 && e <= 122 ? 0 : e >= 65 && e <= 90 ? 1 : e >= 48 && e <= 57 ? 2 : e === -1 ? 3 : e === 44 || e === 59 ? 5 : 4
}
...
function Hh(e, t, n, r, s, i) {
    ...
    const l = e.filter(f => !u.has(f)),
        c = zh(l, r, s, t, n, i);
    return n0(o, c), o = jh(o), o = o.filter(f => {
        const h = f.original.toOffsetRange().slice(t).map(g => g.trim());
        return h.join(`
`).length >= 15 && Yh(h, g => g.length >= 2) >= 2
    }), o = Xh(e, o), o
}
...
function $h(e, t, n, r) {
    const s = [],
        i = e.filter(l => l.modified.isEmpty && l.original.length >= 3).map(l => new el(l.original, t, l)),
        o = new Set(e.filter(l => l.original.isEmpty && l.modified.length >= 3).map(l => new el(l.modified, n, l))),
        u = new Set;
    for (const l of i) {
        let c = -1,
            f;
...
function zh(e, t, n, r, s, i) {
    ...
    l.sort(r0(Ht(d => d.modifiedLineRange.length, Yt)));
    const c = new pi,
        f = new pi;
    for (const d of l) {
    ...
    for (let d = 0; d < o.length; d++) {
        ...
        for (S = 0; S < _; S++) {
            ...
            if (I > r.length || R > s.length || c.contains(R) || f.contains(I) || !ol(r[I - 1], s[R - 1], i)) break
        }
...
function ol(e, t, n) {
    ...
    const s = new tl().compute(new Ei([e], new U(1, 1, 1, e.length), !1), new Ei([t], new U(1, 1, 1, t.length), !1), n);
    let i = 0;
    ...
    function u(f) {
        let h = 0;
        for (let d = 0; d < e.length; d++) Ba(f.charCodeAt(d)) || h++;
        return h
    }
...
function ul(e, t, n) {
    let r = n;
    return r = ll(e, t, r), r = ll(e, t, r), r = Qh(e, t, r), r
}
...
function Qh(e, t, n) {
    ...
    for (let r = 0; r < n.length; r++) {
        ...
        i.seq1Range.isEmpty ? n[r] = cl(i, e, t, u, l) : i.seq2Range.isEmpty && (n[r] = cl(i.swap(), t, e, l, u).swap())
    }
    return n
}
...
var hl = class {
    ...
    getBoundaryScore(e) {
        const t = e === 0 ? 0 : fl(this.lines[e - 1]),
            n = e === this.lines.length ? 0 : fl(this.lines[e]);
        return 1e3 - (t + n)
    }
    getText(e) {
...
var nf = class {
    constructor() {
        this.dynamicProgrammingDiffing = new qh, this.myersDiffingAlgorithm = new tl, this.streamingDPDiffing = new Ch
    }
    computeDiff(e, t, n) {
        ...
        if (e.length <= 1 && oo(e, t, (R, A) => R === A)) return new Se([], [], !1);
        if (e.length === 1 && e[0].length === 0 || t.length === 1 && t[0].length === 0) return new Se([new Pe(new q(1, e.length + 1), new q(1, t.length + 1), [new xe(new U(1, 1, e.length, e[e.length - 1].length + 1), new U(1, 1, t.length, t[t.length - 1].length + 1))])], [], !1);
        const r = n.maxComputationTimeMs === 0 ? vi.instance : new Jh(n.maxComputationTimeMs, n.shouldGracefullyFallBackOnTimeout),
        ...
        const u = e.length * t.length < 1e6 && n.onlyCareAboutPrefixOfOriginalLines === !0,
            ...
            h = new hl(l, e),
            d = new hl(c, t),
            g = u ? f ? Oe.trivial(h, d) : this.streamingDPDiffing.compute(h, d, r, (R, A) => e[R] === t[A] ? t[A].length === 0 ? .1 : 1 + Math.log(1 + t[A].length) : .99) : h.length + d.length < 1700 ? this.dynamicProgrammingDiffing.compute(h, d, r, (R, A) => e[R] === t[A] ? t[A].length === 0 ? .1 : 1 + Math.log(1 + t[A].length) : .99) : this.myersDiffingAlgorithm.compute(h, d, r);
        let p = g.diffs,
            T = g.hitTimeout;
        if (u) {
        ...
        const _ = T;
        if (p = ul(h, d, p), p = ef(h, d, p), n.skipDiffRefinement) {
            const R = p.map(A => new Pe(new q(A.seq1Range.start + 1, A.seq1Range.endExclusive + 1), new q(A.seq2Range.start + 1, A.seq2Range.endExclusive + 1), void 0));
            return new Se(R, [], T)
        }
        const b = [],
        ...
        k(e.length - y);
        const L = ju(b, new Ni(e), new Ni(t));
        let I = [];
    ...
    computeMoves(e, t, n, r, s, i, o, u) {
        return Hh(e, t, n, r, s, i).map(f => {
            const h = this.refineDiff(t, n, new te(f.original.toOffsetRange(), f.modified.toOffsetRange()), i, o, u),
                d = ju(h.mappings, new Ni(t), new Ni(n), !0);
            return new Sh(f, d)
        })
    }
    refineDiff(e, t, n, r, s, i) {
        const u = rf(n).toRangeMapping2(e, t),
            l = new Ei(e, u.originalRange, s),
            c = new Ei(t, u.modifiedRange, s),
            f = l.length + c.length < 500 ? this.dynamicProgrammingDiffing.compute(l, c, r) : this.myersDiffingAlgorithm.compute(l, c, r),
            h = !1;
        let d = f.diffs;
        h && te.assertSorted(d), d = ul(l, c, d), h && te.assertSorted(d), d = ml(l, c, d, (p, T) => p.findWordContaining(T)), h && te.assertSorted(d), i.extendToSubwords && (d = ml(l, c, d, (p, T) => p.findSubWordContaining(T), !0), h && te.assertSorted(d)), d = Zh(l, c, d), h && te.assertSorted(d), d = tf(l, c, d), h && te.assertSorted(d);
        const g = d.map(p => new xe(l.translateRange(p.seq1Range), c.translateRange(p.seq2Range)));
        return h && xe.assertSorted(g), {
            mappings: g,
...
function sf(e, t, n) {
    let r = gl(e),
        s = gl(t);
    if (s.length * r.length > 1e7 && (r = dl(e), s = dl(t)), s.length === 0 && r.length === 0) return {
        identical: !0,
        quitEarly: !1,
        changes: []
    };
...
var af = 34028234663852886e22,
    of = -34028234663852886e22,
    uf = 4294967295,
    lf = 2147483647,
    cf = -2147483648;
...
function Ti(e) {
    ...
    if (!Number.isInteger(e) || e > lf || e < cf) throw new Error("invalid int 32: " + e)
}

function Ua(e) {
    if (typeof e != "number") throw new Error("invalid uint 32: " + typeof e);
    if (!Number.isInteger(e) || e > uf || e < 0) throw new Error("invalid uint 32: " + e)
}

function pl(e) {
    if (typeof e != "number") throw new Error("invalid float 32: " + typeof e);
    if (Number.isFinite(e) && (e > af || e < of)) throw new Error("invalid float 32: " + e)
}
var wl = Symbol("@bufbuild/protobuf/enum-type");
...
function Tl(e) {
    ...
    function i(o, u) {
        ...
        s *= n, r = r * n + l, r >= _i && (s = s + (r / _i | 0), r = r % _i)
    }
    return i(-24, -18), i(-18, -12), i(-12, -6), i(-6), t ? yl(r, s) : Ca(r, s)
}
...
function _l(e, t) {
    if ({
            lo: e,
            hi: t
        } = gf(e, t), t <= 2097151) return String(_i * t + e);
    const n = e & 16777215,
        r = (e >>> 24 | t << 8) & 16777215,
        s = t >> 16 & 65535;
    let i = n + r * 6777216 + s * 6710656,
        ...
        u = s * 2;
    const l = 1e7;
    return i >= l && (o += Math.floor(i / l), i %= l), o >= l && (u += Math.floor(o / l), o %= l), u.toString() + Ll(o) + Ll(i)
}
...
function wf() {
    ...
    return {
        ...
        enc(s) {
            return typeof s != "string" && (s = s.toString()), n(s), Tl(s)
        },
        uEnc(s) {
            return typeof s != "string" && (s = s.toString()), r(s), Tl(s)
        },
        dec(s, i) {
            return df(s, i)
        },
...
var Je = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".split(""),
    yi = [];
for (let e = 0; e < Je.length; e++) yi[Je[e].charCodeAt(0)] = e;
yi[45] = Je.indexOf("+"), yi[95] = Je.indexOf("/");
var Il = {
    dec(e) {
        let t = e.length * 3 / 4;
        ...
        for (let u = 0; u < e.length; u++) {
            if (i = yi[e.charCodeAt(u)], i === void 0) switch (e[u]) {
                case "=":
                    s = 0;
                case `
`:
...
function Ef(e, t, n) {
    ...
    const r = t.runtime.bin.makeReadOptions(n),
        s = vf(e.getType().runtime.bin.listUnknownFields(e), t.field),
        [i, o] = Al(t);
...
function xl(e, t) {
    ...
    switch (e.kind) {
        case "enum":
        case "scalar":
            return e.opt || e.req ? t[n] !== void 0 : e.kind == "enum" ? t[n] !== e.T.values[0].no : !kl(e.T, t[n]);
        case "message":
            return t[n] !== void 0;
        case "map":
...
function Lf() {
    return {
            ...
            try {
                for (s of n.fields.byNumber()) {
                    if (!xl(s, e)) {
                        ...
                        if (!t.emitDefaultValues || !kf(s)) continue
                    }
        ...
        writeScalar(e, t, n) {
            if (t !== void 0 && (n || kl(e, t))) return ki(e, t)
        },
        debug: De
    }
}
...
function Bl(e, t, n, r, s) {
    ...
    if (n.repeated) {
        ...
        for (const u of t) {
            ...
            switch (n.kind) {
                case "message":
                    ...
                    break;
                case "enum":
                    const l = qa(n.T, u, r.ignoreUnknownFields, !0);
                    l !== Ri && o.push(l);
                    break;
                case "scalar":
                    try {
        ...
        for (const [u, l] of Object.entries(t)) {
            ...
            switch (n.V.kind) {
                case "message":
                    ...
                    break;
                case "enum":
                    const f = qa(n.V.T, l, r.ignoreUnknownFields, !0);
                    f !== Ri && (o[c] = f);
                    break;
                case "scalar":
                    try {
        ...
        case "message":
            ...
            break;
        case "enum":
            const l = qa(n.T, t, r.ignoreUnknownFields, !1);
            switch (l) {
                case Li:
                    Ol(n, e);
                    break;
...
function Zt(e, t, n, r) {
    ...
    switch (e) {
        ...
        case E.UINT32:
            ...
            return e == E.UINT32 || e == E.FIXED32 ? Ua(i) : Ti(i), i;
        case E.INT64:
        case E.SFIXED64:
        case E.SINT64:
...
function qa(e, t, n, r) {
    if (t === null) return e.typeName == "google.protobuf.NullValue" ? 0 : r ? e.values[0].no : Li;
    switch (typeof t) {
        case "number":
...
function Ul(e, t, n) {
    if (e.kind == "map") {
        ...
        switch (e.V.kind) {
            case "scalar":
                for (const [o, u] of s) r[o.toString()] = ki(e.V.T, u);
                break;
            case "message":
            ...
            case "enum":
                const i = e.V.T;
                for (const [o, u] of s) r[o.toString()] = Va(i, u, n.enumAsInteger);
                break
        }
    ...
    if (e.repeated) {
        ...
        switch (e.kind) {
            case "scalar":
                for (let s = 0; s < t.length; s++) r.push(ki(e.T, t[s]));
                break;
            case "enum":
                for (let s = 0; s < t.length; s++) r.push(Va(e.T, t[s], n.enumAsInteger));
                break;
            case "message":
    ...
    switch (e.kind) {
        case "scalar":
            return ki(e.T, t);
        case "enum":
            return Va(e.T, t, n.enumAsInteger);
        case "message":
            return Dl(e.T, t).toJson(n)
    }
}
...
function ki(e, t) {
    switch (e) {
        ...
        case E.BYTES:
            return re(t instanceof Uint8Array), Il.enc(t)
    }
}
var ae;
(function(e) {
...
var Af = class {
        ...
        uint32(e) {
            for (Ua(e); e > 127;) this.buf.push(e & 127 | 128), e = e >>> 7;
            return this.buf.push(e), this
        }
        int32(e) {
            return Ti(e), Rl(e, this.buf), this
        }
        bool(e) {
        ...
        sint32(e) {
            return Ti(e), e = (e << 1 ^ e >> 31) >>> 0, Rl(e, this.buf), this
        }
        sfixed64(e) {
            let t = new Uint8Array(8),
        ...
        int64(e) {
            let t = oe.enc(e);
            return Ja(t.lo, t.hi, this.buf), this
        }
        sint64(e) {
            let t = oe.enc(e),
                n = t.hi >> 31,
    ...
    If = class {
        constructor(e, t) {
            this.varint64 = ff, this.uint32 = pf, this.buf = e, this.len = e.length, this.pos = 0, this.view = new DataView(e.buffer, e.byteOffset, e.byteLength), this.textDecoder = t ?? new TextDecoder
        }
        tag() {
            let e = this.uint32(),
                t = e >>> 3,
    ...
    Jl = {
        readUnknownFields: !0,
        readerFactory: e => new If(e)
    },
    Cl = {
        writeUnknownFields: !0,
        writerFactory: () => new Af
    };
...
function ql(e, t, n, r, s) {
    ...
    switch (n.oneof && (e = e[n.oneof.localName], e.case != o && delete e.value, e.case = o, o = "value"), n.kind) {
        ...
        case "message":
            const c = n.T;
            i ? e[o].push(Ai(t, new c, s, n)) : et(e[o]) ? Ai(t, e[o], s, n) : (e[o] = Ai(t, new c, s, n), c.fieldWrapper && !n.oneof && !n.repeated && (e[o] = c.fieldWrapper.unwrapField(e[o])));
            break;
        case "map":
            let [f, h] = Of(n, t, s);
            e[o][f] = h;
...
function Vl(e, t, n, r) {
    ...
    switch (e.kind) {
        ...
        case "enum":
            ...
            if (s)
                if (re(Array.isArray(t)), e.packed) Ff(n, i, e.no, t);
                else
        ...
        case "message":
            if (s) {
                re(Array.isArray(t));
                for (const o of t) Gl(n, r, e, o)
            } else Gl(n, r, e, t);
            break;
        case "map":
            re(typeof t == "object" && t != null);
            for (const [o, u] of Object.entries(t)) Mf(n, r, e, o, u);
            break
    }
}
    ...
    return {
        ...
        clone(e) {
            ...
            for (const s of t.fields.byMember()) {
                ...
                let o;
                if (s.repeated) o = i.map(Si);
                else if (s.kind == "map") {
                    o = r[s.localName];
                    for (const [u, l] of Object.entries(i)) o[u] = Si(l)
...
function Hl(e, t, n) {
    return {
        ...
        makeMessageType(r, s, i) {
            return hf(this, r, s, i)
        },
        makeEnum: mf,
        makeEnumType: vl,
        getEnumType: Nl,
        makeExtension(r, s, i) {
            return Nf(this, r, s, i)
        }
    }
}
var Yl = class {
...
var Cf = new Set(["constructor", "toString", "toJSON", "valueOf"]),
    qf = new Set(["getType", "clone", "equals", "fromBinary", "fromJson", "fromJsonString", "toBinary", "toJson", "toJsonString", "toObject"]),
    jl = e => `${e}$`,
    Vf = e => qf.has(e) ? jl(e) : e,
    Gf = e => Cf.has(e) ? jl(e) : e,
    Wf = class {
        constructor(e) {
            this.kind = "oneof", this.repeated = !1, this.packed = !1, this.opt = !1, this.req = !1, this.default = void 0, this.fields = [], this.name = e, this.localName = Uf(e)
        }
        addField(e) {
...
function Xl(e, t) {
    ...
    for (const s of typeof e == "function" ? e() : e) {
        const i = s;
        if (i.localName = $l(s.name, s.oneof !== void 0), i.jsonName = s.jsonName ?? Jf(s.name), i.repeated = s.repeated ?? !1, s.kind == "scalar" && (i.L = s.L ?? He.BIGINT), i.delimited = s.delimited ?? !1, i.req = s.req ?? !1, i.opt = s.opt ?? !1, s.packed === void 0 && (t ? i.packed = s.kind == "enum" || s.kind == "scalar" && s.T != E.BYTES && s.T != E.STRING : i.packed = !1), s.oneof !== void 0) {
            const o = typeof s.oneof == "string" ? s.oneof : s.oneof.name;
            (!r || r.name != o) && (r = new Wf(o)), i.oneof = r, r.addField(i)
        }
        n.push(i)
    }
    return n
}
var m = Hl("proto3", e => new Yl(e, t => Xl(t, !0)), e => {
    ...
    w = Hl("proto2", e => new Yl(e, t => Xl(t, !1)), e => {
        for (const t of e.getType().fields.byMember()) {
            const n = t.localName,
                r = e;
            if (t.repeated) {
...
})(Pi || (Pi = {})), w.util.setEnumType(Pi, "google.protobuf.FieldDescriptorProto.Label", [{
    no: 1,
    name: "LABEL_OPTIONAL"
}, {
    no: 3,
...
})(xi || (xi = {})), w.util.setEnumType(xi, "google.protobuf.FieldOptions.OptionRetention", [{
    no: 0,
...
})(Di || (Di = {})), w.util.setEnumType(Di, "google.protobuf.FeatureSet.FieldPresence", [{
    no: 0,
...
})(Mi || (Mi = {})), w.util.setEnumType(Mi, "google.protobuf.FeatureSet.EnumType", [{
    no: 0,
...
})(Fi || (Fi = {})), w.util.setEnumType(Fi, "google.protobuf.FeatureSet.RepeatedFieldEncoding", [{
    no: 0,
...
})(Bi || (Bi = {})), w.util.setEnumType(Bi, "google.protobuf.FeatureSet.Utf8Validation", [{
    no: 0,
...
})(Ui || (Ui = {})), w.util.setEnumType(Ui, "google.protobuf.FeatureSet.MessageEncoding", [{
    no: 0,
...
})(Ji || (Ji = {})), w.util.setEnumType(Ji, "google.protobuf.FeatureSet.JsonFormat", [{
    no: 0,
...
})(Ci || (Ci = {})), w.util.setEnumType(Ci, "google.protobuf.GeneratedCodeInfo.Annotation.Semantic", [{
    no: 0,
    name: "NONE"
}, {
    no: 1,
...
var nc = class nr extends v {
        ...
        fromJson(t, n) {
            ...
            for (const [r, s] of Object.entries(t)) this.fields[r] = qi.fromJson(s);
            return this
        }
        static {
            this.runtime = m
    ...
    rc = class sr extends v {
        ...
        fromJson(t, n) {
            ...
            for (let r of t) this.values.push(qi.fromJson(r));
            return this
        }
        static {
            this.runtime = m
...
})(Ha || (Ha = {})), w.util.setEnumType(Ha, "google.protobuf.compiler.CodeGeneratorResponse.Feature", [{
    no: 0,
    name: "FEATURE_NONE"
}, {
    no: 1,
...
})($a || ($a = {})), m.util.setEnumType($a, "aiserver.v1.FeatureType", [{
    no: 0,
...
})(za || (za = {})), m.util.setEnumType(za, "aiserver.v1.EmbeddingModel", [{
    no: 0,
...
})(Vi || (Vi = {})), m.util.setEnumType(Vi, "aiserver.v1.GetDiffRequest.OutputFormat", [{
    no: 0,
...
var $4 = class ws extends v {
    ...
    z4 = class Ns extends v {
        ...
        static {
            this.typeName = "aiserver.v1.ErrorAnalyticsMetadata"
        }
        static {
            this.fields = m.util.newFieldList(() => [{
                no: 1,
...
})(Gi || (Gi = {})), m.util.setEnumType(Gi, "aiserver.v1.CodeChunk.Intent", [{
    no: 0,
...
})(Wi || (Wi = {})), m.util.setEnumType(Wi, "aiserver.v1.CodeChunk.SummarizationStrategy", [{
    no: 0,
...
var u2 = class Gs extends v {
    ...
    Ed = class zs extends v {
        ...
        static fromBinary(t, n) {
            return new zs().fromBinary(t, n)
        }
        static fromJson(t, n) {
            return new zs().fromJson(t, n)
        }
        static fromJsonString(t, n) {
            return new zs().fromJsonString(t, n)
        }
        static equals(t, n) {
            return m.util.equals(zs, t, n)
        }
    };
...
var N = class {
        ...
        static toRGBA(t) {
            ...
            if (r === 0) o = u = l = s;
                ...
                const c = s < .5 ? s * (1 + r) : s + r - s * r,
                    f = 2 * s - c;
                o = js._hue2rgb(f, c, n + 1 / 3), u = js._hue2rgb(f, c, n), l = js._hue2rgb(f, c, n - 1 / 3)
            }
    ...
    Hi = class Uc {
        ...
        static fromRGBA(t) {
            const n = t.r / 255,
                ...
                l = i === 0 ? 0 : u / i;
            let c;
            return u === 0 ? c = 0 : i === n ? c = ((r - s) / u % 6 + 6) % 6 : i === r ? c = (s - n) / u + 2 : c = (n - r) / u + 4, new Uc(Math.round(c * 60), l, i, t.a)
        }
        static toRGBA(t) {
            const {
                h: n,
    ...
    Yi = class Q {
        ...
        get hsva() {
            return this._hsva ? this._hsva : Hi.fromRGBA(this.rgba)
        }
        constructor(t) {
            if (t)
                if (t instanceof N) this.rgba = t;
                else if (t instanceof tt) this._hsla = t, this.rgba = tt.toRGBA(t);
            else if (t instanceof Hi) this._hsva = t, this.rgba = Hi.toRGBA(t);
            else throw new Error("Invalid color ctor argument");
            else throw new Error("Color needs a value")
        }
        equals(t) {
            return !!t && N.equals(this.rgba, t.rgba) && tt.equals(this.hsla, t.hsla) && Hi.equals(this.hsva, t.hsva)
        }
...
function f2(e, t) {
    if (!e) return;
    const n = Yi.Format.CSS.parseHex(t);
    if (n) return {
        range: e,
        color: Xa(n.rgba.r, n.rgba.g, n.rgba.b, n.rgba.a)
    }
}
...
function fc(e, t, n) {
    ...
    const s = t[0].values(),
        i = mc(s),
        o = new Yi(new tt(i[0], i[1] / 100, i[2] / 100, n ? i[3] : 1));
    return {
        range: e,
        color: Xa(o.rgba.r, o.rgba.g, o.rgba.b, o.rgba.a)
    }
}
...
function g2(e) {
    return !e || typeof e.getValue != "function" || typeof e.positionAt != "function" ? [] : d2(e)
}
var p2 = /^-+|-+$/g,
    dc = 100,
    w2 = 5;
...
function v2(e, t) {
    const n = [],
        r = e.getLineCount(),
        s = vh(t.markSectionHeaderRegex),
        i = new RegExp(t.markSectionHeaderRegex, `gdm${s?"s":""}`);
    for (let o = 1; o <= r; o += dc - w2) {
        const u = Math.min(o + dc - 1, r),
            l = [];
...
function T2(e) {
    return e.indexOf("/") === -1 && (e = gc(e)), /^[a-zA-Z]:(\/|$)/.test(e) && (e = "/" + e), e
}

function pc(e, t = X.sep) {
    if (!e) return "";
    const n = e.length,
        r = e.charCodeAt(0);
    if (ze(r)) {
        ...
        return t
    } else if (_2(r) && e.charCodeAt(1) === 58) return ze(e.charCodeAt(2)) ? e.slice(0, 2) + t : e.slice(0, 2);
    let s = e.indexOf("://");
    if (s !== -1) {
        for (s += 3; s < n; s++)
...
var Qa = class {
        ...
        compare(e, t, n = !1) {
            return e === t ? 0 : K0(this.getComparisonKey(e, n), this.getComparisonKey(t, n))
        }
        isEqual(e, t, n = !1) {
        ...
        isEqualOrParent(e, t, n = !1) {
            if (e.scheme === t.scheme) {
                if (e.scheme === ce.file) return wc(qe(e), qe(t), this._ignorePathCasing(e)) && e.query === t.query && (n || e.fragment === t.fragment);
                if (Nc(e.authority, t.authority)) return wc(e.path, t.path, this._ignorePathCasing(e), "/") && e.query === t.query && (n || e.fragment === t.fragment)
            }
            return !1
        }
        joinPath(e, ...t) {
        ...
        dirname(e) {
            ...
            let t;
            return e.scheme === ce.file ? t = be.file(Xm(qe(e))).path : (t = X.dirname(e.path), e.authority && t.length && t.charCodeAt(0) !== 47 && (console.error(`dirname("${e.toString})) resulted in a relative path`), t = "/")), e.with({
                path: t
            })
        }
        normalizePath(e) {
            ...
            let t;
            return e.scheme === ce.file ? t = be.file(Ym(qe(e))).path : t = X.normalize(e.path), e.with({
                path: t
            })
        }
        relativePath(e, t) {
            if (e.scheme !== t.scheme || !Nc(e.authority, t.authority)) return;
            if (e.scheme === ce.file) {
                const s = jm(qe(e), qe(t));
                return ct ? gc(s) : s
            }
            let n = e.path || "/";
            const r = t.path || "/";
        ...
        resolvePath(e, t) {
            if (e.scheme === ce.file) {
                const n = be.file(zm(qe(e), t));
                return e.with({
                    authority: n.authority,
                    path: n.path
                })
            }
            return t = T2(t), e.with({
        ...
        isEqualAuthority(e, t) {
            return e === t || e !== void 0 && t !== void 0 && tm(e, t)
        }
        hasTrailingPathSeparator(e, t = fi) {
            if (e.scheme === ce.file) {
                const n = qe(e);
                return n.length > pc(n).length && n[n.length - 1] === t
            } else {
                const n = e.path;
                return n.length > 1 && n.charCodeAt(n.length - 1) === 47 && !/^[a-zA-Z]:(\/$|\\$)/.test(e.fsPath)
            }
        }
        removeTrailingPathSeparator(e, t = fi) {
            return bc(e, t) ? e.with({
                path: e.path.substr(0, e.path.length - 1)
            }) : e
        }
        addTrailingPathSeparator(e, t = fi) {
            let n = !1;
            if (e.scheme === ce.file) {
                const r = qe(e);
                n = r !== void 0 && r.length === pc(r).length && r[r.length - 1] === t
            } else {
                t = "/";
                const r = e.path;
                n = r.length === 1 && r.charCodeAt(r.length - 1) === 47
            }
            return !n && !bc(e, t) ? e.with({
                path: e.path + "/"
            }) : e
        }
    },
    z = new Qa(() => !1),
    Td = new Qa(e => e.scheme === ce.file ? !J0 : !0),
    _d = new Qa(e => !0),
    yd = z.isEqual.bind(z),
    Ld = z.isEqualOrParent.bind(z),
    Rd = z.getComparisonKey.bind(z),
    kd = z.basenameOrAuthority.bind(z),
    y2 = z.basename.bind(z),
    Ad = z.extname.bind(z),
    Id = z.dirname.bind(z),
    Sd = z.joinPath.bind(z),
    Pd = z.normalizePath.bind(z),
    xd = z.relativePath.bind(z),
    Od = z.resolvePath.bind(z),
    Dd = z.isAbsolutePath.bind(z),
    Nc = z.isEqualAuthority.bind(z),
    bc = z.hasTrailingPathSeparator.bind(z),
    Md = z.removeTrailingPathSeparator.bind(z),
    Fd = z.addTrailingPathSeparator.bind(z),
    vc;
(function(e) {
...
var Bd = Symbol("MicrotaskDelay"),
    L2, Za;
(function() {
    typeof globalThis.requestIdleCallback != "function" || typeof globalThis.cancelIdleCallback != "function" ? Za = (e, t, n) => {
        H0(() => {
            if (r) return;
            const s = Date.now() + 15;
            t(Object.freeze({
...
var Ud = class ve {
            ...
            return {
                next: async () => {
                    do {
                        ...
                        await ti.toPromise(this._onStateChanged.event)
                    } while (!0)
                },
    ...
    Jd = 60 * 1e3,
    I2 = "workerTextModelSync",
    S2 = class {
        constructor() {
            this._models = Object.create(null)
        }
        bindToServer(e) {
            e.setChannel(I2, this)
        }
        getModel(e) {
        ...
        $acceptNewModel(e) {
            this._models[e.url] = new P2(be.parse(e.url), e.lines, e.EOL, e.versionId)
        }
    ...
    P2 = class extends A2 {
        ...
        getWordAtPosition(e, t) {
            const n = Oa(e.column, Cu(t), this._lines[e.lineNumber - 1], 0);
    ...
    x2 = class Xs {
        constructor(t = null) {
            this._foreignModule = t, this._workerTextModelSyncServer = new S2
        }
        dispose() {}
        async $ping() {
            return "pong"
        ...
        async $computeUnicodeHighlights(t, n, r) {
            ...
            return s ? Ah.computeUnicodeHighlights(s, n, r) : {
                ranges: [],
                hasMore: !1,
        ...
        async $computeDiff(t, n, r, s) {
            const i = this._getModel(t),
                o = this._getModel(n);
            return !i || !o ? null : Xs.computeDiff(i, o, r, s)
        }
        async $computeWordDiff(t, n, r) {
            return sf(t, n, r)
        }
        async $computeLinesDiff(t, n) {
            const r = L4.fromBinary(new Uint8Array(t));
        ...
        async $computeMoreMinimalEdits(t, n, r) {
            ...
            for (let {
                ...
                if (Math.max(c.length, h.length) > Xs._diffLimit) {
                    i.push({
                        range: l,
                        text: c
                    });
        ...
        $computeHumanReadableDiff(t, n, r) {
            ...
            for (let {
                ...
                if (Math.max(f.length, p.length) > Xs._diffLimit) {
                    i.push({
                        range: c,
                        text: f
                    });
            ...
            e: for (const l of t) {
                ...
                if (c) {
                    for (const f of c.words(o))
                        if (!(f === n || !isNaN(Number(f))) && (u.add(f), u.size > Xs._suggestionsLimit)) break e
                }
            }
            return {
                words: Array.from(u),
        ...
        async $navigateValueSet(t, n, r, s, i) {
            ...
            return Im.INSTANCE.navigateValueSet(n, l, c, f, r)
        }
        $fmr(t, n) {
...
typeof importScripts == "function" && (globalThis.monaco = wh()), bm(() => new x2(null));

//# sourceMappingURL=http://go/sourcemap/sourcemaps/3dc559280adc5f931ade8e25c7b85393842acf30/core/vs/editor/common/services/editorWebWorkerMain.js.map

//# debugId=b932c701-793b-592c-b893-a8215b4f0cbe