(() => {
    ...
    class t {
        ...
        diffWithOptionsObj(e, n, t, o) {
            ...
            const u = null !== (s = t.timeout) && void 0 !== s ? s : 1 / 0,
                c = Date.now() + u,
                h = [{
                    oldPos: -1,
            ...
            if (h[0].oldPos + 1 >= r && f + 1 >= l) return i(this.buildValues(h[0].lastComponent, n, e));
            let p = -1 / 0,
                m = 1 / 0;
            const g = () => {
                for (let o = Math.max(p, -a); o <= Math.min(m, a); o += 2) {
                    ...
                    const c = a && a.oldPos + 1 < r;
                    if (u || c) {
                        if (s = !c || u && a.oldPos < d.oldPos ? this.addToPath(d, !0, !1, 0, t) : this.addToPath(a, !1, !0, 1, t), f = this.extractCommon(s, n, e, o, t), s.oldPos + 1 >= r && f + 1 >= l) return i(this.buildValues(s.lastComponent, n, e)) || !0;
                        h[o] = s, s.oldPos + 1 >= r && (m = Math.min(m, o - 1)), f + 1 >= l && (p = Math.max(p, o + 1))
                    } else h[o] = void 0
                }
                a++
            };
            if (o) ! function e() {
                setTimeout(function() {
                    if (a > d || Date.now() > c) return o(void 0);
                    g() || e()
                }, 0)
            }();
            else
        ...
        extractCommon(e, n, t, o, s) {
            ...
            let r = e.oldPos,
                a = r - o,
                d = 0;
            for (; a + 1 < i && r + 1 < l && this.equals(t[r + 1], n[a + 1], s);) a++, r++, d++, s.oneChangePerToken && (e.lastComponent = {
                count: 1,
                previousComponent: e.lastComponent,
                added: !1,
                removed: !1
            });
            return d && !s.oneChangePerToken && (e.lastComponent = {
                count: d,
                previousComponent: e.lastComponent,
                added: !1,
                removed: !1
    ...
    function a(e) {
        const n = e => e.endsWith("\n") ? e : `${e}\n`,
            {
                hunks: t
            } = function(e, n, t, o, i, r, a) {
                let d;
                d = a ? "function" == typeof a ? {
                    callback: a
                } : a : {}, void 0 === d.context && (d.context = 4);
                const u = d.context;
                ...
                if (!d.callback) return c(s(t, o, d));
                {
                    const {
                        callback: e
                    } = d;
                    s(t, o, Object.assign(Object.assign({}, d), {
                        callback: n => {
                            const t = c(n);
                            e(t)
                        }
                ...
                function c(t) {
                    ...
                    for (let e = 0; e < t.length; e++) {
                        ...
                        if (n.lines = i, n.added || n.removed) {
                            if (!a) {
                                const n = t[e - 1];
                                a = h, d = f, n && (c = u > 0 ? o(n.lines.slice(-u)) : [], a -= c.length, d -= c.length)
                            }
                            for (const e of i) c.push((n.added ? "+" : "-") + e);
                            n.added ? f += i.length : h += i.length
                        } else {
                            if (a)
                                if (i.length <= 2 * u && e < t.length - 2)
                                    for (const e of o(i)) c.push(e);
                                else {
                                    const e = Math.min(i.length, u);
                                    for (const n of o(i.slice(0, e))) c.push(n);
                                    const n = {
                                        oldStart: a,
                                        oldLines: h - a + e,
                                        newStart: d,
            ...
            }("a", "b", n(e.original), n(e.new), "", "", {
                context: 3
            }),
            o = (e, n) => 0 === n ? `${e},0` : 1 === n ? `${e}` : `${e},${n}`,
            i = e.filePath?.trim(),
            a = i && i.length > 0 ? i : "file",
            d = e.fileChangeType ?? "modified",
            u = "added" === d ? "/dev/null" : a,
            c = "deleted" === d ? "/dev/null" : a;
        return {
            diffString: 0 === t.length ? "" : [`--- ${r(u,"a")}`, `+++ ${r(c,"b")}`, ...t.flatMap(e => [`@@ -${o(e.oldStart,e.oldLines)} +${o(e.newStart,e.newLines)} @@`, ...e.lines])].join("\n"),
            linesAdded: t.reduce((e, n) => e + n.lines.filter(e => e.startsWith("+")).length, 0),
            linesRemoved: t.reduce((e, n) => e + n.lines.filter(e => e.startsWith("-")).length, 0)
        }
    }
    module.exports = n
})();