(() => {
    ...
    class l {
        ...
        isNonFastForwardPushError(e) {
            if (!(e instanceof Error && "stderr" in e && "string" == typeof e.stderr)) return !1;
            const t = e.stderr;
            return t.includes("[rejected]") && (t.includes("(non-fast-forward)") || t.includes("(fetch first)"))
        }
        ...
        async ensureCurrentBranchPushed(e, t) {
            ...
            try {
                ...
                try {
                    ...
                    if (this.isNonFastForwardPushError(e)) throw new Error(`Your branch "${n}" is behind ${r}. Pull the latest changes, then try moving to cloud again.`);
                    throw e
                }
            } finally {
                s?.dispose()
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/4aa8ff1b7877ed7bd01bcba308698f71a6735380/extensions/cursor-checkout/dist/main.js.map