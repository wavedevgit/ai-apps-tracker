    ...
    var e = {
            ...
            1154: (e, t, n) => {
                ...
                const r = n(3940),
                    ...
                    p = (e, t) => {
                        ...
                        if (!1 !== n.fastpaths && !/(^[*!]|[/()[\]{}"])/.test(e)) {
                            let r = !1,
                                s = e.replace(u, (e, t, n, i, s, o) => "\\" === i ? (r = !0, e) : "?" === i ? t ? t + i + (s ? T.repeat(s.length) : "") : 0 === o ? I + (s ? T.repeat(s.length) : "") : T.repeat(n.length) : "." === i ? C.repeat(n.length) : "*" === i ? t ? t + i + (s ? R : "") : R : t ? e : `\\${e}`);
                ...
                p.fastpaths = (e, t) => {
                    ...
                    let D = !0 === n.bash ? ".*?" : x;
                    n.capture && (D = `(${D})`);
                    const A = e => !0 === e.noglobstar ? D : `(${C}(?:(?!${y}${e.dot?f:l}).)*?)`,
                        S = e => {
                            switch (e) {
                                case "*":
                                    return `${v}${p}${D}`;
                                ...
                                case "**":
                                    return v + A(n);
                                case "**/*":
                                    return `(?:${v}${A(n)}${h})?${E}${p}${D}`;
                                case "**/*.*":
                                    return `(?:${v}${A(n)}${h})?${E}${D}${l}${p}${D}`;
                                case "**/.*":
                                ...
                                return e.prototype.throwError = function(e) {
                                    ...
                                    if (!this.context.allowYield && this.matchKeyword("yield")) e = this.parseYieldExpression();
                                        ...
                                        if (e.type === l || this.match("=>")) {
                                            ...
                                            e = this.finalize(this.startNode(t), new o.AssignmentExpression(v, e, E)), this.context.firstCoverInitializedNameError = null
                                        }
                                    }
                                    return e
                    ...
                    if (!0 === n.tokens && (V.maxDepth = 0, v(k) || S.push(J), V.tokens = S), !0 === n.parts || !0 === n.tokens) {
                        ...
                        for (let r = 0; r < A.length; r++) {
                            const i = t ? t + 1 : _,
                                s = A[r],
                                o = e.slice(i, s);
                            n.tokens && (0 === r && 0 !== _ ? (S[r].isPrefix = !0, S[r].value = G) : S[r].value = o, E(S[r]), V.maxDepth += S[r].depth), 0 === r && "" === o || b.push(o), t = s
                        }
                        if (t && t + 1 < e.length) {
                            const r = e.slice(t + 1);
                            b.push(r), n.tokens && (S[S.length - 1].value = r, E(S[S.length - 1]), V.maxDepth += S[S.length - 1].depth)
                        }
            ...
            4027: (e, t, n) => {
                const r = e.exports = (e, t, n = {}) => (g(t), !(!n.nocomment && "#" === t.charAt(0)) && new E(t, n).match(e));
                e.exports = r;
                const i = n(3112);
                r.sep = i.sep;
                ...
                const m = (e, t = {}) => (g(e), t.nobrace || !/\{(?:(?!\{).)*\}/.test(e) ? [e] : o(e)),
                    ...
                    x = Symbol("subparse");
                r.makeRe = (e, t) => new E(e, t || {}).makeRe(), r.match = (e, t, n = {}) => {
                    const r = new E(t, n);
                ...
                class E {
                    ...
                    parse(e, t) {
                        ...
                        for (let t, s = 0; s < e.length && (t = e.charAt(s)); s++)
                            if (this.debug("%s\t%s %s %j", e, s, r, t), o) {
                                ...
                                case ")": {
                                    ...
                                    l.pop(), F(), i = !0, E = e, r += E.close, "!" === E.type && f.push(Object.assign(E, {
                                        reEnd: r.length
                                    }));
                                    continue
                                }
                        ...
                        for (D && (m = e.slice(S + 1), C = this.parse(m, x), r = r.substring(0, A) + "\\[" + C[0], i = i || C[1]), E = l.pop(); E; E = l.pop()) {
                            let e;
                            e = r.slice(E.reStart + E.open.length), this.debug("setting tail", r, E), e = e.replace(/((?:\\{2}){0,64})(\\?)\|/g, (e, t, n) => (n || (n = "\\"), t + t + n + "|")), this.debug("tail=%j\n   %s", e, e, E, r);
                            const t = "*" === E.type ? c : "?" === E.type ? u : "\\" + E.type;
                            i = !0, r = r.slice(0, E.reStart) + t + "\\(" + e
                        }
                        F(), o && (r += "\\\\");
            ...
            5887: (e, t, n) => {
                ...
                function c(e, t, n) {
                    ...
                    let C = y();
                    if (n.keepLines && f > 0 && E(l(c, f), 0, 0), 17 !== C) {
                    ...
                    for (; 17 !== C;) {
                        let e = m.getTokenOffset() + m.getTokenLength() + o,
                            ...
                            r = "",
                            i = !1;
                        for (; 0 === f && (12 === t || 13 === t);) E(" ", e, m.getTokenOffset() + o), e = m.getTokenOffset() + m.getTokenLength() + o, i = 12 === t, r = i ? x() : "", t = y();
                        if (2 === t) 1 !== C && d--, n.keepLines && f > 0 || !n.keepLines && 1 !== C ? r = x() : n.keepLines && (r = " ");
                        else if (4 === t) 3 !== C && d--, n.keepLines && f > 0 || !n.keepLines && 3 !== C ? r = x() : n.keepLines && (r = " ");
                        else {
                            switch (C) {
                                case 3:
                                case 1:
                        ...
                        17 === t && (r = n.keepLines && f > 0 ? x() : n.insertFinalNewline ? c : ""), E(r, e, m.getTokenOffset() + o), C = t
                    }
                    return v
                }
                            ...
                            case 3:
                                return function() {
                                    ...
                                    for (; 4 !== i.getToken() && 17 !== i.getToken();) {
                                        if (5 === i.getToken()) {
                                            if (t || A(4, [], []), x(","), D(), 4 === i.getToken() && C) break
                                        } else t && A(6, [], []);
                            ...
                            case 1:
                                return function() {
                                    ...
                                    for (; 2 !== i.getToken() && 17 !== i.getToken();) {
                                        if (5 === i.getToken()) {
                                            if (e || A(4, [], []), x(","), D(), 2 === i.getToken() && C) break
                                        } else e && A(6, [], []);
                                        b() || A(4, [], [2, 5]), e = !0
                                    }
                    ...
                    m = (e, t, n, r = {}) => {
                        ...
                        return !0 === i.capture && (i.wrap = !0), n = n || i.step || 1, a(n) ? a(e) && a(t) ? ((e, t, n = 1, r = {}) => {
                            ...
                            let E = {
                                ...
                                C = e => E[e < 0 ? "negatives" : "positives"].push(Math.abs(e)),
                                D = [],
                                A = 0;
                            for (; o ? i >= s : i <= s;) !0 === r.toRegex && n > 1 ? C(i) : D.push(c(v(i, A), x, y)), i = o ? i - n : i + n, A++;
            ...
            7105: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    E(), e.subscriptions.push(c.workspace.onDidChangeConfiguration(e => {
                        (e.affectsConfiguration("http.proxy") || e.affectsConfiguration("http.proxyStrictSSL")) && E()
                    }));
            ...
            7511: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    g = void 0
                }, t.isWorkspaceFolder = C, t.getScriptRunner = D, t.getPackageManager = A, t.detectPackageManager = S, t.hasNpmScripts = async function() {
                    ...
                    return C(e.scope) ? e.definition.path ? u.Uri.file(c.join(e.scope.uri.fsPath, e.definition.path, "package.json")) : u.Uri.file(c.join(e.scope.uri.fsPath, "package.json")) : null
                ...
                t.INSTALL_SCRIPT = "install", t.NpmTaskProvider = class {
                    ...
                    async provideTasks() {
                        return (await b(this.context, !0)).map(e => e.task)
                    }
                    async resolveTask(e) {
                ...
                const x = ["build", "compile", "watch"],
                    ...
                    E = new Set(["install", "pack", "pack", "publish", "publishOnly", "restart", "shrinkwrap", "stop", "test", "uninstall", "version"]);
                ...
                async function b(e, t) {
                    if (!g) {
                        ...
                        for await (const r of async function*() {
                            const e = new Set,
                                t = u.workspace.workspaceFolders;
                            if (t)
                                for (const n of t)
                                    if (w(n) && !m.test(p.Utils.basename(n.uri))) {
                                        const t = new u.RelativePattern(n, "**/package.json"),
                                            r = await u.workspace.findFiles(t, "**/{node_modules,.vscode-test}/**");
                                        for (const t of r) k(n, t) || e.has(t.fsPath) || (yield t, e.add(t.fsPath))
                                    }
                        }()) {
                            const i = await F(e, r, t);
                            n.push(...i)
                        }
                        g = n
                    }
                ...
                async function F(e, n, r) {
                    const i = [],
                        s = u.workspace.getWorkspaceFolder(n);
                    if (!s) return i;
                    const o = await R(n);
                    if (!o) return i;
                    const a = [];
                    for (const {
                        ...
                        of o.scripts) {
                        const o = await B(e, t, s, n, i, r);
                        a.push({
                            task: o,
                            location: new u.Location(n, c)
                        })
                    }
                    return u.workspace.getConfiguration("npm", s).get("scriptExplorerExclude", []).find(e => e.includes(t.INSTALL_SCRIPT)) || a.push({
                        task: await N(e, s, n, "install dependencies from package", r)
                    }), a
                }
                ...
                async function B(e, t, n, r, i, s) {
                    ...
                    return function(e) {
                        ...
                        for (const t of y)
                            if (e === t) return !0;
                        return !1
                    }(m) ? d.group = u.TaskGroup.Test : (g = m, v.has(g) || E.has(g) ? d.group = u.TaskGroup.Clean : i && function(e) {
                ...
                async function R(e) {
                    ...
                    const t = e.fsPath;
                    if (await I(t)) try {
                        const t = await u.workspace.openTextDocument(e);
                        return (0, d.readScripts)(t)
                    } catch (t) {
                ...
                n.r(t), n.d(t, {
                    ...
                    (() => {
                        ...
                        class l {
                            ...
                            static parse(e, t = !1) {
                                const n = c.exec(e);
                                return n ? new p(n[2] || a, E(n[4] || a), E(n[5] || a), E(n[7] || a), E(n[9] || a), t) : new p(a, a, a, a, a)
                            }
                            static file(t) {
                                let n = a;
                    ...
                    e.dump = function() {
                        ...
                        switch (function(e, t, n, r, i) {
                            ...
                            case 2:
                                return "'" + t.replace(/'/g, "''") + "'";
                            case 3:
                                return "|" + E(t, e.indent) + C(f(t, s));
                            case 4:
                                return ">" + E(t, e.indent) + C(f(function(e, t) {
                    ...
                    if (/\$$/.test(i.pre))
                        for (var u = 0; u < a.length; u++) {
                            ...
                            var x, y, v = /^-?\d+\.\.-?\d+(?:\.\.-?\d+)?$/.test(i.body),
                                E = /^[a-zA-Z]\.\.[a-zA-Z](?:\.\.-?\d+)?$/.test(i.body),
                                C = v || E,
                                D = i.body.indexOf(",") >= 0;
                            if (!C && !D) return i.post.match(/,.*\}/) ? g(e = i.pre + "{" + i.body + o + i.post) : [e];
                            if (C) x = i.body.split(/\.\./);
                            ...
                            if (C) {
                                ...
                                for (var T = A; k(T, S); T += w) {
                                    var _;
                                    if (E) "\\" === (_ = String.fromCharCode(T)) && (_ = "");
                            ...
                            for (B = 0; B < y.length; B++)
                                for (u = 0; u < a.length; u++) l = s + y[B] + a[u], (!t || C || l) && n.push(l)
                        }
                    return n
                }
            },
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/6e696fa8ae574d6a40e0f1dbf74bd7d823f0b0d0/extensions/npm/dist/npmMain.js.map