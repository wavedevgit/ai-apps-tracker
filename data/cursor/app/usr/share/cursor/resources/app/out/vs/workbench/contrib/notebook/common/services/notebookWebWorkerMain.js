...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "d6c59cf4-088e-53ab-914f-91344875c8c6")
    } catch (e) {}
}();
var qt = function(t, e) {
...
var Xa = class {
    ...
    } [(rr = Symbol.iterator, nr = Symbol.toStringTag, rr)]() {
        return this.values()
    }
};
...
var _s = (t, e) => t - e,
    ir = class Gn {
        ...
        filter(e) {
            return new Gn(n => this.iterate(r => e(r) ? n(r) : !0))
        }
        map(e) {
            return new Gn(n => this.iterate(r => n(e(r))))
        }
        some(e) {
            let n = !1;
        ...
        findLastMaxBy(e) {
            let n, r = !0;
            return this.iterate(i => ((r || zt.isGreaterThan(e(i, n))) && (r = !1, n = i), !0)), n
        }
    };
ir.empty = new ir(t => {});
...
(t => {
    ...
    function* f(C, I) {
        for (const A of C) I(A) && (yield A)
    }
    t.filter = f;

    function* g(C, I) {
        let A = 0;
        for (const S of C) yield I(S, A++)
    }
    t.map = g;
    ...
    function* _(C, I, A = C.length) {
        for (I < -C.length && (I = 0), I < 0 && (I += C.length), A < 0 ? A += C.length : A > C.length && (A = C.length); I < A; I++) yield C[I]
    }
    t.slice = _;

    function y(C, I = Number.POSITIVE_INFINITY) {
        const A = [];
        if (I === 0) return [A, C];
        const S = C[Symbol.iterator]();
        for (let D = 0; D < I; D++) {
            const K = S.next();
            if (K.done) return [A, t.empty()];
            A.push(K.value)
        }
        return [A, {
            [Symbol.iterator]() {
    ...
    async function M(C) {
        const I = [];
        for await (const A of C) I.push(A);
...
var fr = class Bi {
    ...
    dispose() {
        this._isDisposed || (Ht(this), this._isDisposed = !0, this.clear())
    }
    get isDisposed() {
    ...
    deleteAndLeak(e) {
        e && this._toDispose.has(e) && (this._toDispose.delete(e), Gt(e, null))
    }
};
...
var Yt = fr,
    Oe = class {
        constructor() {
            this._store = new Yt, Kt(this), Gt(this._store, this)
        }
        dispose() {
            Ht(this), this._store.dispose()
        }
        _register(t) {
...
Oe.None = Object.freeze({
    dispose() {}
});
var Qt = class Yn {
    constructor(e) {
        this.element = e, this.next = Yn.Undefined, this.prev = Yn.Undefined
    }
};
...
(t => {
    ...
    function r(E) {
        return (b, x = null, w) => {
            let N = !1,
                O;
            return O = E(F => {
                if (!N) return O ? O.dispose() : N = !0, b.call(x, F)
            }, null, w), N && O.dispose(), O
        }
    }
    t.once = r;
    ...
    function s(E, b, x) {
        return h((w, N = null, O) => E(F => w.call(N, b(F)), null, O), x)
    }
    t.map = s;

    function o(E, b, x) {
        return h((w, N = null, O) => E(F => {
            b(F), w.call(N, F)
        }, null, O), x)
    }
    t.forEach = o;
    ...
    function a(E, b, x) {
        return h((w, N = null, O) => E(F => b(F) && w.call(N, F), null, O), x)
    }
    t.filter = a;
    ...
    function g(E, b, x = 100, w = !1, N = !1, O, F) {
        let H, X, qe, ft = 0,
            Qe;
        const tr = {
    ...
    function v(E, b = !1, x = [], w) {
        ...
        w && w.add(O);
        const F = () => {
                N?.forEach(X => H.fire(X)), N = null
            },
            H = new le({
                onWillAddFirstListener() {
                    O || (O = E(X => H.fire(X)), w && w.add(O))
                },
    ...
    class M {
        ...
        filter(b) {
            return this.steps.push(x => b(x) ? x : y), this
        }
        reduce(b, x) {
            let w = x;
    ...
    function C(E, b, x = w => w) {
        const w = (...H) => F.fire(x(...H)),
            N = () => E.on(b, w),
            O = () => E.removeListener(b, w),
            F = new le({
    ...
    function A(E, b, x = w => w) {
        const w = (...H) => F.fire(x(...H)),
            N = () => E.addEventListener(b, w),
            O = () => E.removeEventListener(b, w),
            F = new le({
                onWillAddFirstListener: N,
                onDidRemoveLastListener: O
            });
    ...
    class k {
        constructor(b, x) {
            ...
            x || e(w), this.emitter = new le(w), x && x.add(this.emitter)
        }
        beginUpdate(b) {
            this._counter++
        }
    ...
    function Ae(E, b) {
        return new k(E, b).emitter.event
    }
    t.fromObservable = Ae;
    ...
    function es(E) {
        return (b, x, w) => {
            ...
            const F = {
                ...
                endUpdate() {
                    N--, N === 0 && (E.reportChanges(), O && (O = !1, b.call(x)))
                },
            ...
            E.addObserver(F), E.reportChanges();
            const H = {
                dispose() {
                    E.removeObserver(F)
                }
    ...
    le = class {
        ...
        get event() {
            return this._event ??= (t, e, n) => {
                ...
                return n instanceof Yt ? n.add(o) : Array.isArray(n) && n.push(o), o
            }, this._event
        }
        _removeListener(t) {
...
var s1 = class {
    ...
    get onCancellationRequested() {
        return this._isCancelled ? xr : (this._emitter || (this._emitter = new le), this._emitter.event)
    }
    dispose() {
...
function Sr(t, e, n = 0, r = t.length, i = 0, s = e.length) {
    for (; n < r && i < s; n++, i++) {
...
var Ve = class Jn {
    ...
    static getInstance(e) {
        return Jn.cache.get(Array.from(e))
    }
    static getLocales() {
        return Jn._locales.value
    }
    isAmbiguous(e) {
...
Ve.ambiguousCharacterData = new rn(() => JSON.parse('{"_common":[8232,32,8233,32,5760,32,8192,32,8193,32,8194,32,8195,32,8196,32,8197,32,8198,32,8200,32,8201,32,8202,32,8287,32,8199,32,8239,32,2042,95,65101,95,65102,95,65103,95,8208,45,8209,45,8210,45,65112,45,1748,45,8259,45,727,45,8722,45,10134,45,11450,45,1549,44,1643,44,184,44,42233,44,894,59,2307,58,2691,58,1417,58,1795,58,1796,58,5868,58,65072,58,6147,58,6153,58,8282,58,1475,58,760,58,42889,58,8758,58,720,58,42237,58,451,33,11601,33,660,63,577,63,2429,63,5038,63,42731,63,119149,46,8228,46,1793,46,1794,46,42510,46,68176,46,1632,46,1776,46,42232,46,1373,96,65287,96,8219,96,1523,96,8242,96,1370,96,8175,96,65344,96,900,96,8189,96,8125,96,8127,96,8190,96,697,96,884,96,712,96,714,96,715,96,756,96,699,96,701,96,700,96,702,96,42892,96,1497,96,2036,96,2037,96,5194,96,5836,96,94033,96,94034,96,65339,91,10088,40,10098,40,12308,40,64830,40,65341,93,10089,41,10099,41,12309,41,64831,41,10100,123,119060,123,10101,125,65342,94,8270,42,1645,42,8727,42,66335,42,5941,47,8257,47,8725,47,8260,47,9585,47,10187,47,10744,47,119354,47,12755,47,12339,47,11462,47,20031,47,12035,47,65340,92,65128,92,8726,92,10189,92,10741,92,10745,92,119311,92,119355,92,12756,92,20022
,120,120065,120,120117,120,120169,120,120221,120,120273,120,120325,120,120377,120,120429,120,120481,120,5441,120,5501,120,5741,88,9587,88,66338,88,71916,88,65336,88,8553,88,117997,88,119831,88,119883,88,119935,88,119987,88,120039,88,120091,88,120143,88,120195,88,120247,88,120299,88,120351,88,120403,88,120455,88,42931,88,935,88,120510,88,120568,88,120626,88,120684,88,120742,88,11436,88,11613,88,5815,88,42219,88,66192,88,66228,88,66327,88,66855,88,611,121,7564,121,65369,121,119858,121,119910,121,119962,121,120014,121,120066,121,120118,121,120170,121,120222,121,120274,121,120326,121,120378,121,120430,121,120482,121,655,121,7935,121,43866,121,947,121,8509,121,120516,121,120574,121,120632,121,120690,121,120748,121,1199,121,4327,121,71900,121,65337,89,117998,89,119832,89,119884,89,119936,89,119988,89,120040,89,120092,89,120144,89,120196,89,120248,89,120300,89,120352,89,120404,89,120456,89,933,89,978,89,120508,89,120566,89,120624,89,120682,89,120740,89,11432,89,1198,89,5033,89,5053,89,42220,89,94019,89,71844,89,66226,89,119859,122,119911,122,119963,122,120015,122,120067,122,120119,122,120171,122,120223,122,120275,122,120327,122,120379,122,120431,122,120483,122,7458,122,43923,122,71876,122,71909,90,66293,90,65338,90,8484,90,8488,90,117999,90,119833,90,119885,90,119937,90,119989,90,120041,90,120197,90,120249,90,120301,90,120353,90,120405,90,120457,90,918,90,120493,90,120551,90,120609,90,120667,90,120725,90,5059,90,42204,90,71849,90,65282,34,65283,35,65284,36,65285,37,65286,38,65290,42,65291,43,65294,46,65295,47,65296,48,65298,50,65299,51,65300,52,65301,53,65302,54,65303,55,65304,56,65305,57,65308,60,65309,61,65310,62,65312,64,65316,68,65318,70,65319,71,65324,76,65329,81,65330,82,65333,85,65334,86,65335,87,65343,95,65346,98,65348,100,65350,102,65355,107,65357,109,65358,110,65361,113,65362,114,65364,116,65365,117,65367,119,65370,122,65371,123,65373,125,119846,109],"_default":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8217,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"cs":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"de":[65374,126,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"es":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"fr":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"it":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ja":[8211,45,8218,44,65281,33,8216,96,8245,96,180,96,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65292,44,65297,49,65307,59],"ko":[8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pl":[65374,126,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"pt-BR":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"qps-ploc":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"ru":[65374,126,8218,44,65306,58,65281,33,8216,96,8245,96,180,96,12494,47,305,105,921,73,1009,112,215,120,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"tr":[160,32,8211,45,65374,126,8218,44,65306,58,65281,33,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65288,40,65289,41,65292,44,65297,49,65307,59,65311,63],"zh-hans":[160,32,65374,126,8218,44,8245,96,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89,65297,49],"zh-hant":[8211,45,65374,126,8218,44,180,96,12494,47,1047,51,1073,54,1072,97,1040,65,1068,98,1042,66,1089,99,1057,67,1077,101,1045,69,1053,72,305,105,1050,75,921,73,1052,77,1086,111,1054,79,1009,112,1088,112,1056,80,1075,114,1058,84,215,120,1093,120,1061,88,1091,121,1059,89]}')), Ve.cache = new a1({
    ...
    function e(u) {
        const c = new Map;
        for (let h = 0; h < u.length; h += 2) c.set(u[h], u[h + 1]);
        return c
    }

    function n(u, c) {
        const h = new Map(u);
        for (const [f, g] of c) h.set(f, g);
        return h
    }
...
var un = "default",
    ...
    R1 = class {
        ...
        createProxyToRemoteChannel(t, e) {
            const n = {
                get: (r, i) => (typeof i == "string" && !r[i] && (Rr(i) ? r[i] = s => this.listen(t, i, s) : Mr(i) ? r[i] = this.listen(t, i, void 0) : i.charCodeAt(0) === 36 && (r[i] = async (...s) => (await e?.(), this.sendMessage(t, i, s)))), r[i])
            };
...
function Mr(t) {
    return t[0] === "o" && t[1] === "n" && Ir(t.charCodeAt(2))
}
...
var Z1 = class $i {
    ...
    _step() {
        ...
        let r = this._h0,
            ...
            a = this._h4,
            l, u, c;
        for (let h = 0; h < 80; h++) h < 20 ? (l = i & s | ~i & o, u = 1518500249) : h < 40 ? (l = i ^ s ^ o, u = 1859775393) : h < 60 ? (l = i & s | i & o | s & o, u = 2400959708) : (l = i ^ s ^ o, u = 3395469782), c = pn(r, 5) + l + a + u + e.getUint32(h * 4, !1) & 4294967295, a = o, o = s, s = pn(i, 30), i = r, r = c;
...
var We = class {
    ...
    Ur = class Ge {
        ...
        ComputeDiffRecursive(e, n, r, i, s) {
            ...
            if (e > n || r > i) {
                let h;
                return r <= i ? (We.Assert(e === n + 1, "originalStart should only be one more than originalEnd"), h = [new ue(e, 0, r, i - r + 1)]) : e <= n ? (We.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), h = [new ue(e, n - e + 1, r, 0)]) : (We.Assert(e === n + 1, "originalStart should only be one more than originalEnd"), We.Assert(r === i + 1, "modifiedStart should only be one more than modifiedEnd"), h = []), h
            }
            const o = [0],
                a = [0],
            ...
            if (!s[0]) {
                ...
                let f = [];
                return s[0] ? f = [new ue(u + 1, n - (u + 1) + 1, c + 1, i - (c + 1) + 1)] : f = this.ComputeDiffRecursive(u + 1, n, c + 1, i, s), this.ConcatenateChanges(h, f)
            }
            return [new ue(e, n - e + 1, r, i - r + 1)]
        }
        WALKTRACE(e, n, r, i, s, o, a, l, u, c, h, f, g, m, p, d, v, _) {
            ...
            do {
                const B = S + e;
                B === I || B < A && u[B - 1] < u[B + 1] ? (h = u[B + 1], m = h - S - i, h < D && C.MarkNextChange(), D = h, C.AddModifiedElement(h + 1, m), S = B + 1 - e) : (h = u[B - 1] + 1, m = h - S - i, h < D && C.MarkNextChange(), D = h - 1, C.AddOriginalElement(h, m + 1), S = B - 1 - e), K >= 0 && (u = this.m_forwardHistory[K], e = u[0], I = 1, A = u.length - 1)
            } while (--K >= -1);
            if (y = C.getReverseChanges(), _[0]) {
                let B = g[0] + 1,
                    k = d[0] + 1;
                if (y !== null && y.length > 0) {
                    const Ae = y[y.length - 1];
                    B = Math.max(B, Ae.getOriginalEnd()), k = Math.max(k, Ae.getModifiedEnd())
                }
            ...
            return this.ConcatenateChanges(y, M)
        }
        ComputeRecursionPoint(e, n, r, i, s, o, a) {
            ...
            for (let S = 1; S <= m / 2 + 1; S++) {
                let D = 0,
                    K = 0;
                c = this.ClipDiagonalBound(_ - S, S, _, p), h = this.ClipDiagonalBound(_ + S, S, _, p);
                for (let k = c; k <= h; k += 2) {
                    k === c || k < h && d[k - 1] < d[k + 1] ? l = d[k + 1] : l = d[k - 1] + 1, u = l - (k - _) - M;
                    const Ae = l;
                    for (; l < n && u < i && this.ElementsAreEqual(l + 1, u + 1);) l++, u++;
                    if (d[k] = l, l + u > D + K && (D = l, K = u), !A && Math.abs(k - y) <= S - 1 && l >= v[k]) return s[0] = l, o[0] = u, Ae <= v[k] && S <= 1448 ? this.WALKTRACE(_, c, h, M, y, f, g, C, d, v, l, n, s, u, i, o, A, a) : null
                }
                const B = (D - e + (K - r) - S) / 2;
                if (this.ContinueProcessingPredicate !== null && !this.ContinueProcessingPredicate(D, B)) return a[0] = !0, s[0] = D, o[0] = K, B > 0 && S <= 1448 ? this.WALKTRACE(_, c, h, M, y, f, g, C, d, v, l, n, s, u, i, o, A, a) : (e++, r++, [new ue(e, n - e + 1, r, i - r + 1)]);
                f = this.ClipDiagonalBound(y - S, S, y, p), g = this.ClipDiagonalBound(y + S, S, y, p);
                for (let k = f; k <= g; k += 2) {
                    k === f || k < g && v[k - 1] >= v[k + 1] ? l = v[k + 1] - 1 : l = v[k - 1], u = l - (k - y) - C;
                    const Ae = l;
                    for (; l > e && u > r && this.ElementsAreEqual(l, u);) l--, u--;
                    if (v[k] = l, A && Math.abs(k - _) <= S && l <= d[k]) return s[0] = l, o[0] = u, Ae >= d[k] && S <= 1448 ? this.WALKTRACE(_, c, h, M, y, f, g, C, d, v, l, n, s, u, i, o, A, a) : null
                }
                if (S <= 1447) {
                    let k = new Int32Array(h - c + 2);
                    k[0] = _ - c + 1, ze.Copy2(d, c, k, 1, h - c + 1), this.m_forwardHistory.push(k), k = new Int32Array(g - f + 2), k[0] = y - f + 1, ze.Copy2(v, f, k, 1, g - f + 1), this.m_reverseHistory.push(k)
                }
            }
            return this.WALKTRACE(_, c, h, M, y, f, g, C, d, v, l, n, s, u, i, o, A, a)
        }
        PrettifyChanges(e) {
            for (let n = 0; n < e.length; n++) {
                const r = e[n],
        ...
        ConcatenateChanges(e, n) {
            ...
            if (this.ChangesOverlap(e[e.length - 1], n[0], r)) {
                ...
                return ze.Copy(e, 0, i, 0, e.length - 1), i[e.length - 1] = r[0], ze.Copy(n, 1, i, e.length, n.length - 1), i
            } else {
                const i = new Array(e.length + n.length);
                return ze.Copy(e, 0, i, 0, e.length), ze.Copy(n, 0, i, e.length, n.length), i
            }
        }
        ChangesOverlap(e, n, r) {
            if (We.Assert(e.originalStart <= n.originalStart, "Left change is not less than or equal to right change"), We.Assert(e.modifiedStart <= n.modifiedStart, "Left change is not less than or equal to right change"), e.originalStart + e.originalLength >= n.originalStart || e.modifiedStart + e.modifiedLength >= n.modifiedStart) {
                ...
                return e.originalStart + e.originalLength >= n.originalStart && (s = n.originalStart + n.originalLength - e.originalStart), e.modifiedStart + e.modifiedLength >= n.modifiedStart && (a = n.modifiedStart + n.modifiedLength - e.modifiedStart), r[0] = new ue(i, s, o, a), !0
    ...
    eo = (t, e) => {
        ...
        let s = -1,
            ...
            a = n,
            l = n;
        for (; l--;) Ce[t.charCodeAt(l)] |= 1 << l;
        for (l = 0; l < r; l++) {
            let u = Ce[e.charCodeAt(l)];
            const c = u | o;
            u |= (u & s) + s ^ s, o |= ~(u | s), s &= u, o & i && a++, s & i && a--, o = o << 1 | 1, s = s << 1 | ~(c | o), o &= c
        }
        for (l = n; l--;) Ce[t.charCodeAt(l)] = 0;
        return a
    };
...
function to(t, e) {
    ...
    for (; l < a - 1; l++) {
        ...
        const d = l * 32,
            v = Math.min(32, r) + d;
        for (let _ = d; _ < v; _++) Ce[e.charCodeAt(_)] |= 1 << _;
        for (let _ = 0; _ < n; _++) {
            const y = Ce[t.charCodeAt(_)],
                M = i[_ / 32 | 0] >>> _ & 1,
                C = s[_ / 32 | 0] >>> _ & 1,
                I = y | m,
                A = ((y | C) & p) + p ^ p | y | C;
            let S = m | ~(A | p),
                D = p & A;
            S >>> 31 ^ M && (i[_ / 32 | 0] ^= 1 << _), D >>> 31 ^ C && (s[_ / 32 | 0] ^= 1 << _), S = S << 1 | M, D = D << 1 | C, p = D | ~(I | S), m = S & I
        }
        for (let _ = d; _ < v; _++) Ce[e.charCodeAt(_)] = 0
    }
    let u = 0,
        c = -1;
    const h = l * 32,
        f = Math.min(32, r - h) + h;
    for (let m = h; m < f; m++) Ce[e.charCodeAt(m)] |= 1 << m;
    let g = r;
    for (let m = 0; m < n; m++) {
        const p = Ce[t.charCodeAt(m)],
            d = i[m / 32 | 0] >>> m & 1,
            v = s[m / 32 | 0] >>> m & 1,
            _ = p | u,
            y = ((p | v) & c) + c ^ c | p | v;
        let M = u | ~(y | c),
            C = c & y;
        g += M >>> r - 1 & 1, g -= C >>> r - 1 & 1, M >>> 31 ^ d && (i[m / 32 | 0] ^= 1 << m), C >>> 31 ^ v && (s[m / 32 | 0] ^= 1 << m), M = M << 1 | d, C = C << 1 | v, c = C | ~(_ | M), u = M & _
    }
    for (let m = h; m < f; m++) Ce[e.charCodeAt(m)] = 0;
    return g
}
...
var z = {
        resolve(...t) {
            ...
            for (let i = t.length - 1; i >= -1; i--) {
                ...
                if (o === 1) T(c) && (a = 1, u = !0);
                    ...
                    if (u = !0, T(s.charCodeAt(1))) {
                        let h = 2,
                            f = h;
                        for (; h < o && !T(s.charCodeAt(h));) h++;
                        if (h < o && h !== f) {
                            const g = s.slice(f, h);
                            for (f = h; h < o && T(s.charCodeAt(h));) h++;
                            if (h < o && h !== f) {
                                for (f = h; h < o && !T(s.charCodeAt(h));) h++;
                ...
                else be(c) && s.charCodeAt(1) === ve && (l = s.slice(0, 2), a = 2, o > 2 && T(s.charCodeAt(2)) && (u = !0, a = 3));
                if (l.length > 0)
                    if (e.length > 0) {
        ...
        normalize(t) {
            ...
            if (T(s))
                if (i = !0, T(t.charCodeAt(1))) {
                    let a = 2,
                        l = a;
                    for (; a < e && !T(t.charCodeAt(a));) a++;
                    if (a < e && a !== l) {
                        const u = t.slice(l, a);
                        for (l = a; a < e && T(t.charCodeAt(a));) a++;
                        if (a < e && a !== l) {
                            for (l = a; a < e && !T(t.charCodeAt(a));) a++;
            ...
            else be(s) && t.charCodeAt(1) === ve && (r = t.slice(0, 2), n = 2, e > 2 && T(t.charCodeAt(2)) && (i = !0, n = 3));
            let o = n < e ? St(t.slice(n), !i, "\\", T) : "";
            if (o.length === 0 && !i && (o = "."), o.length > 0 && T(t.charCodeAt(e - 1)) && (o += "\\"), !i && r === void 0 && t.includes(":")) {
                if (o.length >= 2 && be(o.charCodeAt(0)) && o.charCodeAt(1) === ve) return `.\\${o}`;
                let a = t.indexOf(":");
                do
                    if (a === e - 1 || T(t.charCodeAt(a + 1))) return `.\\${o}`; while ((a = t.indexOf(":", a + 1)) !== -1)
            }
        ...
        isAbsolute(t) {
            ...
            return T(n) || e > 2 && be(n) && t.charCodeAt(1) === ve && T(t.charCodeAt(2))
        },
        join(...t) {
            ...
            for (let s = 0; s < t.length; ++s) {
                const o = t[s];
                W(o, "path"), o.length > 0 && (e === void 0 ? e = n = o : e += `\\${o}`)
            }
            if (e === void 0) return ".";
            let r = !0,
                i = 0;
            if (typeof n == "string" && T(n.charCodeAt(0))) {
                ++i;
                const s = n.length;
                s > 1 && T(n.charCodeAt(1)) && (++i, s > 2 && (T(n.charCodeAt(2)) ? ++i : r = !1))
            }
            if (r) {
                for (; i < e.length && T(e.charCodeAt(i));) i++;
                i >= 2 && (e = `\\${e.slice(i)}`)
            }
            return z.normalize(e)
        },
        relative(t, e) {
            if (W(t, "from"), W(e, "to"), t === e) return "";
            const n = z.resolve(t),
                r = z.resolve(e);
            ...
            if (n.length !== t.length || r.length !== e.length) {
                ...
                const d = m.length,
                    ...
                    _ = d < v ? d : v;
                let y;
                for (y = 0; y < _ && m[y].toLowerCase() === p[y].toLowerCase(); y++);
                return y === 0 ? r : y === _ ? v > _ ? p.slice(y).join("\\") : d > _ ? "..\\".repeat(d - 1 - y) + ".." : "" : "..\\".repeat(d - y) + p.slice(y).join("\\")
            }
            let i = 0;
        ...
        dirname(t) {
            ...
            } else be(i) && t.charCodeAt(1) === ve && (n = e > 2 && T(t.charCodeAt(2)) ? 3 : 2, r = n);
            let s = -1,
                o = !0;
            for (let a = e - 1; a >= r; --a)
                if (T(t.charCodeAt(a))) {
        ...
        basename(t, e) {
            e !== void 0 && W(e, "suffix"), W(t, "path");
            let n = 0,
                r = -1,
                i = !0,
                s;
            if (t.length >= 2 && be(t.charCodeAt(0)) && t.charCodeAt(1) === ve && (n = 2), e !== void 0 && e.length > 0 && e.length <= t.length) {
                if (e === t) return "";
                let o = e.length - 1,
                    a = -1;
        ...
        extname(t) {
            ...
            let e = 0,
                ...
                s = !0,
                o = 0;
            t.length >= 2 && t.charCodeAt(1) === ve && be(t.charCodeAt(0)) && (e = r = 2);
        ...
        parse(t) {
            ...
            let r = 0,
                i = t.charCodeAt(0);
            if (n === 1) return T(i) ? (e.root = e.dir = t, e) : (e.base = e.name = t, e);
            if (T(i)) {
                if (r = 1, T(t.charCodeAt(1))) {
                    let h = 2,
                        f = h;
                    for (; h < n && !T(t.charCodeAt(h));) h++;
                    if (h < n && h !== f) {
                        for (f = h; h < n && T(t.charCodeAt(h));) h++;
                        if (h < n && h !== f) {
                            for (f = h; h < n && !T(t.charCodeAt(h));) h++;
                            h === n ? r = h : h !== f && (r = h + 1)
                        }
            ...
            } else if (be(i) && t.charCodeAt(1) === ve) {
                if (n <= 2) return e.root = e.dir = t, e;
                if (r = 2, T(t.charCodeAt(2))) {
    ...
    U = {
        ...
        normalize(t) {
            if (W(t, "path"), t.length === 0) return ".";
            const e = t.charCodeAt(0) === G,
                n = t.charCodeAt(t.length - 1) === G;
            return t = St(t, !e, "/", _n), t.length === 0 ? e ? "/" : n ? "./" : "." : (n && (t += "/"), e ? `/${t}` : t)
        },
        isAbsolute(t) {
            return W(t, "path"), t.length > 0 && t.charCodeAt(0) === G
        },
        join(...t) {
            if (t.length === 0) return ".";
            const e = [];
            for (let n = 0; n < t.length; ++n) {
                const r = t[n];
                W(r, "path"), r.length > 0 && e.push(r)
            }
            return e.length === 0 ? "." : U.normalize(e.join("/"))
        },
        relative(t, e) {
            if (W(t, "from"), W(e, "to"), t === e || (t = U.resolve(t), e = U.resolve(e), t === e)) return "";
            const n = 1,
                r = t.length,
                i = r - n,
                s = 1,
...
var vo = "tkn",
    bo = class {
        ...
        get _remoteResourcesPath() {
            return U.join(this._serverRootPath, R.vscodeRemoteResource)
        }
        set(t, e, n) {
...
var Lo = "vscode-app",
    Vr = class Pt {
        ...
        uriToFileUri(e) {
            return e.scheme === R.vscodeFileResource ? e.with({
                scheme: R.file,
                authority: e.authority !== Pt.FALLBACK_AUTHORITY ? e.authority : null,
                query: null,
                fragment: null
            }) : e
        }
...
var q = "",
    ...
    se = class Dt {
        ...
        static joinPath(e, ...n) {
            ...
            let r;
            return Me && e.scheme === "file" ? r = Dt.file(z.join(It(e, !0), ...n)).path : r = U.join(e.path, ...n), e.with({
                path: r
            })
        }
        toString(e = !1) {
...
var ye = class Fe {
        ...
        with(e = this.lineNumber, n = this.column) {
            return e === this.lineNumber && n === this.column ? this : new Fe(e, n)
        }
        delta(e = 0, n = 0) {
...
var vn = (function() {
    ...
    yn = class {
        ...
        next() {
            if (this.right !== L) return wn(this.right);
            let t = this;
            for (; t.parent !== L && t.parent.left !== t;) t = t.parent;
    ...
    L = new yn(null, 0);
L.parent = L, L.left = L, L.right = L, L.color = 0;

function wn(t) {
    for (; t.left !== L;) t = t.left;
    return t
}
...
function Ln(t) {
    return t === L ? 0 : t.size_left + t.piece.length + Ln(t.right)
}

function xn(t) {
    return t === L ? 0 : t.lf_left + t.piece.lineFeedCnt + xn(t.right)
}
...
function Ze(t, e) {
    const n = e.right;
    n.size_left += e.size_left + (e.piece ? e.piece.length : 0), n.lf_left += e.lf_left + (e.piece ? e.piece.lineFeedCnt : 0), e.right = n.left, n.left !== L && (n.left.parent = e), n.parent = e.parent, e.parent === L ? t.root = n : e.parent.left === e ? e.parent.left = n : e.parent.right = n, n.left = e, e.parent = n
}

function et(t, e) {
    const n = e.left;
    e.left = n.right, n.right !== L && (n.right.parent = e), n.parent = e.parent, e.size_left -= n.size_left + (n.piece ? n.piece.length : 0), e.lf_left -= n.lf_left + (n.piece ? n.piece.lineFeedCnt : 0), e.parent === L ? t.root = n : e === e.parent.right ? e.parent.right = n : e.parent.left = n, n.right = e, e.parent = n
}

function kt(t, e) {
    let n, r;
    if (e.left === L ? (r = e, n = r.right) : e.right === L ? (r = e, n = r.left) : (r = wn(e.right), n = r.right), r === t.root) {
        t.root = n, n.color = 0, e.detach(), En(), t.root.parent = L;
        return
    }
    const i = r.color === 1;
    if (r === r.parent.left ? r.parent.left = n : r.parent.right = n, r === e ? (n.parent = r.parent, tt(t, n)) : (r.parent === e ? n.parent = r : n.parent = r.parent, tt(t, n), r.left = e.left, r.right = e.right, r.parent = e.parent, r.color = e.color, e === t.root ? t.root = r : e === e.parent.left ? e.parent.left = r : e.parent.right = r, r.left !== L && (r.left.parent = r), r.right !== L && (r.right.parent = r), r.size_left = e.size_left, r.lf_left = e.lf_left, tt(t, r)), e.detach(), n.parent.left === n) {
        const o = Ln(n),
            a = xn(n);
    ...
    let s;
    for (; n !== t.root && n.color === 0;) n === n.parent.left ? (s = n.parent.right, s.color === 1 && (s.color = 0, n.parent.color = 1, Ze(t, n.parent), s = n.parent.right), s.left.color === 0 && s.right.color === 0 ? (s.color = 1, n = n.parent) : (s.right.color === 0 && (s.left.color = 0, s.color = 1, et(t, s), s = n.parent.right), s.color = n.parent.color, n.parent.color = 0, s.right.color = 0, Ze(t, n.parent), n = t.root)) : (s = n.parent.left, s.color === 1 && (s.color = 0, n.parent.color = 1, et(t, n.parent), s = n.parent.left), s.left.color === 0 && s.right.color === 0 ? (s.color = 1, n = n.parent) : (s.left.color === 0 && (s.right.color = 0, s.color = 1, Ze(t, s), s = n.parent.left), s.color = n.parent.color, n.parent.color = 0, s.left.color = 0, et(t, n.parent), n = t.root));
    n.color = 0, En()
}
...
function Jr(t, e) {
    for (tt(t, e); e !== t.root && e.parent.color === 1;)
        if (e.parent === e.parent.parent.left) {
            ...
            n.color === 1 ? (e.parent.color = 0, n.color = 0, e.parent.parent.color = 1, e = e.parent.parent) : (e === e.parent.right && (e = e.parent, Ze(t, e)), e.parent.color = 0, e.parent.parent.color = 1, et(t, e.parent.parent))
        } else {
            const n = e.parent.parent.left;
            n.color === 1 ? (e.parent.color = 0, n.color = 0, e.parent.parent.color = 1, e = e.parent.parent) : (e === e.parent.left && (e = e.parent, et(t, e)), e.parent.color = 0, e.parent.parent.color = 1, Ze(t, e.parent.parent))
        } t.root.color = 0
}

function we(t, e, n, r) {
    for (; e !== t.root && e !== L;) e.parent.left === e && (e.parent.size_left += n, e.parent.lf_left += r), e = e.parent
}
    ...
    Qo = class {
        ...
        create(t, e, n) {
            this._buffers = [new De("", [0])], this._lastChangeBufferPos = {
                line: 0,
                column: 0
            }, this.root = L, this._lineCnt = 1, this._length = 0, this._EOL = e, this._EOLLength = e.length, this._EOLNormalized = n;
            let r = null;
            for (let i = 0, s = t.length; i < s; i++)
        ...
        getOffsetAt(t, e) {
            let n = 0,
                r = this.root;
            for (; r !== L;)
                if (r.left !== L && r.lf_left + 1 >= t) r = r.left;
            ...
            for (; e !== L;)
                ...
                if (n += e.lf_left + i.index, i.index === 0) {
                    const s = this.getOffsetAt(n + 1, 1),
                        o = r - s;
                    return new ye(n + 1, o + 1)
                }
                return new ye(n + 1, i.remainder + 1)
            } else if (t -= e.size_left + e.piece.length, n += e.lf_left + e.piece.lineFeedCnt, e.right === L) {
                const i = this.getOffsetAt(n + 1, 1),
                    s = r - t - i;
                return new ye(n + 1, s + 1)
            } else e = e.right;
            return new ye(1, 1)
        }
        getValueInRange(t, e) {
        ...
        findMatchesInNode(t, e, n, r, i, s, o, a, l, u, c) {
            ...
            let v, _;
            e._wordSeparators ? (v = h.buffer.substring(g, m), _ = y => y + g, e.reset(0)) : (v = h.buffer, _ = y => y, e.reset(g));
            do
                if (p = e.next(v), p) {
            ...
            for (; f !== l.node;) {
                ...
                if (m >= 1) {
                    const d = this._buffers[f.piece.bufferIndex].lineStarts,
                        v = this.offsetInBuffer(f.piece.bufferIndex, f.piece.start),
                        _ = d[u.line + m],
                        y = h === t.startLineNumber ? t.startColumn : 1;
                    if (s = this.findMatchesInNode(f, o, h, y, u, this.positionInBuffer(f, _ - v), e, n, r, s, i), s >= r) return i;
                    h += m
                }
        ...
        insert(t, e, n = !1) {
            if (this._EOLNormalized = this._EOLNormalized && n, this._lastVisitedLine.lineNumber = 0, this._lastVisitedLine.value = "", this.root !== L) {
                const {
                    node: r,
                    remainder: i,
                    nodeStartOffset: s
                } = this.nodeAt(t), o = r.piece, a = o.bufferIndex, l = this.positionInBuffer(r, i);
                if (r.piece.bufferIndex === 0 && o.end.line === this._lastChangeBufferPos.line && o.end.column === this._lastChangeBufferPos.column && s + o.length === t && e.length < Le) {
...
`
        ...
        delete(t, e) {
            if (this._lastVisitedLine.lineNumber = 0, this._lastVisitedLine.value = "", e <= 0 || this.root === L) return;
            ...
            if (i === s) {
                ...
                if (n.nodeStartOffset === t) {
                    if (e === i.piece.length) {
                        const g = i.next();
                        kt(this, i), this.validateCRLFWithPrevNode(g), this.computeBufferMetadata();
                        return
                    }
            ...
            const u = i.next();
            for (let h = u; h !== L && h !== s; h = h.next()) o.push(h);
...
`);
        ...
        deleteNodes(t) {
            for (let e = 0; e < t.length; e++) kt(this, t[e])
        }
        createNewPieces(t) {
            if (t.length > Le) {
                const u = [];
                for (; t.length > Le;) {
                    const h = t.charCodeAt(Le - 1);
                    let f;
                    h === 13 || h >= 55296 && h <= 56319 ? (f = t.substring(0, Le - 1), t = t.substring(Le - 1)) : (f = t.substring(0, Le), t = t.substring(Le));
                    const g = xe(f);
        ...
        getLineRawContent(t, e = 0) {
            ...
            if (i) {
                ...
                const o = t;
                for (; n !== L;)
                    if (n.left !== L && n.lf_left >= t - 1) n = n.left;
        ...
        computeBufferMetadata() {
            let t = this.root,
                e = 1,
                n = 0;
            for (; t !== L;) e += t.lf_left + t.piece.lineFeedCnt, n += t.size_left + t.piece.length, t = t.right;
...
`)
        ...
        startWithLF(t) {
            ...
            if (t === L || t.piece.lineFeedCnt === 0) return !1;
            const e = t.piece,
        ...
        endWithCR(t) {
            return typeof t == "string" ? t.charCodeAt(t.length - 1) === 13 : t === L || t.piece.lineFeedCnt === 0 ? !1 : this.nodeCharCodeAt(t, t.piece.length - 1) === 13
        }
...
`);
            ...
            for (let h = 0; h < n.length; h++) kt(this, n[h])
        }
...
`, n.piece.length === 1) kt(this, n);
        ...
        rbInsertRight(t, e) {
            ...
            else if (t.right === L) t.right = n, n.parent = t;
            else {
                const i = wn(t.right);
                i.left = n, n.parent = i
            }
...
var ea = class ge {
        ...
        toString() {
            return this.oldText.length === 0 ? `(insert@${this.oldPosition} "${Ot(this.newText)}")` : this.newText.length === 0 ? `(delete@${this.oldPosition} "${Ot(this.oldText)}")` : `(replace@${this.oldPosition} "${Ot(this.oldText)}" with "${Ot(this.newText)}")`
        }
...
` ? 2 : 1) ? _ = d.text : _ = d.text.replace(/\r\n|\r|\n/g, A)
            ...
            for (let p = 0, d = l.length - 1; p < d; p++) {
                const v = l[p].range.getEndPosition(),
                    _ = l[p + 1].range.getStartPosition();
                if (_.isBeforeOrEqual(v)) {
                    if (_.isBefore(v)) throw new Error("Overlapping ranges are not allowed!");
                    u = !0
                }
            }
            ...
            if (n)
                for (let p = 0; p < l.length; p++) {
                    ...
                    if (d.isAutoWhitespaceEdit && d.range.isEmpty())
                        for (let _ = v.startLineNumber; _ <= v.endLineNumber; _++) {
                            let y = "";
                            _ === v.startLineNumber && (y = this.getLineContent(d.range.startLineNumber), sn(y) !== -1) || h.push({
                                lineNumber: _,
                                oldContent: y
                            })
                        }
            ...
            if (r) {
                ...
                for (let d = 0; d < l.length; d++) {
                    const v = l[d],
                        _ = c[d],
                        y = this.getValueInRange(v.range),
                        M = v.rangeOffset + p;
                    p += v.text.length - y.length, f[d] = {
            ...
            if (n && h.length > 0) {
                ...
                for (let p = 0, d = h.length; p < d; p++) {
                    const v = h[p].lineNumber;
                    if (p > 0 && h[p - 1].lineNumber === v) continue;
                    const _ = h[p].oldContent,
                        y = this.getLineContent(v);
...
function ii(t, e = U.sep) {
    ...
    const n = t.length,
        r = t.charCodeAt(0);
    if (Ne(r)) {
        if (Ne(t.charCodeAt(1)) && !Ne(t.charCodeAt(2))) {
            let s = 3;
            const o = s;
            for (; s < n && !Ne(t.charCodeAt(s)); s++);
            if (o !== s && !Ne(t.charCodeAt(s + 1))) {
                for (s += 1; s < n; s++)
                    if (Ne(t.charCodeAt(s))) return t.slice(0, s + 1).replace(/[\\/]/g, e)
            }
        }
        return e
    ...
    if (i !== -1) {
        for (i += 3; i < n; i++)
            if (Ne(t.charCodeAt(i))) return t.slice(0, i + 1)
    }
    return ""
}
...
function oa(t, e, n) {
    for (let r = 0; r < n; r++) {
        let i = t.charCodeAt(r),
            s = e.charCodeAt(r);
        if (i !== s) {
            if (i >= 128 || s >= 128) return Sr(t, e, r, n, r, n) === 0;
            if (i >= 97 && i <= 122 && (i -= 32), s >= 97 && s <= 122 && (s -= 32), i !== s) return !1
        }
    }
    return !0
}
...
var Nn = class {
        ...
        addTrailingPathSeparator(t, e = At) {
            let n = !1;
            if (t.scheme === R.file) {
                const r = Ee(t);
...
var ha = ne(1844, null),
    ...
    Tn = class Xn {
        ...
        scan() {
            for (; !this._isAtEnd();) switch (this._start = this._current, this._advance()) {
                ...
                case 61:
                    ...
                    } else this._match(126) ? this._addToken(9) : this._error(On("==", "=~"));
                    break;
                case 60:
                ...
                case 62:
                    ...
                    break;
                case 38:
                    this._match(38) ? this._addToken(15) : this._error(On("&&"));
                    break;
                case 124:
                    this._match(124) ? this._addToken(16) : this._error(On("||"));
                    break;
                case 32:
                case 13:
                case 9:
        ...
        _regex() {
            ...
            for (; e < this._input.length && Xn._regexFlags.has(this._input.charCodeAt(e));) e++;
            this._current = e;
...
Tn._regexFlags = new Set(["i", "g", "s", "m", "y", "u"].map(t => t.charCodeAt(0))), Tn._keywords = new Map([
    ["not", 14],
    ["in", 13],
    ["false", 12],
    ["true", 11]
...
var ga = Object.prototype.hasOwnProperty,
    ...
    di = class ct {
        ...
        _primary() {
            ...
            switch (e.type) {
                case 11:
                    return this._advance(), J.true();
                case 12:
                    return this._advance(), J.false();
                case 0: {
                    this._advance();
                    const n = this._expr();
                ...
                case 17: {
                        ...
                        switch (i.type) {
                            ...
                            case 19: {
                                ...
                                for (; !this._isAtEnd() && o.type !== 15 && o.type !== 16;) {
                                    ...
                                    if (a < 0) break;
                                    s.push(nt.getLexeme(o)), this._advance(), o = this._peek()
                                }
                                const l = s.join(""),
                                    u = l.lastIndexOf("/"),
                    ...
                    switch (this._peek().type) {
                        case 3: {
                            this._advance();
                            const i = this._value();
                            if (this._previous().type === 18) return J.equals(n, i);
                            switch (i) {
                                case "true":
                                    return J.has(n);
                                case "false":
                        ...
                        case 4: {
                            this._advance();
                            const i = this._value();
                            if (this._previous().type === 18) return J.notEquals(n, i);
                            switch (i) {
                                case "true":
                                    return J.not(n);
                                case "false":
                        ...
                        case 8:
                            return this._advance(), Un.create(n, this._value());
                        case 13:
                            return this._advance(), J.in(n, this._value());
                        default:
                            return J.has(n)
                    }
                }
...
var Rn = class Bt {
        ...
        cmp(e) {
            return e.type !== this.type ? this.type - e.type : zn(this.id, e.id)
        }
        equals(e) {
        ...
        negate() {
            return Bt.createWithoutRegistration(`!${this.id}`, () => !this.fn())
        }
    },
    Pn = class {
        constructor() {
...
var Mt = class Yi {
    ...
    xa = class Zn {
        ...
        map(e) {
            return new Zn(this._actual.map(e))
        }
        negate() {
            return this._actual
        }
...
var _i = class Ye {
        ...
        cmp(e) {
            ...
            for (let n = 0, r = this.expr.length; n < r; n++) {
                const i = it(this.expr[n], e.expr[n]);
                if (i !== 0) return i
            }
            return 0
        }
        ...
        static _normalizeArr(e, n, r) {
            ...
            if (i.length !== 0) {
                ...
                for (; i.length > 1;) {
                    ...
                    const a = i.pop(),
                        l = i.length === 0,
                        u = Wn.create(o.expr.map(c => Ye.create([c, a], null, r)), null, l);
                    u && (i.push(u), i.sort(it))
                }
                if (i.length === 1) return i[0];
                if (r) {
        ...
        map(e) {
            return new Ye(this.expr.map(n => n.map(e)), null)
        }
        negate() {
            if (!this.negated) {
                const e = [];
                for (const n of this.expr) e.push(n.negate());
                this.negated = Wn.create(e, this, !0)
            }
            return this.negated
        }
    },
    Wn = class Ue {
        ...
        map(e) {
            return new Ue(this.expr.map(n => n.map(e)), null)
        }
        negate() {
            if (!this.negated) {
                const e = [];
    ...
    Ci = class Ft extends st {
        ...
        constructor(e, n, r) {
            super(e, null), this._defaultValue = n, typeof r == "object" ? Ft._info.push({
                ...r,
                key: e
            }) : r !== !0 && Ft._info.push({
                key: e,
        ...
        isEqualTo(e) {
            return Bn.create(this.key, e)
        }
        notEqualsTo(e) {
            return Fn.create(this.key, e)
        }
        greater(e) {
...
function Li(t) {
    ...
    return {
        notebook: i ? i.notebook : t.with({
            scheme: e.get("notebookScheme") || R.file,
            fragment: null,
            query: null
        }),
        openIn: n,
...
var Ma = class {
    ...
    getNotebook(t) {
        if (t.scheme === R.vscodeNotebookCell) {
            const e = Kn(t);
            if (e) {
...
(t => {
    ...
    function r(l, u) {
        return l.with({
            scheme: R.vscodeNotebookCellOutput,
            query: new URLSearchParams({
                openIn: "editor",
                outputId: u ?? "",
                notebookScheme: l.scheme !== R.file ? l.scheme : ""
            }).toString()
        })
    }
...
var Vl = new vi("notebookEditorCursorAtBoundary", "none"),
    ...
    Ra = class Ut {
        ...
        static parse(e) {
            if (e.startsWith(Ut._prefix)) {
                const n = e.substring(Ut._prefix.length).split("/");
...
var qa = class {
        ...
        setValue(t, e) {
            return t = Ke(t), e = Ke(e), this.values[t] === e ? !1 : (this.values[t] = e, t - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = t - 1), !0)
        }
        removeValues(t, e) {
            t = Ke(t), e = Ke(e);
            const n = this.values,
    ...
    Va = class {
        ...
        onEvents(t) {
            ...
            const e = t.changes;
            for (const n of e) this._acceptDeleteRange(n.range), this._acceptInsertText(new ye(n.range.startLineNumber, n.range.startColumn), n.text);
    ...
    Wa = class extends Va {
        ...
        _validatePosition(t) {
            if (!ye.isIPosition(t)) throw new Error("bad position");
            let {
                lineNumber: e,
                column: n
            } = t, r = !1;
...
function za(t, e) {
    ...
    return r.forEach((u, c) => {
        ...
        const h = c > 0 ? r.slice(0, c).reverse().find(A => A.original >= 0) : void 0,
            f = h?.original ?? -1,
            g = h?.modified ?? -1,
            m = r.slice(c + 1).find(A => A.original >= 0),
            p = new Set,
            d = r.findIndex((A, S) => S > c && A.original >= 0),
            v = d >= 0 ? r[d].original : -1;
        e.forEach((A, S) => {
            if (i.has(S)) {
                p.add(S);
                return
            }
            m && S >= m.original && p.add(S), v >= 0 && S > v && p.add(S)
        });
        const _ = t[c];
        ...
        if (f > 0 && g > 0 && f === g && (d >= 0 ? d : t.length - 1) === (v >= 0 ? v : e.length - 1) && !p.has(c) && c < e.length) {
            const A = (d >= 0 ? d : t.length) - g,
                S = (v >= 0 ? v : e.length) - f;
            if (A === S && _.cellKind === e[c].cellKind) {
                l(c, c), u.original = c;
                return
            }
        }
        const {
            ...
            if (p.has(A)) return !1;
            if (d > 0 || f > 0) {
                const D = n.originalToModified.get(A);
                if (D && f < A && Array.from(D).find(([B, k]) => B === c || B >= d || s.has(c) ? !1 : k.editCount < S.editCount)) return !1
            }
            return !p.has(A)
        });
        if (y >= 0 && c > 0 && r[c - 1].original === y - 1) {
            l(c, y), r[c].original = y;
            return
        }
        const C = c > 0 && e.length > r[c - 1].original ? r[c - 1].original + 1 : -1,
            I = c > 0 && C >= 0 && C < e.length ? e[C].getValue() : void 0;
        if (y >= 0 && c > 0 && typeof I == "string" && !i.has(C) && (_.getValue().includes(I) || I.includes(_.getValue()))) {
            l(c, C), r[c].original = C;
            return
        }
        if (M < 90 || c === 0 && r.length === 1) {
            l(c, y), r[c].original = y;
            return
        }
    }), r
    ...
    Ha = class {
        ...
        acceptModelChanged(t) {
            t.rawEvents.forEach(e => {
                if (e.kind === ke.ModelChange) this._spliceNotebookCells(e.changes);
                else if (e.kind === ke.Move) {
                    const n = this.cells.splice(e.index, 1);
                    this.cells.splice(e.newIdx, 0, ...n)
                } else if (e.kind === ke.Output) {
                    const n = this.cells[e.index];
                    n.outputs = e.outputs
                } else if (e.kind === ke.ChangeCellLanguage) {
                    this._assertIndex(e.index);
                    const n = this.cells[e.index];
                    n.language = e.language
                } else if (e.kind === ke.ChangeCellMetadata) {
                    this._assertIndex(e.index);
                    const n = this.cells[e.index];
                    n.metadata = e.metadata
                } else if (e.kind === ke.ChangeCellInternalMetadata) {
                    this._assertIndex(e.index);
                    const n = this.cells[e.index];
                    n.internalMetadata = e.internalMetadata
                } else e.kind === ke.ChangeDocumentMetadata && (this.metadata = e.metadata)
            })
        }
        _assertIndex(t) {
    ...
    Ga = class {
        ...
        async $computeDiff(t, e) {
            ...
            return f.changes.forEach(d => {
                if (!d.originalLength && d.modifiedLength) {
                    const v = g.findIndex(_ => _.type === "insert" && _.modifiedCellIndex === d.modifiedStart);
                    g.slice(m, v).forEach(_ => {
                        if (_.type === "unchanged" || _.type === "modified") {
                            const y = n.cells[_.originalCellIndex],
                                M = r.cells[_.modifiedCellIndex];
                            (_.type === "modified" || y.getComparisonValue() !== M.getComparisonValue()) && p.push(new ue(_.originalCellIndex, 1, _.modifiedCellIndex, 1))
                        }
                    }), p.push(d), m = v + 1
                } else if (d.originalLength && !d.modifiedLength) {
                    const v = g.findIndex(_ => _.type === "delete" && _.originalCellIndex === d.originalStart);
                    g.slice(m, v).forEach(_ => {
                        if (_.type === "unchanged" || _.type === "modified") {
                            const y = n.cells[_.originalCellIndex],
                                M = r.cells[_.modifiedCellIndex];
                    ...
                    const v = g.findIndex(_ => _.type === "delete" && _.originalCellIndex === d.originalStart || _.type === "insert" && _.modifiedCellIndex === d.modifiedStart);
                    g.slice(m, v).forEach(_ => {
                        if (_.type === "unchanged" || _.type === "modified") {
                            const y = n.cells[_.originalCellIndex],
                                M = r.cells[_.modifiedCellIndex];
                ...
                if (d.type === "unchanged" || d.type === "modified") {
                    const v = n.cells[d.originalCellIndex],
                        _ = r.cells[d.modifiedCellIndex];
                    (d.type === "modified" || v.getComparisonValue() !== _.getComparisonValue()) && p.push(new ue(d.originalCellIndex, 1, d.modifiedCellIndex, 1))
                }
            }), {
                metadataChanged: l,
                cellsDiff: {
        ...
        updateCellIdsBasedOnMappings(t, e, n) {
            ...
            return e.map((i, s) => {
                ...
                i.internalMetadata = i.internalMetadata || {
                    internalId: ""
                }, i.internalMetadata.internalId = r.get(s) ?? vn()
            }), !0
        }
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/e48ee6102a199492b0c9964699bf011886708ba0/core/vs/workbench/contrib/notebook/common/services/notebookWebWorkerMain.js.map

//# debugId=d6c59cf4-088e-53ab-914f-91344875c8c6