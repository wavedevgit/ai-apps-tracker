"use strict";
(self.webpackChunkvscode_js_profile_table = self.webpackChunkvscode_js_profile_table || []).push([
    [848], {
        848: (_, e, t) => {
            t.d(e, {
                decode_bytes: () => r.pt,
                init_panic_hook: () => r.d3
            });
            var n = t(16),
                r = t(4);
            (0, r.lI)(n)
        ...
        4: (_, e, t) => {
            ...
            let i = new("undefined" == typeof TextDecoder ? (0, _.require)("util").TextDecoder : TextDecoder)("utf-8", {
                ignoreBOM: !0,
                fatal: !0
            });
            i.decode();
            ...
            let w = 0,
                p = new("undefined" == typeof TextEncoder ? (0, _.require)("util").TextEncoder : TextEncoder)("utf-8");
            const u = "function" == typeof p.encodeInto ? function(_, e) {
            ...
            function h(_, e, t) {
                if (void 0 === t) {
                    const t = p.encode(_),
                        n = e(t.length, 1) >>> 0;
                    return o().subarray(n, n + t.length).set(t), w = t.length, n
                }
                let n = _.length,
                    r = e(n, 1) >>> 0;
                const i = o();
                ...
                if (s !== n) {
                    0 !== s && (_ = _.slice(s)), r = t(r, n, n = s + 3 * _.length, 1) >>> 0;
            ...
            function y() {
                return null !== f && 0 !== f.byteLength || (f = new Int32Array(n.memory.buffer)), f
            }
            ...
            function v() {
                return null !== x && 0 !== x.byteLength || (x = new Uint32Array(n.memory.buffer)), x
            }
            ...
            class I {
                ...
                get_class_counts(_) {
                    try {
                        ...
                        var e = y()[o / 4 + 0],
                            t = y()[o / 4 + 1],
                            r = (i = e, s = t, i >>>= 0, v().subarray(i / 4, i / 4 + s)).slice();
