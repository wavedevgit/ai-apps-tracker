...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "24e54ab8-71d3-5079-b4f0-19e9e9f8d95e")
    } catch (e) {}
}();
var u1 = function(e, t) {
...
export function __esDecorate(e, t, r, s, i, n) {
    ...
    for (var o = s.kind, c = o === "getter" ? "get" : o === "setter" ? "set" : "value", l = !t && e ? s.static ? e : e.prototype : null, u = t || (l ? Object.getOwnPropertyDescriptor(l, s.name) : {}), f, d = !1, h = r.length - 1; h >= 0; h--) {
        var m = {};
        for (var E in s) m[E] = E === "access" ? {} : s[E];
        for (var E in s.access) m.access[E] = s.access[E];
        m.addInitializer = function(k) {
            if (d) throw new TypeError("Cannot add initializers after decoration has completed");
            n.push(a(k || null))
        };
        var C = (0, r[h])(o === "accessor" ? {
            get: u.get,
            set: u.set
        } : u[c], m);
        if (o === "accessor") {
            ...
            (f = a(C.get)) && (u.get = f), (f = a(C.set)) && (u.set = f), (f = a(C.init)) && i.unshift(f)
        } else(f = a(C)) && (o === "field" ? i.unshift(f) : u[c] = f)
    }
    l && Object.defineProperty(l, s.name, u), d = !0
}
...
export function __awaiter(e, t, r, s) {
    ...
    return new(r || (r = Promise))(function(n, a) {
        ...
        function l(u) {
            u.done ? n(u.value) : i(u.value).then(o, c)
        }
...
export function __asyncGenerator(e, t, r) {
    ...
    function l(h) {
        h.value instanceof __await ? Promise.resolve(h.value.v).then(u, f) : d(n[0][2], h)
    }
    ...
    function d(h, m) {
        h(m), n.shift(), n.length && c(n[0][0], n[0][1])
    }
}
...
var $n = typeof SuppressedError == "function" ? SuppressedError : function(e, t, r) {
    var s = new Error(r);
    return s.name = "SuppressedError", s.error = e, s.suppressed = t, s
};
export function __disposeResources(e) {
    function t(s) {
        e.error = e.hasError ? new $n(s, e.error, "An error was suppressed during disposal.") : s, e.hasError = !0
    }
    ...
    Vn = (e, t, r, s) => {
        if (t && typeof t == "object" || typeof t == "function")
            for (let i of h1(t)) !qn.call(e, i) && i !== r && f1(e, i, {
                get: () => t[i],
                enumerable: !(s = jn(t, i)) || s.enumerable
            });
        return e
    },
    zn = (e, t, r) => (r = e != null ? Mn(Wn(e)) : {}, Vn(t || !e || !e.__esModule ? f1(r, "default", {
        value: e,
        enumerable: !0
    }) : r, e));
...
var Rr, Ir, Hn, Nr = x({
    "out-build/vs/base/common/collections.js"() {
        ...
        Hn = class {
            constructor(e, t) {
                this.toKey = t, this._map = new Map, this[Rr] = "SetWithKey";
            ...
            } [(Ir = Symbol.iterator, Rr = Symbol.toStringTag, Ir)]() {
                return this.values()
            }
        }
    }
...
function Tt(e) {
    Kn(e) || $r.onUnexpectedError(e)
}

function Kn(e) {
    return e instanceof ot ? !0 : e instanceof Error && e.name === Rt && e.message === Rt
}
var Fr, $r, Rt, ot, d1, Mr, jr, Qe = x({
...
` + e.stack) : e
        ...
        }, $r = new Fr, Rt = "Canceled", ot = class extends Error {
            constructor() {
                if (super(Rt), this.name = this.message, jr && typeof console < "u") {
                    const e = new Error().stack ?? "";
                    Mr.some(t => e.includes(t)) && console.trace("[DebugCancellation] CancellationError created")
                }
            }
        }, d1 = class Pr extends Error {
            constructor(t) {
        ...
        }, Mr = ["composerChatService", "composerService", "composerUtilsService", "composerAgentService", "composerCapabilities", "composerDecisionsService", "aiServiceImpl", "toolsV2Service", "toolsV2HandlerRegistryService", "agentCompatService", "mockAgentStreamController", "mockComposerStreamController", "toolFormer", "ToolFormer", "tool", "agent", "Agent", "stream", "Stream", "ComposerFullInputBox", "ComposerToolFormerMessage", "QuickAgentConversation", "composerActions", "cancelAll", "abortChatAndWaitForFinish", "abortGenerationUUID"], jr = !1
    }
});
...
function Qn(e, t, r = 0, s = e.length) {
    let i = r,
        n = s;
    for (; i < n;) {
    ...
    "out-build/vs/base/common/arraysFind.js"() {
        ...
        qr = class kn {
            ...
            findLastMonotonous(t) {
                ...
                const r = Qn(this._array, t, this._findLastMonotonousLastIdx);
...
var p1, Br, m1, g1 = x({
    "out-build/vs/base/common/arrays.js"() {
        ...
        Yn(), Qe(), (e => {
            ...
            filter(t) {
                return new kr(r => this.iterate(s => t(s) ? r(s) : !0))
            }
            map(t) {
                return new kr(r => this.iterate(s => r(t(s))))
            }
            some(t) {
                let r = !1;
...
var Vr, zr, Gr, Hr, _1, y1, eo, Kr, Jr, It, Qr, v1 = x({
        "out-build/vs/base/common/map.js"() {
            ...
            Hr = class {
                ...
                constructor(t, r) {
                    if (this[Vr] = "ResourceMap", t instanceof Pt) this.map = new Map(t.map), this.toKey = r ?? Pt.defaultToKey;
                    else if (Xn(t)) {
                        this.map = new Map, this.toKey = r ?? Pt.defaultToKey;
                        for (const [s, i] of t) this.set(s, i)
                    } else this.map = new Map, this.toKey = t ?? Pt.defaultToKey
                }
                set(t, r) {
                    return this.map.set(this.toKey(t), new Hr(t, r)), this
                }
                get(t) {
            ...
            }, _1.defaultToKey = e => e.toString(), y1 = _1, eo = class {
                constructor(e, t) {
                    this[zr] = "ResourceSet", !e || typeof e == "function" ? this._map = new y1(e) : (this._map = new y1(t), e.forEach(this.add, this))
                }
                get size() {
                    return this._map.size
                }
                ...
                constructor() {
                    this[Gr] = "LinkedMap", this._map = new Map, this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0
                }
                clear() {
    ...
    b1, io = x({
        "out-build/vs/base/common/iterator.js"() {
            ...
            w1(), (e => {
                ...
                function* o(g) {
                    for (let _ = g.length - 1; _ >= 0; _--) yield g[_]
                }
                e.reverse = o;
                ...
                function* d(g, _) {
                    for (const O of g) _(O) && (yield O)
                }
                e.filter = d;

                function* h(g, _) {
                    let O = 0;
                    for (const T of g) yield _(T, O++)
                }
                e.map = h;
                ...
                function* E(...g) {
                    for (const _ of g) so(_) ? yield* _: yield _
                }
                e.concat = E;

                function C(g, _, O) {
                    let T = O;
                    for (const A of g) T = _(T, A);
                    return T
                }
                e.reduce = C;
                ...
                function* B(g, _, O = g.length) {
                    for (_ < -g.length && (_ = 0), _ < 0 && (_ += g.length), O < 0 ? O += g.length : O > g.length && (O = g.length); _ < O; _++) yield g[_]
                }
                e.slice = B;

                function P(g, _ = Number.POSITIVE_INFINITY) {
                    const O = [];
                    if (_ === 0) return [O, g];
                    const T = g[Symbol.iterator]();
                    for (let A = 0; A < _; A++) {
                        const j = T.next();
                ...
                async function J(g) {
                    const _ = [];
                    for await (const O of g) _.push(O);
...
function oo(e, t) {
    if (Me)
        for (const r of e) Me.setParent(r, t)
}
...
var Yr, Me, Zr, E1, je, me, A1, Xr, ut = x({
        "out-build/vs/base/common/lifecycle.js"() {
            "use strict";
            if (g1(), Nr(), v1(), Wr(), io(), Yr = !1, Me = null, Zr = class xn {
                    constructor() {
                    ...
                    computeLeakingDisposables(t = 10, r) {
                        ...
                        if (r) s = r;
                            ...
                            const c = new Map,
                                l = [...this.livingDisposables.values()].filter(f => f.source !== null && !this.getRootParent(f, c).isSingleton);
                            if (l.length === 0) return;
                            const u = new Set(l.map(f => f.value));
                            if (s = l.filter(f => !(f.parent && u.has(f.parent))), s.length === 0) throw new Error("There are cyclic diposable chains!")
                        }
                        if (!s) return;

                        function i(c) {
                            function l(f, d) {
                                for (; f.length > 0 && d.some(h => typeof h == "string" ? h === f[0] : f[0].match(h));) f.shift()
                            }
...
`), c)
                        ...
                        for (const c of s.slice(0, t)) {
                            ...
                            for (let f = 0; f < l.length; f++) {
                                let d = l[f];
                                d = `(shared with ${n.get(l.slice(0,f+1).join(`
`)).size}/${s.length} leaks) at ${d}`;
                                const m = n.get(l.slice(0, f).join(`
`)),
                                    E = Gn([...m].map(C => i(C)[f]), C => C);
                                delete E[l[f]];
                                for (const [C, k] of Object.entries(E)) u.unshift(`    - stacktraces of ${k.length} other leaks continue with ${C}`);
                                u.unshift(d)
                            }
                            a += `
...
`), {
            ...
            E1 = class On {
                constructor() {
                    this._toDispose = new Set, this._isDisposed = !1, at(this)
                }
                dispose() {
                    this._isDisposed || (lt(this), this._isDisposed = !0, this.clear())
                }
                get isDisposed() {
                ...
                add(t) {
                    ...
                    return ct(t, this), this._isDisposed ? On.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t
                }
                delete(t) {
                    if (t) {
                ...
                deleteAndLeak(t) {
                    t && this._toDispose.has(t) && (this._toDispose.delete(t), ct(t, null))
                }
            }, E1.DISABLE_DISPOSED_WARNING = !1, je = E1, me = class {
                constructor() {
                    this._store = new je, at(this), ct(this._store, this)
                }
                dispose() {
                    lt(this), this._store.dispose()
                }
                _register(e) {
                    if (e === this) throw new Error("Cannot register a disposable on itself!");
                    return this._store.add(e)
                }
            }, me.None = Object.freeze({
                dispose() {}
            }), A1 = class {
                constructor() {
                    this._isDisposed = !1, at(this)
                }
                get value() {
                    return this._isDisposed ? void 0 : this._value
                }
                set value(e) {
                    this._isDisposed || e === this._value || (this._value?.dispose(), e && ct(e, this), this._value = e)
                }
                clear() {
                    this.value = void 0
                }
                dispose() {
                    this._isDisposed = !0, lt(this), this._value?.dispose(), this._value = void 0
                }
                clearAndLeak() {
                    const e = this._value;
                    return this._value = void 0, e && ct(e, null), e
                }
            }, Xr = class {
                constructor() {
                    this._store = new Map, this._isDisposed = !1, at(this)
                }
                dispose() {
                    lt(this), this._isDisposed = !0, this.clearAndDisposeAll()
                }
                clearAndDisposeAll() {
                    if (this._store.size) try {
                        C1(this._store.values())
                    } finally {
                        this._store.clear()
                    }
                }
    ...
    S1, co = x({
        "out-build/vs/base/common/linkedList.js"() {
            ...
            S1 = class xr {
                constructor(t) {
                    this.element = t, this.next = xr.Undefined, this.prev = xr.Undefined
                }
            }, S1.Undefined = new S1(void 0)
        }
    }),
    es, ts, uo = x({
        "out-build/vs/base/common/stopwatch.js"() {
            "use strict";
            es = globalThis.performance && typeof globalThis.performance.now == "function", ts = class Dn {
                static create(t) {
                    return new Dn(t)
                }
                constructor(t) {
                    this._now = es && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1
                }
                stop() {
    ...
    P1, rs, ne, Nt, ss, k1, x1, is, Ft, ns, os, as, ft, ls, cs, oe, us, O1 = x({
        "out-build/vs/base/common/event.js"() {
            "use strict";
            Nr(), Qe(), Wr(), ut(), co(), uo(), P1 = !1, rs = !1, (e => {
                e.None = () => me.None;
                ...
                function t(b) {
                    if (rs) {
                        ...
                        let y = 0;
                        b.onDidAddListener = () => {
                            ++y === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), v.print()), p?.()
                        }
                    }
                }

                function r(b, p) {
                    return h(b, () => {}, 0, void 0, !0, void 0, p)
                }
                e.defer = r;
                ...
                function s(b) {
                    return (p, v = null, y) => {
                        let S = !1,
                            D;
                        return D = b($ => {
                            if (!S) return D ? D.dispose() : S = !0, p.call(v, $)
                        }, null, y), S && D.dispose(), D
                    }
                }
                e.once = s;

                function i(b, p) {
                    return e.once(e.filter(b, p))
                }
                e.onceIf = i;

                function n(b, p, v) {
                    return f((y, S = null, D) => b($ => y.call(S, p($)), null, D), v)
                }
                e.map = n;

                function a(b, p, v) {
                    return f((y, S = null, D) => b($ => {
                        p($), y.call(S, $)
                    }, null, D), v)
                }
                e.forEach = a;
                ...
                function o(b, p, v) {
                    return f((y, S = null, D) => b($ => p($) && y.call(S, $), null, D), v)
                }
                e.filter = o;
                ...
                function h(b, p, v = 100, y = !1, S = !1, D, $) {
                    let G, Q, Je, Dt = 0,
                        nt;
                    const Tr = {
                        ...
                        onWillAddFirstListener() {
                            G = b(In => {
                                Dt++, Q = p(Q, In), y && !Je && (Lt.fire(Q), Q = void 0), nt = () => {
                                    const Nn = Q;
                                    Q = void 0, Je = void 0, (!y || Dt > 1) && Lt.fire(Nn), Dt = 0
                                }, typeof v == "number" ? (clearTimeout(Je), Je = setTimeout(nt, v)) : Je === void 0 && (Je = 0, queueMicrotask(nt))
                            })
                        },
                    ...
                    $ || t(Tr);
                    const Lt = new oe(Tr);
                    return $?.add(Lt), Lt.event
                }
                e.debounce = h;

                function m(b, p = 0, v) {
                    return e.debounce(b, (y, S) => y ? (y.push(S), y) : [S], p, void 0, !0, void 0, v)
                }
                e.accumulate = m;

                function E(b, p = (y, S) => y === S, v) {
                    let y = !0,
                        S;
                    return o(b, D => {
                        const $ = y || !p(D, S);
                ...
                function C(b, p, v) {
                    return [e.filter(b, p, v), e.filter(b, y => !p(y), v)]
                }
                e.split = C;

                function k(b, p = !1, v = [], y) {
                    let S = v.slice(),
                        D = b(Q => {
                            S ? S.push(Q) : G.fire(Q)
                        });
                    y && y.add(D);
                    const $ = () => {
                            S?.forEach(Q => G.fire(Q)), S = null
                        },
                        G = new oe({
                            onWillAddFirstListener() {
                                D || (D = b(Q => G.fire(Q)), y && y.add(D))
                            },
                ...
                class J {
                    ...
                    filter(p) {
                        return this.steps.push(v => p(v) ? v : P), this
                    }
                    reduce(p, v) {
                        let y = v;
                        return this.steps.push(S => (y = p(y, S), y)), this
                    }
                    latch(p = (v, y) => v === y) {
                        let v = !0,
                            y;
                ...
                function g(b, p, v = y => y) {
                    const y = (...G) => $.fire(v(...G)),
                        S = () => b.on(p, y),
                        D = () => b.removeListener(p, y),
                        $ = new oe({
                ...
                function O(b, p, v = y => y) {
                    const y = (...G) => $.fire(v(...G)),
                        S = () => b.addEventListener(p, y),
                        D = () => b.removeEventListener(p, y),
                        $ = new oe({
                            onWillAddFirstListener: S,
                            onDidRemoveLastListener: D
                        });
                ...
                function T(b, p) {
                    return new Promise(v => s(b)(v, null, p))
                }
                e.toPromise = T;
                ...
                class F {
                    constructor(p, v) {
                        ...
                        v || t(y), this.emitter = new oe(y), v && v.add(this.emitter)
                    }
                    beginUpdate(p) {
                        this._counter++
                    }
                ...
                function Fe(b, p) {
                    return new F(b, p).emitter.event
                }
                e.fromObservable = Fe;
                ...
                function W(b) {
                    return (p, v, y) => {
                        ...
                        const $ = {
                            ...
                            endUpdate() {
                                S--, S === 0 && (b.reportChanges(), D && (D = !1, p.call(v)))
                            },
                        ...
                        b.addObserver($), b.reportChanges();
                        const G = {
                            dispose() {
                                b.removeObserver($)
                            }
                        };
                        return y instanceof je ? y.add(G) : Array.isArray(y) && y.push(G), G
                    }
                }
                e.fromObservableLight = W
            })(ne || (ne = {})), Nt = class Or {
                constructor(t) {
                    this.listenerCount = 0, this.invocationCount = 0, this.elapsedOverall = 0, this.durations = [], this.name = `${t}_${Or._idPool++}`, Or.all.add(this)
                }
                start(t) {
                    this._stopWatch = new ts, this.listenerCount = t
                }
                stop() {
                    if (this._stopWatch) {
            ...
            }, Nt.all = new Set, Nt._idPool = 0, ss = Nt, k1 = -1, x1 = class Ln {
                constructor(t, r, s = (Ln._idPool++).toString(16).padStart(3, "0")) {
            ...
            }, x1._idPool = 1, is = x1, Ft = class Tn {
                constructor(t) {
                    this.value = t
                }
                static create() {
...
`))
                ...
                constructor(e) {
                    this.value = e, this.id = as++
                }
            }, ls = 2, cs = (e, t) => {
                if (e instanceof ft) t(e);
                else
                ...
                constructor(e) {
                    this._size = 0, this._options = e, this._leakageMon = k1 > 0 || this._options?.leakWarningThreshold ? new is(e?.onListenerError ?? Tt, this._options?.leakWarningThreshold ?? k1) : void 0, this._perfMon = this._options?._profName ? new ss(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue
                }
                dispose() {
                    if (!this._disposed) {
                    ...
                    return this._event ??= (e, t, r) => {
                        if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
                            ...
                            const c = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
                                l = new os(`${o}. HINT: Stack shows most frequent listener (${c[1]}-times)`, c[0]);
                            return (this._options?.onListenerError || Tt)(l), me.None
                        }
                        if (this._disposed) return me.None;
                        t && (e = e.bind(t));
                        const s = new ft(e);
                        let i, n;
                        this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (s.stack = Ft.create(), i = this._leakageMon.check(s.stack, this._size + 1)), P1 && (s.stack = n ?? Ft.create()), this._listeners ? this._listeners instanceof ft ? (this._deliveryQueue ??= new us, this._listeners = [this._listeners, s]) : this._listeners.push(s) : (this._options?.onWillAddFirstListener?.(this), this._listeners = s, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
                        const a = $e(() => {
                            i?.(), this._removeListener(s)
                        });
                        return r instanceof je ? r.add(a) : Array.isArray(r) && r.push(a), a
                    }, this._event
                }
                _removeListener(e) {
                ...
                fire(e) {
                    if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners)
                        if (this._listeners instanceof ft) this._deliver(this._listeners, e);
                        else {
...
function ds(e, t) {
    ...
    }), ps && (r = "\uFF3B" + r.replace(/[aouei]/g, "$&$&") + "\uFF3D"), r
}

function w(e, t, ...r) {
    return ds(typeof e == "number" ? ho(e, t) : t, r)
}
...
var ps, $t = x({
        "out-build/vs/nls.js"() {
            "use strict";
            hs(), hs(), ps = fs() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0
        }
    }),
    We, ht, dt, Ye, ms, D1, Mt, gs, _s, ys, vs, pt, mt, L1, ws, ge, _e, K, T1, bs, jt, V, Oe, ye, Cs, Es, As, Ss, he, Ee, Ps, ks, xs, Os, po, mo, go, _o, yo, vo, wo, X = x({
        "out-build/vs/base/common/platform.js"() {
            "use strict";
            if ($t(), We = "en", ht = !1, dt = !1, Ye = !1, ms = !1, D1 = !1, Mt = !1, gs = !1, _s = !1, ys = !1, vs = !1, pt = void 0, mt = We, L1 = We, ws = void 0, ge = void 0, _e = globalThis, K = void 0, typeof _e.vscode < "u" && typeof _e.vscode.process < "u" ? K = _e.vscode.process : typeof process < "u" && typeof process?.versions?.node == "string" && (K = process), T1 = typeof K?.versions?.electron == "string", bs = T1 && K?.type === "renderer", typeof K == "object") {
                ht = K.platform === "win32", dt = K.platform === "darwin", Ye = K.platform === "linux", ms = Ye && !!K.env.SNAP && !!K.env.SNAP_REVISION, gs = T1, ys = !!K.env.CI || !!K.env.BUILD_ARTIFACTSTAGINGDIRECTORY, pt = We, mt = We;
                const e = K.env.VSCODE_NLS_CONFIG;
                if (e) try {
                    const t = JSON.parse(e);
                    pt = t.userLocale, L1 = t.osLocale, mt = t.resolvedLanguage || We, ws = t.languagePack?.translationsConfigFile
                } catch {}
                D1 = !0
            } else typeof navigator == "object" && !bs ? (ge = navigator.userAgent, ht = ge.indexOf("Windows") >= 0, dt = ge.indexOf("Macintosh") >= 0, _s = (ge.indexOf("Macintosh") >= 0 || ge.indexOf("iPad") >= 0 || ge.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, Ye = ge.indexOf("Linux") >= 0, vs = ge?.indexOf("Mobi") >= 0, Mt = !0, mt = fs() || We, pt = navigator.language.toLowerCase(), L1 = pt) : console.error("Unable to resolve platform.");
            jt = 0, dt ? jt = 1 : ht ? jt = 3 : Ye && (jt = 2), V = ht, Oe = dt, ye = Ye, Cs = D1, Es = Mt, As = Mt && typeof _e.importScripts == "function", Ss = As ? _e.origin : void 0, he = ge, Ee = mt, (e => {
                function t() {
                    return Ee
                }
                e.value = t;
                ...
                e.isDefault = s
            })(Ps || (Ps = {})), ks = typeof _e.postMessage == "function" && !_e.importScripts, xs = (() => {
                if (ks) {
                    const e = [];
                    _e.addEventListener("message", r => {
            ...
            })(), Os = !!(he && he.indexOf("Chrome") >= 0), po = !!(he && he.indexOf("Firefox") >= 0), mo = !!(!Os && he && he.indexOf("Safari") >= 0), go = !!(he && he.indexOf("Edg/") >= 0), _o = !!(he && he.indexOf("Android") >= 0), yo = K?.arch, vo = K?.platform, wo = K?.versions?.node
        }
    }),
    qe, Wt, Ze, qt, Ds, bo, R1 = x({
        "out-build/vs/base/common/process.js"() {
            "use strict";
            if (X(), Wt = globalThis.vscode, typeof Wt < "u" && typeof Wt.process < "u") {
                const e = Wt.process;
                qe = {
                    get platform() {
                        return e.platform
                ...
                get platform() {
                    return V ? "win32" : Oe ? "darwin" : "linux"
                },
                get arch() {},
                get env() {
                    return {}
            ...
            Ze = qe.cwd, qt = qe.env, Ds = qe.platform, bo = qe.arch
        }
    });
...
function Ut(e, t, r, s) {
    ...
    for (let l = 0; l <= e.length; ++l) {
        ...
        if (s(c)) {
            if (!(a === l - 1 || o === 1))
                if (o === 2) {
                    if (i.length < 2 || n !== 2 || i.charCodeAt(i.length - 1) !== De || i.charCodeAt(i.length - 2) !== De) {
                        if (i.length > 2) {
                            const u = i.lastIndexOf(r);
                            u === -1 ? (i = "", n = 0) : (i = i.slice(0, u), n = i.length - 1 - i.lastIndexOf(r)), a = l, o = 0;
                            continue
                        } else if (i.length !== 0) {
                            i = "", n = 0, a = l, o = 0;
                            continue
...
function Ls(e, t) {
    ...
    const r = t.dir || t.root,
        s = t.base || `${t.name||""}${Eo(t.ext)}`;
    return r ? r === t.root ? `${r}${s}` : `${r}${e}${s}` : s
}
var Ts, Rs, Is, Ns, De, z, ee, ve, Fs, N1, te, U, $s, N, Bt, Ue, Y, F1, Ms, Le, Xe, js, Ao, So, Po, ie, ko, ae = x({
    "out-build/vs/base/common/path.js"() {
        "use strict";
        R1(), Ts = 65, Rs = 97, Is = 90, Ns = 122, De = 46, z = 47, ee = 92, ve = 58, Fs = 63, N1 = class extends Error {
            constructor(e, t, r) {
                let s;
            ...
            resolve(...e) {
                ...
                for (let i = e.length - 1; i >= -1; i--) {
                    let n;
                    if (i >= 0) {
                        if (n = e[i], q(n, `paths[${i}]`), n.length === 0) continue
                    } else t.length === 0 ? n = Ze() : (n = qt[`=${t}`] || Ze(), (n === void 0 || n.slice(0, 2).toLowerCase() !== t.toLowerCase() && n.charCodeAt(2) === ee) && (n = `${t}\\`));
                    const a = n.length;
                    let o = 0,
                        c = "",
                        l = !1;
                    ...
                    if (a === 1) L(u) && (o = 1, l = !0);
                        ...
                        if (l = !0, L(n.charCodeAt(1))) {
                            let f = 2,
                                d = f;
                            for (; f < a && !L(n.charCodeAt(f));) f++;
                            if (f < a && f !== d) {
                                const h = n.slice(d, f);
                                for (d = f; f < a && L(n.charCodeAt(f));) f++;
                                if (f < a && f !== d) {
                                    for (d = f; f < a && !L(n.charCodeAt(f));) f++;
                                    (f === a || f !== d) && (c = `\\\\${h}\\${n.slice(d,f)}`, o = f)
                                }
                            }
                        } else o = 1;
                    else Ae(u) && n.charCodeAt(1) === ve && (c = n.slice(0, 2), o = 2, a > 2 && L(n.charCodeAt(2)) && (l = !0, o = 3));
                    if (c.length > 0)
                        if (t.length > 0) {
            ...
            normalize(e) {
                ...
                if (L(n))
                    if (i = !0, L(e.charCodeAt(1))) {
                        let o = 2,
                            c = o;
                        for (; o < t && !L(e.charCodeAt(o));) o++;
                        if (o < t && o !== c) {
                            const l = e.slice(c, o);
                            for (c = o; o < t && L(e.charCodeAt(o));) o++;
                            if (o < t && o !== c) {
                                for (c = o; o < t && !L(e.charCodeAt(o));) o++;
                ...
                else Ae(n) && e.charCodeAt(1) === ve && (s = e.slice(0, 2), r = 2, t > 2 && L(e.charCodeAt(2)) && (i = !0, r = 3));
                let a = r < t ? Ut(e.slice(r), !i, "\\", L) : "";
                if (a.length === 0 && !i && (a = "."), a.length > 0 && L(e.charCodeAt(t - 1)) && (a += "\\"), !i && s === void 0 && e.includes(":")) {
                    if (a.length >= 2 && Ae(a.charCodeAt(0)) && a.charCodeAt(1) === ve) return `.\\${a}`;
                    let o = e.indexOf(":");
                    do
                        if (o === t - 1 || L(e.charCodeAt(o + 1))) return `.\\${a}`; while ((o = e.indexOf(":", o + 1)) !== -1)
                }
            ...
            isAbsolute(e) {
                ...
                return L(r) || t > 2 && Ae(r) && e.charCodeAt(1) === ve && L(e.charCodeAt(2))
            },
            join(...e) {
                ...
                for (let n = 0; n < e.length; ++n) {
                    const a = e[n];
                    q(a, "path"), a.length > 0 && (t === void 0 ? t = r = a : t += `\\${a}`)
                }
                if (t === void 0) return ".";
                let s = !0,
                    i = 0;
                if (typeof r == "string" && L(r.charCodeAt(0))) {
                    ++i;
                    const n = r.length;
                    n > 1 && L(r.charCodeAt(1)) && (++i, n > 2 && (L(r.charCodeAt(2)) ? ++i : s = !1))
                }
                if (s) {
            ...
            relative(e, t) {
                ...
                if (r.length !== e.length || s.length !== t.length) {
                    const m = r.split("\\"),
                        E = s.split("\\");
                    m[m.length - 1] === "" && m.pop(), E[E.length - 1] === "" && E.pop();
                    const C = m.length,
                        k = E.length,
                        B = C < k ? C : k;
                    let P;
                    for (P = 0; P < B && m[P].toLowerCase() === E[P].toLowerCase(); P++);
                    return P === 0 ? s : P === B ? k > B ? E.slice(P).join("\\") : C > B ? "..\\".repeat(C - 1 - P) + ".." : "" : "..\\".repeat(C - P) + E.slice(P).join("\\")
                }
                let i = 0;
                for (; i < e.length && e.charCodeAt(i) === ee;) i++;
                let n = e.length;
                for (; n - 1 > i && e.charCodeAt(n - 1) === ee;) n--;
                const a = n - i;
                let o = 0;
                for (; o < t.length && t.charCodeAt(o) === ee;) o++;
                let c = t.length;
                for (; c - 1 > o && t.charCodeAt(c - 1) === ee;) c--;
                const l = c - o,
                    u = a < l ? a : l;
                let f = -1,
                    d = 0;
                ...
                if (d !== u) {
                    ...
                    if (l > u) {
                        if (t.charCodeAt(o + d) === ee) return s.slice(o + d + 1);
                        if (d === 2) return s.slice(o + d)
                    }
                    a > u && (e.charCodeAt(i + d) === ee ? f = d : d === 2 && (f = 3)), f === -1 && (f = 0)
                }
                let h = "";
                for (d = i + f + 1; d <= n; ++d)(d === n || e.charCodeAt(d) === ee) && (h += h.length === 0 ? ".." : "\\..");
                return o += f, h.length > 0 ? `${h}${s.slice(o,c)}` : (s.charCodeAt(o) === ee && ++o, s.slice(o, c))
            },
            toNamespacedPath(e) {
                ...
                if (t.charCodeAt(0) === ee) {
                    if (t.charCodeAt(1) === ee) {
                        ...
                        if (r !== Fs && r !== De) return `\\\\?\\UNC\\${t.slice(2)}`
                    }
                } else if (Ae(t.charCodeAt(0)) && t.charCodeAt(1) === ve && t.charCodeAt(2) === ee) return `\\\\?\\${t}`;
                return t
            },
            dirname(e) {
                q(e, "path");
                ...
                } else Ae(i) && e.charCodeAt(1) === ve && (r = t > 2 && L(e.charCodeAt(2)) ? 3 : 2, s = r);
                let n = -1,
                    a = !0;
                for (let o = t - 1; o >= s; --o)
                    if (L(e.charCodeAt(o))) {
            ...
            basename(e, t) {
                t !== void 0 && q(t, "suffix"), q(e, "path");
                let r = 0,
                    s = -1,
                    i = !0,
                    n;
                if (e.length >= 2 && Ae(e.charCodeAt(0)) && e.charCodeAt(1) === ve && (r = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
                    if (t === e) return "";
                    let a = t.length - 1,
                        o = -1;
            ...
            extname(e) {
                ...
                let t = 0,
                    ...
                    n = !0,
                    a = 0;
                e.length >= 2 && e.charCodeAt(1) === ve && Ae(e.charCodeAt(0)) && (t = s = 2);
                for (let o = e.length - 1; o >= t; --o) {
                    ...
                    i === -1 && (n = !1, i = o + 1), c === De ? r === -1 ? r = o : a !== 1 && (a = 1) : r !== -1 && (a = -1)
                }
            ...
            parse(e) {
                ...
                let s = 0,
                    i = e.charCodeAt(0);
                if (r === 1) return L(i) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
                if (L(i)) {
                    if (s = 1, L(e.charCodeAt(1))) {
                        let f = 2,
                            d = f;
                        for (; f < r && !L(e.charCodeAt(f));) f++;
                        if (f < r && f !== d) {
                            for (d = f; f < r && L(e.charCodeAt(f));) f++;
                            if (f < r && f !== d) {
                                for (d = f; f < r && !L(e.charCodeAt(f));) f++;
                                f === r ? s = f : f !== d && (s = f + 1)
                            }
                ...
                } else if (Ae(i) && e.charCodeAt(1) === ve) {
                    if (r <= 2) return t.root = t.dir = e, t;
                    if (s = 2, L(e.charCodeAt(2))) {
                ...
                for (; l >= s; --l) {
                    ...
                    o === -1 && (c = !1, o = l + 1), i === De ? n === -1 ? n = l : u !== 1 && (u = 1) : n !== -1 && (u = -1)
                }
                return o !== -1 && (n === -1 || u === 0 || u === 1 && n === o - 1 && n === a + 1 ? t.base = t.name = e.slice(a, o) : (t.name = e.slice(a, n), t.base = e.slice(a, o), t.ext = e.slice(n, o))), a > 0 && a !== s ? t.dir = e.slice(0, a - 1) : t.dir = t.root, t
            },
            sep: "\\",
            delimiter: ";",
            win32: null,
            ...
            resolve(...e) {
                ...
                for (let s = e.length - 1; s >= 0 && !r; s--) {
                    const i = e[s];
                    q(i, `paths[${s}]`), i.length !== 0 && (t = `${i}/${t}`, r = i.charCodeAt(0) === z)
                }
                if (!r) {
                    const s = $s();
                    t = `${s}/${t}`, r = s.charCodeAt(0) === z
                }
                return t = Ut(t, !r, "/", I1), r ? `/${t}` : t.length > 0 ? t : "."
            },
            normalize(e) {
                if (q(e, "path"), e.length === 0) return ".";
                const t = e.charCodeAt(0) === z,
                    r = e.charCodeAt(e.length - 1) === z;
                return e = Ut(e, !t, "/", I1), e.length === 0 ? t ? "/" : r ? "./" : "." : (r && (e += "/"), t ? `/${e}` : e)
            },
            isAbsolute(e) {
                return q(e, "path"), e.length > 0 && e.charCodeAt(0) === z
            },
            join(...e) {
                if (e.length === 0) return ".";
                const t = [];
                for (let r = 0; r < e.length; ++r) {
                    const s = e[r];
                    q(s, "path"), s.length > 0 && t.push(s)
                }
                return t.length === 0 ? "." : N.normalize(t.join("/"))
            },
            relative(e, t) {
                if (q(e, "from"), q(t, "to"), e === t || (e = N.resolve(e), t = N.resolve(t), e === t)) return "";
                const r = 1,
                    s = e.length,
                    i = s - r,
                    n = 1,
                ...
                let u = "";
                for (l = r + c + 1; l <= s; ++l)(l === s || e.charCodeAt(l) === z) && (u += u.length === 0 ? ".." : "/..");
            ...
            parse(e) {
                ...
                for (; c >= s; --c) {
                    ...
                    a === -1 && (o = !1, a = c + 1), u === De ? i === -1 ? i = c : l !== 1 && (l = 1) : i !== -1 && (l = -1)
                }
                if (a !== -1) {
                    const u = n === 0 && r ? 1 : n;
                    i === -1 || l === 0 || l === 1 && i === a - 1 && i === n + 1 ? t.base = t.name = e.slice(u, a) : (t.name = e.slice(u, i), t.base = e.slice(u, a), t.ext = e.slice(i, a))
                }
            ...
            win32: null,
            posix: null
        }, N.win32 = U.win32 = U, N.posix = U.posix = N, Bt = te ? U.normalize : N.normalize, Ue = te ? U.isAbsolute : N.isAbsolute, Y = te ? U.join : N.join, F1 = te ? U.resolve : N.resolve, Ms = te ? U.relative : N.relative, Le = te ? U.dirname : N.dirname, Xe = te ? U.basename : N.basename, js = te ? U.extname : N.extname, Ao = te ? U.format : N.format, So = te ? U.parse : N.parse, Po = te ? U.toNamespacedPath : N.toNamespacedPath, ie = te ? U.sep : N.sep, ko = te ? U.delimiter : N.delimiter
    }
});
...
var Oo = x({
    ...
    $1, Vt, gt, et, zt = x({
        "out-build/vs/base/common/cancellation.js"() {
            "use strict";
            O1(), $1 = Object.freeze(function(e, t) {
                ...
                function t(r) {
                    return r === e.None || r === e.Cancelled || r instanceof gt ? !0 : !r || typeof r != "object" ? !1 : typeof r.isCancellationRequested == "boolean" && typeof r.onCancellationRequested == "function"
                }
                e.isCancellationToken = t, e.None = Object.freeze({
                    isCancellationRequested: !1,
                    onCancellationRequested: ne.None
                }), e.Cancelled = Object.freeze({
                    isCancellationRequested: !0,
                    onCancellationRequested: $1
                })
            })(Vt || (Vt = {})), gt = class {
                constructor() {
                ...
                get onCancellationRequested() {
                    return this._isCancelled ? $1 : (this._emitter || (this._emitter = new oe), this._emitter.event)
                }
                dispose() {
                ...
                cancel() {
                    this._token ? this._token instanceof gt && this._token.cancel() : this._token = Vt.Cancelled
                }
                dispose(e = !1) {
                    e && this.cancel(), this._parentListener?.dispose(), this._token ? this._token instanceof gt && this._token.dispose() : this._token = Vt.None
                }
            }
        }
    });
...
var Ws, Lo = x({
        "out-build/vs/base/common/cache.js"() {
            ...
            zt(), Ws = class {
                constructor(e, t) {
                    this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = Do) : (this._fn = t, this._computeKey = e.getCacheKey)
                }
                get(e) {
    ...
    To = x({
        "out-build/vs/base/common/strings.cursor.js"() {
            "use strict"
        }
    });
...
function j1(e, t, r = 0, s = e.length, i = 0, n = t.length) {
    for (; r < s && i < n; r++, i++) {
...
function Us(e, t) {
    return Be(e, t, 0, e.length, 0, t.length)
}

function Be(e, t, r = 0, s = e.length, i = 0, n = t.length) {
    for (; r < s && i < n; r++, i++) {
        let c = e.charCodeAt(r),
            l = t.charCodeAt(i);
        if (c === l) continue;
        if (c >= 128 || l >= 128) return j1(e.toLowerCase(), t.toLowerCase(), r, s, i, n);
        Bs(c) && (c -= 32), Bs(l) && (l -= 32);
        const u = c - l;
        if (u !== 0) return u
    }
...
function W1(e, t) {
    return e.length === t.length && Be(e, t) === 0
}

function Io(e, t) {
    const r = t.length;
    return t.length > e.length ? !1 : Be(e, t, 0, r) === 0
}

function No(e, t) {
    const r = e.length,
        s = r - t.length;
    return s >= 0 && Be(e, t, s, r) === 0
}
...
var Vs, zs, Gs, $o, Mo, Hs, Ve, Ks, ze = x({
    "out-build/vs/base/common/strings.js"() {
        "use strict";
        Lo(), _t(), To(), Vs = /(?:\x1b\[|\x9b)[=?>!]?[\d;:]*["$#'* ]?[a-zA-Z@^`{}|~]/, zs = /(?:\x1b\]|\x9d).*?(?:\x1b\\|\x07|\x9c)/, Gs = /\x1b(?:[ #%\(\)\*\+\-\.\/]?[a-zA-Z0-9\|}~@])/, $o = new RegExp("(?:" + [Vs.source, zs.source, Gs.source].join("|") + ")", "g"), Mo = "\uFEFF", Hs = class kt {
            static getInstance() {
        ...
        }, Hs._INSTANCE = null, Ve = class Dr {
            constructor(t) {
                this.confusableDictionary = t
            }
            static getInstance(t) {
                return Dr.cache.get(Array.from(t))
            }
            static getLocales() {
                return Dr._locales.value
            }
            isAmbiguous(t) {
            ...
            function s(l, u) {
                if (!l) return u;
                const f = new Map;
                for (const [d, h] of l) u.has(d) && f.set(d, h);
                return f
            }
            const i = Ve.ambiguousCharacterData.value;
            let n = e.filter(l => !l.startsWith("_") && l in i);
            n.length === 0 && (n = ["_default"]);
            let a;
            for (const l of n) {
                const u = t(i[l]);
                a = s(a, u)
            ...
            const o = t(i._common),
                c = r(o, a);
            return new Ve(c)
        }), Ve._locales = new Te(() => Object.keys(Ve.ambiguousCharacterData.value).filter(e => !e.startsWith("_"))), Ks = class xt {
            static getRawData() {
...
function jo(e) {
    return e.indexOf("/") === -1 && (e = Js(e)), /^[a-zA-Z]:(\/|$)/.test(e) && (e = "/" + e), e
}

function Qs(e, t = N.sep) {
    if (!e) return "";
    const r = e.length,
        s = e.charCodeAt(0);
    if (Re(s)) {
        if (Re(e.charCodeAt(1)) && !Re(e.charCodeAt(2))) {
            let n = 3;
            const a = n;
            for (; n < r && !Re(e.charCodeAt(n)); n++);
            if (a !== n && !Re(e.charCodeAt(n + 1))) {
                for (n += 1; n < r; n++)
                    if (Re(e.charCodeAt(n))) return e.slice(0, n + 1).replace(/[\\/]/g, t)
            }
        }
        return t
    } else if (Zs(s) && e.charCodeAt(1) === 58) return Re(e.charCodeAt(2)) ? e.slice(0, 2) + t : e.slice(0, 2);
    let i = e.indexOf("://");
    if (i !== -1) {
        for (i += 3; i < r; i++)
            if (Re(e.charCodeAt(i))) return e.slice(0, i + 1)
    }
    return ""
}
...
function Uo(e, t, r) {
    for (let s = 0; s < r; s++) {
        let i = e.charCodeAt(s),
            n = t.charCodeAt(s);
        if (i !== n) {
            if (i >= 128 || n >= 128) return Be(e, t, s, r, s, r) === 0;
            if (i >= 97 && i <= 122 && (i -= 32), n >= 97 && n <= 122 && (n -= 32), i !== n) return !1
        }
    }
    return !0
}

function Se(e, t, r, s = ie) {
    if (e === t) return !0;
    if (!e || !t) return !1;
    const i = e.length,
        n = t.length;
    ...
    const a = s.charCodeAt(0),
        o = t.charCodeAt(n - 1) === a;
    if (n < i && !o && e.charCodeAt(n) !== a) return !1;
    if (r) {
        if (!Uo(e, t, n)) return !1
    } else if (!qo(e, t, n)) return !1;
    return n === i || o ? !0 : e.charCodeAt(n) === a
}
...
function Bo(e) {
    const t = Bt(e);
    return V ? e.length > 3 ? !1 : Vo(t) && (e.length === 2 || t.charCodeAt(2) === 92) : t === N.sep
}

function Vo(e, t = V) {
    return t ? Zs(e.charCodeAt(0)) && e.charCodeAt(1) === 58 : !1
}
...
function yt(e, t, r = 8) {
    ...
    for (let n = 0; n < r; n++) {
        let a;
        n === 0 && V && !t && (r === 3 || r === 4) ? a = ei : a = Xs, s += a.charAt(Math.floor(Math.random() * a.length))
    }
    let i;
    return t ? i = `${t}-${s}` : i = s, e ? Y(e, i) : i
}
var Xs, ei, Ge = x({
        "out-build/vs/base/common/extpath.js"() {
            "use strict";
            ae(), X(), ze(), w1(), Xs = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789", ei = "BDEFGHIJKMOQRSTUVWXYZbdefghijkmoqrstuvwxyz0123456789"
        }
    }),
    zo = x({
    ...
    Go, Ho = x({
        "out-build/vs/base/common/buffer.js"() {
            "use strict";
            _t(), zo(), Go = new Te(() => new Uint8Array(256))
        }
    });
...
function Ko(e, t) {
    ...
    if (e.scheme && !si.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
    if (e.path) {
        if (e.authority) {
...
function Yo(e) {
    ...
    for (let r = 0; r < e.length; r++) {
        ...
        s === 35 || s === 63 ? (t === void 0 && (t = e.substr(0, r)), t += B1[s]) : t !== void 0 && (t += e[r])
    }
    return t !== void 0 ? t : e
}
...
function q1(e, t) {
    ...
    if (i && (s += i, s += ":"), (n || i === "file") && (s += le, s += le), n) {
        let l = n.indexOf("@");
        if (l !== -1) {
            const u = n.substr(0, l);
            n = n.substr(l + 1), l = u.lastIndexOf(":"), l === -1 ? s += r(u, !1, !1) : (s += r(u.substr(0, l), !1, !1), s += ":", s += r(u.substr(l + 1), !1, !0)), s += "@"
        }
    ...
    return o && (s += "?", s += r(o, !1, !1)), c && (s += "#", s += t ? c : ti(c, !1, !1)), s
}
...
function ri(e) {
    try {
        ...
        return e.length > 3 ? e.substr(0, 3) + ri(e.substr(3)) : e
    }
}

function Ht(e) {
    return e.match(V1) ? e.replace(V1, t => ri(t)) : e
}
var si, ii, ni, M, le, oi, Z, U1, He, B1, V1, Ke = x({
    "out-build/vs/base/common/uri.js"() {
        "use strict";
        ae(), X(), Kt(), Ho(), si = /^\w[\w\d+.-]*$/, ii = /^\//, ni = /^\/\//, M = "", le = "/", oi = /^(([^:/?#]+?):)?(\/\/([^/?#]*))?([^?#]*)(\?([^#]*))?(#(.*))?/, Z = class o1 {
            static isUri(t) {
            ...
            constructor(t, r, s, i, n, a = !1) {
                typeof t == "object" ? (this.scheme = t.scheme || M, this.authority = t.authority || M, this.path = t.path || M, this.query = t.query || M, this.fragment = t.fragment || M) : (this.scheme = Jo(t, a), this.authority = r || M, this.path = Qo(this.scheme, s || M), this.query = i || M, this.fragment = n || M, Ko(this, a))
            }
            get fsPath() {
                return Gt(this, !1)
            }
            with(t) {
                ...
                return r === void 0 ? r = this.scheme : r === null && (r = M), s === void 0 ? s = this.authority : s === null && (s = M), i === void 0 ? i = this.path : i === null && (i = M), n === void 0 ? n = this.query : n === null && (n = M), a === void 0 ? a = this.fragment : a === null && (a = M), r === this.scheme && s === this.authority && i === this.path && n === this.query && a === this.fragment ? this : new He(r, s, i, n, a)
            }
            static parse(t, r = !1) {
                const s = oi.exec(t);
                return s ? new He(s[2] || M, Ht(s[4] || M), Ht(s[5] || M), Ht(s[7] || M), Ht(s[9] || M), r) : new He(M, M, M, M, M)
            }
            static file(t) {
                let r = M;
                if (V && (t = t.replace(/\\/g, le)), t[0] === le && t[1] === le) {
                    const s = t.indexOf(le, 2);
                    s === -1 ? (r = t.substring(2), t = le) : (r = t.substring(2, s), t = t.substring(s) || le)
                }
                return new He("file", r, t, M, M)
            }
            static from(t, r) {
                return new He(t.scheme, t.authority, t.path, t.query, t.fragment, r)
            }
            static joinPath(t, ...r) {
                if (!t.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
                let s;
                return V && t.scheme === "file" ? s = o1.file(U.join(Gt(t, !0), ...r)).path : s = N.join(t.path, ...r), t.with({
                    path: s
                })
            }
            toString(t = !1) {
            ...
            static revive(t) {
                if (t) {
                    ...
                    {
                        const r = new He(t);
                        return r._formatted = t.external ?? null, r._fsPath = t._sep === U1 ? t.fsPath ?? null : null, r
                    }
                } else return t
            } [Symbol.for("debug.description")]() {
                return `URI(${this.toString()})`
            }
        }, U1 = V ? 1 : void 0, He = class extends Z {
            constructor() {
            ...
            toString(e = !1) {
                return e ? q1(this, !0) : (this._formatted || (this._formatted = q1(this, !1)), this._formatted)
            }
            toJSON() {
                const e = {
                    $mid: 1
                };
                return this._fsPath && (e.fsPath = this._fsPath, e._sep = U1), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e
            }
        }, B1 = {
            58: "%3A",
            47: "%2F",
...
var H, ai, li, ci, ui, z1, fi, hi, Xo, ea, di, Kt = x({
    "out-build/vs/base/common/network.js"() {
        ...
        Qe(), X(), ze(), Ke(), ae(), (e => {
            ...
            setServerRootPath(e, t) {
                this._serverRootPath = N.join(t ?? "/", Zo(e))
            }
            getServerRootPath() {
                return this._serverRootPath
            }
            get _remoteResourcesPath() {
                return N.join(this._serverRootPath, H.vscodeRemoteResource)
            }
            set(e, t, r) {
            ...
            rewrite(e) {
                ...
                return typeof i == "string" && (n += `&${ai}=${encodeURIComponent(i)}`), Z.from({
                    scheme: Es ? this._preferredWebSchema : H.vscodeRemoteResource,
                    authority: `${r}:${s}`,
                    path: this._remoteResourcesPath,
                    query: n
                })
            }
        }, ci = new li, ui = "vscode-app", z1 = class a1 {
            asBrowserUri(t) {
                const r = this.toUri(t);
                return this.uriToBrowserUri(r)
            }
            uriToBrowserUri(t) {
                return t.scheme === H.vscodeRemote ? ci.rewrite(t) : t.scheme === H.file && (Cs || Ss === `${H.vscodeFileResource}://${a1.FALLBACK_AUTHORITY}`) ? t.with({
        ...
        }, z1.FALLBACK_AUTHORITY = ui, fi = z1, hi = new fi, Xo = Object.freeze({
            ...
            function s(n) {
                let a;
                typeof n == "string" ? a = new URL(n).searchParams : n instanceof URL ? a = n.searchParams : Z.isUri(n) && (a = new URL(n.toString(!0)).searchParams);
                const o = a?.get(r);
                if (o) return t.get(o)
            }
...
var Jt, I, pi, ta, ra, sa, ia, na, mi, oa, aa, G1, la, ca, ua, fa, H1, K1, ha, da, gi, J1 = x({
        "out-build/vs/base/common/resources.js"() {
            "use strict";
            Ge(), Kt(), ae(), X(), ze(), Ke(), Jt = class {
                constructor(e) {
                    this._ignorePathCasing = e
                }
                compare(e, t, r = !1) {
                    return e === t ? 0 : M1(this.getComparisonKey(e, r), this.getComparisonKey(t, r))
                }
                isEqual(e, t, r = !1) {
                ...
                isEqualOrParent(e, t, r = !1) {
                    if (e.scheme === t.scheme) {
                        if (e.scheme === H.file) return Se(Pe(e), Pe(t), this._ignorePathCasing(e)) && e.query === t.query && (r || e.fragment === t.fragment);
                        if (H1(e.authority, t.authority)) return Se(e.path, t.path, this._ignorePathCasing(e), "/") && e.query === t.query && (r || e.fragment === t.fragment)
                    }
                    return !1
                }
                joinPath(e, ...t) {
                ...
                dirname(e) {
                    ...
                    let t;
                    return e.scheme === H.file ? t = Z.file(Le(Pe(e))).path : (t = N.dirname(e.path), e.authority && t.length && t.charCodeAt(0) !== 47 && (console.error(`dirname("${e.toString})) resulted in a relative path`), t = "/")), e.with({
                        path: t
                    })
                }
                normalizePath(e) {
                    ...
                    let t;
                    return e.scheme === H.file ? t = Z.file(Bt(Pe(e))).path : t = N.normalize(e.path), e.with({
                        path: t
                    })
                }
                relativePath(e, t) {
                    ...
                    return N.relative(r, s)
                }
                resolvePath(e, t) {
                    if (e.scheme === H.file) {
                        const r = Z.file(F1(Pe(e), t));
                        return e.with({
                            authority: r.authority,
                            path: r.path
                        })
                    }
                    return t = jo(t), e.with({
                        path: N.resolve(e.path, t)
                    })
                }
                isAbsolutePath(e) {
                ...
                isEqualAuthority(e, t) {
                    return e === t || e !== void 0 && t !== void 0 && W1(e, t)
                }
                hasTrailingPathSeparator(e, t = ie) {
                    if (e.scheme === H.file) {
                        const r = Pe(e);
                ...
                removeTrailingPathSeparator(e, t = ie) {
                    return K1(e, t) ? e.with({
                        path: e.path.substr(0, e.path.length - 1)
                    }) : e
                }
                addTrailingPathSeparator(e, t = ie) {
                    let r = !1;
                    if (e.scheme === H.file) {
                        const s = Pe(e);
                        r = s !== void 0 && s.length === Qs(s).length && s[s.length - 1] === t
                    } else {
                        t = "/";
                        const s = e.path;
                        r = s.length === 1 && s.charCodeAt(s.length - 1) === 47
                    }
                    return !r && !K1(e, t) ? e.with({
                        path: e.path + "/"
                    }) : e
                }
            }, I = new Jt(() => !1), pi = new Jt(e => e.scheme === H.file ? !ye : !0), ta = new Jt(e => !0), ra = I.isEqual.bind(I), sa = I.isEqualOrParent.bind(I), ia = I.getComparisonKey.bind(I), na = I.basenameOrAuthority.bind(I), mi = I.basename.bind(I), oa = I.extname.bind(I), aa = I.dirname.bind(I), G1 = I.joinPath.bind(I), la = I.normalizePath.bind(I), ca = I.relativePath.bind(I), ua = I.resolvePath.bind(I), fa = I.isAbsolutePath.bind(I), H1 = I.isEqualAuthority.bind(I), K1 = I.hasTrailingPathSeparator.bind(I), ha = I.removeTrailingPathSeparator.bind(I), da = I.addTrailingPathSeparator.bind(I), (e => {
...
function ga(e) {
    ...
    const i = new Promise((n, a) => {
        const o = t.token.onCancellationRequested(() => {
            s = !0, o.dispose(), a(new ot)
        });
        Promise.resolve(r).then(c => {
            o.dispose(), t.dispose(), s ? ao(c) && c.dispose() : n(c)
        }, c => {
    ...
    return t ? new Promise((r, s) => {
        const i = setTimeout(() => {
            ...
            n = t.onCancellationRequested(() => {
                clearTimeout(i), n.dispose(), s(new ot)
            })
    }) : ga(r => yi(e, r))
}
var vi, Q1, wi, Y1, bi, Ci, _a, Z1, X1, Ei, er, vt = x({
    "out-build/vs/base/common/async.js"() {
        "use strict";
        zt(), Qe(), O1(), ut(), J1(), X(), ma(), _t(), vi = class {
            constructor(e) {
                this._size = 0, this._isDisposed = !1, this.maxDegreeOfParalellism = e, this.outstandingPromises = [], this.runningPromises = 0, this._onDrained = new oe
            }
            whenIdle() {
                return this.size > 0 ? ne.toPromise(this.onDrained) : Promise.resolve()
            }
            get onDrained() {
            ...
            queueFor(e, t, r = I) {
                ...
                if (!i) {
                    ...
                    this.drainListeners || (this.drainListeners = new Xr), this.drainListeners.set(n, a), this.queues.set(s, i)
                }
                return i.queue(t)
            }
            onDidQueueDrain() {
            ...
            constructor(e, t) {
                super(), this.options = e, this.handler = t, this.pendingWork = [], this.throttler = this._register(new A1), this.disposed = !1, this.lastExecutionTime = 0
            }
            get pending() {
            ...
            typeof globalThis.requestIdleCallback != "function" || typeof globalThis.cancelIdleCallback != "function" ? Z1 = (e, t, r) => {
                xs(() => {
                    if (s) return;
                    const i = Date.now() + 15;
                    t(Object.freeze({
            ...
            constructor(t, r) {
                this._state = 0, this._results = [], this._error = null, this._onReturn = r, this._onStateChanged = new oe, queueMicrotask(async () => {
                    const s = {
...
function ya(e, t, r) {
    ...
    if (s) return s;
    let i;
    return Si.test(e) ? i = e.normalize(t) : i = e, r.set(e, i), i
}
var Ai, va, Si, Pi = x({
    "out-build/vs/base/common/normalization.js"() {
        "use strict";
        v1(), Ai = new It(1e4), va = new It(1e4), Si = /[^\u0000-\u0080]/
    }
});
import * as R from "fs";
import {
...
async function ki(e, t = 0, r) {
    if (Bo(e)) throw new Error("rimraf - will refuse to recursively delete root");
    return t === 0 ? rr(e) : ba(e, r)
}
async function ba(e, t = yt(wa())) {
    try {
        try {
            await R.promises.rename(e, t)
        } catch (r) {
            return r.code === "ENOENT" ? void 0 : rr(e)
        }
        rr(t).catch(r => {})
    } catch (r) {
...
async function Qt(e, t) {
    return Ea(await (t ? Ca(e) : R.promises.readdir(e)))
}
async function Ca(e) {
    try {
        return await R.promises.readdir(e, {
            withFileTypes: !0
        })
    } catch (s) {
    ...
    for (const s of r) {
        let i = !1,
            ...
            a = !1;
        try {
            const o = await R.promises.lstat(Y(e, s));
...
function Ea(e) {
    return e.map(t => typeof t == "string" ? Oe ? tr(t) : t : (t.name = Oe ? tr(t.name) : t.name, t))
}
async function Aa(e) {
    const t = await Qt(e),
        r = [];
    for (const s of t) await bt.existsDirectory(Y(e, s)) && r.push(s);
    return r
}
...
function Sa(e, t, r) {
    return Ii.queueFor(Z.file(e), () => {
        const s = Di(r);
        return new Promise((i, n) => Pa(e, t, s, a => a ? n(a) : i()))
    }, pi)
}
...
function Pa(e, t, r, s) {
    if (!Yt) return R.writeFile(e, t, {
        mode: r.mode,
        flag: r.flag
    }, s);
    R.open(e, r.flag, r.mode, (i, n) => {
        if (i) return s(i);
        R.writeFile(n, t, a => {
            if (a) return R.close(n, () => s(a));
            R.fdatasync(n, o => (o && (console.warn("[node.js fs] fdatasync is now disabled for this session because it failed: ", o), Oi(!1)), R.close(n, c => s(c))))
        })
    })
}
...
function tt(e, t, r) {
    const s = Di(r);
    if (!Yt) return R.writeFileSync(e, t, {
        mode: s.mode,
        flag: s.flag
    });
    const i = R.openSync(e, s.flag, s.mode);
    try {
        R.writeFileSync(i, t);
        try {
            R.fdatasyncSync(i)
        } catch (n) {
            console.warn("[node.js fs] fdatasyncSync is now disabled for this session because it failed: ", n), Oi(!1)
        }
    } finally {
        R.closeSync(i)
    }
...
async function ka(e, t, r = 6e4) {
    if (e !== t) try {
        V && typeof r == "number" ? await Li(e, t, Date.now(), r) : await R.promises.rename(e, t)
    } catch (s) {
        if (e.toLowerCase() !== t.toLowerCase() && s.code === "EXDEV" || e.endsWith(".")) await Ti(e, t, {
            preserveSymlinks: !1
        }), await ki(e, 1);
        else throw s
    }
}
async function Li(e, t, r, s, i = 0) {
    try {
        return await R.promises.rename(e, t)
    } catch (n) {
        ...
        return await yi(Math.min(100, i * 10)), Li(e, t, r, s, i + 1)
    }
}
...
async function Ri(e, t, r) {
    ...
    if (i) {
        if (r.options.preserveSymlinks) try {
            return await Da(e, t, r)
        } catch {}
        if (i.dangling) return
    }
    return s.isDirectory() ? xa(e, t, s.mode & sr, r) : Oa(e, t, s.mode & sr)
}
async function xa(e, t, r, s) {
    await R.promises.mkdir(t, {
        recursive: !0,
        mode: r
    });
    const i = await Qt(e);
    for (const n of i) await Ri(Y(e, n), Y(t, n), s)
}
async function Oa(e, t, r) {
    await R.promises.copyFile(e, t), await R.promises.chmod(t, r)
}
async function Da(e, t, r) {
    let s = await R.promises.readlink(e);
    Se(s, r.root.source, !ye) && (s = Y(r.root.target, s.substr(r.root.source.length + 1))), await R.promises.symlink(s, t)
}
var bt, Ii, Yt, sr, we, ir = x({
    "out-build/vs/base/node/pfs.js"() {
        "use strict";
        vt(), Ge(), Pi(), ae(), X(), J1(), Ke(), (e => {
            async function t(i) {
                let n;
                try {
                    if (n = await R.promises.lstat(i), !n.isSymbolicLink()) return {
                        stat: n
                    }
                } catch {}
                try {
                    return {
                        stat: await R.promises.stat(i),
                    ...
                    if (V && a.code === "EACCES") try {
                        return {
                            stat: await R.promises.stat(await R.promises.readlink(i)),
                            symbolicLink: {
                                dangling: !1
                            }
                        }
            ...
            e.existsDirectory = s
        })(bt || (bt = {})), Ii = new wi, Yt = !0, sr = 511, we = new class {
            get read() {
                return (e, t, r, s, i) => new Promise((n, a) => {
                    R.read(e, t, r, s, i, (o, c, l) => o ? a(o) : n({
                        bytesRead: c,
                        buffer: l
                    }))
                })
            ...
            get write() {
                return (e, t, r, s, i) => new Promise((n, a) => {
                    R.write(e, t, r, s, i, (o, c, l) => o ? a(o) : n({
                        bytesWritten: c,
                        buffer: l
                    }))
                })
            ...
            get realpath() {
                return wt(R.realpath)
            }
            get ftruncate() {
                return wt(R.ftruncate)
            }
            async exists(e) {
                try {
                    return await R.promises.access(e), !0
                } catch {
                    return !1
                }
            }
...
import * as La from "net";

function nr(e, t, r, s = 1) {
    let i = !1;
...
function or(e, t, r, s) {
    if (t === 0) return s(0);
    const i = new La.Socket;
    i.once("connect", () => (Ni(i), or(e + r, t - 1, r, s))), i.once("data", () => {}), i.once("error", n => (Ni(i), n.code !== "ECONNREFUSED" ? or(e + r, t - 1, r, s) : s(e))), i.connect(e, "127.0.0.1")
}
...
import * as Fi from "fs";
async function Ra(e) {
    try {
        return await we.realpath(e)
    } catch {
        const r = Ia(e);
        return await Fi.promises.access(r, Fi.constants.R_OK), r
    }
}
        ...
        r.forEach((i, n) => {
            if (i === rt) {
                ...
                for (const u of i) {
                    ...
                    if (c && (u !== "]" || !l)) {
                        let f;
                        u === "-" ? f = u : (u === "^" || u === "!") && !l ? f = "^" : u === cr ? f = "" : f = qs(u), l += f;
                        continue
                    }
                    switch (u) {
                        case "{":
                ...
                n < r.length - 1 && (r[n + 1] !== rt || n + 2 < r.length) && (t += Ct)
            }
            s = i === rt
        })
    }
...
function ar(e, t) {
    ...
    const s = t.ignoreCase ?? !1,
        i = t.ignoreCase ?? !ye,
        n = {
            ...t,
            equals: s ? W1 : (l, u) => l === u,
            endsWith: s ? No : (l, u) => l.endsWith(u),
            isEqualOrParent: (l, u) => Se(l, u, i)
        },
        a = `${s?r.toLowerCase():r}_${!!t.trimForExclusions}_${s}`;
    let o = ur.get(a);
    if (o) return Wi(o, e, n);
    let c;
    return Vi.test(r) ? o = $a(r.substring(4), r, n) : (c = zi.exec(lr(r, n))) ? o = Ma(c[1], r, n) : (t.trimForExclusions ? Hi : Gi).test(r) ? o = ja(r, n) : (c = Ki.exec(lr(r, n))) ? o = qi(c[1].substring(1), r, !0, n) : (c = Ji.exec(lr(r, n))) ? o = qi(c[1], r, !1, n) : o = Wa(r, n), ur.set(a, o), Wi(o, e, n)
}
...
function Fa(e, t) {
    ...
    const s = ie.charCodeAt(0),
        i = t.charCodeAt(r - 1) === s;
    let n = !0;
    for (let a = 0; a < r; a++)
        if (t.charCodeAt(a) > 127) {
            n = !1;
            break
        } if (n) {
        const a = t.toLowerCase(),
            o = u => u >= 65 && u <= 90 ? u + 32 : u,
            c = o(a.charCodeAt(0)),
            l = r > 1 ? o(a.charCodeAt(r - 1)) : c;
        return {
            ...e,
            isEqualOrParent(u, f) {
                ...
                if (u.length > r) {
                    const h = i ? r - 1 : r;
                    if (u.charCodeAt(h) !== s) return !1
                }
                let d = u.charCodeAt(0);
                if (d !== c) {
                    if (d > 127) return Se(u, t, !0);
                    if (d = o(d), d !== c) return !1
                }
                if (r > 1) {
                    let h = u.charCodeAt(r - 1);
                    if (h !== l) {
                        if (h > 127) return Se(u, t, !0);
                        if (h = o(h), h !== l) return !1
                    }
                }
                for (let h = 0; h < r; h++) {
                    const m = u.charCodeAt(h),
                        E = a.charCodeAt(h);
                    if (m === E) continue;
                    if (m > 127) return Se(u, t, !0);
                    let C = m;
                    if (C >= 65 && C <= 90 && (C += 32), C !== E) return !1
                }
                return !0
            }
        }
...
function Wi(e, t, r) {
    ...
    const s = t.base,
        i = s.length,
        a = r.ignoreCase ?? !ye ? Fa(r, s) : r,
        o = ie.charCodeAt(0),
        c = function(l, u) {
            if (!a.isEqualOrParent(l, s)) return null;
            let f = i;
            for (; f < l.length && l.charCodeAt(f) === o;) f++;
            return e(l.substring(f), u)
        };
    return c.allBasenames = e.allBasenames, c.allPaths = e.allPaths, c.basenames = e.basenames, c.patterns = e.patterns, c
}
...
function $a(e, t, r) {
    return function(s, i) {
        return typeof s == "string" && r.endsWith(s, e) ? t : null
    }
}
...
function Ma(e, t, r) {
    const s = `/${e}`,
        i = `\\${e}`,
        n = function(o, c) {
            return typeof o != "string" ? null : c ? r.equals(c, e) ? t : null : r.equals(o, e) || r.endsWith(o, s) || r.endsWith(o, i) ? t : null
        },
        a = [e];
    return n.basenames = a, n.patterns = [t], n.allBasenames = a, n
}

function ja(e, t) {
    const r = Ui(e.slice(1, -1).split(",").map(o => ar(o, t)).filter(o => o !== de), e),
        s = r.length;
    if (!s) return de;
    if (s === 1) return r[0];
...
function qi(e, t, r, s) {
    const i = ie === N.sep,
        n = i ? e : e.replace(Bi, ie),
        a = ie + n,
        o = N.sep + e;
    let c;
    return r ? c = function(l, u) {
        return typeof l == "string" && (s.equals(l, n) || s.endsWith(l, a) || !i && (s.equals(l, e) || s.endsWith(l, o))) ? t : null
    } : c = function(l, u) {
        return typeof l == "string" && (s.equals(l, n) || !i && s.equals(l, e)) ? t : null
    }, c.allPaths = [(r ? "*/" : "./") + e], c
}

function Wa(e, t) {
    try {
        const r = new RegExp(`^${ji(e)}$`, t.ignoreCase ? "i" : void 0);
        return function(s) {
            return r.lastIndex = 0, typeof s == "string" && r.test(s) ? e : null
        }
    } catch {
        return de
    }
...
function Ba(e, t) {
    const r = Ui(Object.getOwnPropertyNames(e).map(o => Va(o, e[o], t)).filter(o => o !== de)),
        s = r.length;
    if (!s) return de;
    if (!r.some(o => !!o.requiresSiblings)) {
        ...
        const o = function(u, f) {
            ...
            c = r.find(u => !!u.allBasenames);
        c && (o.allBasenames = c.allBasenames);
        const l = r.reduce((u, f) => f.allPaths ? u.concat(f.allPaths) : u, []);
    ...
    const i = function(o, c, l) {
            ...
            for (let d = 0, h = r.length; d < h; d++) {
                const m = r[d];
                m.requiresSiblings && l && (c || (c = Xe(o)), u || (u = c.substr(0, c.length - js(o).length)));
                const E = m(o, c, u, l);
        ...
        if (typeof i == "string") {
            const n = (a, o, c, l) => {
                ...
                const u = i.replace("$(basename)", () => c),
                    f = l(u);
                return _i(f) ? f.then(d => d ? e : null) : f ? e : null
            };
...
var rt, cr, Ct, Et, Bi, Vi, zi, Gi, Hi, Ki, Ji, ur, fr, de, za = x({
        "out-build/vs/base/common/glob.js"() {
            "use strict";
            g1(), vt(), Ge(), v1(), ae(), X(), ze(), rt = "**", cr = "/", Ct = "[/\\\\]", Et = "[^/\\\\]", Bi = /\//g, Vi = /^\*\*\/\*\.[\w\.-]+$/, zi = /^\*\*\/([\w\.-]+)\/?$/, Gi = /^{\*\*\/\*?[\w\.-]+\/?(,\*\*\/\*?[\w\.-]+\/?)*}$/, Hi = /^{\*\*\/\*?[\w\.-]+(\/(\*\*)?)?(,\*\*\/\*?[\w\.-]+(\/(\*\*)?)?)*}$/, Ki = /^\*\*((\/[\w\.-]+)+)\/?$/, Ji = /^([\w\.-]+(\/[\w\.-]+)*)\/?$/, ur = new It(1e4), fr = function() {
                return !1
            }, de = function() {
                return null
            }
    ...
    Qi, Yi, hr, Zi, dr, Ie, At, Zt, Ga = x({
        "out-build/vs/base/common/ternarySearchTree.js"() {
            ...
            g1(), ze(), Qi = class {
                ...
                cmp(e) {
                    return this._caseSensitive ? j1(e, this._value, 0, e.length, this._from, this._to) : Be(e, this._value, 0, e.length, this._from, this._to)
                }
                value() {
                ...
                reset(e) {
                    return this._value = e, this._states = [], this._value.scheme && this._states.push(1), this._value.authority && this._states.push(2), this._value.path && (this._pathIterator = new hr(!1, !this._ignorePathCasing(e)), this._pathIterator.reset(e.path), this._pathIterator.value() && this._states.push(3)), this._ignoreQueryAndFragment(e) || (this._value.query && this._states.push(4), this._value.fragment && this._states.push(5)), this._stateIdx = 0, this
                }
                next() {
                ...
                cmp(e) {
                    if (this._states[this._stateIdx] === 1) return Us(e, this._value.scheme);
                    if (this._states[this._stateIdx] === 2) return Us(e, this._value.authority);
                    if (this._states[this._stateIdx] === 3) return this._pathIterator.cmp(e);
                    if (this._states[this._stateIdx] === 4) return M1(e, this._value.query);
                    if (this._states[this._stateIdx] === 5) return M1(e, this._value.fragment);
                    throw new Error
                }
                value() {
                ...
                static wrap(t) {
                    return t === void 0 ? Lr.Val : t
                }
                static unwrap(t) {
                    return t === Lr.Val ? void 0 : t
                }
            }, dr.Val = Symbol("undefined_placeholder"), Ie = dr, At = class {
                constructor() {
                    this.height = 1
                }
                isEmpty() {
                ...
                static forUris(t = () => !1, r = () => !1) {
                    return new Ot(new Zi(t, r))
                }
                static forPaths(t = !1) {
                    return new Ot(new hr(void 0, !t))
                }
                static forStrings() {
                    return new Ot(new Qi)
                }
                static forConfigKeys() {
                    return new Ot(new Yi)
                }
                constructor(t) {
                    this._iter = t
                }
                ...
                set(t, r) {
                    ...
                    let i;
                    this._root || (this._root = new At, this._root.segment = s.value());
                    const n = [];
                    for (i = this._root;;) {
                        const o = s.cmp(i.segment);
                        if (o > 0) i.left || (i.left = new At, i.left.segment = s.value()), n.push([-1, i]), i = i.left;
                        else if (o < 0) i.right || (i.right = new At, i.right.segment = s.value()), n.push([1, i]), i = i.right;
                        else if (s.hasNext()) s.next(), i.mid || (i.mid = new At, i.mid.segment = s.value()), n.push([0, i]), i = i.mid;
                        else break
                    }
                    ...
                    for (let o = n.length - 1; o >= 0; o--) {
                        ...
                        if (l < -1 || l > 1) {
                            const u = n[o][0],
                                f = n[o + 1][0];
                            if (u === 1 && f === 1) n[o][1] = c.rotateLeft();
                            else if (u === -1 && f === -1) n[o][1] = c.rotateRight();
                            else if (u === 1 && f === -1) c.right = n[o + 1][1] = n[o + 1][1].rotateRight(), n[o][1] = c.rotateLeft();
                            else if (u === -1 && f === 1) c.left = n[o + 1][1] = n[o + 1][1].rotateLeft(), n[o][1] = c.rotateRight();
...
function Ha(e, t, r) {
    t[ke.DI_TARGET] === t ? t[ke.DI_DEPENDENCIES].push({
        id: e,
        index: r
    }) : (t[ke.DI_DEPENDENCIES] = [{
        id: e,
        index: r
    }], t[ke.DI_TARGET] = t)
}
...
function pr(e) {
    if (ke.serviceIds.has(e)) return ke.serviceIds.get(e);
    const t = function(r, s, i) {
        if (arguments.length !== 3) throw new Error("@IServiceName-decorator can only be used to decorate a parameter");
        Ha(t, r, i)
    };
    return t.toString = () => e, ke.serviceIds.set(e, t), t
}
var ke, Ka, Xi = x({
    "out-build/vs/platform/instantiation/common/instantiation.js"() {
        ...
        })(ke || (ke = {})), Ka = pr("instantiationService")
    }
});

function Ja(e, t, r) {
    return !e || !t || e === t || t.length > e.length ? !1 : (t.charAt(t.length - 1) !== ie && (t += ie), r ? Io(e, t) : e.indexOf(t) === 0)
}
var Qa, en, pe, Ya = x({
    "out-build/vs/platform/files/common/files.js"() {
        "use strict";
        Ga(), ae(), ze(), w1(), Ke(), $t(), Xi(), X(), Kt(), _t(), Qa = pr("fileService"), en = class l1 {
            constructor(t, r) {
                this.ignorePathCasing = r, this.correlationId = void 0, this.added = new Te(() => {
                    const s = Zt.forUris(() => this.ignorePathCasing);
            ...
            static formatSize(t) {
                return ro(t) || (t = 0), t < xe.KB ? w(2033, null, t.toFixed(0)) : t < xe.MB ? w(2034, null, (t / xe.KB).toFixed(2)) : t < xe.GB ? w(2035, null, (t / xe.MB).toFixed(2)) : t < xe.TB ? w(2036, null, (t / xe.GB).toFixed(2)) : w(2037, null, (t / xe.TB).toFixed(2))
            }
...
function e2(e, t) {
    return typeof t == "string" && !t.startsWith(rt) && !Ue(t) ? {
        base: e,
        pattern: t
    } : t
}
...
function tn(e, t) {
    const r = [];
    for (const s of t) r.push(qa(e2(e, s)));
    return r
}
...
var rn, sn, r2 = x({
    "out-build/vs/platform/files/common/watcher.js"() {
        "use strict";
        za(), ut(), ae(), X(), Ke(), Ya(), rn = class Rn extends me {
            constructor(t, r, s, i) {
                super(), this.onFileChanges = t, this.onLogMessage = r, this.verboseLogging = s, this.options = i, this.watcherDisposables = this._register(new A1), this.requests = void 0, this.restartCounter = 0
            }
            init() {
                const t = new je;
        ...
        }, rn.MAX_RESTARTS = 5, sn = class {
            constructor() {
                this.coalesced = new Set, this.mapPathToChange = new Map
            }
            toKey(e) {
                return ye ? e.resource.fsPath : e.resource.fsPath.toLowerCase()
            }
            processEvent(e) {
            ...
            coalesce() {
                const e = [],
                    t = [];
                return Array.from(this.coalesced).filter(r => r.type !== 2 ? (e.push(r), !1) : !0).sort((r, s) => r.resource.fsPath.length - s.resource.fsPath.length).filter(r => t.some(s => Ja(r.resource.fsPath, s, !ye)) ? !1 : (t.push(r.resource.fsPath), !0)).concat(e)
            }
        }
    }
});
...
async function n2(e, t, r, s, i = 512) {
    const n = await we.open(e, "r"),
                    ...
                    if (h === 0) {
                        ...
                        try {
                            for (; !o.token.isCancellationRequested;) {
                                const {
                                    bytesRead: m
                                } = await we.read(n, a, 0, i, null);
                                if (!m || o.token.isCancellationRequested) break;
                                t(a.slice(0, m))
                            }
                        } catch (m) {
                            c = new Error(m), o.dispose(!0)
                        } finally {
                            l = !1
                        }
                    }
    ...
    return await f.ready, r(), new Promise((d, h) => {
...
var Xt, nn, o2 = x({
        "out-build/vs/platform/files/node/watcher/nodejs/nodejsWatcherLib.js"() {
            "use strict";
            vt(), zt(), Ge(), ut(), Pi(), ae(), X(), J1(), Ke(), Na(), ir(), r2(), _t(), Xt = class c1 extends me {
                constructor(t, r, s, i, n, a) {
                    super(), this.request = t, this.recursiveWatcher = r, this.onDidFilesChange = s, this.onDidWatchFail = i, this.onLogMessage = n, this.verboseLogging = a, this.throttledFileChangesEmitter = this._register(new Ci({
                        maxWorkChunkSize: 100,
                        throttleDelay: 200,
                        maxBufferedWork: 1e4
                    }, o => this.onDidFilesChange(o))), this.fileChangesAggregator = this._register(new bi(o => this.handleFileChanges(o), c1.FILE_CHANGES_HANDLER_DELAY)), this.cts = new et, this.realPath = new Te(async () => {
                        let o = this.request.path;
                        try {
                            o = await Ra(this.request.path), this.request.path !== o && this.trace(`correcting a path to watch that seems to be a symbolic link (original: ${this.request.path}, real: ${o})`)
                        } catch {}
                        return o
                    }), this._isReusingRecursiveWatcher = !1, this.didFail = !1, this.excludes = tn(this.request.path, this.request.excludes), this.includes = this.request.includes ? tn(this.request.path, this.request.includes) : void 0, this.filter = Za(this.request) ? this.request.filter : void 0, this.ready = this.watch()
                }
                ...
                async watch() {
                    try {
                        const t = await i2.stat(this.request.path);
                ...
                doWatchWithExistingWatcher(t, r) {
                    if (t) return !1;
                    const s = Z.file(this.request.path),
                ...
                async doWatchWithNodeJS(t, r) {
                    ...
                    const i = new et(this.cts.token);
                    r.add($e(() => i.dispose(!0)));
                    const n = new je;
                    r.add(n);
                    try {
                        const a = Z.file(this.request.path),
                            o = Xe(s),
                            c = s2(s);
                        n.add($e(() => {
                        ...
                        const l = new Set;
                        if (t) try {
                            for (const f of await we.readdir(s)) l.add(f)
                        } catch (f) {
                            this.error(f)
                        }
                        ...
                        n.add($e(() => {
                            ...
                            i.token.isCancellationRequested || (this.error(`Failed to watch ${s} for changes using fs.watch() (${f}, ${d})`), this.notifyWatchFailed())
                        }), c.on("change", (f, d) => {
                            if (i.token.isCancellationRequested) return;
                            this.verboseLogging && this.traceWithCorrelation(`[raw] ["${f}"] ${d}`);
                            let h = "";
                            if (d && (h = d.toString(), Oe && (h = tr(h))), !(!h || f !== "change" && f !== "rename"))
                                if (t)
                                    if (f === "rename") {
                                        u.get(h)?.dispose();
                                        const m = setTimeout(async () => {
                                            if (u.delete(h), Ys(h, o, !ye) && !await we.exists(s)) {
                                                this.onWatchedPathDeleted(a);
                                                return
                                            }
                                            if (i.token.isCancellationRequested) return;
                                            const E = await this.existsChildStrictCase(Y(s, h));
                                            if (i.token.isCancellationRequested) return;
                                            let C;
                                            E ? l.has(h) ? C = 0 : (C = 1, l.add(h)) : (l.delete(h), C = 2), this.onFileChange({
                                                resource: G1(a, h),
                                                type: C,
                                                cId: this.request.correlationId
                                            })
                                        }, c1.FILE_DELETE_HANDLER_DELAY);
                                        u.set(h, $e(() => clearTimeout(m)))
                                    } else {
                                        let m;
                                        l.has(h) ? m = 0 : (m = 1, l.add(h)), this.onFileChange({
                                            resource: G1(a, h),
                                            type: m,
                                            cId: this.request.correlationId
                                        })
                                    }
                            else if (f === "rename" || !Ys(h, o, !ye)) {
                                const m = setTimeout(async () => {
                                    const E = await we.exists(s);
                                    i.token.isCancellationRequested || (E ? (this.onFileChange({
                                        resource: a,
                                        type: 0,
                                        cId: this.request.correlationId
                                    }, !0), n.add(await this.doWatch(!1))) : this.onWatchedPathDeleted(a))
                                }, c1.FILE_DELETE_HANDLER_DELAY);
                                n.clear(), n.add($e(() => clearTimeout(m)))
                ...
                async existsChildStrictCase(t) {
                    if (ye) return we.exists(t);
                    try {
                        const r = Xe(t);
                        return (await we.readdir(Le(t))).some(i => i === r)
                    } catch (r) {
            ...
            }, Xt.FILE_DELETE_HANDLER_DELAY = 100, Xt.FILE_CHANGES_HANDLER_DELAY = 75, nn = Xt
        }
    }),
    a2 = Un({
        "node_modules/minimist/index.js"(e, t) {
            t.exports = function(n, a) {
                ...
                typeof a.unknown == "function" && (o.unknownFn = a.unknown), typeof a.boolean == "boolean" && a.boolean ? o.allBools = !0 : [].concat(a.boolean).filter(Boolean).forEach(function(A) {
                    o.bools[A] = !0
                });
                var c = {};
                Object.keys(a.alias || {}).forEach(function(A) {
                    c[A] = [].concat(a.alias[A]), c[A].forEach(function(j) {
                        c[j] = [A].concat(c[A].filter(function(fe) {
                            return j !== fe
                        }))
                    })
                }), [].concat(a.string).filter(Boolean).forEach(function(A) {
                    o.strings[A] = !0, c[A] && (o.strings[c[A]] = !0)
                });
                var l = a.default || {},
                    u = {
                        _: []
                ...
                Object.keys(o.bools).forEach(function(A) {
                    h(A, l[A] === void 0 ? !1 : l[A])
                });
                var f = [];
                n.indexOf("--") !== -1 && (f = n.slice(n.indexOf("--") + 1), n = n.slice(0, n.indexOf("--")));

                function d(A, j) {
                    return o.allBools && /^--[^=]+$/.test(j) || o.strings[A] || o.bools[A] || c[A]
                }

                function h(A, j, fe) {
                    if (!(fe && o.unknownFn && !d(A, fe) && o.unknownFn(fe) === !1)) {
                        var F = !o.strings[A] && s(j) ? Number(j) : j;
                        m(u, A.split("."), F), (c[A] || []).forEach(function(Fe) {
                            m(u, Fe.split("."), F)
                        })
                    }
                }
                ...
                function m(A, j, fe) {
                    for (var F = A, Fe = 0; Fe < j.length - 1; Fe++) {
                        var W = j[Fe];
                        if (i(F, W)) return;
                        F[W] === void 0 && (F[W] = {}), (F[W] === Object.prototype || F[W] === Number.prototype || F[W] === String.prototype) && (F[W] = {}), F[W] === Array.prototype && (F[W] = []), F = F[W]
                    }
                    var W = j[j.length - 1];
                    i(F, W) || ((F === Object.prototype || F === Number.prototype || F === String.prototype) && (F = {}), F === Array.prototype && (F = []), F[W] === void 0 || o.bools[W] || typeof F[W] == "boolean" ? F[W] = fe : Array.isArray(F[W]) ? F[W].push(fe) : F[W] = [F[W], fe])
                }

                function E(A) {
                    return c[A].some(function(j) {
                        return o.bools[j]
                    })
                }
                for (var C = 0; C < n.length; C++) {
                    ...
                    if (/^--.+=/.test(k)) {
                        ...
                        var P = k.match(/^--(.+)/)[1],
                            g = n[C + 1];
                        g !== void 0 && !/^-/.test(g) && !o.bools[P] && !o.allBools && (!c[P] || !E(P)) ? (h(P, g, k), C++) : /^(true|false)$/.test(g) ? (h(P, g === "true", k), C++) : h(P, o.strings[P] ? "" : !0, k)
                    } else if (/^-[^-]+/.test(k)) {
                        for (var _ = k.slice(1, -1).split(""), O = !1, T = 0; T < _.length; T++) {
                            var g = k.slice(T + 2);
                            if (g === "-") {
                                h(_[T], g, k);
                                continue
                            }
                            if (/[A-Za-z]/.test(_[T]) && /=/.test(g)) {
                                h(_[T], g.split("=")[1], k), O = !0;
                                break
                            }
                            if (/[A-Za-z]/.test(_[T]) && /-?\d+(\.\d*)?(e-?\d+)?$/.test(g)) {
                                h(_[T], g, k), O = !0;
                                break
                            }
                            if (_[T + 1] && _[T + 1].match(/\W/)) {
                                h(_[T], k.slice(T + 2), k), O = !0;
                                break
                            } else h(_[T], o.strings[_[T]] ? "" : !0, k)
                        }
                        var P = k.slice(-1)[0];
                        !O && P !== "-" && (n[C + 1] && !/^(-|--)[^-]/.test(n[C + 1]) && !o.bools[P] && (!c[P] || !E(P)) ? (h(P, n[C + 1], k), C++) : n[C + 1] && /^(true|false)$/.test(n[C + 1]) ? (h(P, n[C + 1] === "true", k), C++) : h(P, o.strings[P] ? "" : !0, k))
                    } else if ((!o.unknownFn || o.unknownFn(k) !== !1) && u._.push(o.strings._ || !s(k) ? k : Number(k)), a.stopEarly) {
                        u._.push.apply(u._, n.slice(C + 1));
                        break
                    }
                }
                return Object.keys(l).forEach(function(A) {
                    r(u, A.split(".")) || (m(u, A.split("."), l[A]), (c[A] || []).forEach(function(j) {
                        m(u, j.split("."), l[A])
                    }))
                }), a["--"] ? (u["--"] = new Array, f.forEach(function(A) {
                    u["--"].push(A)
...
function on(e, t, r = dn) {
    ...
    if (c && s) {
        const d = o;
        for (const C in c.options) d[C] = c.options[C];
        const h = e.filter(C => C !== s),
            m = r.getSubcommandReporter ? r.getSubcommandReporter(s) : void 0,
            E = on(h, d, m);
        return {
            [s]: E,
            _: []
    ...
    const l = (0, cn.default)(e, {
        ...
        u = {},
        f = l;
    u._ = l._.map(d => String(d)).filter(d => d.length > 0), delete f._;
    for (const d in t) {
        const h = t[d];
        ...
        let m = f[d];
        if (h.deprecates)
            for (const E of h.deprecates) f.hasOwnProperty(E) && (m || (m = f[E], m && r.onDeprecatedOption(E, h.deprecationMessage || w(1907, null, d))), delete f[E]);
        if (typeof m < "u") {
            if (h.type === "string[]") {
                if (Array.isArray(m) || (m = [m]), !h.allowEmptyValue) {
                    const E = m.filter(C => C.length > 0);
                    E.length !== m.length && (r.onEmptyValue(d), m = E.length > 0 ? E : void 0)
                }
            } else h.type === "string" && (Array.isArray(m) ? (m = m.pop(), r.onMultipleValues(d, m)) : !m && !h.allowEmptyValue && (r.onEmptyValue(d), m = void 0));
            u[d] = m, h.deprecationMessage && r.onDeprecatedOption(d, h.deprecationMessage)
        }
        delete f[d]
    }
    for (const d in f) r.onUnknownOption(d);
    return u
}
...
function an(e, t) {
    ...
    for (const a of e) {
        const o = a[0],
            ...
            l = ln(s - o.length - 2);
        n.push("  " + o + l + c[0]);
        for (let u = 1; u < c.length; u++) n.push(ln(s) + c[u])
    }
    return n
}
...
function f2(e, t, r, s, i) {
    const n = process.stdout.isTTY && process.stdout.columns || 80,
        a = i?.noInputFiles !== !0 ? `[${w(1908,null)}...]` : "",
        o = [`${e} ${r}`];
    o.push(""), o.push(`${w(1909,null)}: ${t} [${w(1910,null)}]${a}`), o.push(""), i?.noPipe !== !0 && (V ? o.push(w(1911, null, t)) : o.push(w(1912, null, t)), o.push(""));
    const c = {},
        l = [];
    for (const u in s) {
        const f = s[u];
        if (f.type === "subcommand") f.description && l.push({
            command: u,
            description: f.description
        });
        else if (f.description && f.cat) {
            let d = c[f.cat];
            d || (c[f.cat] = d = {}), d[u] = f
        }
    }
    ...
    return l.length && (o.push(w(1913, null)), o.push(...an(l.map(u => [u.command, u.description]), n)), o.push("")), o.join(`
`)
}

function h2(e, t) {
    return `${e||w(1914,null)}
${t||w(1915,null)}
${process.arch}`
}
...
import d2 from "assert";

function p2(e, t) {
    const r = (c, l) => {
            console.warn(w(1916, null, c, l))
        },
        s = c => {
            console.warn(w(1917, null, c))
        },
        i = (c, l) => {
        ...
        n = c => ({
            onUnknownOption: l => {
                e1.includes(c) || console.warn(w(1919, null, l, c))
            },
            onMultipleValues: r,
            onEmptyValue: s,
            onDeprecatedOption: i,
            getSubcommandReporter: e1.includes(c) ? n : void 0
        }),
        o = on(e, t1, t ? {
            onUnknownOption: c => {
                console.warn(w(1920, null, c))
            },
            onMultipleValues: r,
            onEmptyValue: s,
            onDeprecatedOption: i,
    ...
    return o.goto && o._.forEach(c => d2(/^(\w:)?[^:]+(:\d*){0,2}:?$/.test(c), w(1921, null))), o
}
...
function g2(e) {
    let [, , ...t] = e;
    return process.env.VSCODE_DEV && (t = m2(t) || []), p2(t, !0)
}
...
async function v2(e) {
    ...
    r ? (e && console.log(`Found VSCODE_CLI_ENCODING variable: ${r}`), t = Promise.resolve(r)) : V ? t = new Promise(i => {
        e && console.log('Running "chcp" to detect terminal encoding...'), mn("chcp", (n, a, o) => {
            if (a) {
                ...
                const c = Object.keys(mr);
                for (const l of c)
                    if (a.indexOf(l) >= 0) return i(mr[l])
            }
            return i(void 0)
        })
    }) : t = new Promise(i => {
    ...
    const s = await t;
    return e && console.log(`Detected raw terminal encoding: ${s}`), !s || s.toLowerCase() === "utf-8" || s.toLowerCase() === gr ? gr : y2(s)
}
var mr, gn, gr, w2 = x({
...
function A2() {
    return yt(b2(), "code-stdin", 3)
}
async function S2(e) {
    await r1.promises.appendFile(e, ""), await r1.promises.chmod(e, 384)
}
async function P2(e, t, r) {
    let [s, i] = await Promise.all([v2(t), import("@vscode/iconv-lite-umd"), S2(e)]);
    ...
    process.stdin.on("data", o => {
        const c = a.write(o);
        n.queue(() => r1.promises.appendFile(e, c))
    }), process.stdin.on("end", () => {
        const o = a.end();
        n.queue(async () => {
            try {
                typeof o == "string" && await r1.promises.appendFile(e, o)
            } finally {
                r?.()
            }
        })
...
function D2(e) {
    const t = yt(O2());
    try {
        return x2(t, ""), e && console.log(`Marker file for --wait created: ${t}`), t
    } catch (r) {
...
var L2 = x({
    ...
    re, s1, se, T2 = x({
        "out-build/vs/platform/product/common/product.js"() {
            "use strict";
            if (R1(), s1 = globalThis.vscode, typeof s1 < "u" && typeof s1.context < "u") {
                const e = s1.context.configuration();
                if (e) re = e.product;
                else throw new Error("Sandbox: unable to resolve product configuration from preload script.")
            } else if (globalThis._VSCODE_PRODUCT_JSON && globalThis._VSCODE_PACKAGE_JSON) {
                if (re = globalThis._VSCODE_PRODUCT_JSON, qt.VSCODE_DEV, qt.VSCODE_DEV_ONBOARDING && Object.assign(re, {
                        nameShort: `${re.nameShort} Onboarding`,
                        nameLong: `${re.nameLong} Onboarding`,
                        dataFolderName: `${re.dataFolderName}-onboarding`,
                        serverDataFolderName: re.serverDataFolderName ? `${re.serverDataFolderName}-onboarding` : void 0
                    }), !re.version) {
            ...
            } else re = {}, Object.keys(re).length === 0 && Object.assign(re, {
                version: "1.94.0-dev",
    ...
    R2, _r, I2 = x({
        "out-build/vs/platform/profiling/common/profiling.js"() {
            "use strict";
            ae(), Xi(), R2 = pr("IV8InspectProfilingService"), (e => {
                function t(i) {
                    return !!(i.samples && i.timeDeltas)
                }
                e.isValidProfile = t;

                function r(i, n = "noAbsolutePaths") {
                    for (const a of i.nodes) a.callFrame && a.callFrame.url && (Ue(a.callFrame.url) || /^\w[\w\d+.-]*:\/\/\/?/.test(a.callFrame.url)) && (a.callFrame.url = Y(n, Xe(a.callFrame.url)));
                    return i
                }
                ...
                function s(i, n = "noAbsolutePaths") {
                    const a = o => {
                        o.callFrame.url && (Ue(o.callFrame.url) || /^\w[\w\d+.-]*:\/\/\/?/.test(o.callFrame.url)) && (o.callFrame.url = Y(n, Xe(o.callFrame.url)));
                        for (const c of o.children) a(c)
                    };
                    return a(i.head), i
                }
                e.rewriteAbsolutePathsInHeapProfile = s
            })(_r || (_r = {}))
        }
    });
...
async function Cn(e) {
    ...
    for (const r of e1)
        if (t[r]) {
            if (!se.tunnelApplicationName) {
                console.error(`'${r}' command not supported in ${se.applicationName}`);
                return
            }
            const s = {
                ...process.env
            ...
            return new Promise((n, a) => {
                ...
                if (process.env.VSCODE_DEV) o = i1("cargo", ["run", "--", r, ...i], {
                    cwd: Y(En(), "cli"),
                    stdio: c,
                    env: s
                });
                else {
                    const l = process.platform === "darwin" ? Y(Le(Le(process.execPath)), "Resources", "app") : V ? Y(Le(process.execPath), "resources", "app") : Le(process.execPath),
                        u = Y(l, "bin", `${se.tunnelApplicationName}${V?".exe":""}`);
                    o = i1(u, [r, ...i], {
                        cwd: Ze(),
                        stdio: c,
                        env: s
        ...
        const r = `${se.applicationName}${V?".exe":""}`,
            s = se.nameLong.startsWith("Cursor") ? hn : t1;
        console.log(f2(se.nameLong, r, se.version, s))
    } else if (t.version) console.log(h2(se.version, se.commit));
        ...
        console.log(Y(En(), "out", "vs", "workbench", "contrib", "terminal", "common", "scripts", r))
    } else if (q2(t)) {
        let r;
        ...
        const r = t._[0];
        if (!r || !Ue(r) || !yr(r) || !n1(r).isFile()) throw new Error("Using --file-write with invalid arguments.");
        let s, i;
        try {
            const n = JSON.parse(wn(r, "utf8"));
            s = n.source, i = n.target
        } catch {
            throw new Error("Using --file-write with invalid arguments.")
        }
        if (V)
            for (const n of [s, i]) typeof n == "string" && Wo(n) && _n(Z.file(n).authority);
        if (!s || !i || s === i || !Ue(s) || !Ue(i) || !yr(s) || !n1(s).isFile() || !yr(i) || !n1(i).isFile()) throw new Error("Using --file-write with invalid arguments.");
        try {
            let n = 0,
                a = !1;
            t["file-chmod"] && (n = n1(i).mode, n & 128 || (vn(i, n | 128), a = !0));
            const o = wn(s);
            V ? (M2(i, 0), tt(i, o, {
                flag: "r+"
            })) : tt(i, o), a && vn(i, n)
        ...
        t.verbose && (r.ELECTRON_ENABLE_LOGGING = "1"), (t.verbose || t.status) && s.push(async l => {
            l.stdout?.on("data", u => console.log(u.toString("utf8").trim())), l.stderr?.on("data", u => console.log(u.toString("utf8").trim())), await ne.toPromise(ne.fromNodeEventEmitter(l, "exit"))
        });
        ...
        if (C2())
            if (i) {
                ...
                try {
                    const l = new X1;
                    await P2(n, !!t.verbose, () => l.complete()), t.wait || s.push(() => l.p), Ne(e, n), Ne(e, "--skip-add-to-recently-opened"), console.log(`Reading from stdin via: ${n}`)
                } catch (l) {
                    console.log(`Failed to create file to read via stdin: ${l.toString()}`), n = void 0
                }
            } else s.push(l => E2(1e3).then(u => {
                u && console.log(V ? `Run with '${se.applicationName} -' to read output from another program (e.g. 'echo Hello World | ${se.applicationName} -').` : `Run with '${se.applicationName} -' to read from stdin (e.g. 'ps aux | grep code | ${se.applicationName} -').`)
            }));
        let a;
        if (t.wait && (a = D2(t.verbose), a && Ne(e, "--waitMarkerFilePath", a), s.push(async l => {
                let u;
                Oe ? u = new Promise(f => {
                    l.on("exit", (d, h) => {
                        (d !== 0 || h) && f()
                    })
                }) : u = ne.toPromise(ne.fromNodeEventEmitter(l, "exit"));
                try {
                    await Promise.race([xi(a), ne.toPromise(ne.fromNodeEventEmitter(l, "error")), u])
                } finally {
                    n && bn(n)
                }
            })), t["prof-startup"]) {
            const l = "127.0.0.1",
                u = await nr(xo(), 10, 3e3),
                f = await nr(u + 1, 10, 3e3),
                d = await nr(f + 1, 10, 3e3);
            if (u * f * d === 0) throw new Error("Failed to find free ports for profiler. Make sure to shutdown all instances of the editor first.");
            const h = yt(j2(), "prof");
            Ne(e, `--inspect-brk=${l}:${u}`), Ne(e, `--remote-debugging-port=${l}:${f}`), Ne(e, `--inspect-brk-extensions=${l}:${d}`), Ne(e, "--prof-startup-prefix", h), Ne(e, "--no-cached-data"), tt(h, e.slice(-6).join("|")), s.push(async m => {
                const E = B => B.find(P => P.webSocketDebuggerUrl ? P.type === "page" ? P.url.indexOf("bootstrap/index.html") > 0 : !0 : !1),
                    C = async (B, P, J) => {
                        const g = (await import("chrome-remote-interface")).default;
                        let _;
                        for (let O = 0; O < P; O++) try {
                            return await g({
                                ...
                                target: T => {
                                    const A = J(T);
                                    if (!A) throw Object.assign(new Error("no target"), {
                                        code: "ECONNREFUSED"
                                    });
                                    return A
                                }
                            ...
                            _ = T, await new Promise(A => setTimeout(A, 50))
                        }
                        throw _ instanceof Error ? _ : new Error("failed to connect")
                    };
                class k {
                    static async start(P, J, g) {
                        let _;
                        try {
                            _ = await C(g.port, g.tries ?? 10, g.target ?? E), await _.Runtime.runIfWaitingForDebugger(), await _.Profiler.enable(), await _.Profiler.setSamplingInterval({
                                interval: 100
                            }), await _.Profiler.start()
                        } catch {
                            console.error(`FAILED to start profiling for '${P}' on port '${g.port}'`), _ && (await _.close().catch(() => {}), _ = void 0)
                        }
                        return {
                            async stop() {
                                if (!_) return;
                                let O;
                                try {
                                    O = (await _.Profiler.stop()).profile
                                } finally {
                                    await _.close().catch(() => {})
                                }
                                let T = "";
                                process.env.VSCODE_DEV || (O = _r.rewriteAbsolutePaths(O, "piiRemoved"), T = ".txt"), tt(`${J}.${P}.cpuprofile${T}`, JSON.stringify(O, void 0, 4))
                            }
                        }
                    }
                }
                try {
                    const B = k.start("main", h, {
                            port: u
                        }),
                        P = k.start("extHost", h, {
                            port: d,
                        ...
                        J = k.start("renderer", h, {
                            port: f,
                            tries: 200,
                            target: function(T) {
                                return T.filter(A => A.webSocketDebuggerUrl ? A.type === "page" ? A.url.indexOf("workbench/workbench.html") > 0 || A.url.indexOf("workbench/workbench-dev.html") > 0 : !0 : !1)[0]
                            }
                        }),
                        g = await B,
                        _ = await P,
                        O = await J;
                    await xi(h), await g.stop(), await O.stop(), await _.stop(), tt(h, "")
                } catch {
        ...
        let c;
        if (!Oe) !t.verbose && t.status && (o.stdio = ["ignore", "pipe", "ignore"]), c = i1(process.execPath, e.slice(2), o);
        else {
            const l = ["-n", "-g"];
            if (l.push("-a", process.execPath), t.verbose || t.status) {
                l.push("--wait-apps");
                for (const u of t.verbose ? ["stdout", "stderr"] : ["stdout"]) {
                    const f = yt(W2(), `code-${u}`);
                    tt(f, ""), l.push(`--${u}`, f), s.push(async d => {
                        try {
                            const h = u === "stdout" ? process.stdout : process.stderr,
                                m = new et;
                            d.on("close", () => {
                                setTimeout(() => m.dispose(!0), 200)
                            }), await n2(f, E => h.write(E), () => {}, m.token)
                        } finally {
                            bn(f)
                        }
                    })
            ...
            for (const u in r) u !== "_" && (l.push("--env"), l.push(`${u}=${r[u]}`));
...
var U2 = x({
    "out-build/vs/code/node/cli.js"() {
        "use strict";
        O1(), ae(), X(), Oo(), ir(), Ta(), o2(), pn(), _2(), k2(), L2(), T2(), zt(), Ge(), I2(), Kt(), R1(), $2(), Ke(), vt(), Cn(process.argv).then(() => An(0)).then(null, e => {
            console.error(e.message || e.stack || e), An(1)
        })
    }
});
...
var Ll = G2(import.meta.url),
    H2 = ce.dirname(z2(import.meta.url)),
    Tl = process.platform === "win32";
...
function K2() {
    try {
        typeof process.env.VSCODE_CWD != "string" && (process.env.VSCODE_CWD = process.cwd()), process.platform === "win32" && process.chdir(ce.dirname(process.execPath))
    } catch (e) {
        console.error(e)
    }
}
...
function J2(e) {
    const t = ce.dirname(H2);

    function r() {
        return process.env.VSCODE_DEV ? t : process.platform === "darwin" ? ce.dirname(ce.dirname(ce.dirname(t))) : ce.dirname(ce.dirname(t))
    }

    function s() {
        if (process.env.VSCODE_PORTABLE) return process.env.VSCODE_PORTABLE;
        if (process.platform === "win32" || process.platform === "linux") return ce.join(r(), "data");
        const c = e.portable || `${e.applicationName}-portable-data`;
        return ce.join(ce.dirname(r()), c)
    }
    const i = s(),
...
br.BUILD_INSERT_PACKAGE_CONFIGURATION && (br = wr("../package.json"));
var Cr = st,
    tl = br;
if (!("commit" in st) || st.commit === void 0) try {
    const {
        execSync: e
    } = wr("child_process"), t = process.cwd(), r = e("git rev-parse HEAD", {
        cwd: t,
        encoding: "utf8",
...
function rl() {
    if (typeof performance == "object" && typeof performance.mark == "function" && !performance.nodeTiming) return typeof performance.timeOrigin != "number" && !performance.timing ? Er() : {
        mark(e, t) {
    ...
    if (typeof process == "object") {
        ...
        return Er(e)
    } else return console.trace("perf-util loaded in UNKNOWN environment"), Er()
}

function sl(e) {
    return e.MonacoPerformanceMarks || (e.MonacoPerformanceMarks = rl()), e.MonacoPerformanceMarks
}
var Pn = sl(globalThis),
    it = Pn.mark,
    Fl = Pn.getMarks,
    il = Z2(import.meta.url),
    nl = Q2.dirname(Y2(import.meta.url));
if ((process.env.ELECTRON_RUN_AS_NODE || process.versions.electron) && X2(`data:text/javascript;base64,${Buffer.from(`
...
async function al() {
    ...
    if (!(process.env.VSCODE_DEV || !t)) {
        try {
            globalThis._VSCODE_NLS_MESSAGES = JSON.parse((await vr.promises.readFile(t)).toString())
        } catch (r) {
            if (console.error(`Error reading NLS messages file ${t}: ${r}`), e?.languagePack?.corruptMarkerFile) try {
                await vr.promises.writeFile(e.languagePack.corruptMarkerFile, "corrupted")
            } catch (s) {
                console.error(`Error writing corrupted NLS marker file: ${s}`)
            }
            if (e?.defaultMessagesFile && e.defaultMessagesFile !== t) try {
                globalThis._VSCODE_NLS_MESSAGES = JSON.parse((await vr.promises.readFile(e.defaultMessagesFile)).toString())
            } catch (s) {
                console.error(`Error reading default NLS messages file ${e.defaultMessagesFile}: ${s}`)
            }
        }
        return it("code/didLoadNls"), e
    }
}
async function ll() {
    await ol()
...
async function cl({
    ...
    if (it("code/willGenerateNls"), process.env.VSCODE_DEV || e === "pseudo" || e.startsWith("en") || !s || !r) return St(e, t, i);
    try {
        const n = await ul(r);
        if (!n) return St(e, t, i);
        const a = fl(n, e);
        if (!a) return St(e, t, i);
        const o = n[a],
            c = o?.translations?.vscode;
        if (!o || typeof o.hash != "string" || !o.translations || typeof c != "string" || !await Sr(c)) return St(e, t, i);
        const l = `${o.hash}.${a}`,
            u = be.join(r, "clp", l),
            f = be.join(u, s),
            d = be.join(f, "nls.messages.json"),
            h = be.join(u, "tcf.json"),
            m = be.join(u, "corrupted.info");
        await Sr(m) && await Ce.promises.rm(u, {
            recursive: !0,
            force: !0,
            maxRetries: 3
        });
        const E = {
            ...
            osLocale: t,
            resolvedLanguage: a,
            defaultMessagesFile: be.join(i, "nls.messages.json"),
            languagePack: {
            ...
            _cacheRoot: u,
            _resolvedLanguagePackCoreLocation: f,
            _corruptedFile: m
        };
        if (await Sr(f)) return hl(f).catch(() => {}), it("code/didGenerateNls"), E;
        const [, C, k, B] = await Promise.all([Ce.promises.mkdir(f, {
            recursive: !0
        }), JSON.parse(await Ce.promises.readFile(be.join(i, "nls.keys.json"), "utf-8")), JSON.parse(await Ce.promises.readFile(be.join(i, "nls.messages.json"), "utf-8")), JSON.parse(await Ce.promises.readFile(c, "utf-8"))]), P = [];
        let J = 0;
        for (const [g, _] of C) {
            const O = B.contents[g];
            for (const T of _) P.push(O?.[T] || k[J]), J++
        }
        return await Promise.all([Ce.promises.writeFile(d, JSON.stringify(P), "utf-8"), Ce.promises.writeFile(h, JSON.stringify(o.translations), "utf-8")]), it("code/didGenerateNls"), E
    } catch (n) {
...
async function ul(e) {
    const t = be.join(e, "languagepacks.json");
    try {
        return JSON.parse(await Ce.promises.readFile(t, "utf-8"))
    } catch {
        return
    }
}
...
function St(e, t, r) {
    return it("code/didGenerateNls"), {
        userLocale: e,
        osLocale: t,
        resolvedLanguage: "en",
        defaultMessagesFile: be.join(r, "nls.messages.json"),
        locale: e,
        availableLanguages: {}
    }
}
async function Sr(e) {
    try {
        return await Ce.promises.access(e), !0
    } catch {
        return !1
    }
}
...
function hl(e) {
    const t = new Date;
    return Ce.promises.utimes(e, t, t)
}
var dl = B2(V2(import.meta.url)),
    pl = await cl({
        userLocale: "en",
        osLocale: "en",
        commit: Cr.commit,
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/e48ee6102a199492b0c9964699bf011886708ba0/core/cli.js.map

//# debugId=24e54ab8-71d3-5079-b4f0-19e9e9f8d95e