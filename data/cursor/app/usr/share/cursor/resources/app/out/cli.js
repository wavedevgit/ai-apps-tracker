...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "7d9517da-c6e2-53db-9d1e-50963f0a1027")
    } catch (e) {}
}();
var u1 = function(e, t) {
...
var e2, Gi, Ji, Qi, Yi, Zi, Xi, en, t2, tn, rn, r2, s2 = L({
    "out-build/vs/platform/files/common/files.js"() {
        ...
        Qa(), ce(), We(), v1(), Ve(), Ft(), Ki(), Y(), Kt(), dt(), e2 = or("fileService"), (function(e) {
            ...
            static formatSize(t) {
                return no(t) || (t = 0), t < te.KB ? v(2033, null, t.toFixed(0)) : t < te.MB ? v(2034, null, (t / te.KB).toFixed(2)) : t < te.GB ? v(2035, null, (t / te.MB).toFixed(2)) : t < te.TB ? v(2036, null, (t / te.GB).toFixed(2)) : v(2037, null, (t / te.TB).toFixed(2))
            }
        }
    }
});
...
function an(e, t, r = pn) {
    ...
    for (const d in t) {
        ...
        let p = u[d];
        if (h.deprecates)
            for (const b of h.deprecates) u.hasOwnProperty(b) && (p || (p = u[b], p && r.onDeprecatedOption(b, h.deprecationMessage || v(1907, null, d))), delete u[b]);
        if (typeof p < "u") {
            if (h.type === "string[]") {
...
function v2(e, t, r, s, i) {
    const n = process.stdout.isTTY && process.stdout.columns || 80,
        a = i?.noInputFiles !== !0 ? `[${v(1908,null)}...]` : "",
        o = [`${e} ${r}`];
    o.push(""), o.push(`${v(1909,null)}: ${t} [${v(1910,null)}]${a}`), o.push(""), i?.noPipe !== !0 && (V ? o.push(v(1911, null, t)) : o.push(v(1912, null, t)), o.push(""));
    const c = {},
        l = [];
    for (const f in s) {
        const u = s[f];
    ...
    return l.length && (o.push(v(1913, null)), o.push(...ln(l.map(f => [f.command, f.description]), n)), o.push("")), o.join(`
`)
}

function y2(e, t) {
    return `${e||v(1914,null)}
${t||v(1915,null)}
${process.arch}`
}
    ...
    "out-build/vs/platform/environment/node/argv.js"() {
        ...
        un = Hn(p2(), 1), Y(), Ft(), fn = {
            ...
            add: {
                ...
                alias: "a",
                args: "folder",
                description: v(1867, null)
            },
            remove: {
                type: "boolean",
                cat: "o",
                args: "folder",
                description: v(1868, null)
            },
            goto: {
                type: "boolean",
                cat: "o",
                ...
                description: v(1869, null)
            },
            "new-window": {
                type: "boolean",
                cat: "o",
                alias: "n",
                description: v(1870, null)
            },
            "reuse-window": {
                type: "boolean",
                cat: "o",
                alias: "r",
                description: v(1871, null)
            },
            "suppress-popups-on-startup": {
                type: "boolean",
                cat: "o",
                description: v(1872, null)
            },
            "web-worker-exthost": {
                type: "boolean",
                cat: "o",
                description: v(1873, null)
            },
            glass: {
                type: "boolean",
                cat: "o",
                description: v(1874, null)
            },
            classic: {
                type: "boolean",
                cat: "o",
                description: v(1875, null)
            },
            wait: {
                type: "boolean",
                cat: "o",
                alias: "w",
                description: v(1876, null)
            },
            waitMarkerFilePath: {
                type: "string"
            },
            locale: {
                ...
                cat: "o",
                args: "locale",
                description: v(1877, null)
            },
            "user-data-dir": {
                type: "string",
                cat: "o",
                args: "dir",
                description: v(1878, null)
            },
            profile: {
                type: "string",
                cat: "o",
                args: "profileName",
                description: v(1879, null)
            },
            help: {
                type: "boolean",
                cat: "o",
                alias: "h",
                description: v(1880, null)
            },
            "extensions-dir": {
                type: "string",
            ...
            "list-extensions": {
                type: "boolean",
                cat: "e",
                description: v(1882, null)
            },
            "show-versions": {
                type: "boolean",
                cat: "e",
                description: v(1883, null)
            },
            category: {
                type: "string",
                allowEmptyValue: !0,
                cat: "e",
                description: v(1884, null),
                args: "category"
            },
            "install-extension": {
                type: "string[]",
                cat: "e",
                args: "ext-id | path",
                description: v(1885, null)
            },
            "pre-release": {
                type: "boolean",
                cat: "e",
                description: v(1886, null)
            },
            "uninstall-extension": {
                type: "string[]",
                cat: "e",
                args: "ext-id",
                description: v(1887, null)
            },
            "update-extensions": {
                type: "boolean",
                cat: "e",
                description: v(1888, null)
            },
            "enable-proposed-api": {
                type: "string[]",
                allowEmptyValue: !0,
                cat: "e",
                args: "ext-id",
                description: v(1889, null)
            },
            "add-mcp": {
                type: "string[]",
                cat: "o",
                args: "json",
                description: v(1890, null)
            },
            version: {
                type: "boolean",
                cat: "t",
                alias: "v",
                description: v(1891, null)
            },
            verbose: {
                type: "boolean",
                cat: "t",
                global: !0,
                description: v(1892, null)
            },
            log: {
                type: "string[]",
                cat: "t",
                args: "level",
                global: !0,
                description: v(1893, null)
            },
            status: {
                type: "boolean",
                alias: "s",
                cat: "t",
                description: v(1894, null)
            },
            "prof-startup": {
                type: "boolean",
                cat: "t",
                description: v(1895, null)
            },
            "prof-append-timers": {
                type: "string"
            },
            ...
            "disable-extensions": {
                ...
                cat: "t",
                description: v(1896, null)
            },
            "disable-extension": {
                type: "string[]",
                cat: "t",
                args: "ext-id",
                description: v(1897, null)
            },
            sync: {
                type: "string",
                cat: "t",
                description: v(1898, null),
                args: ["on | off"]
            },
            "inspect-extensions": {
                type: "string",
            ...
            "inspect-brk-extensions": {
                ...
                args: "port",
                cat: "t",
                description: v(1900, null)
            },
            "disable-lcd-text": {
                type: "boolean",
                cat: "t",
                description: v(1901, null)
            },
            "disable-gpu": {
                type: "boolean",
                cat: "t",
                description: v(1902, null)
            },
            "disable-chromium-sandbox": {
                type: "boolean",
                cat: "t",
                description: v(1903, null)
            },
            sandbox: {
                type: "boolean"
            },
            "locate-shell-integration-path": {
                ...
                cat: "t",
                args: ["shell"],
                description: v(1904, null)
            },
            telemetry: {
                type: "boolean",
                cat: "t",
                description: v(1905, null)
            },
            remote: {
                type: "string",
                allowEmptyValue: !0
...
function b2(e, t) {
    const r = (c, l) => {
            console.warn(v(1916, null, c, l))
        },
        s = c => {
            console.warn(v(1917, null, c))
        },
        i = (c, l) => {
            console.warn(v(1918, null, c, l))
        },
        n = c => ({
            onUnknownOption: l => {
                Zt.includes(c) || console.warn(v(1919, null, l, c))
            },
            onMultipleValues: r,
            onEmptyValue: s,
    ...
    return o.goto && o._.forEach(c => w2(/^(\w:)?[^:]+(:\d*){0,2}:?$/.test(c), v(1921, null))), o
}
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/c6285feaba0ad62603f7c22e72f0a170dc8415a0/core/cli.js.map

//# debugId=7d9517da-c6e2-53db-9d1e-50963f0a1027