(function(g, Q) {
    typeof exports == "object" && typeof module < "u" ? Q(exports) : typeof define == "function" && define.amd ? define(["exports"], Q) : (g = typeof globalThis < "u" ? globalThis : g || self, Q(g.acorn = {}))
})(exports, function(g) {
    "use strict";
    var Q = [509, 0, 227, 0, 150, 4, 294, 9, 1368, 2, 2, 1, 6, 3, 41, 2, 5, 0, 166, 1, 574, 3, 9, 9, 370, 1, 81, 2, 71, 10, 50, 3, 123, 2, 54, 14, 32, 10, 3, 1, 11, 3, 46, 10, 8, 0, 46, 9, 7, 2, 37, 13, 2, 9, 6, 1, 45, 0, 13, 2, 49, 13, 9, 3, 2, 11, 83, 11, 7, 0, 3, 0, 158, 11, 6, 9, 7, 3, 56, 1, 2, 6, 3, 1, 3, 2, 10, 0, 11, 1, 3, 6, 4, 4, 193, 17, 10, 9, 5, 0, 82, 19, 13, 9, 214, 6, 3, 8, 28, 1, 83, 16, 16, 9, 82, 12, 9, 9, 84, 14, 5, 9, 243, 14, 166, 9, 71, 5, 2, 1, 3, 3, 2, 0, 2, 1, 13, 9, 120, 6, 3, 6, 4, 0, 29, 9, 41, 6, 2, 3, 9, 0, 10, 10, 47, 15, 406, 7, 2, 7, 17, 9, 57, 21, 2, 13, 123, 5, 4, 0, 2, 1, 2, 6, 2, 0, 9, 9, 49, 4, 2, 1, 2, 4, 9, 9, 330, 3, 10, 1, 2, 0, 49, 6, 4, 4, 14, 9, 5351, 0, 7, 14, 13835, 9, 87, 9, 39, 4, 60, 6, 26, 9, 1014, 0, 2, 54, 8, 3, 82, 0, 12, 1, 19628, 1, 4706, 45, 3, 22, 543, 4, 4, 5, 9, 7, 3, 6, 31, 3, 149, 2, 1418, 49, 513, 54, 5, 49, 9, 0, 15, 0, 23, 4, 2, 14, 1361, 6, 2, 16, 3, 6, 2, 1, 2, 4, 101, 0, 161, 6, 10, 9, 357, 0, 62, 13, 499, 13, 983, 6, 110, 6, 6, 9, 4759, 9, 787719, 239],
        ...
        fe = "break case catch continue debugger default do else finally for function if return switch throw try var while with null true false instanceof typeof void delete new in this",
        ft = {
            5: fe,
    ...
    function V(e, t) {
        return e < 65 ? e === 36 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && xt.test(String.fromCharCode(e)) : t === !1 ? !1 : de(e, we)
    }

    function M(e, t) {
        return e < 48 ? e === 36 : e < 58 ? !0 : e < 65 ? !1 : e < 91 ? !0 : e < 97 ? e === 95 : e < 123 ? !0 : e <= 65535 ? e >= 170 && mt.test(String.fromCharCode(e)) : t === !1 ? !1 : de(e, we) || de(e, Q)
    }
    var v = function(t, i) {
    ...
    function Ie(e, t, i) {
        ...
        for (var s = t; s < i; s++) {
            ...
            if (U(r)) return s < i - 1 && r === 13 && e.charCodeAt(s + 1) === 10 ? s + 2 : s + 1
        }
        return -1
    }
    var xe = /[\u1680\u2000-\u200a\u202f\u205f\u3000\ufeff]/,
    ...
    function yt(e) {
        ...
        if (t.ecmaVersion === "latest" ? t.ecmaVersion = 1e8 : t.ecmaVersion == null ? (!Te && typeof console == "object" && console.warn && (Te = !0, console.warn(`Since Acorn 8.0.0, options.ecmaVersion is required.
Defaulting to 2020, but this will stop working in the future.`)), t.ecmaVersion = 11) : t.ecmaVersion >= 2015 && (t.ecmaVersion -= 2009), t.allowReserved == null && (t.allowReserved = t.ecmaVersion < 5), (!e || e.allowHashBang == null) && (t.allowHashBang = t.ecmaVersion >= 14), Ne(t.onToken)) {
            var s = t.onToken;
    ...
    function Ct(e, t) {
        return function(i, s, r, n, u, o) {
            ...
            e.locations && (h.loc = new X(this, u, o)), e.ranges && (h.range = [r, n]), t.push(h)
        }
    }
    var Z = 1,
        G = 2,
    ...
    var re = 0,
        ...
        Me = 5,
        y = function(t, i, s) {
            this.options = t = yt(t), this.sourceFile = t.sourceFile, this.keywords = B(ft[t.ecmaVersion >= 6 ? 6 : t.sourceType === "module" ? "5module" : 5]);
            var r = "";
...
`, s - 1) + 1, this.curLine = this.input.slice(0, this.lineStart).split(S).length) : (this.pos = this.lineStart = 0, this.curLine = 1), this.type = a.eof, this.value = null, this.start = this.end = this.pos, this.startLoc = this.endLoc = this.curPosition(), this.lastTokEndLoc = this.lastTokStartLoc = null, this.lastTokStart = this.lastTokEnd = this.pos, this.context = this.initialContext(), this.exprAllowed = !0, this.inModule = t.sourceType === "module", this.strict = this.inModule || this.strictDirective(this.pos), this.potentialArrowAt = -1, this.potentialArrowInForAwait = !1, this.yieldPos = this.awaitPos = this.awaitIdentPos = 0, this.labels = [], this.undefinedExports = Object.create(null), this.pos === 0 && t.allowHashBang && this.input.slice(0, 2) === "#!" && this.skipLineComment(2), this.scopeStack = [], this.enterScope(Z), this.regexpState = null, this.privateNameStack = []
    ...
    y.prototype.parse = function() {
        ...
        return (this.currentVarScope().flags & Le) > 0 && !this.currentVarScope().inClassFieldInit
    ...
    _.strictDirective = function(e) {
        ...
        return this.type === a.eof || this.type === a.braceR || S.test(this.input.slice(this.lastTokEnd, this.start))
    ...
    l.isLet = function(e) {
        ...
        var e = A.exec(this.input),
            ...
            i;
        return !S.test(this.input.slice(this.pos, t)) && this.input.slice(t, t + 8) === "function" && (t + 8 === this.input.length || !(M(i = this.input.charCodeAt(t + 8)) || i > 55295 && i < 56320))
        ...
        switch (this.isLet(e) && (s = a._var, n = "let"), s) {
            ...
            default:
                ...
                return s === a.name && d.type === "Identifier" && this.eat(a.colon) ? this.parseLabeledStatement(r, f, d, e) : this.parseExpressionStatement(r, d)
        }
    ...
    l.parseCatchClauseParam = function() {
        var e = this.parseBindingAtom(),
            t = e.type === "Identifier";
        return this.enterScope(t ? Oe : 0), this.checkLValPattern(e, t ? De : R), this.expect(a.parenR), e
        ...
        e.id = this.parseBindingAtom(), this.checkLValPattern(e.id, t === "var" ? Ce : R, !1)
    };
    var $ = 1,
        ke = 2,
        Ue = 4;
    l.parseFunction = function(e, t, i, s, r) {
        ...
        return this.yieldPos = 0, this.awaitPos = 0, this.awaitIdentPos = 0, this.enterScope(ye(e.async, e.generator)), t & $ || (e.id = this.type === a.name ? this.parseIdent() : null), this.parseFunctionParams(e), this.parseFunctionBody(e, i, !1, r), this.yieldPos = n, this.awaitPos = u, this.awaitIdentPos = o, this.finishNode(e, t & $ ? "FunctionDeclaration" : "FunctionExpression")
        ...
        if (s ? (i.computed = !1, i.key = this.startNodeAt(this.lastTokStart, this.lastTokStartLoc), i.key.name = s, this.finishNode(i.key, "Identifier")) : this.parseClassElementName(i), t < 13 || this.type === a.parenL || u !== "method" || r || n) {
            var f = !i.static && ue(i, "constructor"),
                d = f && e;
            f && u !== "method" && this.raise(i.key.start, "Constructor can't have get/set modifier"), i.kind = f ? "constructor" : u, this.parseClassMethod(i, r, n, d)
        ...
        var r = e.key;
        e.kind === "constructor" ? (t && this.raise(r.start, "Constructor can't be a generator"), i && this.raise(r.start, "Constructor can't be an async method")) : e.static && ue(e, "prototype") && this.raise(r.start, "Classes may not have a static property named prototype");
        ...
        if (ue(e, "constructor") ? this.raise(e.key.start, "Classes can't have a field named 'constructor'") : e.static && ue(e, "prototype") && this.raise(e.key.start, "Classes can't have a static field named 'prototype'"), this.eat(a.eq)) {
        ...
        if (this.options.checkPrivateFields)
            for (var s = this.privateNameStack.length, r = s === 0 ? null : this.privateNameStack[s - 1], n = 0; n < i.length; ++n) {
                var u = i[n];
                Y(t, u.name) || (r ? r.used.push(u) : this.raiseRecoverable(u.start, "Private field '#" + u.name + "' must be declared in an enclosing class"))
            }
    };
    ...
    l.parseExportAllDeclaration = function(e, t) {
        ...
        if (this.type === a._function || (e = this.isAsyncFunction())) {
            var t = this.startNode();
            return this.next(), e && this.next(), this.parseFunction(t, $ | Ue, !1, e)
        ...
        e && (typeof t != "string" && (t = t.type === "Identifier" ? t.name : t.value), Y(e, t) && this.raiseRecoverable(i, "Duplicate export '" + t + "'"), e[t] = !0)
        ...
        return this.next(), this.type === a.string ? (e.specifiers = St, e.source = this.parseExprAtom()) : (e.specifiers = this.parseImportSpecifiers(), this.expectContextual("from"), e.source = this.type === a.string ? this.parseExprAtom() : this.unexpected()), this.semicolon(), this.finishNode(e, "ImportDeclaration")
    ...
    I.toAssignable = function(e, t, i) {
        ...
        switch (e.type) {
            case "Identifier":
                this.strict && this.reservedWordsStrictBind.test(e.name) && this.raiseRecoverable(e.start, (s ? "Binding " : "Assigning to ") + e.name + " in strict mode"), s && (t === R && e.name === "let" && this.raiseRecoverable(e.start, "let is disallowed as a lexically bound name"), i && (Y(i, e.name) && this.raiseRecoverable(e.start, "Argument name clash"), i[e.name] = !0), t !== Me && this.declareName(e.name, t, e.start));
                break;
            case "ChainExpression":
                this.raiseRecoverable(e.start, "Optional chaining cannot appear in left-hand side");
                break;
    ...
    H.initialContext = function() {
        ...
        return t === b.f_expr || t === b.f_stat ? !0 : e === a.colon && (t === b.b_stat || t === b.b_expr) ? !t.isExpr : e === a._return || e === a.name && this.exprAllowed ? S.test(this.input.slice(this.lastTokEnd, this.start)) : e === a._else || e === a.semi || e === a.eof || e === a.parenR || e === a.arrow ? !0 : e === a.braceL ? t === b.b_stat : e === a._var || e === a._const || e === a.name ? !1 : !this.exprAllowed
        ...
        e.beforeExpr && e !== a._else && !(e === a.semi && this.curContext() !== b.p_stat) && !(e === a._return && S.test(this.input.slice(this.lastTokEnd, this.start))) && !((e === a.colon || e === a.braceL) && this.curContext() === b.b_stat) ? this.context.push(b.f_expr) : this.context.push(b.f_stat), this.exprAllowed = !1
    ...
    p.checkPropClash = function(e, t, i) {
        ...
        var s = !1,
            ...
            n = -1,
            u = -1;
        t ? (r = t.parenthesizedAssign, n = t.trailingComma, u = t.doubleProto, t.parenthesizedAssign = t.trailingComma = -1) : (t = new ne, s = !0);
        var o = this.start,
            h = this.startLoc;
        ...
        if (n != null && (!r || this.type !== a._in) && n > s) {
            ...
            var f = this.start,
                d = this.startLoc,
                C = this.parseExprOp(this.parseMaybeUnary(null, !1, !1, r), f, d, n, r),
                q = this.buildBinary(t, i, e, C, h, u || o);
            return (u && this.type === a.coalesce || o && (this.type === a.logicalOR || this.type === a.logicalAND)) && this.raiseRecoverable(this.start, "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"), this.parseExprOp(q, t, i, s, r)
        }
        return e
    ...
    function qe(e) {
        return e.type === "MemberExpression" && e.property.type === "PrivateIdentifier" || e.type === "ChainExpression" && qe(e.expression)
    }
    p.parseExprSubscripts = function(e, t) {
        ...
        if (f || h && this.type !== a.parenL && this.type !== a.backQuote || this.eat(a.dot)) {
            ...
            d.object = e, f ? (d.property = this.parseExpression(), this.expect(a.bracketR)) : this.type === a.privateId && e.type !== "Super" ? d.property = this.parsePrivateIdent() : d.property = this.parseIdent(this.options.allowReserved !== "never"), d.computed = !!f, o && (d.optional = h), e = this.finishNode(d, "MemberExpression")
            ...
            var le = this.parseExprList(a.parenR, this.options.ecmaVersion >= 8, !1, C);
            if (r && !h && this.shouldParseAsyncArrow()) return this.checkPatternErrors(C, !1), this.checkYieldAwaitInDefaultParams(), this.awaitIdentPos > 0 && this.raise(this.awaitIdentPos, "Cannot use 'await' as identifier inside an async function"), this.yieldPos = q, this.awaitPos = ie, this.awaitIdentPos = W, this.parseSubscriptAsyncArrow(t, i, le, u);
            this.checkExpressionErrors(C, !0), this.yieldPos = q || this.yieldPos, this.awaitPos = ie || this.awaitPos, this.awaitIdentPos = W || this.awaitIdentPos;
            var z = this.startNodeAt(t, i);
            z.callee = e, z.arguments = le, o && (z.optional = h), e = this.finishNode(z, "CallExpression")
            ...
            K.tag = e, K.quasi = this.parseTemplate({
                isTagged: !0
        ...
        switch (this.type) {
            ...
            case a.name:
                var n = this.start,
                    ...
                    o = this.containsEsc,
                    h = this.parseIdent(!1);
                if (this.options.ecmaVersion >= 8 && !o && h.name === "async" && !this.canInsertSemicolon() && this.eat(a._function)) return this.overrideContext(b.f_expr), this.parseFunction(this.startNodeAt(n, u), 0, !1, !0, t);
                if (r && !this.canInsertSemicolon()) {
                    if (this.eat(a.arrow)) return this.parseArrowExpression(this.startNodeAt(n, u), [h], !1, t);
                    if (this.options.ecmaVersion >= 8 && h.name === "async" && this.type === a.name && !o && (!this.potentialArrowInForAwait || this.value !== "of" || this.containsEsc)) return h = this.parseIdent(!1), (this.canInsertSemicolon() || !this.eat(a.arrow)) && this.unexpected(), this.parseArrowExpression(this.startNodeAt(n, u), [h], !0, t)
                }
                return h;
            case a.regexp:
                var f = this.value;
                return s = this.parseLiteral(f.value), s.regex = {
                    pattern: f.pattern,
                    flags: f.flags
                }, s;
            case a.num:
            ...
            case a.parenL:
                ...
                return e && (e.parenthesizedAssign < 0 && !this.isSimpleAssignTarget(C) && (e.parenthesizedAssign = d), e.parenthesizedBind < 0 && (e.parenthesizedBind = d)), C;
            case a.bracketL:
        ...
        var i = this.start,
            s = this.startLoc,
            r, n = this.options.ecmaVersion >= 8;
        if (this.options.ecmaVersion >= 6) {
            this.next();
            var u = this.start,
                o = this.startLoc,
            ...
            for (this.yieldPos = 0, this.awaitPos = 0; this.type !== a.parenR;)
                ...
                W = this.start, h.push(this.parseParenItem(this.parseRestBinding())), this.type === a.comma && this.raiseRecoverable(this.start, "Comma is not permitted after the rest element");
                break
            } else h.push(this.parseMaybeAssign(!1, C, this.parseParenItem));
            var le = this.lastTokEnd,
                z = this.lastTokEndLoc;
            if (this.expect(a.parenR), e && this.shouldParseArrow(h) && this.eat(a.arrow)) return this.checkPatternErrors(C, !1), this.checkYieldAwaitInDefaultParams(), this.yieldPos = q, this.awaitPos = ie, this.parseParenArrowList(i, s, h, t);
            (!h.length || d) && this.unexpected(this.lastTokStart), W && this.unexpected(W), this.checkExpressionErrors(C, !0), this.yieldPos = q || this.yieldPos, this.awaitPos = ie || this.awaitPos, h.length > 1 ? (r = this.startNodeAt(u, o), r.expressions = h, this.finishNodeAt(r, "SequenceExpression", le, z)) : r = h[0]
...
`),
        ...
        return !e.computed && e.key.type === "Identifier" && e.key.name === "async" && (this.type === a.name || this.type === a.num || this.type === a.string || this.type === a.bracketL || this.type.keyword || this.options.ecmaVersion >= 9 && this.type === a.star) && !S.test(this.input.slice(this.lastTokEnd, this.start))
        ...
        if (r) e.body = this.parseMaybeAssign(s), e.expression = !0, this.checkParams(e, !1);
            ...
            var h = this.labels;
            this.labels = [], u && (this.strict = !0), this.checkParams(e, !n && !u && !t && !i && this.isSimpleParamList(e.params)), this.strict && e.id && this.checkLValSimple(e.id, Me), e.body = this.parseBlock(!1, void 0, u && !n), e.expression = !1, this.adaptDirectivePrologue(e.body.body), this.labels = h
        }
        this.exitScope()
    ...
    D.enterScope = function(e) {
        ...
        if (t === R) {
            ...
            for (var o = this.scopeStack.length - 1; o >= 0; --o) {
                ...
                if (h.lexical.indexOf(e) > -1 && !(h.flags & Oe && h.lexical[0] === e) || !this.treatFunctionsAsVarInScope(h) && h.functions.indexOf(e) > -1) {
                    s = !0;
                    break
                }
                if (h.var.push(e), this.inModule && h.flags & Z && delete this.undefinedExports[e], h.flags & be) break
            }
    ...
    var ee = function(t, i, s) {
            this.type = "", this.start = i, this.end = 0, t.options.locations && (this.loc = new X(t, s)), t.options.directSourceFile && (this.sourceFile = t.options.directSourceFile), t.options.ranges && (this.range = [i, 0])
        },
        te = y.prototype;
    ...
    var Ge = "ASCII ASCII_Hex_Digit AHex Alphabetic Alpha Any Assigned Bidi_Control Bidi_C Bidi_Mirrored Bidi_M Case_Ignorable CI Cased Changes_When_Casefolded CWCF Changes_When_Casemapped CWCM Changes_When_Lowercased CWL Changes_When_NFKC_Casefolded CWKCF Changes_When_Titlecased CWT Changes_When_Uppercased CWU Dash Default_Ignorable_Code_Point DI Deprecated Dep Diacritic Dia Emoji Emoji_Component Emoji_Modifier Emoji_Modifier_Base Emoji_Presentation Extender Ext Grapheme_Base Gr_Base Grapheme_Extend Gr_Ext Hex_Digit Hex IDS_Binary_Operator IDSB IDS_Trinary_Operator IDST ID_Continue IDC ID_Start IDS Ideographic Ideo Join_Control Join_C Logical_Order_Exception LOE Lowercase Lower Math Noncharacter_Code_Point NChar Pattern_Syntax Pat_Syn Pattern_White_Space Pat_WS Quotation_Mark QMark Radical Regional_Indicator RI Sentence_Terminal STerm Soft_Dotted SD Terminal_Punctuation Term Unified_Ideograph UIdeo Uppercase Upper Variation_Selector VS White_Space space XID_Continue XIDC XID_Start XIDS",
        ...
        Nt = "Basic_Emoji Emoji_Keycap_Sequence RGI_Emoji_Modifier_Sequence RGI_Emoji_Flag_Sequence RGI_Emoji_Tag_Sequence RGI_Emoji_ZWJ_Sequence RGI_Emoji",
        Vt = {
            9: "",
            10: "",
            11: "",
        ...
        Ze = Xe + " Elymaic Elym Nandinagari Nand Nyiakeng_Puachue_Hmong Hmnp Wancho Wcho",
        Je = Ze + " Chorasmian Chrs Diak Dives_Akuru Khitan_Small_Script Kits Yezi Yezidi",
        $e = Je + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
    ...
    c.regexp_eatPatternCharacters = function(e) {
        ...
        if (e.lastStringValue = "", this.regexp_eatRegExpIdentifierStart(e)) {
            for (e.lastStringValue += F(e.lastIntValue); this.regexp_eatRegExpIdentifierPart(e);) e.lastStringValue += F(e.lastIntValue);
            return !0
        }
        return !1
        ...
        var t = e.pos,
            ...
            s = e.current(i);
        return e.advance(i), s === 92 && this.regexp_eatRegExpUnicodeEscapeSequence(e, i) && (s = e.lastIntValue), Bt(s) ? (e.lastIntValue = s, !0) : (e.pos = t, !1)
    };
    ...
    c.regexp_eatCharacterClassEscape = function(e) {
        ...
        if (e.switchU && this.options.ecmaVersion >= 9 && ((i = t === 80) || t === 112)) {
            ...
            var s;
            if (e.eat(123) && (s = this.regexp_eatUnicodePropertyValueExpression(e)) && e.eat(125)) return i && s === N && e.raise("Invalid property name"), s;
    ...
    c.regexp_eatUnicodePropertyValueExpression = function(e) {
        ...
        var t = 0;
        for (e.lastStringValue = ""; rt(t = e.current());) e.lastStringValue += F(t), e.advance();
    ...
    c.regexp_eatUnicodePropertyValue = function(e) {
        var t = 0;
        for (e.lastStringValue = ""; Ut(t = e.current());) e.lastStringValue += F(t), e.advance();
        return e.lastStringValue !== ""
    };
    ...
    c.regexp_eatLoneUnicodePropertyNameOrValue = function(e) {
        ...
        if (e.eat(91)) {
            ...
            return e.eat(93) || e.raise("Unterminated character class"), t && i === N && e.raise("Negated character class may contain strings"), !0
        }
        return !1
        ...
        if (e.eat(91)) {
            ...
            if (e.eat(93)) return i && s === N && e.raise("Negated character class may contain strings"), s;
            e.pos = t
        }
        if (e.eat(92)) {
        ...
        for (var t = this.regexp_classString(e); e.eat(124);) this.regexp_classString(e) === N && (t = N);
        return t
        ...
        var i = e.current();
        return i < 0 || i === e.lookahead() && qt(i) || jt(i) ? !1 : (e.advance(), e.lastIntValue = i, !0)
    };
    ...
    c.regexp_eatClassControlLetter = function(e) {
        ...
        var t = e.pos,
            i = 0;
        for (e.lastIntValue = 0; he(i = e.current());) e.lastIntValue = 10 * e.lastIntValue + (i - 48), e.advance();
        return e.pos !== t
    };
    ...
    c.regexp_eatHexDigits = function(e) {
        var t = e.pos,
            i = 0;
        for (e.lastIntValue = 0; nt(i = e.current());) e.lastIntValue = 16 * e.lastIntValue + ut(i), e.advance();
        return e.pos !== t
    };
    ...
    var ce = function(t) {
            this.type = t.type, this.value = t.value, this.start = t.start, this.end = t.end, t.options.locations && (this.loc = new X(t, t.startLoc, t.endLoc)), t.options.ranges && (this.range = [t.start, t.end])
        },
        x = y.prototype;
    x.next = function(e) {
        ...
        if (i === -1 && this.raise(this.pos - 2, "Unterminated comment"), this.pos = i + 2, this.options.locations)
            for (var s = void 0, r = t;
                (s = Ie(this.input, r, this.pos)) > -1;) ++this.curLine, r = this.lineStart = s;
        ...
        for (var t = this.pos, i = this.options.onComment && this.curPosition(), s = this.input.charCodeAt(this.pos += e); this.pos < this.input.length && !U(s);) s = this.input.charCodeAt(++this.pos);
        ...
        e: for (; this.pos < this.input.length;) {
            ...
            switch (e) {
                ...
                case 47:
                    ...
                    break;
                default:
                    if (e > 8 && e < 14 || e >= 5760 && xe.test(String.fromCharCode(e))) ++this.pos;
                    else break e
            }
        }
        ...
        var t = this.input.charCodeAt(this.pos + 1);
        return t === e ? t === 45 && !this.inModule && this.input.charCodeAt(this.pos + 2) === 62 && (this.lastTokEnd === 0 || S.test(this.input.slice(this.lastTokEnd, this.pos))) ? (this.skipLineComment(3), this.skipSpace(), this.nextToken()) : this.finishOp(a.incDec, 2) : t === 61 ? this.finishOp(a.assign, 2) : this.finishOp(a.plusMin, 1)
        ...
        var e = this.options.ecmaVersion,
            t = 35;
        if (e >= 13 && (++this.pos, t = this.fullCharCodeAtPos(), V(t, !0) || t === 92)) return this.finishToken(a.privateId, this.readWord1());
        ...
        for (var e, t, i = this.pos;;) {
            ...
            if (S.test(s) && this.raise(i, "Unterminated regular expression"), e) e = !1;
            else {
                if (s === "[") t = !0;
                else if (s === "]" && t) t = !1;
                else if (s === "/" && !t) break;
        ...
        for (var s = this.options.ecmaVersion >= 12 && t === void 0, r = i && this.input.charCodeAt(this.pos) === 48, n = this.pos, u = 0, o = 0, h = 0, f = t ?? 1 / 0; h < f; ++h, ++this.pos) {
            ...
            if (d >= 97 ? C = d - 97 + 10 : d >= 65 ? C = d - 65 + 10 : d >= 48 && d <= 57 ? C = d - 48 : C = 1 / 0, C >= e) break;
            o = d, u = u * e + C
        }
    ...
    x.readRadixNumber = function(e) {
        ...
        for (var t = "", i = ++this.pos;;) {
            ...
            var s = this.input.charCodeAt(this.pos);
            if (s === e) break;
            s === 92 ? (t += this.input.slice(i, this.pos), t += this.readEscapedChar(!1), i = this.pos) : s === 8232 || s === 8233 ? (this.options.ecmaVersion < 10 && this.raise(this.start, "Unterminated string constant"), ++this.pos, this.options.locations && (this.curLine++, this.lineStart = this.pos)) : (U(s) && this.raise(this.start, "Unterminated string constant"), ++this.pos)
        }
...
`;
        ...
        for (var e = "", t = !0, i = this.pos, s = this.options.ecmaVersion >= 6; this.pos < this.input.length;) {
            ...
            if (M(r, s)) this.pos += r <= 65535 ? 1 : 2;
                ...
                (t ? V : M)(u, s) || this.invalidStringToken(n, "Invalid Unicode escape"), e += F(u), i = this.pos
            } else break;
            t = !1
        }
