"use strict";
exports.id = 425, exports.ids = [425], exports.modules = {
    425: (_, e, t) => {
        t.a(_, (async (_, n) => {
            try {
                t.d(e, {
                    decode_bytes: () => i.pt,
                    init_panic_hook: () => i.d3
                });
                var r = t(871),
                    i = t(763),
                    s = _([r]);
    ...
    763: (_, e, t) => {
        ...
        function h(_, e, t) {
            if (void 0 === t) {
                const t = p.encode(_),
                    n = e(t.length, 1) >>> 0;
                return g().subarray(n, n + t.length).set(t), w = t.length, n
            }
            let n = _.length,
                r = e(n, 1) >>> 0;
            const i = g();
        ...
        function m() {
            return null !== k && 0 !== k.byteLength || (k = new Uint32Array(n.memory.buffer)), k
        }
        ...
        class I {
            ...
            get_class_counts(_) {
                try {
                    ...
                    var e = y()[g / 4 + 0],
                        t = y()[g / 4 + 1],
                        r = (i = e, s = t, i >>>= 0, m().subarray(i / 4, i / 4 + s)).slice();
