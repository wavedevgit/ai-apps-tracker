...
(function() {
    ...
    async function b(n, e) {
        ...
        e?.beforeImport?.(o);
        const {
            enableDeveloperKeybindings: t,
            removeDeveloperKeybindingsAfterLoad: d,
            developerDeveloperKeybindingsDisposable: i,
            forceDisableShowDevtoolsOnError: a
        } = v(o, e);
        w(o);
        const s = new URL(`${S(o.appRoot,{isWindows:p.platform==="win32",scheme:"vscode-file",fallbackAuthority:"vscode-app"})}/out/`);
        globalThis._VSCODE_FILE_ROOT = s.toString(), D(o, s);
        try {
            let r;
            return r = await import(new URL(`${n}.js`, s).href), i && d && i(), {
                result: r,
                configuration: o
            }
        } catch (r) {
    ...
    async function j() {
        ...
        return performance.mark("code/didWaitForWindowConfig"), clearTimeout(n), e
    }

    function v(n, e) {
        const {
            forceEnableDeveloperKeybindings: o,
            disallowReloadKeybinding: t,
            removeDeveloperKeybindingsAfterLoad: d,
            forceDisableShowDevtoolsOnError: i
    ...
    function x(n) {
        const e = l.ipcRenderer,
            ...
            t = p.platform === "darwin" ? "meta-alt-73" : "ctrl-shift-73",
            d = "123",
            i = p.platform === "darwin" ? "meta-82" : "ctrl-82";
        let a = function(s) {
            const r = o(s);
            r === t || r === d ? e.send("vscode:toggleDevTools") : r === i && !n && e.send("vscode:reloadWindow")
        };
    ...
    function w(n) {
        globalThis._VSCODE_NLS_MESSAGES = n.nls.messages, globalThis._VSCODE_NLS_LANGUAGE = n.nls.language;
        let e = n.nls.language || "en";
        e === "zh-tw" ? e = "zh-Hant" : e === "zh-cn" && (e = "zh-Hans"), window.document.documentElement.setAttribute("lang", e)
    }

    function k(n, e) {
        e && l.ipcRenderer.send("vscode:openDevTools"), console.error(`[uncaught exception]: ${n}`), n && typeof n != "string" && n.stack && console.error(n.stack)
    }
    ...
    function S(n, e) {
        ...
        let t;
        return e.isWindows && o.startsWith("//") ? t = encodeURI(`${e.scheme||"file"}:${o}`) : t = encodeURI(`${e.scheme||"file"}://${e.fallbackAuthority||""}${o}`), t.replace(/#/g, "%23")
    }
    ...
    function D(n, e) {
        const o = {
            ...
            t = "../../packages/ui/dist/automations.js",
            d = {
                "proto/": "../proto/",
                ...
                "@anysphere/ui/components/Automations": t,
                "@anysphere/ui/components/Automations/AgentSettingsForm": t,
                "@anysphere/ui/components/Automations/AsyncAgentsList": t,
                "@anysphere/ui/components/Automations/components": t,
                "@anysphere/ui/components/Automations/components/DetailHeader": t,
                "@anysphere/ui/components/Automations/components/FilterTabs": t,
                "@anysphere/ui/components/Automations/hooks": t,
                "@anysphere/ui/components/Automations/platform/capabilities": t,
                "@anysphere/ui/components/Automations/runtime/AutomationsRuntime": t,
                "@anysphere/ui/components/Automations/templates/TemplateGallery": t,
                "@anysphere/ui/components/Automations/triggers/InlineTriggerButton": t,
                "@anysphere/ui/components/Automations/triggers/trigger-picker-styles": t,
                "@anysphere/ui/components/Automations/types": t,
                "@anysphere/ui/components/Automations/utils/formatters": t,
                "@anysphere/ui/components/Automations/utils/prefill": t,
                "@anysphere/ui/components/Automations/utils/triggerDataUtils": t,
        ...
        for (const [r, m] of Object.entries(o)) i.imports[r] = new URL(`../node_modules/${m}`, e).href;
        for (const [r, m] of Object.entries(d)) i.imports[r] = new URL(`./external/${m}`, e).href;
        const a = ["api/context", "api/diag", "api/metrics", "api/propagation", "api/trace", "baggage/context-helpers", "baggage/internal/baggage-impl", "baggage/internal/symbol", "baggage/types", "baggage/utils", "common/Attributes", "common/Exception", "common/Time", "context/context", "context/NoopContextManager", "context/types", "diag/ComponentLogger", "diag/consoleLogger", "diag/internal/logLevelLogger", "diag/internal/noopLogger", "diag/types", "experimental/index", "experimental/trace/SugaredOptions", "experimental/trace/SugaredTracer", "internal/global-utils", "internal/semver", "metrics/Meter", "metrics/MeterProvider", "metrics/Metric", "metrics/NoopMeter", "metrics/NoopMeterProvider", "metrics/ObservableResult", "platform/browser/globalThis", "platform/browser/index", "platform/index", "platform/node/globalThis", "platform/node/index", "propagation/NoopTextMapPropagator", "propagation/TextMapPropagator", "trace/attributes", "trace/context-utils", "trace/internal/tracestate-impl", "trace/internal/tracestate-validators", "trace/internal/utils", "trace/invalid-span-constants", "trace/link", "trace/NonRecordingSpan", "trace/NoopTracer", "trace/NoopTracerProvider", "trace/ProxyTracer", "trace/ProxyTracerProvider", "trace/Sampler", "trace/SamplingResult", "trace/span", "trace/span_context", "trace/span_kind", "trace/spancontext-utils", "trace/SpanOptions", "trace/status", "trace/trace_flags", "trace/trace_state", "trace/tracer", "trace/tracer_options", "trace/tracer_provider", "context-api", "diag-api", "index", "metrics-api", "propagation-api", "trace-api", "version"],
            s = new URL("../node_modules/@opentelemetry/api/build/esm/", e).href;
        for (const r of a) i.imports[`${s}${r}`] = `${s}${r}.js`;
        if (i.imports[`${s}platform`] = `${s}platform/index.js`, i.imports[`${s}experimental`] = `${s}experimental/index.js`, i.imports[`${s}platform/node`] = `${s}platform/node/index.js`, i.imports[`${s}platform/browser`] = `${s}platform/browser/index.js`, n.cssModules && n.cssModules.size > 0) {
            performance.mark("code/willAddCssLoader"), globalThis._VSCODE_CSS_LOAD = function(c, y, f) {
                const u = document.createElement("link");
                u.rel = "stylesheet", u.href = c + "?hash=" + f, u.type = "text/css", u.media = "screen", u.id = y.replace(".css", ""), document.head.appendChild(u)
            };
            const r = n.cssModules,
                m = new Map(Array.from(r, ([c, y]) => [c, {
                    hash: y,
                    url: new URL(c, e).href
                }])),
                A = `
				const cssMapping = ${JSON.stringify(Object.fromEntries(m))};
		...
		`,
            ...
            for (const [c, y] of n.cssModules) {
                const f = new URL(c, e).href;
                i.imports[f] = L + "#module=" + encodeURIComponent(c)
            }
            const _ = window.trustedTypes?.createPolicy("vscode-bootstrapImportMap", {
                ...
                h = JSON.stringify(i, void 0, 2),
                g = document.createElement("script");
            g.type = "importmap", g.setAttribute("nonce", "0c6a828f1297"), g.textContent = _?.createScript(h) ?? h, document.head.appendChild(g), performance.mark("code/didAddCssLoader")
        }
    }
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/0cf8b06883f54e26bb4f0fb8647c9500ccb43310/core/vs/code/electron-sandbox/extensionMonitor/extensionMonitor.js.map
