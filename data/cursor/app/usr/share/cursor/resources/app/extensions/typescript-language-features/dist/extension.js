...
(() => {
    var e = {
            ...
            136: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.inMemoryResourcePrefix = t.emptyAuthority = void 0;
                const c = n(857),
                    l = o(n(6928)),
                    u = o(n(1398)),
                    d = n(4906),
                ...
                class R extends x.Disposable {
                    constructor(e, t, n, i) {
                        ...
                        }, null, this._disposables), this.bufferSyncSupport.onWillChange(e => {
                    ...
                    startService(e = !1) {
                        ...
                        if (this.hasServerFatallyCrashedTooManyTimes) return this.logger.info("Not starting server: too many crashes"), D.None;
                        ...
                        return this.telemetryReporter.logTelemetry("tsserver.spawned", {
                            ...o,
                            ...
                            this.logger.error(`TSServer exited. Code: ${t}. Signal: ${n}`), this.telemetryReporter.logTelemetry("tsserver.exitWithCode", {
                                ...o,
                                code: t ?? void 0,
                                signal: n ?? void 0
                    ...
                    resetWatchers() {
                        clearTimeout(this.watchChangeTimeout), (0, x.disposeAll)(Array.from(this.watches.values()))
                    }
                    async showVersionPicker() {
                        this._versionManager.promptUserForVersion()
                    }
                    async promptForNodeVersion() {
                        await this._nodeVersionManager.resetWorkspaceNodeChoice()
                    }
                    async openTsServerLogFile() {
                        if (this._configuration.tsServerLogLevel === d.TsServerLogLevel.Off) return u.window.showErrorMessage(u.l10n.t("TS Server logging is off. Please set 'typescript.tsserver.log' and restart the TS server to enable logging"), {
                            title: u.l10n.t("Enable logging and restart TS server")
                        }).then(e => {
                            if (e) return u.workspace.getConfiguration().update("typescript.tsserver.log", "verbose", !0).then(() => {
                                this.restartTsServer()
                            })
                        }), !1;
                        ...
                        switch (this.serverState.server.tsServerLog.type) {
                            ...
                            case "file":
                                try {
                                    const e = await u.workspace.openTextDocument(this.serverState.server.tsServerLog.uri);
                                    return await u.window.showTextDocument(e), !0
                                } catch {}
                                try {
                                    return await u.commands.executeCommand("revealFileInOS", this.serverState.server.tsServerLog.uri), !0
                                } catch {
                                    return u.window.showWarningMessage(u.l10n.t("Could not open TS Server log file")), !1
                                }
                        }
                    }
                    serviceStarted(e) {
                        this.bufferSyncSupport.reset();
                        const t = this.apiVersion.gte(y.API.v380) ? this.configuration.watchOptions : void 0,
                            n = {
                                hostInfo: "vscode",
                                preferences: {
                        ...
                        this.executeWithoutWaitingForResponse("configure", n), this.setCompilerOptionsForInferredProjects(this._configuration), e && (this._onResendModelsRequested.fire(), this.bufferSyncSupport.reinitialize(), this.bufferSyncSupport.requestAllDiagnostics());
                        for (const [e, t] of this.pluginManager.configurations()) this.configurePlugin(e, t)
                    }
                    setCompilerOptionsForInferredProjects(e) {
                        const t = {
                            options: this.getCompilerOptionsForInferredProjects(e)
                        };
                        this.executeWithoutWaitingForResponse("compilerOptionsForInferredProjects", t)
                    }
                    ...
                    serviceExited(e, t) {
                        if (this.resetWatchers(), this.loadingIndicator.reset(), this.serverState = D.None, e) {
                            ...
                            2 == this.numberRestarts && (this.tracer.forceLogging = !0), this.numberRestarts > 5 ? (this.numberRestarts = 0, e < 1e4 ? (this.lastStart = Date.now(), n = !1, this.hasServerFatallyCrashedTooManyTimes = !0, s = this.pluginManager.plugins.length ? u.window.showErrorMessage(u.l10n.t("The JS/TS language service immediately crashed 5 times. The service will not be restarted.\nThis may be caused by a plugin contributed by one of these extensions: {0}.\nPlease try disabling these extensions before filing an issue against VS Code.", i)) : u.window.showErrorMessage(u.l10n.t("The JS/TS language service immediately crashed 5 times. The service will not be restarted."), r), this.telemetryReporter.logTelemetry("serviceExited")) : e < 3e5 && (this.lastStart = Date.now(), this._isPromptingAfterCrash || (s = this.pluginManager.plugins.length ? u.window.showWarningMessage(u.l10n.t("The JS/TS language service crashed 5 times in the last 5 Minutes.\nThis may be caused by a plugin contributed by one of these extensions: {0}\nPlease try disabling these extensions before filing an issue against VS Code.", i)) : u.window.showWarningMessage(u.l10n.t("The JS/TS language service crashed 5 times in the last 5 Minutes."), r)))) : ["vscode-insiders", "code-oss"].includes(u.env.uriScheme) && (this.numberRestarts = 0, this._isPromptingAfterCrash || (s = this.pluginManager.plugins.length ? u.window.showWarningMessage(u.l10n.t("The JS/TS language service crashed.\nThis may be caused by a plugin contributed by one of these extensions: {0}.\nPlease try disabling these extensions before filing an issue against VS Code.", i)) : u.window.showWarningMessage(u.l10n.t("The JS/TS language service crashed."), r))), s && (this._isPromptingAfterCrash = !0), s?.then(async e => {
                                if (this._isPromptingAfterCrash = !1, e === r) {
                                    ...
                                    if (t.isYarnPnp()) {
                                        const e = {
                                            title: u.l10n.t("Report issue against Yarn PnP")
                                        };
                                        await u.window.showWarningMessage(u.l10n.t("Please report an issue against Yarn PnP"), {
                                            modal: !0,
                                            detail: u.l10n.t("The workspace is using a version of the TypeScript Server that has been patched by Yarn PnP. This patching is a common source of bugs.")
                                        }, e) === e && u.env.openExternal(u.Uri.parse("https://github.com/yarnpkg/berry/issues"))
                                    } else e && t.lt(e) ? u.window.showWarningMessage(u.l10n.t("Please update your TypeScript version"), {
                                        modal: !0,
                                        detail: u.l10n.t("The workspace is using an old version of TypeScript ({0}).\n\nBefore reporting an issue, please update the workspace to use TypeScript {1} or newer to make sure the bug has not already been fixed.", t.displayName, e.displayName)
                                    }) : u.env.openExternal(u.Uri.parse("https://github.com/microsoft/vscode/wiki/TypeScript-Issues"))
                                }
                    ...
                    toResource(e) {
                        if ((0, E.isWeb)()) {
                            if (e.startsWith("/lib.") && e.endsWith(".d.ts")) return u.Uri.joinPath(this.context.extensionUri, "dist", "browser", "typescript", e.slice(1));
                            const n = e.match(/^\/([^\/]+)\/([^\/]*)\/(.+)$/);
                            if (n) {
                                const e = u.Uri.parse(n[1] + "://" + (n[2] === t.emptyAuthority ? "" : n[2]) + "/" + n[3]);
                                return this.bufferSyncSupport.toVsCodeResource(e)
                            }
                        }
                        if (e.startsWith(t.inMemoryResourcePrefix)) {
                            const n = e.match(/^\^\/([^\/]+)\/([^\/]*)\/(.+)$/);
                            if (n) {
                                const e = u.Uri.parse(n[1] + "://" + (n[2] === t.emptyAuthority ? "" : n[2]) + "/" + n[3]);
                                return this.bufferSyncSupport.toVsCodeResource(e)
                                ...
                                for (const t of u.workspace.notebookDocuments)
                                    for (const n of t.getCells())
                                        if (n.document.uri.toString() === e.toString()) {
                                            e = t.uri;
                                            break
                                        } for (const n of t.sort((e, t) => e.uri.path.length - t.uri.path.length))
                                if (n.uri.scheme === e.scheme && n.uri.authority === e.authority && e.path.startsWith(n.uri.path + "/")) return n.uri;
                    ...
                    fatalError(e, t) {
                        if (this.telemetryReporter.logTelemetry("fatalError", {
                    ...
                    dispatchEvent(e) {
                        switch (e.event) {
                            case S.EventName.syntaxDiag:
                            case S.EventName.semanticDiag:
                            case S.EventName.suggestionDiag:
                            case S.EventName.regionSemanticDiag: {
                                this.loadingIndicator.reset();
                                const t = e;
                            ...
                            case S.EventName.configFileDiag:
                                return void this._onConfigDiagnosticsReceived.fire(e);
                            case S.EventName.telemetry: {
                                const t = e.body;
                                return void this.dispatchTelemetryEvent(t)
                            }
                            ...
                            case S.EventName.projectsUpdatedInBackground: {
                                this.loadingIndicator.reset();
                                const t = e.body.openFiles.map(e => this.toResource(e));
                                return void this.bufferSyncSupport.getErr(t)
                            }
                            case S.EventName.beginInstallTypes:
                                return void this._onDidBeginInstallTypings.fire(e.body);
                            case S.EventName.endInstallTypes:
                                return void this._onDidEndInstallTypings.fire(e.body);
                            case S.EventName.typesInstallerInitializationFailed:
                                return void this._onTypesInstallerInitializationFailed.fire(e.body);
                            case S.EventName.surveyReady:
                                return void this._onSurveyReady.fire(e.body);
                            case S.EventName.projectLoadingStart:
                                return void this.loadingIndicator.startedLoadingProject(e.body.projectName);
                            case S.EventName.projectLoadingFinish:
                                return void this.loadingIndicator.finishedLoadingProject(e.body.projectName);
                            case S.EventName.createDirectoryWatcher: {
                                const n = e.body.path;
                                if (n.startsWith(t.inMemoryResourcePrefix)) return;
                                if ("darwin" === process.platform && n === l.join((0, c.homedir)(), "Library")) return;
                                return void this.createFileSystemWatcher(e.body.id, new u.RelativePattern(u.Uri.file(n), e.body.recursive ? "**" : "*"), e.body.ignoreUpdate)
                            }
                            case S.EventName.createFileWatcher: {
                                const n = e.body.path;
                                if (n.startsWith(t.inMemoryResourcePrefix)) return;
                                return void this.createFileSystemWatcher(e.body.id, new u.RelativePattern(u.Uri.file(n), "*"))
                            }
                            case S.EventName.closeFileWatcher:
                                return void this.closeFileSystemWatcher(e.body.id);
                            case S.EventName.requestCompleted: {
                                const t = e.body.performanceData?.diagnosticsDuration;
                                return void(t && this.diagnosticsManager.logDiagnosticsPerformanceTelemetry(t.map(e => {
                                    const t = this.toResource(e.file);
                                    return {
                                        ...e,
                                        fileLineCount: this.bufferSyncSupport.lineCount(t)
                                    }
                                })))
                            }
                        }
                    ...
                    scheduleExecuteWatchChangeRequest() {
                        this.watchChangeTimeout || (this.watchChangeTimeout = setTimeout(() => {
                            this.watchChangeTimeout = void 0;
                            const e = Array.from(this.watchEvents, ([e, t]) => ({
                                id: e,
                                updated: t.updated && Array.from(t.updated),
                                created: t.created && Array.from(t.created),
                                deleted: t.deleted && Array.from(t.deleted)
                            }));
                            this.watchEvents.clear(), this.executeWithoutWaitingForResponse("watchChange", e)
                        }, 100))
                    }
                    addWatchEvent(e, t, n) {
                    ...
                    dispatchTelemetryEvent(e) {
                        ...
                        switch (e.telemetryEventName) {
                            case "typingsInstalled": {
                                const n = e.payload;
                                t.installedPackages = n.installedPackages, "boolean" == typeof n.installSuccess && (t.installSuccess = n.installSuccess.toString()), "string" == typeof n.typingsInstallerVersion && (t.typingsInstallerVersion = n.typingsInstallerVersion);
                                break
                            }
                            default: {
                                const n = e.payload;
                                n && Object.keys(n).forEach(e => {
                                    try {
                                        n.hasOwnProperty(e) && (t[e] = "string" == typeof n[e] ? n[e] : JSON.stringify(n[e]))
                                    } catch (e) {}
                                });
                                break
                            }
                    ...
                    _stopMemoryMonitor() {
                        void 0 !== this._memoryCheckTimer && (clearTimeout(this._memoryCheckTimer), this._memoryCheckTimer = void 0, this._memoryMonitorEnabled = !1)
                    }
                }
                ...
                class I extends x.Disposable {
                    ...
                    reset() {
                        this._task && (this._task.resolve(), this._task = void 0)
                    }
                    startedLoadingProject(e) {
                        this.reset();
                        const t = this.getProjectDisplayName(e);
                        u.window.withProgress({
                            location: u.ProgressLocation.Window,
                            title: u.l10n.t("Initializing '{0}'", t)
                        }, () => new Promise(t => {
                            this._task = {
                                project: e,
                                resolve: t
                    ...
                    getProjectDisplayName(e) {
                        const t = this.client.toResource(e),
                            n = u.workspace.asRelativePath(t);
                        return n.length > 60 ? "..." + n.slice(-60) : n
                    }
                    startedLoadingFile(e, t) {
                        this._task || u.window.withProgress({
                            location: u.ProgressLocation.Window,
                            title: u.l10n.t("Analyzing '{0}' and its dependencies", l.basename(e))
                        }, () => t)
                    }
                    finishedLoadingProject(e) {
                        this._task?.project === e && (this._task.resolve(), this._task = void 0)
                    }
                }
            },
            144: (e, t, n) => {
            ...
            185: function(e, t, n) {
                ...
                class b extends h.Disposable {
                    ...
                    dispose() {
                        super.dispose(), this._callbacks.destroy("server disposed"), this._pendingResponses.clear()
                    }
                    kill() {
                        this._process.kill()
                    }
                    dispatchMessage(e) {
                        try {
                            switch (e.type) {
                                case "response":
                                    this._serverSource ? this.dispatchResponse({
                                        ...e,
                                ...
                                case "event": {
                                    ...
                                    if ("requestCompleted" === t.event) {
                                        ...
                                        n && (this._tracer.traceRequestCompleted(this._serverId, "requestCompleted", e, n), n.onSuccess(void 0)), t.body.performanceData && this._onEvent.fire(t)
                                    } else this._tracer.traceEvent(this._serverId, t), this._onEvent.fire(t);
                                    break
                                }
                                default:
                    ...
                    sendRequest(e) {
                        const t = e.request;
                        this._tracer.traceRequest(this._serverId, t, e.expectsResponse, this._requestQueue.length), e.expectsResponse && !e.isAsync && this._pendingResponses.add(e.request.seq);
                        try {
                            this.write(t)
                        } catch (e) {
                ...
                class _ extends h.Disposable {
                    ...
                    get pids() {
                        return [...this.getErrServer.pids, ...this.mainServer.pids]
                    }
                    kill() {
                ...
                class S extends h.Disposable {
                    constructor(e, t, n) {
                        super(), this._projectLoading = !0, this._onEvent = this._register(new c.EventEmitter), this.onEvent = this._onEvent.event, this._onExit = this._register(new c.EventEmitter), this.onExit = this._onExit.event, this._onError = this._register(new c.EventEmitter), this.onError = this._onError.event, this.syntaxServer = e.syntax, this.semanticServer = e.semantic, this.router = new w([{
                            ...
                            canRun: void 0
                        }], t), this._register(this.syntaxServer.onEvent(e => this._onEvent.fire(e))), this._register(this.semanticServer.onEvent(e => {
                            switch (e.event) {
                                case g.EventName.projectLoadingStart:
                                    this._projectLoading = !0;
                                    break;
                                case g.EventName.projectLoadingFinish:
                                case g.EventName.semanticDiag:
                                case g.EventName.syntaxDiag:
                                case g.EventName.suggestionDiag:
                                case g.EventName.configFileDiag:
                    ...
                    get pids() {
                        return [...this.syntaxServer.pids, ...this.semanticServer.pids]
                    }
                    kill() {
            ...
            539: function(e, t, n) {
                ...
                class y extends g.Disposable {
                            ...
                            for (const {
                                ...
                                r && this.client.toTsFilePath(r) && (this._pendingRenames.add({
                                    ...
                                    c.window.withProgress({
                                        ...
                                        title: c.l10n.t("Checking for update of JS/TS imports")
                                    }, () => this.flushRenames())
                                }))
                            }
                        }))
                    ...
                    getConfiguration(e) {
                        return c.workspace.getConfiguration((0, u.doesResourceLookLikeATypeScriptFile)(e) ? "typescript" : "javascript", e)
                    }
                    async promptUser(e) {
                        if (!e.length) return !1;
                        const t = {
                    ...
                    async getJsTsFileBeingMoved(e) {
                        if (e.scheme === l.file) return await async function(e) {
                            try {
                                return (await c.workspace.fs.stat(e)).type === c.FileType.Directory
                            } catch {
                                return !1
                            }
                    ...
                    groupRenames(e) {
                        const t = new Map;
                        for (const n of e) {
                            const e = `${this.client.getWorkspaceRootForResource(n.jsTsFileThatIsBeingMoved)?.fsPath}@@@${(0,u.doesResourceLookLikeATypeScriptFile)(n.jsTsFileThatIsBeingMoved)}`;
                    ...
                    getConfirmMessage(e, t) {
                        const n = [e];
                        return n.push(""), n.push(...t.slice(0, 10).map(e => a.basename(e.fsPath))), t.length > 10 && (t.length - 10 == 1 ? n.push(c.l10n.t("...1 additional file not shown")) : n.push(c.l10n.t("...{0} additional files not shown", t.length - 10))), n.push(""), n.join("\n")
                    }
                    getConfigTargetScope(e, t) {
                        const n = e.inspect(t);
                        return n?.workspaceFolderValue ? c.ConfigurationTarget.WorkspaceFolder : n?.workspaceValue ? c.ConfigurationTarget.Workspace : c.ConfigurationTarget.Global
                    }
                }
            },
            560: (e, t, n) => {
            ...
            746: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.disabledSchemes = t.chatCodeBlock = t.officeScript = t.vscodeNotebookCell = t.walkThroughSnippet = t.vsls = t.azurerepos = t.github = t.git = t.untitled = t.file = void 0, t.getSemanticSupportedSchemes = function() {
                    const e = [t.untitled, t.walkThroughSnippet, t.vscodeNotebookCell, t.chatCodeBlock];
                    return (0, c.isWeb)() ? [...(a.workspace.workspaceFolders ?? []).map(e => e.uri.scheme), ...e] : [t.file, ...e]
                ...
                const a = o(n(1398)),
                    c = n(8160);
                t.file = "file", t.untitled = "untitled", t.git = "git", t.github = "github", t.azurerepos = "azurerepos", t.vsls = "vsls", t.walkThroughSnippet = "walkThroughSnippet", t.vscodeNotebookCell = "vscode-notebook-cell", t.officeScript = "office-script", t.chatCodeBlock = "vscode-chat-code-block", t.disabledSchemes = new Set([t.git, t.vsls, t.github, t.azurerepos])
            },
            800: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
                ...
                class p extends d.Disposable {
                    ...
                    isManagedScriptFile(e) {
                        return (0, u.isSupportedLanguageMode)(e.document) && !c.disabledSchemes.has(e.document.uri.scheme)
                    }
                ...
                class g extends d.Disposable {
                    ...
                    async provideInlayHints(e, t, n) {
                        ...
                        return "response" === o.type && o.success && o.body ? o.body.map(e => {
                            const t = new a.InlayHint(l.Position.fromLocation(e.position), this.convertInlayHintText(e), function(e) {
                                switch (e) {
                                    case "Parameter":
                                        return a.InlayHintKind.Parameter;
                                    case "Type":
                                        return a.InlayHintKind.Type;
                                    default:
                                        return
                                }
                            }(e.kind));
                            return t.paddingLeft = e.whitespaceBefore, t.paddingRight = e.whitespaceAfter, t
                        }) : void 0
                    }
                    convertInlayHintText(e) {
                        return e.displayParts ? e.displayParts.map(e => {
                            const t = new a.InlayHintLabelPart(e.text);
                            return e.span && (t.location = l.Location.fromTextSpan(this.client.toResource(e.span.file), e.span)), t
                        }) : e.text
                    }
                }
                g.minVersion = c.API.v440
            },
            857: e => {
                "use strict";
            ...
            917: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    return (0, u.conditionalRegistration)([(0, u.requireSomeCapability)(t, l.ClientCapability.EnhancedSyntax, l.ClientCapability.Semantic)], () => a.languages.registerReferenceProvider(e.syntax, new d(t)))
                };
                const a = o(n(1398)),
                    c = o(n(2144)),
                    l = n(7371),
            ...
            1033: function(e, t, n) {
                ...
                function l(e, t) {
                    return t.changes?.length ? c.WorkspaceEdit.fromFileCodeEdits(e, t.changes) : void 0
                }
            ...
            1068: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.InlayHintSettingNames = void 0, t.getInlayHintsPreferences = y;
                const a = o(n(6928)),
                    c = o(n(1398)),
                    l = o(n(746)),
                    u = n(3256),
                ...
                class g extends p.Disposable {
                    constructor(e, t) {
                        ...
                        }), c.workspace.onDidCloseTextDocument(e => {
                    ...
                    getFormattingOptions(e) {
                        const t = c.window.visibleTextEditors.find(t => t.document.uri.toString() === e.uri.toString());
                        if (t) return {
                            tabSize: "number" == typeof t.options.tabSize ? t.options.tabSize : void 0,
                            insertSpaces: "boolean" == typeof t.options.insertSpaces ? t.options.insertSpaces : void 0
                        }
                    }
                    ...
                    getFormatOptions(e, t) {
                        const n = c.workspace.getConfiguration((0, u.isTypeScriptDocument)(e) ? "typescript.format" : "javascript.format", e.uri);
                        return {
                            tabSize: t.tabSize,
                            indentSize: t.tabSize,
                            convertTabsToSpaces: t.insertSpaces,
                            newLineCharacter: "\n",
                            insertSpaceAfterCommaDelimiter: n.get("insertSpaceAfterCommaDelimiter"),
                            insertSpaceAfterConstructor: n.get("insertSpaceAfterConstructor"),
                            insertSpaceAfterSemicolonInForStatements: n.get("insertSpaceAfterSemicolonInForStatements"),
                            insertSpaceBeforeAndAfterBinaryOperators: n.get("insertSpaceBeforeAndAfterBinaryOperators"),
                            insertSpaceAfterKeywordsInControlFlowStatements: n.get("insertSpaceAfterKeywordsInControlFlowStatements"),
                            insertSpaceAfterFunctionKeywordForAnonymousFunctions: n.get("insertSpaceAfterFunctionKeywordForAnonymousFunctions"),
                            insertSpaceBeforeFunctionParenthesis: n.get("insertSpaceBeforeFunctionParenthesis"),
                            insertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis: n.get("insertSpaceAfterOpeningAndBeforeClosingNonemptyParenthesis"),
                            insertSpaceAfterOpeningAndBeforeClosingNonemptyBrackets: n.get("insertSpaceAfterOpeningAndBeforeClosingNonemptyBrackets"),
                            insertSpaceAfterOpeningAndBeforeClosingNonemptyBraces: n.get("insertSpaceAfterOpeningAndBeforeClosingNonemptyBraces"),
                            insertSpaceAfterOpeningAndBeforeClosingEmptyBraces: n.get("insertSpaceAfterOpeningAndBeforeClosingEmptyBraces"),
                            insertSpaceAfterOpeningAndBeforeClosingTemplateStringBraces: n.get("insertSpaceAfterOpeningAndBeforeClosingTemplateStringBraces"),
                            insertSpaceAfterOpeningAndBeforeClosingJsxExpressionBraces: n.get("insertSpaceAfterOpeningAndBeforeClosingJsxExpressionBraces"),
                            insertSpaceAfterTypeAssertion: n.get("insertSpaceAfterTypeAssertion"),
                            placeOpenBraceOnNewLineForFunctions: n.get("placeOpenBraceOnNewLineForFunctions"),
                            placeOpenBraceOnNewLineForControlBlocks: n.get("placeOpenBraceOnNewLineForControlBlocks"),
                            semicolons: n.get("semicolons"),
                            indentSwitchCase: n.get("indentSwitchCase")
                        }
                    }
                    getPreferences(e) {
                        const t = c.workspace.getConfiguration((0, u.isTypeScriptDocument)(e) ? "typescript" : "javascript", e),
                            n = c.workspace.getConfiguration((0, u.isTypeScriptDocument)(e) ? "typescript.preferences" : "javascript.preferences", e);
                        return {
                            ...t.get("unstable"),
                            quotePreference: this.getQuoteStylePreference(n),
                            importModuleSpecifierPreference: w(n),
                            importModuleSpecifierEnding: _(n),
                            jsxAttributeCompletionStyle: S(n),
                            allowTextChangesInNewFiles: e.uri.scheme === l.file,
                            providePrefixAndSuffixTextForRename: !1 !== n.get("renameShorthandProperties", !0) && n.get("useAliasesForRenames", !0),
                            allowRenameOfImportPath: !0,
                            includeAutomaticOptionalChainCompletions: t.get("suggest.includeAutomaticOptionalChainCompletions", !0),
                            provideRefactorNotApplicableReason: !0,
                            generateReturnInDocTemplate: t.get("suggest.jsdoc.generateReturns", !0),
                            includeCompletionsForImportStatements: t.get("suggest.includeCompletionsForImportStatements", !0),
                            includeCompletionsWithSnippetText: !0,
                            includeCompletionsWithClassMemberSnippets: t.get("suggest.classMemberSnippets.enabled", !0),
                            includeCompletionsWithObjectLiteralMethodSnippets: t.get("suggest.objectLiteralMethodSnippets.enabled", !0),
                            autoImportFileExcludePatterns: this.getAutoImportFileExcludePatternsPreference(n, c.workspace.getWorkspaceFolder(e.uri)?.uri),
                            autoImportSpecifierExcludeRegexes: n.get("autoImportSpecifierExcludeRegexes"),
                            ...
                            ...y(t),
                            ...this.getOrganizeImportsPreferences(n)
                        }
                    }
                    ...
                    getOrganizeImportsPreferences(e) {
                        const t = e.get("organizeImports.unicodeCollation"),
                            n = e.get("organizeImports.caseSensitivity");
                        return {
                            organizeImportsTypeOrder: m(e.get("organizeImports.typeOrder", "auto"), "auto"),
                            organizeImportsIgnoreCase: "caseInsensitive" === n || "caseSensitive" !== n && "auto",
                            organizeImportsCollation: t,
                            ..."unicode" === t ? {
                                organizeImportsCaseFirst: "caseInsensitive" === n ? void 0 : m(e.get("organizeImports.caseFirst", !1), "default"),
                                organizeImportsAccentCollation: e.get("organizeImports.accentCollation"),
                                organizeImportsLocale: e.get("organizeImports.locale"),
                                organizeImportsNumericCollation: e.get("organizeImports.numericCollation")
                            } : {}
                        }
                    }
                }
                ...
                function y(e) {
                    return {
                        includeInlayParameterNameHints: b(e),
                        includeInlayParameterNameHintsWhenArgumentMatchesName: !e.get(v.parameterNamesSuppressWhenArgumentMatchesName, !0),
                        includeInlayFunctionParameterTypeHints: e.get(v.parameterNamesEnabled, !1),
                        includeInlayVariableTypeHints: e.get(v.variableTypesEnabled, !1),
                        includeInlayVariableTypeHintsWhenTypeMatchesName: !e.get(v.variableTypesSuppressWhenTypeMatchesName, !0),
                        includeInlayPropertyDeclarationTypeHints: e.get(v.propertyDeclarationTypesEnabled, !1),
                        includeInlayFunctionLikeReturnTypeHints: e.get(v.functionLikeReturnTypesEnabled, !1),
                        includeInlayEnumMemberValueHints: e.get(v.enumMemberValuesEnabled, !1)
                    }
                }
                ...
                t.InlayHintSettingNames = v, v.parameterNamesSuppressWhenArgumentMatchesName = "inlayHints.parameterNames.suppressWhenArgumentMatchesName", v.parameterNamesEnabled = "inlayHints.parameterTypes.enabled", v.variableTypesEnabled = "inlayHints.variableTypes.enabled", v.variableTypesSuppressWhenTypeMatchesName = "inlayHints.variableTypes.suppressWhenTypeMatchesName", v.propertyDeclarationTypesEnabled = "inlayHints.propertyDeclarationTypes.enabled", v.functionLikeReturnTypesEnabled = "inlayHints.functionLikeReturnTypes.enabled", v.enumMemberValuesEnabled = "inlayHints.enumMemberValues.enabled"
            },
            1119: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
                ...
                class h extends d.Disposable {
                    constructor(e, t, n) {
                        super(), this._client = e, this._activeTextEditorManager = n, this.openOpenConfigCommandId = "_typescript.openConfig", this.createOrOpenConfigCommandId = "_typescript.createOrOpenConfig", this._ready = !1, this._state = p.None, t.register({
                            ...
                            execute: async (...[e, t]) => {
                                await (0, l.openOrCreateConfig)(this._client.apiVersion, t, e, this._client.configuration)
                            }
                        }), n.onDidChangeActiveJsTsEditor(this.updateStatus, this, this._disposables), this._client.onReady(() => {
                            this._ready = !0, this.updateStatus()
                        })
                    }
                    dispose() {
                        super.dispose(), this._statusItem?.dispose()
                    }
                    async updateStatus() {
                        ...
                        if (this._state !== e) switch (this._state.type === p.Type.Pending && (this._state.cancellation.cancel(), this._state.cancellation.dispose()), this._state = e, this._state.type) {
                            ...
                            case p.Type.Resolved: {
                                ...
                                n.busy = !1, n.detail = void 0, n.severity = a.LanguageStatusSeverity.Information, (0, l.isImplicitProjectConfigFile)(this._state.configFile) ? (n.text = e, n.detail = void 0, n.command = {
                                    ...
                                    title: a.l10n.t("Open Config File"),
                                    arguments: [t, this._state.projectType]
                                });
                                break
                            }
                            case p.Type.SyntaxOnly: {
                                ...
                                e.severity = a.LanguageStatusSeverity.Warning, e.text = a.l10n.t("Partial mode"), e.detail = a.l10n.t("Project wide IntelliSense not available"), e.busy = !1, e.command = {
                                    ...
                                    command: "vscode.open",
                                    arguments: [a.Uri.parse("https://aka.ms/vscode/jsts/partial-mode")]
                                };
                                break
                            }
                        }
            ...
            1520: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    const e = ["**/[jt]sconfig.json", "**/[jt]sconfig.*.json"],
                        t = ["json", "jsonc"].map(t => e.map(e => ({
                            language: t,
                            pattern: e
                        }))).flat();
                    return l.Disposable.from(l.commands.registerCommand(f, async ({
                        resourceUri: e,
                        extendsValue: t,
                        linkType: n
                    }) => {
                ...
                var g;
                ! function(e) {
                    e[e.Extends = 0] = "Extends", e[e.References = 1] = "References"
                }(g || (g = {}));
                class m {
                    provideDocumentLinks(e, t) {
                        const n = a.parseTree(e.getText());
                        return n ? (0, d.coalesce)([this.getExtendsLink(e, n), ...this.getFilesLinks(e, n), ...this.getReferencesLinks(e, n)]) : []
                    }
                    getExtendsLink(e, t) {
                        const n = a.findNodeAtLocation(t, ["extends"]);
                    ...
                    isPathValue(e) {
                        return "string" === e?.type && e.value && !e.value.includes("*")
                    }
                    getFileTarget(e, t) {
                        return (0, c.isAbsolute)(t.value) ? l.Uri.file(t.value) : l.Uri.joinPath(u.Utils.dirname(e.uri), t.value)
                    }
                    getRange(e, t) {
                        const n = t.offset,
                            i = e.positionAt(n + 1),
            ...
            1627: function(e, t, n) {
                ...
                class g extends l.Disposable {
                    constructor(e, t) {
                        ...
                        }), this._register(a.workspace.onDidChangeTextDocument(e => {
                            "typescript" !== e.document.languageId && "typescriptreact" !== e.document.languageId || this._updateAllDiagnosticCodesAfterTimeout()
                        })), this._updateAllDiagnosticCodesAfterTimeout(), this._registerTelemetryEventEmitter()
                    }
                    logDiagnosticsPerformanceTelemetry(e) {
                        for (const t of e) this._telemetryReporter.logTelemetry("diagnostics.performance", {
                            syntaxDiagDuration: t.syntaxDiag,
                            semanticDiagDuration: t.semanticDiag,
                            suggestionDiagDuration: t.suggestionDiag,
                            regionSemanticDiagDuration: t.regionSemanticDiag,
                            fileLineCount: t.fileLineCount
                        })
                    }
                    _updateAllDiagnosticCodesAfterTimeout() {
                        clearTimeout(this._timeout), this._timeout = setTimeout(() => this._updateDiagnosticCodes(), 5e3)
                    }
                    _increaseDiagnosticCodeCount(e) {
                        void 0 !== e && this._diagnosticCodesMap.set(Number(e), (this._diagnosticCodesMap.get(Number(e)) || 0) + 1)
                    }
                    _updateDiagnosticCodes() {
                        this._diagnosticsCollection.forEach((e, t) => {
                            const n = this._diagnosticSnapshotsMap.get(e);
                            this._diagnosticSnapshotsMap.set(e, t), t.filter(e => !n?.some(t => (0, u.equals)(e, t))).forEach(e => {
                                const t = e.code;
                                this._increaseDiagnosticCodeCount("string" == typeof t || "number" == typeof t ? t : t?.value)
                            })
                        })
                    }
                        ...
                        this._telemetryEmitter = setInterval(() => {
                            if (this._diagnosticCodesMap.size > 0) {
                                ...
                                this._diagnosticCodesMap.forEach((t, n) => {
                                    e += `${n}:${t},`
                                }), this._diagnosticCodesMap.clear(), this._telemetryReporter.logTelemetry("typescript.diagnostics", {
                                    diagnosticCodes: e
                                })
                            }
                        }, 3e5)
                ...
                class m extends l.Disposable {
                    ...
                    logDiagnosticsPerformanceTelemetry(e) {
                        this._diagnosticsTelemetryManager?.logDiagnosticsPerformanceTelemetry(e)
                    }
                    scheduleDiagnosticsUpdate(e) {
                        this._pendingUpdates.has(e) || this._pendingUpdates.set(e, setTimeout(() => this.updateCurrentDiagnostics(e), this._updateDelay))
                    }
                    updateCurrentDiagnostics(e) {
                        this._pendingUpdates.has(e) && (clearTimeout(this._pendingUpdates.get(e)), this._pendingUpdates.delete(e));
                        const t = this._diagnostics.get(e);
                        this._currentDiagnostics.set(e, t ? t.getAllDiagnostics(this._settings) : [])
                    }
                    rebuildAll() {
            ...
            1668: (e, t, n) => {
                ...
                t.TypeScriptGoToProjectConfigCommand = class {
                    ...
                    constructor(e, t) {
                        this.activeJsTsEditorTracker = e, this.lazyClientHost = t, this.id = "javascript.goToProjectConfig"
                    }
                    execute() {
                        const e = this.activeJsTsEditorTracker.activeJsTsEditor;
            ...
            1860: function(e, t, n) {
                ...
                class w {
                    constructor(e, t) {
                        this.args = e, this.scriptKind = t, this.type = 0
                    }
                }
                class _ {
                    constructor(e, t) {
                        this.args = e, this.scriptKind = t, this.type = 1
                    }
                }
                class S {
                    constructor(e) {
                ...
                class P {
                    constructor(e, t, n) {
                        this.client = e, this._pending = new v.ResourceMap(t, {
                            onCaseInsensitiveFileSystem: n
                        })
                    }
                    open(e, t) {
                        this.updatePending(e, new _(t, t.scriptKindName))
                    }
                    close(e, t, n) {
                        return this.updatePending(e, new w(t, n))
                    }
                    change(e, t, n) {
                        n.length && this.updatePending(e, new S({
                            fileName: t,
                            textChanges: n.map(e => ({
                                newText: e.text,
                                start: u.Position.toLocation(e.range.start),
                                end: u.Position.toLocation(e.range.end)
                            })).reverse()
                        }))
                    }
                    reset() {
                    ...
                    updatePending(e, t) {
                        switch (t.type) {
                            case 0: {
                                ...
                                if (1 === n?.type && n.scriptKind === t.scriptKind) return this._pending.delete(e), !1;
                                break
                            }
                        }
                        return this._pending.has(e) && this.flush(), this._pending.set(e, t), !0
                    }
                }
                class C {
                    constructor(e, t, n, i) {
                    ...
                    open() {
                        const e = {
                            ...
                            t = b(this.document.languageId);
                        t && (e.scriptKindName = t);
                        const n = this.client.pluginManager.plugins.filter(e => e.languages.indexOf(this.document.languageId) >= 0);
                        n.length && (e.plugins = n.map(e => e.name)), this.synchronizer.open(this.resource, e), this.state = 1
                    }
                    getProjectRootPath(e) {
                        let t = this.client.getWorkspaceRootForResource(e);
                        if (!t && a.workspace.workspaceFolders)
                            for (const n of Array.from(a.workspace.workspaceFolders).sort((e, t) => e.uri.path.length - t.uri.path.length))
                                if (n.uri.scheme === e.scheme && n.uri.authority === e.authority) {
                                    t = n.uri;
                                    break
                                } if (t) {
                            const e = this.client.toTsFilePath(t);
                    ...
                    close() {
                        return 1 !== this.state ? (this.state = 2, !1) : (this.state = 2, this.synchronizer.close(this.resource, this.filepath, b(this.document.languageId)))
                    }
                    onContentChanged(e) {
                        1 !== this.state && console.error(`Unexpected buffer state: ${this.state}`), this.synchronizer.change(this.resource, this.filepath, e)
                    }
                }
                class O extends v.ResourceMap {
                    getForPath(e) {
                        return this.get(a.Uri.file(e))
                    }
                    get allBuffers() {
                        return this.values()
                    }
                }
                class T extends v.ResourceMap {
                    getOrderedFileSet() {
                        const e = Array.from(this.entries()).sort((e, t) => e.value - t.value).map(e => e.resource),
                            t = new v.ResourceMap(this._normalizePath, this.config);
                ...
                class x {
                    ...
                    constructor(e, t, n) {
                        ...
                        } else this._done = !0, (0, f.setImmediate)(n)
                    }
                    isErrorReportingEnabled() {
                        return !!this.client.apiVersion.gte(y.API.v440) || this.client.capabilities.has(d.ClientCapability.Semantic)
                    }
                    areProjectDiagnosticsEnabled() {
                        return this.client.configuration.enableProjectDiagnostics && this.client.capabilities.has(d.ClientCapability.Semantic)
                    }
                    areRegionDiagnosticsEnabled() {
                        return this.client.configuration.enableRegionDiagnostics && this.client.apiVersion.gte(y.API.v560)
                    }
                    cancel() {
                        this._done || this._token.cancel(), this._token.dispose()
                    }
                }
                class j extends m.Disposable {
                    constructor(e, t) {
                        super(), this._onDidChange = this._register(new a.EventEmitter), this.onDidChange = this._onDidChange.event, this._tabResources = new v.ResourceMap(e, t);
                        for (const e of a.window.tabGroups.all)
                            for (const t of e.tabs) this.add(t);
                        this._register(a.window.tabGroups.onDidChangeTabs(e => {
                            const t = e.closed.flatMap(e => this.delete(e)),
                                n = e.opened.flatMap(e => this.add(e));
                            (t.length || n.length) && this._onDidChange.fire({
                                closed: t,
                                opened: n
                            })
                        }))
                    ...
                    has(e) {
                        if (e.scheme === c.vscodeNotebookCell) {
                            const t = a.workspace.notebookDocuments.find(t => t.getCells().some(t => t.document.uri.toString() === e.toString()));
                            return !!t && this.has(t.uri)
                        }
                        const t = this._tabResources.get(e);
                        return !!t && t.tabs.size > 0
                    }
                    add(e) {
                        const t = [];
                    ...
                    getResourcesForTab(e) {
                        return e.input instanceof a.TabInputText ? [e.input.uri] : e.input instanceof a.TabInputTextDiff ? [e.input.original, e.input.modified] : e.input instanceof a.TabInputNotebook ? [e.input.uri] : []
                    }
                }
                class E extends m.Disposable {
                    constructor(e, t, n) {
                        ...
                        this.syncedBuffers = new O(i, {
                            ...
                            if (!this.client.configuration.enableProjectDiagnostics) {
                                for (const t of e.closed) this.syncedBuffers.get(t) && (this.pendingDiagnostics.delete(t), this.pendingGetErr?.files.delete(t));
                                for (const t of e.opened) {
                                    const e = this.syncedBuffers.get(t);
                                    e && this.requestDiagnostic(e)
                                }
                            }
                        })), this.updateConfiguration(), a.workspace.onDidChangeConfiguration(this.updateConfiguration, this, this._disposables)
                    }
                    listen() {
                        ...
                        }, this, this._disposables), a.workspace.textDocuments.forEach(this.openTextDocument, this))
                    }
                    handles(e) {
                    ...
                    ensureHasBuffer(e) {
                        ...
                        const t = a.workspace.textDocuments.find(t => t.uri.toString() === e.toString());
                        return !!t && this.openTextDocument(t)
                    }
                    toVsCodeResource(e) {
                        const t = this.client.toTsFilePath(e);
                    ...
                    toResource(e) {
                        ...
                        return t ? t.resource : a.Uri.file(e)
                    }
                    reset() {
                        this.pendingGetErr?.cancel(), this.pendingDiagnostics.clear(), this.synchronizer.reset()
                    }
                    reinitialize() {
                        this.reset();
                    ...
                    closeResource(e) {
                        ...
                        if (!t) return;
                        this.pendingDiagnostics.delete(e), this.pendingGetErr?.files.delete(e), this.syncedBuffers.delete(e);
                        const n = t.close();
                        this._onDelete.fire(e), n && this.requestAllDiagnostics()
                    }
                    interruptGetErr(e) {
                        if (!this.pendingGetErr || this.client.configuration.enableProjectDiagnostics) return e();
                    ...
                    lineCount(e) {
                        return this.syncedBuffers.get(e)?.lineCount
                    }
                    ...
                    onDidChangeTextDocument(e) {
                        ...
                        t && (this._onWillChange.fire(t.resource), t.onContentChanged(e.contentChanges), !this.requestDiagnostic(t) && this.pendingGetErr && (this.pendingGetErr.cancel(), this.pendingGetErr = void 0, this.triggerDiagnostics()))
                    }
                    requestAllDiagnostics() {
                        for (const e of this.syncedBuffers.allBuffers) this.shouldValidate(e) && this.pendingDiagnostics.set(e.resource, Date.now());
                    ...
                    sendPendingDiagnostics() {
                        ...
                        if (this.pendingGetErr) {
                            ...
                            for (const {
                                ...
                                of this.pendingGetErr.files.entries()) this.syncedBuffers.get(t) && e.set(t, void 0);
                            this.pendingGetErr = void 0
                        }
                        for (const t of this.syncedBuffers.values()) {
                            const n = a.window.visibleTextEditors.filter(e => e.document.uri.toString() === t.resource.toString()).flatMap(e => e.visibleRanges);
                            e.set(t.resource, n.length ? n : void 0)
                        }
                        for (const {
                                resource: t
                            }
                            of e.entries()) {
                            const n = this.syncedBuffers.get(t);
                            n && !this.shouldValidate(n) && e.delete(t)
                        }
                        if (e.size) {
                            const t = this.pendingGetErr = x.executeGetErrRequest(this.client, e, () => {
                    ...
                    updateConfiguration() {
                        const e = a.workspace.getConfiguration("javascript", null),
                            t = a.workspace.getConfiguration("typescript", null);
                        this._validateJavaScript = e.get("validate.enable", !0), this._validateTypeScript = t.get("validate.enable", !0)
                    }
                    shouldValidate(e) {
                        if (c.isOfScheme(e.resource, c.chatCodeBlock)) return !1;
                        if (!this.client.configuration.enableProjectDiagnostics && !this._tabResources.has(e.resource)) return !1;
                        switch (e.languageId) {
                            case l.javascript:
                            case l.javascriptreact:
            ...
            1910: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    return a.languages.registerDocumentSymbolProvider(e.syntax, new d(t, n), {
                        label: "TypeScript"
                    })
                };
                const a = o(n(1398)),
                    ...
                    static convertSymbol(e, t) {
                        ...
                        const r = new a.DocumentSymbol(i, "", (e => {
                            switch (e) {
                                ...
                                case l.Kind.interface:
                                    return a.SymbolKind.Interface;
                                case l.Kind.method:
                                    return a.SymbolKind.Method;
                                case l.Kind.memberVariable:
                                case l.Kind.memberGetAccessor:
                                case l.Kind.memberSetAccessor:
                                    return a.SymbolKind.Property;
                                case l.Kind.variable:
                                case l.Kind.const:
                                case l.Kind.localVariable:
                                    return a.SymbolKind.Variable;
                                case l.Kind.function:
                                case l.Kind.localFunction:
                                    return a.SymbolKind.Function;
                                case l.Kind.constructSignature:
                                case l.Kind.constructorImplementation:
                                    return a.SymbolKind.Constructor
                            }
                            return a.SymbolKind.Variable
            ...
            2071: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    return l.tasks.registerTaskProvider("typescript", new b(e))
                };
                const a = o(n(5887)),
                    c = o(n(6928)),
                    l = o(n(1398)),
                ...
                class b extends h.Disposable {
                    ...
                    async resolveTask(e) {
                        ...
                        if (/\\tsconfig.*\.json/.test(t.tsconfig)) return void l.window.showWarningMessage(l.l10n.t('TypeScript Task in tasks.json contains "\\\\". TypeScript tasks tsconfig must use "/"'));
                        const n = t.tsconfig;
                        if (!n) return;
                    ...
                    async getTsConfigForActiveFile(e) {
                        ...
                        if (t && (0, g.isTsConfigFileName)(t.document.fileName)) {
                            const e = t.document.uri;
                            return [{
                                uri: e,
                                fsPath: e.fsPath,
                                posixPath: e.path,
                                workspaceFolder: l.workspace.getWorkspaceFolder(e)
                            }]
                        }
                    ...
                    async getTsConfigsInWorkspace(e) {
                        const t = new l.CancellationTokenSource;
                        return e.onCancellationRequested(() => t.cancel()), Promise.race([this.tsconfigProvider.getConfigsForWorkspace(t.token).then(e => Array.from(e)), (0, u.wait)(this.findConfigFilesTimeout).then(() => (t.cancel(), []))])
                    }
                    static async getCommand(e) {
                        if (e.workspaceFolder) {
                            const t = await b.getLocalTscAtPath(c.dirname(e.fsPath));
                            if (t) return t;
                            const n = await b.getLocalTscAtPath(e.workspaceFolder.uri.fsPath);
                            if (n) return n
                        }
                        return "tsc"
                    }
                    static async getLocalTscAtPath(e) {
                        const t = process.platform,
                            n = c.join(e, "node_modules", ".bin");
                        return "win32" === t && await (0, f.exists)(l.Uri.file(c.join(n, "tsc.cmd"))) ? c.join(n, "tsc.cmd") : "linux" !== t && "darwin" !== t || !await (0, f.exists)(l.Uri.file(c.join(n, "tsc"))) ? void 0 : c.join(n, "tsc")
                    }
                    ...
                    getLabelForTasks(e) {
                        if (e.workspaceFolder) {
                            const t = l.Uri.file(c.normalize(e.workspaceFolder.uri.fsPath));
                            return c.posix.relative(t.path, e.posixPath)
                        }
                        return e.posixPath
                    }
                    onConfigurationChanged() {
                        const e = l.workspace.getConfiguration("typescript.tsc").get("autoDetect");
                        this.autoDetect = void 0 === e ? y.on : e
                    }
                }
            },
            2111: (e, t, n) => {
            ...
            2144: function(e, t, n) {
                ...
                ! function(e) {
                    e.fromTextSpan = t => e.fromLocations(t.start, t.end), e.toTextSpan = e => ({
                        ...
                        end: u.toLocation(e.end)
                    }), e.fromLocations = (e, t) => new a.Range(Math.max(0, e.line - 1), Math.max(e.offset - 1, 0), Math.max(0, t.line - 1), Math.max(0, t.offset - 1)), e.toFileRange = e => ({
                        startLine: e.start.line + 1,
                        startOffset: e.start.character + 1,
                        endLine: e.end.line + 1,
                        endOffset: e.end.character + 1
                    }), e.toFileRangeRequestArgs = (t, n) => ({
                        file: t,
                        ...e.toFileRange(n)
                    }), e.toFileRangesRequestArgs = (t, n) => ({
                        file: t,
                        ranges: n.map(e.toFileRange)
                ...
                function(e) {
                    e.fromLocation = e => new a.Position(e.line - 1, e.offset - 1), e.toLocation = e => ({
                        line: e.line + 1,
                ...
                function(e) {
                    e.fromTextSpan = (e, t) => new a.Location(e, l.fromTextSpan(t))
                }(d || (t.Location = d = {})),
                function(e) {
                ...
                function(e) {
                    e.fromProtocolScriptElementKind = function(e) {
                        switch (e) {
                            ...
                            case c.Kind.enum:
                                return a.SymbolKind.Enum;
                            case c.Kind.enumMember:
                                return a.SymbolKind.EnumMember;
                            case c.Kind.interface:
                                return a.SymbolKind.Interface;
                            case c.Kind.indexSignature:
                            case c.Kind.callSignature:
                            case c.Kind.method:
                                return a.SymbolKind.Method;
                            ...
                            case c.Kind.constructorImplementation:
                                return a.SymbolKind.Constructor;
                            case c.Kind.typeParameter:
                                return a.SymbolKind.TypeParameter;
                            case c.Kind.string:
                                return a.SymbolKind.String;
                            default:
                                return a.SymbolKind.Variable
                        }
                    }
                ...
                function(e) {
                    e.toProtocolCompletionTriggerKind = function(e) {
                        switch (e) {
                            case a.CompletionTriggerKind.Invoke:
                                return 1;
                ...
                }(g || (t.CompletionTriggerKind = g = {})),
                function(e) {
                    e.toProtocolOrganizeImportsMode = function(e) {
                        switch (e) {
                            case c.OrganizeImportsMode.All:
                                return "All";
                            case c.OrganizeImportsMode.SortAndCombine:
                                return "SortAndCombine";
                            case c.OrganizeImportsMode.RemoveUnused:
                                return "RemoveUnused"
                        }
                    }
                }(m || (t.OrganizeImportsMode = m = {}))
            },
            2174: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
            ...
            2205: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.RestartTsServerCommand = void 0, t.RestartTsServerCommand = class {
                    constructor(e) {
                        ...
                        function(e, t, n) {
                            ...
                            return i ? ("ENOENT" === i.code && (i.message = "No matching pid found"), n(i, null)) : i ? n(i) : void h(r, function(i, l) {
                                ...
                                const g = {
                                        ...
                                        stime: 1e3 * parseFloat(u[12]) / c.clockTick,
                                        cutime: 1e3 * parseFloat(u[13]) / c.clockTick,
                                        cstime: 1e3 * parseFloat(u[14]) / c.clockTick,
            ...
            2236: function(e, t, n) {
                ...
                class f extends p.BaseServiceConfigurationProvider {
                    fixPathPrefixes(e) {
                        const t = ["~" + c.sep];
                        for (const n of t)
                            if (e.startsWith(n)) return c.join(a.homedir(), e.slice(n.length));
                        return e
                    }
                    readGlobalTsdk(e) {
                        const t = e.inspect("typescript.tsdk");
                        return t && "string" == typeof t.globalValue ? this.fixPathPrefixes(t.globalValue) : null
                    }
                    readLocalTsdk(e) {
                        const t = e.inspect("typescript.tsdk");
                        return t && "string" == typeof t.workspaceValue ? this.fixPathPrefixes(t.workspaceValue) : null
                    }
                    readLocalNodePath(e) {
                    ...
                    findNodePath() {
                        try {
                            return u.execFileSync("node", ["-e", "console.log(process.execPath)"], {
                                windowsHide: !0,
                                timeout: 2e3,
                                cwd: l.workspace.workspaceFolders?.[0].uri.fsPath,
                                encoding: "utf-8"
                            }).trim()
                        } catch (e) {
                            return l.window.showWarningMessage(l.l10n.t("Could not detect a Node installation to run TS Server.")), null
                        }
                    }
                    validatePath(e) {
                        return !e || d.existsSync(e) && !d.lstatSync(e).isDirectory() ? e : (l.window.showWarningMessage(l.l10n.t("The path {0} doesn't point to a valid Node installation to run TS Server. Falling back to bundled Node.", e)), null)
                    }
                }
                t.ElectronServiceConfigurationProvider = f
            },
            2287: (e, t) => {
                "use strict";
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.Throttler = t.Delayer = void 0, t.setImmediate = function(e, ...t) {
                    if (global.setImmediate) {
                        const n = global.setImmediate(e, ...t);
                        return {
                            dispose: () => global.clearImmediate(n)
                        }
                    } {
                    ...
                    trigger(e, t = this.defaultDelay) {
                        ...
                        })), (t >= 0 || null === this.timeout) && (this.timeout = setTimeout(() => {
            ...
            2290: function(e, t, n) {
                ...
                class l extends c.Disposable {
                    ...
                    trace(e, t, n) {
                        this.logger[this.forceLogging ? "info" : "trace"](`<${e}> ${t}`, ...n ? [JSON.stringify(n, null, 4)] : [])
                    }
                }
                t.default = l
            },
            ...
            2361: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    return a.languages.registerWorkspaceSymbolProvider(new g(e, t))
                };
                const a = o(n(1398)),
                    c = o(n(746)),
                    l = n(4760),
                ...
                class g {
                    ...
                    async toOpenedFiledPath(e) {
                        if (e.uri.scheme === c.git) try {
                            const t = a.Uri.file(JSON.parse(e.uri.query)?.path);
                            if ((0, l.doesResourceLookLikeATypeScriptFile)(t) || (0, l.doesResourceLookLikeAJavaScriptFile)(t)) {
                                const e = await a.workspace.openTextDocument(t);
                    ...
                    getDocument() {
                        const e = a.window.activeTextEditor?.document;
                        if (e && this.modeIds.includes(e.languageId)) return e;
                        const t = a.workspace.textDocuments;
                        for (const e of t)
            ...
            2435: function(e, t, n) {
                ...
                class u {
                    get output() {
                        return c.window.createOutputChannel("TypeScript", {
                            log: !0
                        })
                    }
                    get logLevel() {
                    ...
                    info(e, ...t) {
                        this.output.info(e, ...t)
                    }
                    trace(e, ...t) {
                        this.output.trace(e, ...t)
                    }
                    error(e, t) {
                        "No content available." !== t?.message && this.output.error(e, ...t ? [t] : [])
                    }
                }
                t.Logger = u, o([l.memoize], u.prototype, "output", null)
            },
            2447: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    function n() {
                        a.commands.executeCommand("setContext", d.context, e.apiVersion.gte(d.minVersion))
                    }
                    return n(), t.register(new d(e)), e.onTsServerStarted(() => n())
                };
                const a = o(n(1398)),
                    c = n(3256),
                    l = n(2928),
                ...
                class d {
                    ...
                    async execute(e) {
                        if (this.client.apiVersion.lt(d.minVersion)) return void a.window.showErrorMessage(a.l10n.t("Find file references failed. Requires TypeScript 4.2+."));
                        if (e ?? (e = a.window.activeTextEditor?.document.uri), !e) return void a.window.showErrorMessage(a.l10n.t("Find file references failed. No resource provided."));
                        const t = await a.workspace.openTextDocument(e);
                        if (!(0, c.isSupportedLanguageMode)(t)) return void a.window.showErrorMessage(a.l10n.t("Find file references failed. Unsupported file type."));
                        ...
                        n ? await a.window.withProgress({
                            ...
                            try {
                                await a.commands.executeCommand("editor.action.showReferences", e, new a.Position(0, 0), s)
                            } finally {
                                await o.update("preferredLocation", c?.workspaceFolderValue ?? c?.workspaceValue)
                            }
                        }) : a.window.showErrorMessage(a.l10n.t("Find file references failed. Unknown file type."))
                    }
                }
            ...
            2634: function(e, t, n) {
                ...
                class p {
                    ...
                    getActiveParameter(e) {
                        ...
                        return t?.isVariadic ? Math.min(e.argumentIndex, t.parameters.length - 1) : e.argumentIndex
                    }
            ...
            2646: function(e, t, n) {
                ...
                class f extends h.TypeScriptBaseCodeLensProvider {
                    ...
                    extractSymbol(e, t, n) {
                        ...
                        switch (t.kind) {
                            ...
                            case c.Kind.constructorImplementation:
                            case c.Kind.memberVariable:
                                if (n && u.Position.fromLocation(n.spans[0].start).isEqual(u.Position.fromLocation(t.spans[0].start))) return;
                                switch (n?.kind) {
                                    case c.Kind.class:
                                    case c.Kind.interface:
                                    case c.Kind.type:
                ...
                t.TypeScriptReferencesCodeLensProvider = f
            },
            2693: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.LogLevelMonitor = void 0;
                const a = o(n(1398)),
                    c = n(4906),
                    l = n(5602);
                class u extends l.Disposable {
                    constructor(e) {
                        super(), this.context = e, this._register(a.workspace.onDidChangeConfiguration(this.onConfigurationChange, this, this._disposables)), this.shouldNotifyExtendedLogging() && this.notifyExtendedLogging()
                    }
                    onConfigurationChange(e) {
                        e.affectsConfiguration(u.logLevelConfigKey) && this.context.globalState.update(u.logLevelChangedStorageKey, new Date)
                    }
                    get logLevel() {
                        return c.TsServerLogLevel.fromString(a.workspace.getConfiguration().get(u.logLevelConfigKey, "off"))
                    }
                    get lastLogLevelChange() {
                        const e = this.context.globalState.get(u.logLevelChangedStorageKey);
                        if (e) {
                            const t = new Date(e);
                    ...
                    get doNotPrompt() {
                        return this.context.globalState.get(u.doNotPromptLogLevelStorageKey) || !1
                    }
                    shouldNotifyExtendedLogging() {
                        const e = this.lastLogLevelChange ? new Date(this.lastLogLevelChange).valueOf() : 0,
                            t = new Date(e + 6048e5);
                        return !this.doNotPrompt && this.logLevel !== c.TsServerLogLevel.Off && t.valueOf() < Date.now()
                    }
                    notifyExtendedLogging() {
                        a.window.showInformationMessage(a.l10n.t("TS Server logging is currently enabled which may impact performance."), {
                            title: a.l10n.t("Disable logging"),
                            choice: 0
                        }, {
                            title: a.l10n.t("Don't show again"),
                            choice: 1
                        }).then(e => {
                            if (e) return 0 === e.choice ? a.workspace.getConfiguration().update(u.logLevelConfigKey, "off", !0) : 1 === e.choice ? this.context.globalState.update(u.doNotPromptLogLevelStorageKey, !0) : void 0
                        })
                    }
                }
                t.LogLevelMonitor = u, u.logLevelConfigKey = "typescript.tsserver.log", u.logLevelChangedStorageKey = "typescript.tsserver.logLevelChanged", u.doNotPromptLogLevelStorageKey = "typescript.tsserver.doNotPromptLogLevel"
            },
            2792: e => {
                e.exports = function(e, t, n) {
                    let i;
            ...
            2928: function(e, t, n) {
                ...
                class l {
                    ...
                    static fromVersionString(e) {
                        let t = a.valid(e);
                        if (!t) return new l(c.l10n.t("invalid version"), "1.0.0", "1.0.0");
                        const n = e.indexOf("-");
                        return n >= 0 && (t = t.substr(0, n)), new l(e, t, e)
                    }
                    constructor(e, t, n) {
                        this.displayName = e, this.version = t, this.fullVersionString = n
                    }
                    eq(e) {
                        return a.eq(this.version, e.version)
                    }
                    gte(e) {
                        return a.gte(this.version, e.version)
                    }
                    lt(e) {
                        return !this.gte(e)
                    }
            ...
            3214: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.onCaseInsensitiveFileSystem = void 0;
                const a = o(n(9896)),
                    c = n(4921);
                t.onCaseInsensitiveFileSystem = (() => {
                    let e;
                    return () => {
                        if (void 0 === e)
                            ...
                            const t = (0, c.getTempFile)("typescript-case-check");
                            a.writeFileSync(t, ""), e = a.existsSync(t.toUpperCase())
                        }
                        return e
                    }
                })()
            ...
            3256: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.jsTsLanguageModes = t.jsxTags = t.javascriptreact = t.javascript = t.typescriptreact = t.typescript = void 0, t.isSupportedLanguageMode = function(e) {
                    return a.languages.match([t.typescript, t.typescriptreact, t.javascript, t.javascriptreact], e) > 0
                }, t.isTypeScriptDocument = function(e) {
                    return a.languages.match([t.typescript, t.typescriptreact], e) > 0
                };
                const a = o(n(1398));
                t.typescript = "typescript", t.typescriptreact = "typescriptreact", t.javascript = "javascript", t.javascriptreact = "javascriptreact", t.jsxTags = "jsx-tags", t.jsTsLanguageModes = [t.javascript, t.javascriptreact, t.typescript, t.typescriptreact]
            },
            3289: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
                ...
                class f extends p.default {
                    async provideDefinition(e, t, n) {
                        ...
                        return a.map(e => {
                            const t = u.Location.fromTextSpan(this.client.toResource(e.file), e);
                            return e.contextStart && e.contextEnd ? {
                                originSelectionRange: o,
                                targetRange: u.Range.fromLocations(e.contextStart, e.contextEnd),
                                targetUri: t.uri,
            ...
            3347: function(e, t, n) {
                ...
                class h {
                    ...
                    constructor(e, t, n) {
                        this.resource = e, this.ranges = t, this.copyOperation = n
                    }
                }
                class f extends a.DocumentPasteEdit {
                ...
                class g extends f {
                    constructor(e, t) {
                        super(), this.operation = t, this.insertText = e
                    }
                }
                const m = "updateImportsOnPaste.enabled";
                class v {
                    constructor(e, t, n) {
                    ...
                    async provideDocumentPasteEdits(e, t, n, i, r) {
                        ...
                        if (c) {
                            const e = c.ranges.map(l.Range.toTextSpan),
                                t = this._client.toTsFilePath(c.resource);
                            t && (u = {
                                file: t,
                                spans: e
                            })
                    ...
                    async resolveDocumentPasteEdit(e, t) {
                        ...
                        const n = await e.operation;
                        return g.tryCreateFromResponse(this._client, n) ?? e
                    }
                ...
                v.kind = a.DocumentDropOrPasteEditKind.TextUpdateImports.append("jsts"), v.metadataMimeType = "application/vnd.code.jsts.metadata"
            },
            3351: (e, t) => {
                "use strict";
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.ConfigurePluginCommand = void 0, t.ConfigurePluginCommand = class {
                    constructor(e) {
            ...
            3390: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    return a.languages.registerFoldingRangeProvider(e.syntax, new u(t))
                };
                const a = o(n(1398)),
                    c = o(n(2144)),
                    l = n(3489);
                class u {
                    ...
                    adjustFoldingEnd(e, t) {
                        if (e.end.character > 0) {
                            const n = t.getText(new a.Range(e.end.translate(0, -1), e.end));
                            if (u.foldEndPairCharacters.includes(n)) return Math.max(e.end.line - 1, e.start.line)
                        }
                        return e.end.line
                    }
            ...
            3433: function(e, t, n) {
                ...
                class l {
                    constructor(e, t) {
                        this._serverId = e, this._tracer = t, this.cancellationPipeName = (0, c.getTempFile)("tscancellation")
                    }
                    tryCancelOngoingRequest(e) {
                        if (!this.cancellationPipeName) return !1;
                        this._tracer.trace(this._serverId, `TypeScript Server: trying to cancel ongoing request with sequence number ${e}`);
                        try {
                            a.writeFileSync(this.cancellationPipeName + e, "")
                        } catch {}
                        return !0
                    }
                }
                t.NodeRequestCanceller = l, t.nodeRequestCancellerFactory = new class {
                    create(e, t) {
                        return new l(e, t)
                    }
                }
            ...
            3606: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.ElectronServiceProcessFactory = void 0;
                const a = o(n(5317)),
                    c = o(n(9896)),
                    l = o(n(6928)),
                    u = o(n(1398)),
                    ...
                    onLengthData(e) {
                        if (!this.isDisposed) try {
                            for (this.buffer.append(e);;) {
                                if (-1 === this.nextMessageLength && (this.nextMessageLength = this.buffer.tryReadContentLength(), -1 === this.nextMessageLength)) return;
            ...
            3651: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.CachedResponse = void 0, t.CachedResponse = class {
                    constructor() {
                        this.version = -1, this.document = ""
                    }
                    execute(e, t) {
                        return this.response && this.matches(e) ? this.response = this.response.then(e => "cancelled" === e.type ? t() : e) : this.reset(e, t)
                    }
                    matches(e) {
                        return this.version === e.version && this.document === e.uri.toString()
                    }
                    async reset(e, t) {
                        return this.version = e.version, this.document = e.uri.toString(), this.response = t()
                    }
                }
            },
            3680: function(e, t, n) {
                ...
                class p {
                    ...
                    getNewLogDirectory(e) {
                        const t = this.logDirectory();
                        if (t) try {
                            return u.Uri.file(c.mkdtempSync(l.join(t, `tsserver-${e}-log-`)))
                        } catch (e) {
                            return
                        }
                    }
                    logDirectory() {
                        try {
                            ...
                            return c.existsSync(e) || c.mkdirSync(e), this.context.logPath
                        } catch {
                            return
                        }
                    }
            ...
            3724: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    const n = new l(t);
                    return a.Disposable.from(a.languages.registerDocumentHighlightProvider(e.syntax, n), a.languages.registerMultiDocumentHighlightProvider(e.syntax, n))
                };
                const a = o(n(1398)),
                    c = o(n(2144));
                class l {
                ...
                function u(e) {
                    return e.highlightSpans.map(e => new a.DocumentHighlight(c.Range.fromTextSpan(e), "writtenReference" === e.kind ? a.DocumentHighlightKind.Write : a.DocumentHighlightKind.Read))
                }
            },
            3753: function(e, t, n) {
                "use strict";
                ...
                const a = o(n(1398)),
                    c = o(n(2144)),
                    l = new a.SnippetString("/**\n * $0\n */");
                class u extends a.CompletionItem {
                    constructor(e, t) {
                ...
                class d {
                    constructor(e, t, n) {
                        this.client = e, this.language = t, this.fileConfigurationManager = n
                    }
            ...
            3952: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.OpenTsServerLogCommand = void 0, t.OpenTsServerLogCommand = class {
                    constructor(e) {
            ...
            4029: function(e, t, n) {
                ...
                async function h(e, t, n, i, r, s) {
                    for (const o of r)
                        for (const {
                            ...
                            const l = c.body?.find(e => e.fixName === a);
                            if (!l) continue;
                            if (!l.fixId) return void u.WorkspaceEdit.withFileCodeEdits(t, n, l.changes);
                            const d = {
                                    scope: {
                                        type: "file",
                                        args: {
                        ...
                        this.edit = new a.WorkspaceEdit, await async function(e, t, n, i, r, s) {
                            for (const o of r)
                                for (const {
                                    ...
                                    const l = c.body?.find(e => e.fixName === a);
                                    if (l) {
                                        u.WorkspaceEdit.withFileCodeEdits(t, n, l.changes);
                                        break
                                    }
                                }
                        }([{
                            codes: c.incorrectlyImplementsInterface,
                            fixName: l.classIncorrectlyImplementsInterface
                        }, {
                ...
                class y {
                    constructor(e, t, n) {
                        this.client = e, this.fileConfigurationManager = t, this.diagnosticsManager = n
                    }
                    get metadata() {
                        return {
            ...
            4496: function(e, t, n) {
                ...
                ! function(e) {
                    e.equals = function(e, t) {
                        return e.uri.toString() === t.uri.toString() && e.name === t.name && e.enableForWorkspaceTypeScriptVersions === t.enableForWorkspaceTypeScriptVersions && c.equals(e.languages, t.languages)
                    }
                }(u || (u = {}));
                class d extends l.Disposable {
                    constructor() {
                        super(), this._pluginConfigurations = new Map, this._onDidUpdatePlugins = this._register(new a.EventEmitter), this.onDidChangePlugins = this._onDidUpdatePlugins.event, this._onDidUpdateConfig = this._register(new a.EventEmitter), this.onDidUpdateConfig = this._onDidUpdateConfig.event, a.extensions.onDidChange(() => {
                            if (!this._plugins) return;
                            const e = this.readPlugins();
                            c.equals(Array.from(this._plugins.values()).flat(), Array.from(e.values()).flat(), u.equals) || (this._plugins = e, this._onDidUpdatePlugins.fire(this))
                        }, void 0, this._disposables)
                    }
                    get plugins() {
                        return this._plugins ?? (this._plugins = this.readPlugins()), Array.from(this._plugins.values()).flat()
                    }
                    setConfiguration(e, t) {
                        this._pluginConfigurations.set(e, t), this._onDidUpdateConfig.fire({
                            pluginId: e,
                            config: t
                        })
                    }
            ...
            4514: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    function(e) {
                        e[e.Normal = 1] = "Normal", e[e.LowPriority = 2] = "LowPriority", e[e.Fence = 3] = "Fence"
                    }(n || (t.RequestQueueingType = n = {})), t.RequestQueue = class {
                        constructor() {
                        ...
                        enqueue(e) {
                            if (e.queueingType === n.Normal) {
                                let t = this.queue.length - 1;
                                for (; t >= 0 && this.queue[t].queueingType === n.LowPriority;) --t;
                        ...
                        tryDeletePendingRequest(e) {
                            for (let t = 0; t < this.queue.length; t++)
                                if (this.queue[t].request.seq === e) return this.queue.splice(t, 1), !0;
                            return !1
                        }
                        createRequest(e, t) {
                            return {
            ...
            4640: function(e, t, n) {
                ...
                t.EditorChatFollowUp = u, u.ID = "_typescript.quickFix.editorChatReplacement2";
                class d {
                    constructor() {
                        this.id = d.ID
                    }
                    async execute(...e) {
                        for (const t of e) await a.commands.executeCommand(t.command, ...t.arguments ?? [])
                    }
                }
            ...
            4705: e => {
                ...
                function a(e) {
                    s > 0 ? null === o && (o = setInterval(c, (e || t) / 2), "function" == typeof o.unref && o.unref()) : null !== o && (clearInterval(o), o = null)
                }
                            ...
                            470: e => {
                                ...
                                var i = {
                                    ...
                                    parse: function(e) {
                                        ...
                                        return -1 === o || -1 === c || 0 === d || 1 === d && o === c - 1 && o === a + 1 ? -1 !== c && (n.base = n.name = 0 === a && s ? e.slice(1, c) : e.slice(a, c)) : (0 === a && s ? (n.name = e.slice(1, o), n.base = e.slice(1, c)) : (n.name = e.slice(a, o), n.base = e.slice(a, c)), n.ext = e.slice(o, c)), a > 0 ? n.dir = e.slice(0, a - 1) : s && (n.dir = "/"), n
                                    },
                                    sep: "/",
                                    delimiter: ":",
                                    win32: null,
                            ...
                            447: (e, t, n) => {
                                ...
                                function P(e) {
                                    try {
                                        ...
                                        return e.length > 3 ? e.substr(0, 3) + P(e.substr(3)) : e
                                    }
                                }
                                ...
                                ! function(e) {
                                    e.joinPath = function(e) {
                                        ...
                                        return e.with({
                                            path: E.join.apply(E, j([e.path], t, !1))
                                        })
            ...
            4821: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    return (0, l.conditionalRegistration)([(0, l.requireSomeCapability)(t, c.ClientCapability.Semantic)], () => {
                        const n = new d(t);
                        return a.languages.registerDocumentRangeSemanticTokensProvider(e.semantic, n, n.getLegend())
                    })
                };
                const a = o(n(1398)),
                    c = n(7371),
                ...
                class d {
                    ...
                    getLegend() {
                        return new a.SemanticTokensLegend(f, g)
                    }
                    async provideDocumentSemanticTokens(e, t) {
                        const n = this.client.toOpenTsFilePath(e);
                        return !n || e.getText().length > u ? null : this.provideSemanticTokens(e, {
                            file: n,
                            start: 0,
                ...
                const f = [];
                f[0] = "class", f[1] = "enum", f[2] = "interface", f[3] = "namespace", f[4] = "typeParameter", f[5] = "type", f[6] = "parameter", f[7] = "variable", f[8] = "enumMember", f[9] = "property", f[10] = "function", f[11] = "method";
                const g = [];
                g[2] = "async", g[0] = "declaration", g[3] = "readonly", g[1] = "static", g[5] = "local", g[4] = "defaultLibrary"
            },
            4846: (e, t) => {
                "use strict";
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.ExperimentationTelemetryReporter = void 0, t.ExperimentationTelemetryReporter = class {
                    constructor(e) {
            ...
            4900: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.VSCodeTelemetryReporter = void 0, t.VSCodeTelemetryReporter = class {
                    constructor(e, t) {
                        this.reporter = e, this.clientVersionDelegate = t
                    }
                    logTelemetry(e, t = {}) {
                        const n = this.reporter;
                        n && (t.version = this.clientVersionDelegate(), n.postEventObj(e, t))
                    }
                }
            },
            4902: function(e, t, n) {
                ...
                class d extends u.Disposable {
                    constructor(e) {
                        super(), this._client = e, this._statusItem = this._register(a.languages.createLanguageStatusItem("typescript.version", l.jsTsLanguageModes)), this._statusItem.name = a.l10n.t("TypeScript Version"), this._statusItem.detail = a.l10n.t("TypeScript version"), this._register(this._client.onTsServerStarted(({
                            version: e
                        }) => this.onDidChangeTypeScriptVersion(e)))
                    }
                    onDidChangeTypeScriptVersion(e) {
                        this._statusItem.text = e.displayName, this._statusItem.command = {
                            command: c.SelectTypeScriptVersionCommand.id,
                            title: a.l10n.t("Select Version"),
                            tooltip: e.path
                        }
                    }
                }
            ...
            4906: function(e, t, n) {
                ...
                class p {
                    ...
                    static readCheckJs(e) {
                        return e.get("js/ts.implicitProjectConfig.checkJs") ?? e.get("javascript.implicitProjectConfig.checkJs", !1)
                    }
                    static readExperimentalDecorators(e) {
                        return e.get("js/ts.implicitProjectConfig.experimentalDecorators") ?? e.get("javascript.implicitProjectConfig.experimentalDecorators", !1)
                    }
                ...
                t.BaseServiceConfigurationProvider = class {
                    loadFromWorkspace() {
                        ...
                        return {
                            ...
                            webProjectWideIntellisenseSuppressSemanticErrors: this.readWebProjectWideIntellisenseSuppressSemanticErrors(e),
                            webTypeAcquisitionEnabled: this.readWebTypeAcquisition(e),
                            enableDiagnosticsTelemetry: this.readEnableDiagnosticsTelemetry(e),
                            enableProjectDiagnostics: this.readEnableProjectDiagnostics(e),
                            maxTsServerMemory: this.readMaxTsServerMemory(e),
                            useBundledNode: this.readUseBundledNode(e),
                            enablePromptUseWorkspaceTsdk: this.readEnablePromptUseWorkspaceTsdk(e),
                            useVsCodeWatcher: this.readUseVsCodeWatcher(e),
                            watchOptions: this.readWatchOptions(e),
                            includePackageJsonAutoImports: this.readIncludePackageJsonAutoImports(e),
                            ...
                            workspaceSymbolsExcludeLibrarySymbols: this.readWorkspaceSymbolsExcludeLibrarySymbols(e),
                    ...
                    readEnableProjectDiagnostics(e) {
                        return e.get("typescript.tsserver.experimental.enableProjectDiagnostics", !1)
                    }
                    readUseVsCodeWatcher(e) {
                        const t = e.get("files.watcherExclude") ?? {};
                        if (!0 === t["**/node_modules/*/**"] || !0 === t["**/node_modules/**"] || !0 === t["**/node_modules"] || !0 === t["**"]) return !1;
                        const n = e.inspect("typescript.tsserver.experimental.useVsCodeWatcher");
                        return "boolean" == typeof n?.globalValue ? n.globalValue : "boolean" == typeof n?.workspaceValue ? n.workspaceValue : "boolean" == typeof n?.workspaceFolderValue ? n.workspaceFolderValue : e.get("typescript.tsserver.watchOptions", h) === h
                    }
                    readWatchOptions(e) {
                        const t = e.get("typescript.tsserver.watchOptions");
                        if (t !== h) return {
                            ...t ?? {}
                        }
                    }
                    ...
                    readMaxTsServerMemory(e) {
                        let t = e.get("typescript.tsserver.maxTsServerMemory", -1);
                    ...
                    readWorkspaceSymbolsExcludeLibrarySymbols(e) {
                        return e.get("typescript.workspaceSymbols.excludeLibrarySymbols", !0)
                    }
                    readWebProjectWideIntellisenseEnable(e) {
                        return e.get("typescript.tsserver.web.projectWideIntellisense.enabled", !0)
                    }
                    readWebProjectWideIntellisenseSuppressSemanticErrors(e) {
                        return this.readWebTypeAcquisition(e) && e.get("typescript.tsserver.web.projectWideIntellisense.suppressSemanticErrors", !1)
                    }
                    readWebTypeAcquisition(e) {
                        return e.get("typescript.tsserver.web.typeAcquisition.enabled", !0)
                    }
            ...
            4921: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.instanceTempDir = void 0, t.getTempFile = function(e) {
                    return l.join(t.instanceTempDir.value, `${e}-${d(20)}.tmp`)
                };
                const a = o(n(9896)),
                    c = o(n(857)),
                    l = o(n(6928)),
            ...
            5141: function(e, t, n) {
                ...
                const a = o(n(746)),
                    c = n(5540);
                class l {
                    constructor(e = l.defaultPathNormalizer, t) {
                    ...
                    isCaseInsensitivePath(e) {
                        return !!(0, c.looksLikeAbsoluteWindowsPath)(e) || "/" === e[0] && this.config.onCaseInsensitiveFileSystem
                    }
                }
                t.ResourceMap = l, l.defaultPathNormalizer = e => e.scheme === a.file ? e.fsPath : e.toString(!0)
            },
            5187: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
                ...
                class d {
                    ...
                    async execute() {
                        if (this.client.apiVersion.lt(d.minVersion)) return void a.window.showErrorMessage(a.l10n.t("Go to Source Definition failed. Requires TypeScript 4.7+."));
                        const e = a.window.activeTextEditor;
                        if (!e) return void a.window.showErrorMessage(a.l10n.t("Go to Source Definition failed. No resource provided."));
                        ...
                        i ? await a.window.withProgress({
                            ...
                            if ("response" === c.type && c.body) {
                                ...
                                if (e.length) return void(1 === e.length ? a.commands.executeCommand("vscode.open", e[0].uri.with({
                                    fragment: `L${e[0].range.start.line+1},${e[0].range.start.character+1}`
                                })) : a.commands.executeCommand("editor.action.showReferences", t, s, e))
                            }
                            a.window.showErrorMessage(a.l10n.t("No source definitions found."))
                        }) : a.window.showErrorMessage(a.l10n.t("Go to Source Definition failed. Unknown file type."))
                    }
                }
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    const D = new y.Logger,
                        R = (0, v.createLazyClientHost)(e, (0, O.onCaseInsensitiveFileSystem)(), {
                            ...
                            versionProvider: a,
                            processFactory: new S.ElectronServiceProcessFactory,
                            activeJsTsEditorTracker: c,
                            serviceConfigurationProvider: new f.ElectronServiceConfigurationProvider,
            ...
            5318: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.ReloadJavaScriptProjectsCommand = t.ReloadTypeScriptProjectsCommand = void 0, t.ReloadTypeScriptProjectsCommand = class {
                    constructor(e) {
            ...
            5328: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.Schemes = void 0, t.isOfScheme = function(e, t) {
            ...
            5376: function(e, t, n) {
                ...
                class y extends a.CompletionItem {
                    constructor(e, t, n, i, r, s, o) {
                        ...
                        if (n.kindModifiers) {
                            ...
                            e.has(u.KindModifiers.optional) && (this.insertText ?? (this.insertText = this.textLabel), this.filterText ?? (this.filterText = this.textLabel), "string" == typeof this.label ? this.label += "?" : this.label.label += "?"), e.has(u.KindModifiers.deprecated) && (this.tags = [a.CompletionItemTag.Deprecated]), e.has(u.KindModifiers.color) && (this.kind = a.CompletionItemKind.Color), this.detail = function(e) {
                                if (!e.kindModifiers || e.kind !== u.Kind.script) return;
                                const t = (0, l.parseKindModifier)(e.kindModifiers);
                                for (const n of u.KindModifiers.fileExtensionKindModifiers)
                                    if (t.has(n)) return e.name.toLowerCase().endsWith(n) ? e.name : e.name + n
                            }(n)
                        }
                        this.resolveRange()
                    }
                    get textLabel() {
                        return "string" == typeof this.label ? this.label : this.label.label
                    }
                    async resolveCompletionItem(e, t) {
                        if (t.onCancellationRequested(() => {
                                this._resolvedPromise && --this._resolvedPromise.waiting <= 0 && setTimeout(() => {
                                    this._resolvedPromise && this._resolvedPromise.waiting <= 0 && this._resolvedPromise.requestToken.cancel()
                                }, 300)
                            ...
                            i = (async () => {
                                ...
                                if (this.useCodeSnippet && await this.isValidFunctionCompletionContext(e, i, this.position, this.document, t)) {
                                    const {
                                        snippet: e,
                                        parameterCount: t
                                    } = (0, m.snippetForFunctionCall)({
                                        ...this,
                                        label: this.textLabel
                                    }, o.displayParts);
                                    this.insertText = e, t > 0 && a.workspace.getConfiguration("editor.parameterHints").get("enabled") && u.push({
                    ...
                    getDetails(e, t) {
                        ...
                        if (t.kind !== u.Kind.script) {
                            ...
                            return n.push(v.asPlainTextWithLinks(t.displayParts, e)), n.join("\n\n")
                        }
                    }
                    ...
                    getRangeFromReplacementSpan(e, t) {
                        if (!e.replacementSpan) return t.optionalReplacementRange ? {
                            inserting: new a.Range(t.optionalReplacementRange.start, this.position),
                            replacing: t.optionalReplacementRange
                        } : void 0;
                        let n = d.Range.fromTextSpan(e.replacementSpan);
                        return n.isSingleLine || (n = new a.Range(n.start.line, n.start.character, n.start.line, t.line.length)), {
                            inserting: n,
                            replacing: n
                        }
                    }
                    ...
                    resolveRange() {
                        ...
                        const e = this.completionContext.wordRange;
                        e && (this.range = {
                            inserting: new a.Range(e.start, this.position),
                            replacing: e
                        })
                    }
                    static convertKind(e) {
                        switch (e) {
                            ...
                            case u.Kind.keyword:
                                return a.CompletionItemKind.Keyword;
                            case u.Kind.const:
                            case u.Kind.let:
                            ...
                            case u.Kind.parameter:
                                return a.CompletionItemKind.Variable;
                            case u.Kind.memberVariable:
                            case u.Kind.memberGetAccessor:
                            case u.Kind.memberSetAccessor:
                                return a.CompletionItemKind.Field;
                            case u.Kind.function:
                            case u.Kind.localFunction:
                                return a.CompletionItemKind.Function;
                            case u.Kind.method:
                            case u.Kind.constructSignature:
                            case u.Kind.callSignature:
                            case u.Kind.indexSignature:
                                return a.CompletionItemKind.Method;
                            case u.Kind.enum:
                                return a.CompletionItemKind.Enum;
                            case u.Kind.enumMember:
                                return a.CompletionItemKind.EnumMember;
                            case u.Kind.module:
                            case u.Kind.externalModuleName:
                                return a.CompletionItemKind.Module;
                            case u.Kind.class:
                            case u.Kind.type:
                                return a.CompletionItemKind.Class;
                            case u.Kind.interface:
                                return a.CompletionItemKind.Interface;
                            case u.Kind.warning:
                                return a.CompletionItemKind.Text;
                            case u.Kind.script:
                                return a.CompletionItemKind.File;
                            case u.Kind.directory:
                                return a.CompletionItemKind.Folder;
                            case u.Kind.string:
                                return a.CompletionItemKind.Constant;
                            default:
                                return a.CompletionItemKind.Property
                        }
                    }
                ...
                class b {
                    constructor(e, t) {
                        this.onCompletionAccepted = e, this.telemetryReporter = t, this.id = b.ID
                    }
                    execute(e) {
                        this.onCompletionAccepted(e), e instanceof y && this.telemetryReporter.logTelemetry("completions.accept", {
                            isPackageJsonImport: e.tsEntry.isPackageJsonImport ? "true" : void 0,
                            isImportStatementCompletion: e.tsEntry.isImportStatementCompletion ? "true" : void 0
                        })
                    }
                }
                b.ID = "_typescript.onCompletionAccepted";
                class w {
                    constructor(e) {
                ...
                class P {
                    ...
                    async provideCompletionItems(e, t, n, i) {
                        ...
                        if (c && !c.isEmpty) {
                            ...
                            "@" === e.getText(new a.Range(c.start, t)) && (c = c.with(t))
                        }
                        ...
                        const T = {
                            ...
                            dotAccessorContext: u,
                            enableCallCompletions: !o.completeFunctionCalls,
                            wordRange: c,
                            line: s.text,
                            completeFunctionCalls: o.completeFunctionCalls,
                            optionalReplacementRange: f
                        };
                        let x = !1,
                            j = !1;
                        const E = [];
                    ...
                    logCompletionsTelemetry(e, t, n, i) {
                        this.telemetryReporter.logTelemetry("completions.execute", {
                            duration: String(e),
                            type: t?.type ?? "unknown",
                            flags: "response" === t?.type && "number" == typeof t.body?.flags ? String(t.body.flags) : void 0,
                            count: String("response" === t?.type && t.body ? t.body.entries.length : 0),
                    ...
                    getTsTriggerCharacter(e) {
                        switch (e.triggerCharacter) {
                            ...
                            case "#":
                                return "#";
                            case " ":
                                return this.client.apiVersion.gte(c.API.v430) ? " " : void 0;
                            case ".":
                            case '"':
                            case "'":
                            case "`":
                ...
                function C(e, t) {
                    return !t.nameSuggestions && e.kind === u.Kind.warning || !t.pathSuggestions && (e.kind === u.Kind.directory || e.kind === u.Kind.script || e.kind === u.Kind.externalModuleName) || !t.autoImportSuggestions && e.hasAction
                }
                P.triggerCharacters = [".", '"', "'", "`", "/", "@", "<", "#", " "]
            },
            5540: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.exists = async function(e) {
                    try {
                        return !!((await a.workspace.fs.stat(e)).type & a.FileType.File)
                    } catch {
                        return !1
                    }
                }, t.looksLikeAbsoluteWindowsPath = function(e) {
            ...
            5544: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    const t = [],
                        n = new l(e.telemetryReporter);
                    return t.push(a.commands.registerCommand("js.projectStatus.command", () => {
                        n.configFileName && u(e, n.configFileName);
                        const {
                            message: t
                        } = n.getCurrentHint();
                        return a.window.showInformationMessage(t)
                    })), t.push(function(e, t) {
                    ...
                    }(n, e)), a.Disposable.from(...t)
                };
                const a = o(n(1398)),
                    c = n(2330);
                class l {
                    constructor(e) {
                        this.telemetryReporter = e, this._item = a.window.createStatusBarItem("status.typescript.exclude", a.StatusBarAlignment.Right, 98), this._item.name = a.l10n.t("TypeScript: Configure Excludes"), this._item.command = "js.projectStatus.command"
                    }
                    getCurrentHint() {
                    ...
                    show(e) {
                        this._currentHint = {
                            message: e ? a.l10n.t("To enable project-wide JavaScript/TypeScript language features, exclude folders with many files, like: {0}", e) : a.l10n.t("To enable project-wide JavaScript/TypeScript language features, exclude large folders with source files that you do not work on.")
                        }, this._item.tooltip = this._currentHint.message, this._item.text = a.l10n.t("Configure Excludes"), this._item.tooltip = a.l10n.t("To enable project-wide JavaScript/TypeScript language features, exclude large folders with source files that you do not work on."), this._item.color = "#A5DF3B", this._item.show(), this.telemetryReporter.logTelemetry("js.hintProjectExcludes")
                    }
                }
            ...
            5602: (e, t) => {
                ...
                class i {
                    ...
                    dispose() {
                        this._isDisposed || (this._isDisposed = !0, n(this._disposables))
                    }
                    _register(e) {
                                    ...
                                    for (;;) {
                                        ...
                                        if (92 !== o) {
                                            ...
                                            switch (e.charCodeAt(i++)) {
                                                ...
                                                case 117:
                                                    const e = g(4, !0);
                                                    e >= 0 ? t += String.fromCharCode(e) : f = 4;
                                                    break;
                                                default:
                                                    f = 5
                                            }
            ...
            5894: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    async getTreatmentVariable(e, t) {
                        ...
                        try {
                            return await n.getTreatmentVariableAsync("vscode", e, !0) ?? t
                        } catch {
                            return t
                        }
                    }
            ...
            5904: function(e, t, n) {
                ...
                class d extends l.Disposable {
                    constructor(e) {
                        super(), this.client = e, this._disposed = !1, this._timeout = void 0, this._cancel = void 0, a.workspace.onDidChangeTextDocument(e => this.onDidChangeTextDocument(e), null, this._disposables)
                    }
                    dispose() {
                        super.dispose(), this._disposed = !0, this._timeout && (clearTimeout(this._timeout), this._timeout = void 0), this._cancel && (this._cancel.cancel(), this._cancel.dispose(), this._cancel = void 0)
                    }
                    onDidChangeTextDocument({
                        ...
                        if (">" === (s.range.start.character > 0 ? e.getText(new a.Range(s.range.start.translate({
                                characterDelta: -1
                            }), s.range.start)) : "")) return;
                        const l = e.version;
                ...
                function p(e, t) {
                    ...
                    }, e => a.Disposable.from(a.window.onDidChangeActiveTextEditor(e), a.workspace.onDidOpenTextDocument(e), a.workspace.onDidChangeConfiguration(e)))
                }
            },
            5983: function(e, t, n) {
                "use strict";
            ...
            6006: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    return a.languages.registerSelectionRangeProvider(e.syntax, new l(t))
                };
                const a = o(n(1398)),
                    c = o(n(2144));
                class l {
                    ...
                    static convertSelectionRange(e) {
                        return new a.SelectionRange(c.Range.fromTextSpan(e.textSpan), e.parent ? l.convertSelectionRange(e.parent) : void 0)
                    }
                }
            },
            6156: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.TypeScriptBaseCodeLensProvider = t.ReferencesCodeLens = void 0, t.getSymbolRange = function(e, t) {
            ...
            6325: function(e, t, n) {
                ...
                class f {
                    ...
                    looksLikePotentialJsxTagContext(e, t) {
                        if (![l.typescriptreact, l.javascript, l.javascriptreact].includes(e.languageId)) return !1;
                        const n = e.getText(new c.Range(t.line, 0, t.line, t.character));
            ...
            6362: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.Condition = void 0, t.conditionalRegistration = function(e, t) {
                    return new u(e, t)
                }, t.requireMinVersion = function(e, t) {
                    return new l(() => e.apiVersion.gte(t), e.onTsServerStarted)
                }, t.requireGlobalConfiguration = function(e, t) {
                    return new l(() => !!a.workspace.getConfiguration(e, null).get(t), a.workspace.onDidChangeConfiguration)
                }, t.requireSomeCapability = function(e, ...t) {
                    return new l(() => t.some(t => e.capabilities.has(t)), e.onDidChangeCapabilities)
                };
                const a = o(n(1398)),
                    c = n(5602);
                class l extends c.Disposable {
                    constructor(e, t) {
                        super(), this.getValue = e, this._onDidChange = this._register(new a.EventEmitter), this.onDidChange = this._onDidChange.event, this._value = this.getValue(), t(() => {
                            const e = this.getValue();
                            e !== this._value && (this._value = e, this._onDidChange.fire())
                        })
                    }
                    get value() {
                        return this._value
                ...
                class u {
                    constructor(e, t) {
                        this.conditions = e, this.doRegister = t, this.registration = void 0;
                    ...
                    update() {
                        this.conditions.every(e => e.value) ? this.registration ?? (this.registration = this.doRegister()) : (this.registration?.dispose(), this.registration = void 0)
                    }
                }
            },
            6381: function(e, t, n) {
                ...
                class p extends l.Disposable {
                    constructor(e, t, n) {
                        if (super(), this.configuration = e, this.versionProvider = t, this.workspaceState = n, this._onDidPickNewVersion = this._register(new a.EventEmitter), this.onDidPickNewVersion = this._onDidPickNewVersion.event, this._currentVersion = this.versionProvider.defaultVersion, this.useWorkspaceTsdkSetting)
                            ...
                            } else this._disposables.push(a.workspace.onDidGrantWorkspaceTrust(() => {
                                this.versionProvider.localVersion && this.updateActiveVersion(this.versionProvider.localVersion)
                            }));
                        this.isInPromptWorkspaceTsdkState(e) && (0, c.setImmediate)(() => {
                            this.promptUseWorkspaceTsdk()
                        })
                    }
                    updateConfiguration(e) {
                        const t = this.configuration;
                        this.configuration = e, !this.isInPromptWorkspaceTsdkState(t) && this.isInPromptWorkspaceTsdkState(e) && this.promptUseWorkspaceTsdk()
                    }
                    get currentVersion() {
                    ...
                    async promptUserForVersion() {
                        const e = await a.window.showQuickPick([this.getBundledPickItem(), ...this.getLocalPickItems(), {
                    ...
                    getBundledPickItem() {
                        ...
                        return {
                            label: (this.useWorkspaceTsdkSetting && a.workspace.isTrusted ? "" : "• ") + a.l10n.t("Use VS Code's Version"),
                            description: e.displayName,
                            detail: e.pathLabel,
                            run: async () => {
                                await this.workspaceState.update(u, !1), this.updateActiveVersion(e)
                            }
                        }
                    }
                    getLocalPickItems() {
                        return this.versionProvider.localVersions.map(e => ({
                            label: (this.useWorkspaceTsdkSetting && a.workspace.isTrusted && this.currentVersion.eq(e) ? "• " : "") + a.l10n.t("Use Workspace Version"),
                            description: e.displayName,
                            detail: e.pathLabel,
                            run: async () => {
                                if (await a.workspace.requestWorkspaceTrust()) {
                                    await this.workspaceState.update(u, !0);
                                    const t = a.workspace.getConfiguration("typescript");
                                    await t.update("tsdk", e.pathLabel, !1), this.updateActiveVersion(e)
                                }
                            }
                        }))
                    }
                    ...
                    updateActiveVersion(e) {
                        ...
                        this._currentVersion = e, t.eq(e) || this._onDidPickNewVersion.fire()
                    }
                    get useWorkspaceTsdkSetting() {
                        return this.workspaceState.get(u, !1)
                    }
                    get suppressPromptWorkspaceTsdkSetting() {
                        return this.workspaceState.get(d, !1)
                    }
                ...
                const h = {
                    ...
                    description: "",
                    run: () => {
                        a.env.openExternal(a.Uri.parse("https://go.microsoft.com/fwlink/?linkid=839919"))
                    }
                }
            },
            6384: (e, t) => {
            ...
            6386: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.Cancellation = void 0, (n = t.Cancellation || (t.Cancellation = {})).addData = function(e) {
                    if (void 0 !== e.$cancellationData) throw new Error("Message already has a property $cancellationData");
                    const t = new SharedArrayBuffer(4),
                        n = new Int32Array(t, 0, 1);
                    return n[0] = 0, e.$cancellationData = t, () => {
                        Atomics.store(n, 0, 1)
                    }
            ...
            6413: function(e, t, n) {
                ...
                class h {
                    ...
                    get localVersions() {
                        const e = this.localTsdkVersions.concat(this.localNodeModulesVersions),
                            t = new Set;
            ...
            6431: function(e, t, n) {
                ...
                t.OpenJsDocLinkCommand = c, c.id = "_typescript.openJsDocLink"
            },
            6449: (e, t, n) => {
                "use strict";
                const i = n(857),
            ...
            6470: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    return a.languages.registerCompletionItemProvider(e.syntax, new d(t), "@")
                };
                const a = o(n(1398)),
                    c = n(2928),
                    l = [{
                        value: "@ts-check",
                        description: a.l10n.t("Enables semantic checking in a JavaScript file. Must be at the top of a file.")
                    }, {
                        value: "@ts-nocheck",
                        description: a.l10n.t("Disables semantic checking in a JavaScript file. Must be at the top of a file.")
                    }, {
                        value: "@ts-ignore",
                        description: a.l10n.t("Suppresses @ts-check errors on the next line of a file.")
                    }],
                    u = [...l, {
                        value: "@ts-expect-error",
                        description: a.l10n.t("Suppresses @ts-check errors on the next line of a file, expecting at least one to exist.")
                    }];
                class d {
                    constructor(e) {
                        this.client = e
            ...
            6477: function(e, t, n) {
                ...
                ! function(e) {
                    ...
                    eq(e) {
                        return this.path === e.path && (this.apiVersion === e.apiVersion || !(!this.apiVersion || !e.apiVersion) && this.apiVersion.eq(e.apiVersion))
                    }
                    get displayName() {
                        const e = this.apiVersion;
                        return e ? e.displayName : a.l10n.t("Could not load the TypeScript version at this path")
                    }
                }
            },
            6489: (e, t) => {
            ...
            7008: function(e, t, n) {
                ...
                t.TypeScriptPluginPathsProvider = class {
                    ...
                    getPluginPaths() {
                        const e = [];
                        for (const t of this.configuration.tsServerPluginPaths) e.push(...this.resolvePluginPath(t));
                        return e
                    }
                    resolvePluginPath(e) {
                        if (a.isAbsolute(e)) return [e];
                        const t = l.RelativeWorkspacePathResolver.asAbsoluteWorkspacePath(e);
                        return void 0 !== t ? [t] : (c.workspace.workspaceFolders || []).map(t => a.join(t.uri.fsPath, e))
                    }
                }
            },
            7059: (e, t, n) => {
                ...
                class m extends f.Disposable {
                    ...
                    get documentSelector() {
                        ...
                        for (const n of this.description.languageIds) {
                            ...
                            for (const t of l.getSemanticSupportedSchemes()) e.push({
                                language: n,
                                scheme: t
                            })
                        }
                    ...
                    configurationChanged() {
                        const e = c.workspace.getConfiguration(this.id, null);
                        this.updateValidate(e.get("validate.enable", !0)), this.updateSuggestionDiagnostics(e.get("suggestionActions.enabled", !0))
                    }
                    handlesUri(e) {
                        const t = (0, a.extname)(e.path).slice(1).toLowerCase();
                        return this.description.standardFileExtensions.includes(t) || this.handlesConfigFile(e)
                    }
                    handlesDocument(e) {
                        return this.description.languageIds.includes(e.languageId) || this.handlesConfigFile(e.uri)
                    }
                    handlesConfigFile(e) {
                        const t = (0, a.basename)(e.fsPath);
                        return !!t && !!this.description.configFilePattern && this.description.configFilePattern.test(t)
                    }
                    get id() {
                    ...
                    updateValidate(e) {
                        this.client.diagnosticsManager.setValidate(this._diagnosticLanguage, e)
                    }
                    updateSuggestionDiagnostics(e) {
                        this.client.diagnosticsManager.setEnableSuggestions(this._diagnosticLanguage, e)
                    }
                    reInitialize() {
            ...
            7102: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    if (e.insertText && "string" != typeof e.insertText) return {
                        snippet: e.insertText,
                        parameterCount: 0
                    };
                    const n = function(e) {
                            const t = [];
                            ...
                            e: for (let a = 0; a < e.length; ++a) {
                                const l = e[a];
                                switch (l.kind) {
                                    case c.DisplayPartKind.methodName:
            ...
            7200: function(e, t, n) {
                ...
                class g {
                    ...
                    getTsServerArgs(e, t, n, i, r, s) {
                        ...
                        if (e === f.TsServerProcessKind.Syntax && (i.gte(h.API.v401) ? o.push("--serverMode", "partialSemantic") : o.push("--syntaxOnly")), o.push("--useInferredProjectPerProjectRoot"), (t.disableAutomaticTypeAcquisition || e === f.TsServerProcessKind.Syntax || e === f.TsServerProcessKind.Diagnostics) && o.push("--disableAutomaticTypingAcquisition"), e !== f.TsServerProcessKind.Semantic && e !== f.TsServerProcessKind.Main || o.push("--enableTelemetry"), s && o.push("--cancellationPipeName", s + "*"), g.isLoggingEnabled(t))
                            if ((0, p.isWeb)()) o.push("--logVerbosity", l.TsServerLogLevel.toString(t.tsServerLogLevel)), a = {
                                ...
                                const n = this._logDirectoryProvider.getNewLogDirectory(e);
                                if (n) {
                                    const e = c.Uri.joinPath(n, "tsserver.log");
                                    a = {
                                        type: "file",
                                        uri: e
                    ...
                    static isLoggingEnabled(e) {
                        return e.tsServerLogLevel !== l.TsServerLogLevel.Off
                    }
                    static getTsLocale(e) {
                        return e.locale ? e.locale : c.env.language
                    }
                }
                t.TypeScriptServerSpawner = g, o([d.memoize], g, "tsServerLogOutputChannel", null)
            },
            7237: (e, t, n) => {
                "use strict";
                const i = n(4950);
            ...
            7239: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.ReselectNodeVersionCommand = void 0, t.ReselectNodeVersionCommand = class {
                    constructor(e) {
                        this.lazyClientHost = e, this.id = "typescript.reselectNodeVersion"
                    }
                    async execute() {
                        await this.lazyClientHost.value.serviceClient.promptForNodeVersion()
                    }
                }
            },
            7272: e => {
            ...
            7284: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.DisableTsgoCommand = t.EnableTsgoCommand = void 0;
                const a = o(n(1398));
                async function c(e) {
                    a.extensions.getExtension("typescript.typescript-lsp") || await a.window.showErrorMessage(a.l10n.t("The TypeScript Go extension is not installed."), {
                        title: a.l10n.t("Open on GitHub"),
                        isCloseAffordance: !0
                    }) && await a.env.openExternal(a.Uri.parse("https://github.com/microsoft/typescript-go"));
                    const t = a.workspace.getConfiguration("typescript");
                    ...
                    await t.update("experimental.useTsgo", e, n), await a.commands.executeCommand("workbench.action.restartExtensionHost")
                }
                t.EnableTsgoCommand = class {
                    constructor() {
            ...
            7369: function(e, t, n) {
                ...
                function _(e, t) {
                    ...
                    return g.WorkspaceEdit.withFileCodeEdits(n, e, t), n
                }
                class S {
                    constructor(e) {
                        this.telemetryReporter = e, this.id = S.ID
                    }
                    async execute(e) {
                ...
                S.ID = "_typescript.didApplyRefactoring";
                class P {
                    constructor(e) {
                        this.client = e, this.id = P.ID
                    }
                    async execute(e) {
                        if (!this.client.toOpenTsFilePath(e.document)) return;
                        const t = await c.window.showQuickPick(e.refactor.actions.map(e => ({
                            action: e,
                            label: e.name,
                            description: e.description
                        })));
                        if (!t) return;
                        const n = new N(this.client, e.document, e.refactor, t.action, e.rangeOrSelection, e.trigger);
                        await n.resolve(y.nulToken), !n.edit || await c.workspace.applyEdit(n.edit, {
                            isRefactoring: !0
                        }) ? n.command && await c.commands.executeCommand(n.command.command, ...n.command.arguments ?? []) : c.window.showErrorMessage(c.l10n.t("Could not apply refactoring"))
                    }
                }
                P.ID = "_typescript.selectRefactoring";
                class C {
                    constructor(e, t) {
                        this.client = e, this.didApplyCommand = t, this.id = C.ID
                    }
                    async execute(e) {
                    ...
                    async getTargetFile(e, t, n) {
                        ...
                        if (b) {
                            if (b === o) {
                                const t = await c.window.showOpenDialog({
                                    title: c.l10n.t("Select move destination"),
                                    openLabel: c.l10n.t("Move to File"),
                                    defaultUri: l.Utils.dirname(e.uri)
                                });
                ...
                C.ID = "_typescript.moveToFileRefactoring";
                const O = Object.freeze({
                        kind: c.CodeActionKind.RefactorExtract.append("function"),
                        matches: e => e.name.startsWith("function_")
                    }),
                    T = Object.freeze({
                        kind: c.CodeActionKind.RefactorExtract.append("constant"),
                        matches: e => e.name.startsWith("constant_")
                    }),
                    x = Object.freeze({
                        kind: c.CodeActionKind.RefactorExtract.append("type"),
                        matches: e => e.name.startsWith("Extract to type alias")
                    }),
                    j = Object.freeze({
                        kind: c.CodeActionKind.RefactorExtract.append("interface"),
                        matches: e => e.name.startsWith("Extract to interface")
                    }),
                    E = Object.freeze({
                        kind: c.CodeActionKind.RefactorMove.append("file"),
                        matches: e => e.name.startsWith("Move to file")
                    }),
                    k = Object.freeze({
                        kind: c.CodeActionKind.RefactorMove.append("newFile"),
                    ...
                    I = Object.freeze({
                        kind: c.CodeActionKind.RefactorRewrite.append("parameters").append("toDestructured"),
                        matches: e => e.name.startsWith("Convert parameters to destructured object")
                    }),
                    A = Object.freeze({
                ...
                class N extends c.CodeAction {
                    ...
                    async resolve(e) {
                        ...
                        if (!t) return;
                        const n = {
                                ...g.Range.toFileRangeRequestArgs(t, this.range),
                    ...
                    static getKind(e) {
                        if (e.kind) return c.CodeActionKind.Empty.append(e.kind);
                        const t = F.find(t => t.matches(e));
                        return t ? t.kind : c.CodeActionKind.Refactor
                    }
                }
                ...
                class $ {
                    static isOnSignatureName(e, t) {
                        if (this._declarationKinds.has(e.kind)) {
                            if (e.nameSpan) {
                                const n = g.Range.fromTextSpan(e.nameSpan);
                                if (t.intersection(n)) return !0
                            }
                            if (!e.nameSpan && /\bexport\b/.test(e.kindModifiers) && e.spans.length) {
                                const n = g.Range.fromTextSpan(e.spans[0]);
                                if (t.intersection(new c.Range(n.start.line, 0, n.start.line, Number.MAX_SAFE_INTEGER))) return !0
                            }
                        }
                    ...
                    interruptGetErrIfNeeded(e, t) {
                        return e.triggerKind === c.CodeActionTriggerKind.Invoke ? this.client.interruptGetErr(t) : t()
                    }
                    async resolveCodeAction(e, t) {
                        return e instanceof N && await e.resolve(t), e
                    }
                    toTsTriggerReason(e) {
                    ...
                    shouldTrigger(e, t) {
                        return !(e.only && !c.CodeActionKind.Refactor.contains(e.only)) && (e.triggerKind === c.CodeActionTriggerKind.Invoke || t instanceof c.Selection)
                    }
                    ...
                    appendInvalidActions(e) {
                        ...
                        if (!e.some(e => e.kind && T.kind.contains(e.kind))) {
                            ...
                            t.disabled = {
                                reason: c.l10n.t("The current selection cannot be extracted")
                            }, t.isPreferred = !0, e.push(t)
                        }
                        if (!e.some(e => e.kind && O.kind.contains(e.kind))) {
                            const t = new c.CodeAction(c.l10n.t("Extract to function"), O.kind);
                            t.disabled = {
                                reason: c.l10n.t("The current selection cannot be extracted")
                            }, e.push(t)
                        }
                ...
                $._declarationKinds = new Set([f.Kind.module, f.Kind.class, f.Kind.interface, f.Kind.function, f.Kind.enum, f.Kind.type, f.Kind.const, f.Kind.variable, f.Kind.let]), $.metadata = {
                    providedCodeActionKinds: [c.CodeActionKind.Refactor, ...F.map(e => e.kind)],
                    documentation: [{
                        kind: c.CodeActionKind.Refactor,
                        command: {
                            command: u.LearnMoreAboutRefactoringsCommand.id,
                            title: c.l10n.t("Learn more about JS/TS refactorings")
                        }
                    }]
                }
            },
            ...
            7543: function(e, t, n) {
                ...
                class p extends u.Disposable {
                    ...
                    update() {
                        const e = this.getEditorCandidatesForActiveTab().filter(e => this.isManagedFile(e)).at(0);
                        this._activeJsTsEditor !== e && (this._activeJsTsEditor = e, this._onDidChangeActiveJsTsEditor.fire(this._activeJsTsEditor))
                    }
                    getEditorCandidatesForActiveTab() {
                        const e = this.getActiveTabInfo();
                        if (!e) return this.getVisibleEditorCandidates();
                        const {
                            tab: t,
                            viewColumn: n
                        } = e;
                        ...
                        if (t.input instanceof a.TabInputTextDiff) {
                            const e = t.input.original,
                                n = t.input.modified;
                            return (0, d.coalesce)([a.window.activeTextEditor, ...a.window.visibleTextEditors]).filter(t => (t.document.uri.toString() === e.toString() || t.document.uri.toString() === n.toString()) && void 0 === t.viewColumn)
                        }
                        if (t.input instanceof a.TabInputNotebook) {
                            const e = a.window.activeTextEditor;
                            if (!e) return [];
                    ...
                    getActiveTabInfo() {
                        try {
                            const e = a.window.tabGroups.all.find(e => e.isActive);
                            if (!e?.activeTab) return;
                            return {
                                tab: e.activeTab,
                    ...
                    getVisibleEditorCandidates() {
                        return (0, d.coalesce)([a.window.activeTextEditor, ...a.window.visibleTextEditors])
                    }
                    isManagedFile(e) {
                        return this.isManagedScriptFile(e) || this.isManagedConfigFile(e)
                    }
                    isManagedScriptFile(e) {
                        return (0, l.isSupportedLanguageMode)(e.document)
                    }
                    isManagedConfigFile(e) {
            ...
            7906: function(e, t, n) {
                ...
                t.CommandManager = class {
                    ...
                    register(e) {
                        ...
                        return t ? t.refCount += 1 : (t = {
                            refCount: 1,
                            registration: a.commands.registerCommand(e.id, e.execute, e)
                        }, this.commands.set(e.id, t)), new a.Disposable(() => {
                            t.refCount -= 1, t.refCount <= 0 && (t.registration.dispose(), this.commands.delete(e.id))
                        })
                    }
                }
            },
                ...
                class p extends l.Disposable {
                    constructor(e, t) {
                        if (super(), this.configuration = e, this.workspaceState = t, this._onDidPickNewVersion = this._register(new a.EventEmitter), this.onDidPickNewVersion = this._onDidPickNewVersion.event, this._currentVersion = this.configuration.globalNodePath || void 0, a.workspace.isTrusted) {
                            ...
                            if (e) {
                                const t = this.canUseWorkspaceNode(e);
                                void 0 === t ? (0, c.setImmediate)(() => {
                                    this.promptAndSetWorkspaceNode()
                                }) : t && (this._currentVersion = e)
                            }
                        } else this._disposables.push(a.workspace.onDidGrantWorkspaceTrust(() => {
                            const e = this.configuration.localNodePath;
                            if (e) {
                    ...
                    async resetWorkspaceNodeChoice() {
                        await this.promptAndSetWorkspaceNode({
                            force: !0
                        })
                    }
                    async updateConfiguration(e) {
                        const t = this.configuration;
                        this.configuration = e, t.globalNodePath === e.globalNodePath && t.localNodePath === e.localNodePath || await this.computeNewVersion()
                    }
                    async computeNewVersion() {
                        let e = this.configuration.globalNodePath || void 0;
                        const t = this.configuration.localNodePath;
                        if (a.workspace.isTrusted && t) {
                            const n = this.canUseWorkspaceNode(t);
                            void 0 === n ? e = await this.promptUseWorkspaceNode() || e : n && (e = t)
                        }
                    ...
                    async promptAndSetWorkspaceNode({
                        ...
                        const t = await this.promptUseWorkspaceNode({
                            force: e
                        });
                        void 0 !== t && this.updateActiveVersion(t)
                    }
                    updateActiveVersion(e) {
                        const t = this.currentVersion;
                        this._currentVersion = e, t !== e && this._onDidPickNewVersion.fire()
                    }
                    canUseWorkspaceNode(e) {
                        if (this.workspaceState.get(d) === e) return this.workspaceState.get(u)
                    }
                    async setUseWorkspaceNodeState(e, t) {
            ...
            8040: function(e, t, n) {
                ...
                const a = o(n(1398)).Disposable.from();
                t.nulToken = {
            ...
            8101: function(e, t, n) {
                ...
                class l {
                    ...
                    execute() {
                        const e = a.window.activeTextEditor && (0, c.isTypeScriptDocument)(a.window.activeTextEditor.document) ? "https://go.microsoft.com/fwlink/?linkid=2114477" : "https://go.microsoft.com/fwlink/?linkid=2116761";
                        a.env.openExternal(a.Uri.parse(e))
                    }
                }
                t.LearnMoreAboutRefactoringsCommand = l, l.id = "_typescript.learnMoreAboutRefactorings"
            },
            8110: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
                ...
                Object.defineProperty(t, "__esModule", {
                    ...
                    }), ...o.commandIds.map(e => n.register({
                        id: e,
                        execute: () => a.commands.executeCommand("editor.action.sourceAction", {
                            kind: o.kind.value,
                            apply: "first"
                        })
                    })));
                    return a.Disposable.from(...s)
                };
                const a = o(n(1398)),
                    c = n(2928),
                    l = n(1788),
                    ...
                    f = {
                        ...
                        kind: a.CodeActionKind.SourceOrganizeImports,
                        mode: l.OrganizeImportsMode.All
                    },
                    g = {
                        commandIds: ["typescript.sortImports", "javascript.sortImports"],
                        minVersion: c.API.v430,
                        title: a.l10n.t("Sort Imports"),
                        kind: a.CodeActionKind.Source.append("sortImports"),
                        mode: l.OrganizeImportsMode.SortAndCombine
                    },
                    m = {
                        commandIds: ["typescript.removeUnusedImports", "javascript.removeUnusedImports"],
                        minVersion: c.API.v490,
                        title: a.l10n.t("Remove Unused Imports"),
                        kind: a.CodeActionKind.Source.append("removeUnusedImports"),
                        mode: l.OrganizeImportsMode.RemoveUnused
                    };
                class v {
                    constructor(e) {
                        this.telemetryReporter = e, this.id = v.ID
                    }
                    async execute() {
                        this.telemetryReporter.logTelemetry("organizeImports.execute", {})
                    }
                }
                v.ID = "_typescript.didOrganizeImports";
                class y extends a.CodeAction {
                    constructor(e, t, n) {
            ...
            8160: function(e, t, n) {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.isWeb = c, t.isWebAndHasSharedArrayBuffers = function() {
                    return c() && globalThis.crossOriginIsolated
                }, t.supportsReadableByteStreams = function() {
                    return c() && "ReadableByteStreamController" in globalThis
                };
                const a = o(n(1398));

                function c() {
                    return "navigator" in globalThis && a.env.uiKind === a.UIKind.Web
                }
            },
            8265: (e, t, n) => {
                const i = n(857),
            ...
            8337: function(e, t, n) {
                ...
                class y {
                    constructor(e, t, n) {
                        this.client = e, this.diagnosticManager = t, this.telemetryReporter = n, this.id = y.ID
                    }
                    async execute({
                        document: e,
                        action: t,
                ...
                class b {
                    constructor(e, t) {
                        this.client = e, this.telemetryReporter = t, this.id = b.ID
                    }
                    async execute(e) {
                ...
                class w {
                    static from(e) {
                        const t = new Map;
                        for (const n of e) t.set(w.key(n), n);
                        return new w(t)
                    }
                    static key(e) {
                        const {
                ...
                class P {
                    constructor() {
                        this._actions = new Set, this._fixAllActions = new Map, this._aiActions = new Set
                    }* values() {
                    ...
                    addAction(e) {
                        if (e.isAI) this._aiActions.add(e);
                            ...
                            for (const t of this._actions) e.tsAction.fixName === t.tsAction.fixName && (0, f.equals)(e.edit, t.edit) && this._actions.delete(t);
                    ...
                    addFixAllAction(e, t) {
                        ...
                        n && this._actions.delete(n), this.addAction(t), this._fixAllActions.set(e, t)
                    }
                    hasFixAllAction(e) {
                ...
                class O {
                    ...
                    async resolveCodeAction(e, t) {
                        if (!(e instanceof S && e.tsAction.fixId)) return e;
                        const n = {
                                scope: {
                                    type: "file",
                                    args: {
                ...
                O._maxCodeActionsPerFile = 1e3, O.metadata = {
                    providedCodeActionKinds: [c.CodeActionKind.QuickFix]
                };
                const T = new Map([
                        [2339, 2339],
                        [2345, 2339]
                    ...
                    x = new Map([
                        [l.annotateWithTypeFromJSDoc, {
                            priority: 2
                        }],
                        [l.constructorForDerivedNeedSuperCall, {
                            priority: 2
                        }],
                        [l.extendsInterfaceBecomesImplements, {
                            priority: 2
                        }],
                        [l.awaitInSyncFunction, {
                            priority: 2
                        }],
                        [l.removeUnnecessaryAwait, {
                            priority: 2
                        }],
                        [l.classIncorrectlyImplementsInterface, {
                            priority: 3
                        }],
                        [l.classDoesntImplementInheritedAbstractMember, {
                            priority: 3
                        }],
                        [l.unreachableCode, {
                            priority: 2
                        ...
                        [l.addMissingOverride, {
                            priority: 2
                        }],
                        [l.addMissingNewOperator, {
                            priority: 2
                        }],
                        [l.fixImport, {
                            priority: 1,
            ...
            8507: (e, t) => {
                ...
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.getPackageInfo = function(e) {
                    const t = e.extension.packageJSON;
            ...
            8631: function(e, t, n) {
                ...
                function m(e, t) {
                    return new Promise(n => d.workspace.onDidChangeTextDocument(t => {
                        t.document.uri.toString() === e.toString() && n(t.document)
                    }, void 0, t))
                }
                t.CURSOR = "$$CURSOR$$", t.wait = e => new Promise(t => setTimeout(() => t(), e)), t.joinLines = (...e) => e.join("win32" === l.platform() ? "\r\n" : "\n"), t.Config = Object.freeze({
            ...
            9334: function(e, t, n) {
                ...
                class l extends c.Disposable {
                    constructor(e) {
                        super(), this._acquiringTypings = new Map, this._client = e, this._register(this._client.onDidBeginInstallTypings(e => this.onBeginInstallTypings(e.eventId))), this._register(this._client.onDidEndInstallTypings(e => this.onEndInstallTypings(e.eventId)))
                    }
                    dispose() {
                        super.dispose();
                    ...
                    onBeginInstallTypings(e) {
                        this._acquiringTypings.has(e) || this._acquiringTypings.set(e, setTimeout(() => {
                ...
                class u extends c.Disposable {
                    constructor(e) {
                        super(), this._promises = new Map, this._register(e.onDidBeginInstallTypings(e => this._onBegin(e.eventId))), this._register(e.onDidEndInstallTypings(e => this._onEndOrTimeout(e.eventId))), this._register(e.onTypesInstallerInitializationFailed(e => this.onTypesInstallerInitializationFailed()))
                    }
                    dispose() {
                    ...
                    _onBegin(e) {
                        ...
                        a.window.withProgress({
                            location: a.ProgressLocation.Window,
                            title: a.l10n.t("Fetching data for better TypeScript IntelliSense")
                        }, () => n)
                    }
                    _onEndOrTimeout(e) {
                    ...
                    async onTypesInstallerInitializationFailed() {
                        const e = a.workspace.getConfiguration("typescript");
                        if (e.get("check.npmIsInstalled", !0)) {
                            const t = {
                                title: a.l10n.t("Don't Show Again")
                            };
                            await a.window.showWarningMessage(a.l10n.t("Could not install typings files for JavaScript language features. Please ensure that NPM is installed, or configure 'typescript.npm' in your user settings. Alternatively, check the [documentation]({0}) to learn more.", "https://go.microsoft.com/fwlink/?linkid=847635"), t) === t && e.update("check.npmIsInstalled", !1, !0)
                        }
                    }
                }
                t.AtaProgressReporter = u
            },
            9401: function(e, t, n) {
                "use strict";
                var i, r = this && this.__createBinding || (Object.create ? function(e, t, n, i) {
                ...
                t.TsConfigProvider = class {
                    async getConfigsForWorkspace(e) {
                        if (!a.workspace.workspaceFolders) return [];
                        const t = new Map;
                        for (const n of await this.findConfigFiles(e)) {
                            const e = a.workspace.getWorkspaceFolder(n);
                            e && t.set(n.fsPath, {
                                uri: n,
                                fsPath: n.fsPath,
                                posixPath: n.path,
                    ...
                    async findConfigFiles(e) {
                        return await a.workspace.findFiles("**/tsconfig*.json", "**/{node_modules,.*}/**", void 0, e)
                    }
                }
            },
            9589: (e, t, n) => {
            ...
            9698: function(e, t, n) {
                ...
                class C extends S.Disposable {
                        ...
                        Promise.resolve().then(() => o(n(539))).then(e => this._register(e.register(this.client, this.fileConfigurationManager, e => this.handles(e)))), Promise.resolve().then(() => o(n(2361))).then(e => this._register(e.register(this.client, a))), this.client.ensureServiceStarted(), this.client.onReady(() => {
                            ...
                            for (const t of r.pluginManager.plugins)
                                if (t.configNamespace && t.languages.length) this.registerExtensionLanguageProvider({
                                    ...
                                    for (const n of t.languages) e.add(n);
                            e.size && this.registerExtensionLanguageProvider({
                    ...
                    getAllModeIds(e, t) {
                        return [...e.map(e => e.languageIds), ...t.plugins.map(e => e.languages)].flat()
                    }
                    get serviceClient() {
                        return this.client
                    }
                    reloadProjects() {
                        this.client.executeWithoutWaitingForResponse("reloadProjects", null), this.triggerAllDiagnostics()
                    }
                    async handles(e) {
                        return !!await this.findLanguage(e) || this.client.bufferSyncSupport.handles(e)
                    }
                    configurationChanged() {
                        const e = c.workspace.getConfiguration("typescript");
                        this.reportStyleCheckAsWarnings = e.get("reportStyleChecksAsWarnings", !0)
                    }
                    async findLanguage(e) {
                        try {
                            for (const t of this.languages)
                                if (t.handlesUri(e)) return t;
                            const t = await c.workspace.openTextDocument(e);
                            return this.languages.find(e => e.handlesDocument(t))
                        } catch {
                            return
                        }
                    }
                    triggerAllDiagnostics() {
                        for (const e of this.languagePerId.values()) e.triggerAllDiagnostics()
                    }
                    populateService() {
            ...
            9749: (e, t, n) => {
                ...
                e.exports = class {
                    ...
                    set lengthCalculator(e) {
                        "function" != typeof e && (e = f), e !== this[o] && (this[o] = e, this[s] = 0, this[d].forEach(e => {
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/042b3c1a4c53f2c3808067f519fbfc67b72cad80/extensions/typescript-language-features/dist/extension.js.map