...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "ee971758-48a4-5f0c-887b-256ddefb6936")
    } catch (e) {}
}();
var kt = function(t, e) {
...
var ks = typeof ae.postMessage == "function" && !ae.importScripts,
    ...
    go = !!(ie && ie.indexOf("Firefox") >= 0),
    po = !!(!Ls && ie && ie.indexOf("Safari") >= 0),
    bo = !!(ie && ie.indexOf("Edg/") >= 0),
    _o = !!(ie && ie.indexOf("Android") >= 0),
    vo = W?.arch,
    yo = W?.platform,
    wo = W?.versions?.node,
...
var Ds = J ? M.normalize : T.normalize,
    ko = J ? M.isAbsolute : T.isAbsolute,
    Ps = J ? M.join : T.join,
    Ms = J ? M.resolve : T.resolve,
    zs = J ? M.relative : T.relative,
    Fs = J ? M.dirname : T.dirname,
    Lo = J ? M.basename : T.basename,
    So = J ? M.extname : T.extname,
    Eo = J ? M.format : T.format,
    No = J ? M.parse : T.parse,
    xo = J ? M.toNamespacedPath : T.toNamespacedPath,
    it = J ? M.sep : T.sep,
    To = J ? M.delimiter : T.delimiter,
    Us = class {
        constructor() {
...
var Li = /(?:\x1b\[|\x9b)[=?>!]?[\d;:]*["$#'* ]?[a-zA-Z@^`{}|~]/,
    ...
    Ei = /\x1b(?:[ #%\(\)\*\+\-\.\/]?[a-zA-Z0-9\|}~@])/,
    Ro = new RegExp("(?:" + [Li.source, Si.source, Ei.source].join("|") + ")", "g"),
    Do = "\uFEFF",
    Ni = class Ge {
        static getInstance() {
...
var zo = new Ft(() => new Uint8Array(256));
...
var $t = class {
    ...
    N = new $t(() => !1),
    Fo = new $t(t => t.scheme === z.file ? !vs : !0),
    Uo = new $t(t => !0),
    Ji = N.isEqual.bind(N),
    $o = N.isEqualOrParent.bind(N),
    Bo = N.getComparisonKey.bind(N),
    jo = N.basenameOrAuthority.bind(N),
    Zi = N.basename.bind(N),
    qo = N.extname.bind(N),
    Vo = N.dirname.bind(N),
    Wo = N.joinPath.bind(N),
    Go = N.normalizePath.bind(N),
    Ho = N.relativePath.bind(N),
    Ko = N.resolvePath.bind(N),
    Qo = N.isAbsolutePath.bind(N),
    ln = N.isEqualAuthority.bind(N),
    un = N.hasTrailingPathSeparator.bind(N),
    Jo = N.removeTrailingPathSeparator.bind(N),
    Zo = N.addTrailingPathSeparator.bind(N),
    cn;
(t => {
...
function $1(t, e) {
    ...
    return r[0] = 0, r[1] = (t << 0 | 0 | 0 | 32768 | 2 << 24) >>> 0, new rr(r, e === null ? U1 : e)
}
var B1 = class {
    constructor(t) {
...
var $n = class Xn {
    ...
    H1 = class {
        constructor(t, e) {
            this.tokenizationSupport = e, this.initialState = this.tokenizationSupport.getInitialState(), this.store = new K1(t)
        }
        getStartState(t) {
    ...
    K1 = class {
        constructor(t) {
            this.lineCount = t, this._tokenizationStateStore = new Q1, this._invalidEndStatesLineNumbers = new J1, this._invalidEndStatesLineNumbers.addRange(new G(1, t + 1))
        }
        getEndState(t) {
    ...
    Q1 = class {
        constructor() {
            this._lineEndStates = new B1(null)
        }
        getEndState(t) {
    ...
    Y1 = class extends ne {
        ...
        tokenizeEncoded(t, e, r) {
            return t.length >= this._maxTokenizationLineLength.get() ? $1(this._encodedLanguageId, r) : this._actual.tokenizeEncoded(t, e, r)
        }
        createBackgroundTokenizer(t, e) {
    ...
    X1 = class extends P1 {
        ...
        async _resetTokenization() {
            ...
            if (!(this._isDisposed || t !== this._languageId || e !== this._encodedLanguageId || !r)) {
                if (r.grammar) {
                    const n = new Y1(this._encodedLanguageId, new Z1(r.grammar, r.initialState, !1, void 0, () => !1, (i, o, a) => {
                        this._host.reportTokenizationTime(i, t, r.sourceExtensionId, o, a)
                    }, !1), ne.None, this._maxTokenizationLineLength);
                    this._tokenizerWithStateStore = new H1(this._lines.length, n)
...
var no = class {
        constructor(t) {
            this._models = new Map, this._grammarCache = [], this._grammarFactory = Promise.resolve(null), this._host = to.getChannel(t)
        }
        async $init(t) {
        ...
        $acceptNewModel(t) {
            const e = Y.revive(t.uri),
                r = this;
            this._models.set(t.controllerId, new X1(e, t.lines, t.EOL, t.versionId, {
        ...
        sendMessage(t, e, r) {
            ...
            return new Promise((i, o) => {
                this._pendingReplies[n] = {
                    resolve: i,
                    reject: o
                }, this._send(new io(this._workerId, n, t, e, r))
            })
        }
        listen(t, e, r) {
            let n = null;
            const i = new X({
                onWillAddFirstListener: () => {
                    n = String(++this._lastSentReq), this._pendingEmitters.set(n, i), this._send(new oo(this._workerId, n, t, e, r))
                },
                onDidRemoveLastListener: () => {
                    this._pendingEmitters.delete(n), this._send(new lo(this._workerId, n)), n = null
                }
            });
            return i.event
        }
        ...
        _handleSubscribeEventMessage(t) {
            const e = t.req,
                r = this._handler.handleEvent(t.channel, t.eventName, t.arg)(n => {
                    this._send(new ao(this._workerId, e, n))
                });
...
var co = class {
        constructor(t, e) {
            this._localChannels = new Map, this._remoteChannels = new Map, this._protocol = new uo({
                sendMessage: (r, n) => {
                    t(r, n)
                },
        ...
        _handleMessage(t, e, r) {
            if (t === sr && e === so) return this.initialize(r[0]);
...
function ho(t) {
    ...
    ir = !0;
    const e = new co(r => globalThis.postMessage(r), r => t(r));
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/776d1f9d76df50a4e0aeca61819a88e7c1b861e0/core/vs/workbench/services/textMate/browser/backgroundTokenization/worker/textMateTokenizationWorker.workerMain.js.map

//# debugId=ee971758-48a4-5f0c-887b-256ddefb6936