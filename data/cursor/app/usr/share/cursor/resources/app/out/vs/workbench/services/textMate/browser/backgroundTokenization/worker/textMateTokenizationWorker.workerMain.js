...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "fe785c71-4b94-5f61-84f9-4f2aa7022cff")
    } catch (e) {}
}();
var Et = function(e, t) {
...
export function __decorate(e, t, r, n) {
    ...
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function") o = Reflect.decorate(e, t, r, n);
        ...
        for (var l = e.length - 1; l >= 0; l--)(a = e[l]) && (o = (i < 3 ? a(o) : i > 3 ? a(t, r, o) : a(t, r)) || o);
...
export function __esDecorate(e, t, r, n, i, o) {
    ...
    for (var l = n.kind, u = l === "getter" ? "get" : l === "setter" ? "set" : "value", c = !t && e ? n.static ? e : e.prototype : null, d = t || (c ? Object.getOwnPropertyDescriptor(c, n.name) : {}), h, m = !1, _ = r.length - 1; _ >= 0; _--) {
        var E = {};
        for (var R in n) E[R] = R === "access" ? {} : n[R];
        for (var R in n.access) E.access[R] = n.access[R];
        E.addInitializer = function(B) {
            if (m) throw new TypeError("Cannot add initializers after decoration has completed");
            o.push(a(B || null))
        };
        var I = (0, r[_])(l === "accessor" ? {
            get: d.get,
            set: d.set
        } : d[u], E);
        if (l === "accessor") {
            ...
            (h = a(I.get)) && (d.get = h), (h = a(I.set)) && (d.set = h), (h = a(I.init)) && i.unshift(h)
        } else(h = a(I)) && (l === "field" ? i.unshift(h) : d[u] = h)
    }
    c && Object.defineProperty(c, n.name, d), m = !0
}
...
export function __awaiter(e, t, r, n) {
    ...
    return new(r || (r = Promise))(function(o, a) {
        ...
        function c(d) {
            d.done ? o(d.value) : i(d.value).then(l, u)
        }
...
export function __asyncGenerator(e, t, r) {
    ...
    function a(_) {
        return function(E) {
            return Promise.resolve(E).then(_, h)
        }
    }
    ...
    function c(_) {
        _.value instanceof __await ? Promise.resolve(_.value.v).then(d, h) : m(o[0][2], _)
    }
    ...
    function m(_, E) {
        _(E), o.shift(), o.length && u(o[0][0], o[0][1])
    }
}
...
var Ds = Object.create ? (function(e, t) {
...
export function __disposeResources(e) {
    function t(n) {
        e.error = e.hasError ? new Ps(n, e.error, "An error was suppressed during disposal.") : n, e.hasError = !0
    }
...
var zs = dr() === "pseudo" || typeof document < "u" && document.location && typeof document.location.hash == "string" && document.location.hash.indexOf("pseudo=true") >= 0;
...
function fr(e, t) {
    ...
    }), zs && (r = "\uFF3B" + r.replace(/[aouei]/g, "$&$&") + "\uFF3D"), r
}

function w(e, t, ...r) {
    return fr(typeof e == "number" ? Fs(e, t) : t, r)
}
...
var pr = typeof W?.versions?.electron == "string",
    Ws = pr && W?.type === "renderer";
if (typeof W == "object") {
    Ke = W.platform === "win32", et = W.platform === "darwin", je = W.platform === "linux", Us = je && !!W.env.SNAP && !!W.env.SNAP_REVISION, $s = pr, Bs = !!W.env.CI || !!W.env.BUILD_ARTIFACTSTAGINGDIRECTORY, tt = Oe, rt = Oe;
    const e = W.env.VSCODE_NLS_CONFIG;
    if (e) try {
        const t = JSON.parse(e);
        tt = t.userLocale, mr = t.osLocale, rt = t.resolvedLanguage || Oe, Vs = t.languagePack?.translationsConfigFile
    } catch {}
    gr = !0
} else typeof navigator == "object" && !Ws ? (oe = navigator.userAgent, Ke = oe.indexOf("Windows") >= 0, et = oe.indexOf("Macintosh") >= 0, js = (oe.indexOf("Macintosh") >= 0 || oe.indexOf("iPad") >= 0 || oe.indexOf("iPhone") >= 0) && !!navigator.maxTouchPoints && navigator.maxTouchPoints > 0, je = oe.indexOf("Linux") >= 0, qs = oe?.indexOf("Mobi") >= 0, Nt = !0, rt = dr() || Oe, tt = navigator.language.toLowerCase(), mr = tt) : console.error("Unable to resolve platform.");
var br;
(function(e) {
    e[e.Web = 0] = "Web", e[e.Mac = 1] = "Mac", e[e.Linux = 2] = "Linux", e[e.Windows = 3] = "Windows"
})(br || (br = {}));
var St = 0;
et ? St = 1 : Ke ? St = 3 : je && (St = 2);
var Re = Ke,
    Gs = et,
    Hs = je,
    Qs = gr,
    _r = Nt,
    Js = Nt && typeof ae.importScripts == "function",
    Ys = Js ? ae.origin : void 0,
    se = oe,
    pe = rt,
    vr;
(function(e) {
...
var Zs = typeof ae.postMessage == "function" && !ae.importScripts,
    yr = (() => {
        if (Zs) {
            const e = [];
...
var Xs = !!(se && se.indexOf("Chrome") >= 0),
    Fo = !!(se && se.indexOf("Firefox") >= 0),
    Uo = !!(!Xs && se && se.indexOf("Safari") >= 0),
    $o = !!(se && se.indexOf("Edg/") >= 0),
    jo = !!(se && se.indexOf("Android") >= 0),
    Bo = W?.arch,
    qo = W?.platform,
    Vo = W?.versions?.node,
    ve, At = globalThis.vscode;
if (typeof At < "u" && typeof At.process < "u") {
    const e = At.process;
    ve = {
        get platform() {
            return e.platform
    ...
    get platform() {
        return Re ? "win32" : Gs ? "darwin" : "linux"
    },
    get arch() {},
    get env() {
        return {}
...
function ii(e, t) {
    if (e === null || typeof e != "object") throw new Lr(t, "Object", e)
}

function P(e, t) {
    if (typeof e != "string") throw new Lr(t, "string", e)
}
var Y = Ks === "win32";
...
function st(e, t, r, n) {
    ...
    for (let c = 0; c <= e.length; ++c) {
        ...
        if (n(u)) {
            if (!(a === c - 1 || l === 1))
                if (l === 2) {
                    if (i.length < 2 || o !== 2 || i.charCodeAt(i.length - 1) !== ye || i.charCodeAt(i.length - 2) !== ye) {
                        if (i.length > 2) {
                            const d = i.lastIndexOf(r);
                            d === -1 ? (i = "", o = 0) : (i = i.slice(0, d), o = i.length - 1 - i.lastIndexOf(r)), a = c, l = 0;
                            continue
                        } else if (i.length !== 0) {
                            i = "", o = 0, a = c, l = 0;
                            continue
                ...
                } else i.length > 0 ? i += `${r}${e.slice(a+1,c)}` : i = e.slice(a + 1, c), o = c - a - 1;
            a = c, l = 0
        } else u === ye && l !== -1 ? ++l : l = -1
    }
    return i
...
var M = {
        resolve(...e) {
            ...
            for (let i = e.length - 1; i >= -1; i--) {
                ...
                } else t.length === 0 ? o = nt() : (o = xt[`=${t}`] || nt(), (o === void 0 || o.slice(0, 2).toLowerCase() !== t.toLowerCase() && o.charCodeAt(2) === J) && (o = `${t}\\`));
                const a = o.length;
                let l = 0,
                    u = "",
                    c = !1;
                ...
                if (a === 1) C(d) && (l = 1, c = !0);
                    ...
                    if (c = !0, C(o.charCodeAt(1))) {
                        let h = 2,
                            m = h;
                        for (; h < a && !C(o.charCodeAt(h));) h++;
                        if (h < a && h !== m) {
                            const _ = o.slice(m, h);
                            for (m = h; h < a && C(o.charCodeAt(h));) h++;
                            if (h < a && h !== m) {
                                for (m = h; h < a && !C(o.charCodeAt(h));) h++;
                                (h === a || h !== m) && (u = `\\\\${_}\\${o.slice(m,h)}`, l = h)
                            }
                        }
                    } else l = 1;
                else ue(d) && o.charCodeAt(1) === le && (u = o.slice(0, 2), l = 2, a > 2 && C(o.charCodeAt(2)) && (c = !0, l = 3));
                if (u.length > 0)
                    if (t.length > 0) {
        ...
        normalize(e) {
            ...
            if (t === 1) return Tt(o) ? "\\" : e;
            if (C(o))
                if (i = !0, C(e.charCodeAt(1))) {
                    let l = 2,
                        u = l;
                    for (; l < t && !C(e.charCodeAt(l));) l++;
                    if (l < t && l !== u) {
                        const c = e.slice(u, l);
                        for (u = l; l < t && C(e.charCodeAt(l));) l++;
                        if (l < t && l !== u) {
                            for (u = l; l < t && !C(e.charCodeAt(l));) l++;
            ...
            else ue(o) && e.charCodeAt(1) === le && (n = e.slice(0, 2), r = 2, t > 2 && C(e.charCodeAt(2)) && (i = !0, r = 3));
            let a = r < t ? st(e.slice(r), !i, "\\", C) : "";
            if (a.length === 0 && !i && (a = "."), a.length > 0 && C(e.charCodeAt(t - 1)) && (a += "\\"), !i && n === void 0 && e.includes(":")) {
                if (a.length >= 2 && ue(a.charCodeAt(0)) && a.charCodeAt(1) === le) return `.\\${a}`;
                let l = e.indexOf(":");
                do
                    if (l === t - 1 || C(e.charCodeAt(l + 1))) return `.\\${a}`; while ((l = e.indexOf(":", l + 1)) !== -1)
            }
        ...
        isAbsolute(e) {
            ...
            return C(r) || t > 2 && ue(r) && e.charCodeAt(1) === le && C(e.charCodeAt(2))
        },
        join(...e) {
            ...
            for (let o = 0; o < e.length; ++o) {
                const a = e[o];
                P(a, "path"), a.length > 0 && (t === void 0 ? t = r = a : t += `\\${a}`)
            }
            if (t === void 0) return ".";
            let n = !0,
                i = 0;
            if (typeof r == "string" && C(r.charCodeAt(0))) {
                ++i;
                const o = r.length;
                o > 1 && C(r.charCodeAt(1)) && (++i, o > 2 && (C(r.charCodeAt(2)) ? ++i : n = !1))
            }
            if (n) {
        ...
        relative(e, t) {
            ...
            if (r.length !== e.length || n.length !== t.length) {
                const E = r.split("\\"),
                    R = n.split("\\");
                E[E.length - 1] === "" && E.pop(), R[R.length - 1] === "" && R.pop();
                const I = E.length,
                    B = R.length,
                    me = I < B ? I : B;
                let U;
                for (U = 0; U < me && E[U].toLowerCase() === R[U].toLowerCase(); U++);
                return U === 0 ? n : U === me ? B > me ? R.slice(U).join("\\") : I > me ? "..\\".repeat(I - 1 - U) + ".." : "" : "..\\".repeat(I - U) + R.slice(U).join("\\")
            }
            let i = 0;
            for (; i < e.length && e.charCodeAt(i) === J;) i++;
            let o = e.length;
            for (; o - 1 > i && e.charCodeAt(o - 1) === J;) o--;
            const a = o - i;
            let l = 0;
            for (; l < t.length && t.charCodeAt(l) === J;) l++;
            let u = t.length;
            for (; u - 1 > l && t.charCodeAt(u - 1) === J;) u--;
            const c = u - l,
                d = a < c ? a : c;
            let h = -1,
                m = 0;
            for (; m < d; m++) {
                const E = e.charCodeAt(i + m);
                if (E !== t.charCodeAt(l + m)) break;
                E === J && (h = m)
            }
            if (m !== d) {
                if (h === -1) return n
                ...
                if (c > d) {
                    if (t.charCodeAt(l + m) === J) return n.slice(l + m + 1);
                    if (m === 2) return n.slice(l + m)
                }
                a > d && (e.charCodeAt(i + m) === J ? h = m : m === 2 && (h = 3)), h === -1 && (h = 0)
            }
            let _ = "";
            for (m = i + h + 1; m <= o; ++m)(m === o || e.charCodeAt(m) === J) && (_ += _.length === 0 ? ".." : "\\..");
            return l += h, _.length > 0 ? `${_}${n.slice(l,u)}` : (n.charCodeAt(l) === J && ++l, n.slice(l, u))
        },
        toNamespacedPath(e) {
            ...
            if (t.charCodeAt(0) === J) {
                if (t.charCodeAt(1) === J) {
                    ...
                    if (r !== si && r !== ye) return `\\\\?\\UNC\\${t.slice(2)}`
                }
            } else if (ue(t.charCodeAt(0)) && t.charCodeAt(1) === le && t.charCodeAt(2) === J) return `\\\\?\\${t}`;
            return t
        },
        dirname(e) {
            P(e, "path");
            ...
            } else ue(i) && e.charCodeAt(1) === le && (r = t > 2 && C(e.charCodeAt(2)) ? 3 : 2, n = r);
            let o = -1,
                a = !0;
            for (let l = t - 1; l >= n; --l)
                if (C(e.charCodeAt(l))) {
        ...
        basename(e, t) {
            ...
            let r = 0,
                ...
                i = !0,
                o;
            if (e.length >= 2 && ue(e.charCodeAt(0)) && e.charCodeAt(1) === le && (r = 2), t !== void 0 && t.length > 0 && t.length <= e.length) {
                if (t === e) return "";
                let a = t.length - 1,
                    l = -1;
                for (o = e.length - 1; o >= r; --o) {
                    ...
                    } else l === -1 && (i = !1, l = o + 1), a >= 0 && (u === t.charCodeAt(a) ? --a === -1 && (n = o) : (a = -1, n = l))
                }
        ...
        extname(e) {
            ...
            let t = 0,
                ...
                o = !0,
                a = 0;
            e.length >= 2 && e.charCodeAt(1) === le && ue(e.charCodeAt(0)) && (t = n = 2);
            for (let l = e.length - 1; l >= t; --l) {
                ...
                i === -1 && (o = !1, i = l + 1), u === ye ? r === -1 ? r = l : a !== 1 && (a = 1) : r !== -1 && (a = -1)
            }
        ...
        parse(e) {
            ...
            let n = 0,
                i = e.charCodeAt(0);
            if (r === 1) return C(i) ? (t.root = t.dir = e, t) : (t.base = t.name = e, t);
            if (C(i)) {
                if (n = 1, C(e.charCodeAt(1))) {
                    let h = 2,
                        m = h;
                    for (; h < r && !C(e.charCodeAt(h));) h++;
                    if (h < r && h !== m) {
                        for (m = h; h < r && C(e.charCodeAt(h));) h++;
                        if (h < r && h !== m) {
                            for (m = h; h < r && !C(e.charCodeAt(h));) h++;
                            h === r ? n = h : h !== m && (n = h + 1)
                        }
            ...
            } else if (ue(i) && e.charCodeAt(1) === le) {
            ...
            for (; c >= n; --c) {
                ...
                l === -1 && (u = !1, l = c + 1), i === ye ? o === -1 ? o = c : d !== 1 && (d = 1) : o !== -1 && (d = -1)
            }
            return l !== -1 && (o === -1 || d === 0 || d === 1 && o === l - 1 && o === a + 1 ? t.base = t.name = e.slice(a, l) : (t.name = e.slice(a, o), t.base = e.slice(a, l), t.ext = e.slice(o, l))), a > 0 && a !== n ? t.dir = e.slice(0, a - 1) : t.dir = t.root, t
        },
        sep: "\\",
        delimiter: ";",
        win32: null,
    ...
    x = {
        resolve(...e) {
            ...
            for (let n = e.length - 1; n >= 0 && !r; n--) {
                const i = e[n];
                P(i, `paths[${n}]`), i.length !== 0 && (t = `${i}/${t}`, r = i.charCodeAt(0) === j)
            }
            if (!r) {
                const n = ai();
                t = `${n}/${t}`, r = n.charCodeAt(0) === j
            }
            return t = st(t, !r, "/", Tt), r ? `/${t}` : t.length > 0 ? t : "."
        },
        normalize(e) {
            if (P(e, "path"), e.length === 0) return ".";
            const t = e.charCodeAt(0) === j,
                r = e.charCodeAt(e.length - 1) === j;
            return e = st(e, !t, "/", Tt), e.length === 0 ? t ? "/" : r ? "./" : "." : (r && (e += "/"), t ? `/${e}` : e)
        },
        isAbsolute(e) {
            return P(e, "path"), e.length > 0 && e.charCodeAt(0) === j
        },
        join(...e) {
            if (e.length === 0) return ".";
            const t = [];
            for (let r = 0; r < e.length; ++r) {
                const n = e[r];
                P(n, "path"), n.length > 0 && t.push(n)
            }
            return t.length === 0 ? "." : x.normalize(t.join("/"))
        },
        relative(e, t) {
            if (P(e, "from"), P(t, "to"), e === t || (e = x.resolve(e), t = x.resolve(t), e === t)) return "";
            const r = 1,
                n = e.length,
                i = n - r,
                o = 1,
            ...
            if (c === l)
                if (a > l) {
                    if (t.charCodeAt(o + c) === j) return t.slice(o + c + 1);
                    if (c === 0) return t.slice(o + c)
                } else i > l && (e.charCodeAt(r + c) === j ? u = c : c === 0 && (u = 0));
            let d = "";
            for (c = r + u + 1; c <= n; ++c)(c === n || e.charCodeAt(c) === j) && (d += d.length === 0 ? ".." : "/..");
            return `${d}${t.slice(o+u)}`
        },
        toNamespacedPath(e) {
            return e
        },
        ...
        extname(e) {
            ...
            for (let a = e.length - 1; a >= 0; --a) {
                ...
                n === -1 && (i = !1, n = a + 1), l === "." ? t === -1 ? t = a : o !== 1 && (o = 1) : t !== -1 && (o = -1)
            }
        ...
        parse(e) {
            ...
            for (; u >= n; --u) {
                ...
                a === -1 && (l = !1, a = u + 1), d === ye ? i === -1 ? i = u : c !== 1 && (c = 1) : i !== -1 && (c = -1)
            }
            if (a !== -1) {
                const d = o === 0 && r ? 1 : o;
                i === -1 || c === 0 || c === 1 && i === a - 1 && i === o + 1 ? t.base = t.name = e.slice(d, a) : (t.name = e.slice(d, i), t.base = e.slice(d, a), t.ext = e.slice(i, a))
            }
...
x.win32 = M.win32 = M, x.posix = M.posix = x;
var li = Y ? M.normalize : x.normalize,
    Go = Y ? M.isAbsolute : x.isAbsolute,
    ui = Y ? M.join : x.join,
    ci = Y ? M.resolve : x.resolve,
    hi = Y ? M.relative : x.relative,
    di = Y ? M.dirname : x.dirname,
    Ho = Y ? M.basename : x.basename,
    Qo = Y ? M.extname : x.extname,
    Jo = Y ? M.format : x.format,
    Yo = Y ? M.parse : x.parse,
    Zo = Y ? M.toNamespacedPath : x.toNamespacedPath,
    it = Y ? M.sep : x.sep,
    Xo = Y ? M.delimiter : x.delimiter,
    fi = class {
        constructor() {
            this.listeners = [], this.unexpectedErrorHandler = function(e) {
                setTimeout(() => {
                    throw e.stack ? It.isErrorNoTelemetry(e) ? new It(e.message + `
...
function ot(e) {
    Cr.onUnexpectedError(e)
}

function ce(e) {
    gi(e) || Cr.onUnexpectedError(e)
}
...
function gi(e) {
    return e instanceof mi ? !0 : e instanceof Error && e.name === Rt && e.message === Rt
}
var mi = class extends Error {
        constructor() {
            if (super(Rt), this.name = this.message, bi && typeof console < "u") {
                const e = new Error().stack ?? "";
                pi.some(t => e.includes(t)) && console.trace("[DebugCancellation] CancellationError created")
            }
        }
    },
    It = class or extends Error {
        constructor(t) {
...
function at(e, t, r = 0, n = e.length) {
    let i = r,
        o = n;
    for (; i < o;) {
...
function Sr(e, t, r = 0, n = e.length) {
    let i = r,
        o = n;
    for (; i < o;) {
        const a = Math.floor((i + o) / 2);
...
var ea = class vs {
    ...
    findLastMonotonous(t) {
        ...
        const r = at(this._array, t, this._findLastMonotonousLastIdx);
...
var wi = (e, t) => e - t,
    ta = class vt {
        ...
        filter(t) {
            return new vt(r => this.iterate(n => t(n) ? r(n) : !0))
        }
        map(t) {
            return new vt(r => this.iterate(n => r(t(n))))
        }
        some(t) {
            let r = !1;
        ...
        findLastMaxBy(t) {
            let r, n = !0;
            return this.iterate(i => ((n || Dt.isGreaterThan(t(i, r))) && (n = !1, r = i), !0)), r
        }
    },
    xr, Tr, Or, Li = class {
        constructor(e, t) {
...
var Rr = class We {
        ...
        constructor(t, r) {
            if (this[xr] = "ResourceMap", t instanceof We) this.map = new Map(t.map), this.toKey = r ?? We.defaultToKey;
            else if (ki(t)) {
                this.map = new Map, this.toKey = r ?? We.defaultToKey;
                for (const [n, i] of t) this.set(n, i)
            } else this.map = new Map, this.toKey = t ?? We.defaultToKey
        }
        set(t, r) {
            return this.map.set(this.toKey(t), new Li(t, r)), this
        }
        get(t) {
        ...
        forEach(t, r) {
            ...
            for (const [n, i] of this.map) t(i.value, i.uri, this)
        }* values() {
    ...
    ra = class {
        constructor(e, t) {
            this[Tr] = "ResourceSet", !e || typeof e == "function" ? this._map = new Rr(e) : (this._map = new Rr(t), e.forEach(this.add, this))
        }
        get size() {
            return this._map.size
        }
...
var na = class {
        constructor() {
            this[Or] = "LinkedMap", this._map = new Map, this._head = void 0, this._tail = void 0, this._size = 0, this._state = 0
        }
        clear() {
...
(function(e) {
    ...
    function* l(L) {
        for (let N = L.length - 1; N >= 0; N--) yield L[N]
    }
    e.reverse = l;
    ...
    function* m(L, N) {
        for (const T of L) N(T) && (yield T)
    }
    e.filter = m;

    function* _(L, N) {
        let T = 0;
        for (const Q of L) yield N(Q, T++)
    }
    e.map = _;
    ...
    function* R(...L) {
        for (const N of L) Ni(N) ? yield* N: yield N
    }
    e.concat = R;

    function I(L, N, T) {
        let Q = T;
        for (const xe of L) Q = N(Q, xe);
        return Q
    }
    e.reduce = I;
    ...
    function* me(L, N, T = L.length) {
        for (N < -L.length && (N = 0), N < 0 && (N += L.length), T < 0 ? T += L.length : T > L.length && (T = L.length); N < T; N++) yield L[N]
    }
    e.slice = me;

    function U(L, N = Number.POSITIVE_INFINITY) {
        const T = [];
        if (N === 0) return [T, L];
        const Q = L[Symbol.iterator]();
        for (let xe = 0; xe < N; xe++) {
            const Ye = Q.next();
            if (Ye.done) return [T, e.empty()];
            T.push(Ye.value)
        }
        return [T, {
            [Symbol.iterator]() {
    ...
    async function Ct(L) {
        const N = [];
        for await (const T of L) N.push(T);
    ...
    sa = class ys {
        ...
        computeLeakingDisposables(t = 10, r) {
            ...
            if (r) n = r;
                ...
                const d = new Set(c.map(h => h.value));
                if (n = c.filter(h => !(h.parent && d.has(h.parent))), n.length === 0) throw new Error("There are cyclic diposable chains!")
            }
            if (!n) return;

            function i(u) {
                function c(h, m) {
                    for (; h.length > 0 && m.some(_ => typeof _ == "string" ? _ === h[0] : h[0].match(_));) h.shift()
                }
                const d = u.source.split(`
`).map(h => h.trim().replace("at ", "")).filter(h => h !== "");
                return c(d, ["Error", /^trackDisposable \(.*\)$/, /^DisposableTracker.trackDisposable \(.*\)$/]), d.reverse()
            }
            const o = new Ci;
            for (const u of n) {
                const c = i(u);
                for (let d = 0; d <= c.length; d++) o.add(c.slice(0, d).join(`
`), u)
            }
            n.sort(yi(u => u.idx, wi));
            let a = "",
                l = 0;
            for (const u of n.slice(0, t)) {
                ...
                for (let h = 0; h < c.length; h++) {
                    let m = c[h];
                    m = `(shared with ${o.get(c.slice(0,h+1).join(`
`)).size}/${n.length} leaks) at ${m}`;
                    const E = o.get(c.slice(0, h).join(`
`)),
                        R = _i([...E].map(I => i(I)[h]), I => I);
                    delete R[c[h]];
                    for (const [I, B] of Object.entries(R)) d.unshift(`    - stacktraces of ${B.length} other leaks continue with ${I}`);
                    d.unshift(m)
                }
                a += `
...
function Oi(e, t) {
    if (Ie)
        for (const r of e) Ie.setParent(r, t)
}
...
var zt = class ws {
        ...
        add(t) {
            ...
            return Mt(t, this), this._isDisposed ? ws.DISABLE_DISPOSED_WARNING || console.warn(new Error("Trying to add a disposable to a DisposableStore that has already been disposed of. The added object will be leaked!").stack) : this._toDispose.add(t), t
        }
        delete(t) {
            if (t) {
        ...
        deleteAndLeak(t) {
            t && this._toDispose.has(t) && (this._toDispose.delete(t), Mt(t, null))
        }
    },
    ie = class {
        static {
        ...
        constructor() {
            this._store = new zt, lt(this), Mt(this._store, this)
        }
        dispose() {
    ...
    ia = class yt {
        static {
            this.Undefined = new yt(void 0)
        }
        constructor(t) {
            this.element = t, this.next = yt.Undefined, this.prev = yt.Undefined
        }
    },
    Ii = globalThis.performance && typeof globalThis.performance.now == "function",
    Mr = class Ls {
        static create(t) {
            return new Ls(t)
        }
        constructor(t) {
            this._now = Ii && t === !1 ? Date.now : globalThis.performance.now.bind(globalThis.performance), this._startTime = this._now(), this._stopTime = -1
        }
        stop() {
...
(function(e) {
    ...
    function t(b) {
        if (Di) {
            ...
            let g = 0;
            b.onDidAddListener = () => {
                ++g === 2 && (console.warn("snapshotted emitter LIKELY used public and SHOULD HAVE BEEN created with DisposableStore. snapshotted here"), p.print()), f?.()
            }
        }
    }

    function r(b, f) {
        return _(b, () => {}, 0, void 0, !0, void 0, f)
    }
    e.defer = r;
    ...
    function n(b) {
        return (f, p = null, g) => {
            let y = !1,
                k;
            return k = b(A => {
                if (!y) return k ? k.dispose() : y = !0, f.call(p, A)
            }, null, g), y && k.dispose(), k
        }
    }
    e.once = n;

    function i(b, f) {
        return e.once(e.filter(b, f))
    }
    e.onceIf = i;

    function o(b, f, p) {
        return h((g, y = null, k) => b(A => g.call(y, f(A)), null, k), p)
    }
    e.map = o;

    function a(b, f, p) {
        return h((g, y = null, k) => b(A => {
            f(A), g.call(y, A)
        }, null, k), p)
    }
    e.forEach = a;
    ...
    function l(b, f, p) {
        return h((g, y = null, k) => b(A => f(A) && g.call(y, A), null, k), p)
    }
    e.filter = l;
    ...
    function c(...b) {
        return (f, p = null, g) => {
            const y = Ri(...b.map(k => k(A => f.call(p, A))));
            return m(y, g)
        }
    }
    e.any = c;
    ...
    function m(b, f) {
        return f instanceof Array ? f.push(b) : f && f.add(b), b
    }

    function _(b, f, p = 100, g = !1, y = !1, k, A) {
        let $, V, Te, Ze = 0,
            $e;
        const hr = {
            ...
            onWillAddFirstListener() {
                $ = b(Rs => {
                    Ze++, V = f(V, Rs), g && !Te && (Xe.fire(V), V = void 0), $e = () => {
                        const Is = V;
                        V = void 0, Te = void 0, (!g || Ze > 1) && Xe.fire(Is), Ze = 0
                    }, typeof p == "number" ? (clearTimeout(Te), Te = setTimeout($e, p)) : Te === void 0 && (Te = 0, queueMicrotask($e))
                })
            },
        ...
        A || t(hr);
        const Xe = new K(hr);
        return A?.add(Xe), Xe.event
    }
    e.debounce = _;

    function E(b, f = 0, p) {
        return e.debounce(b, (g, y) => g ? (g.push(y), g) : [y], f, void 0, !0, void 0, p)
    }
    e.accumulate = E;

    function R(b, f = (g, y) => g === y, p) {
        let g = !0,
            y;
        return l(b, k => {
            const A = g || !f(k, y);
    ...
    function I(b, f, p) {
        return [e.filter(b, f, p), e.filter(b, g => !f(g), p)]
    }
    e.split = I;

    function B(b, f = !1, p = [], g) {
        let y = p.slice(),
            k = b(V => {
                y ? y.push(V) : $.fire(V)
            });
    ...
    class Ct {
        ...
        forEach(f) {
            return this.steps.push(p => (f(p), p)), this
        }
        filter(f) {
            return this.steps.push(p => f(p) ? p : U), this
        }
        reduce(f, p) {
            let g = p;
            return this.steps.push(y => (g = f(g, y), g)), this
        }
        latch(f = (p, g) => p === g) {
            let p = !0,
                g;
    ...
    function L(b, f, p = g => g) {
        const g = (...$) => A.fire(p(...$)),
            y = () => b.on(f, g),
            k = () => b.removeListener(f, g),
            A = new K({
    ...
    function N(b) {
        ...
        const p = () => {
            ...
            y = new K({
                ...
                onDidRemoveLastListener: g
            });
        return y.event
    }
    e.fromRxJS = N;

    function T(b, f, p = g => g) {
        const g = (...$) => A.fire(p(...$)),
            y = () => b.addEventListener(f, g),
            k = () => b.removeEventListener(f, g),
            A = new K({
                onWillAddFirstListener: y,
                onDidRemoveLastListener: k
            });
    ...
    function Q(b, f) {
        return new Promise(p => n(b)(p, null, f))
    }
    e.toPromise = Q;
    ...
    class xs {
        constructor(f, p) {
            ...
            p || t(g), this.emitter = new K(g), p && p.add(this.emitter)
        }
        beginUpdate(f) {
            this._counter++
        }
    ...
    function Ts(b, f) {
        return new xs(b, f).emitter.event
    }
    e.fromObservable = Ts;
    ...
    function Os(b) {
        return (f, p, g) => {
            ...
            const A = {
                ...
                endUpdate() {
                    y--, y === 0 && (b.reportChanges(), k && (k = !1, f.call(p)))
                },
            ...
            b.addObserver(A), b.reportChanges();
            const $ = {
                dispose() {
                    b.removeObserver(A)
                }
            };
            return g instanceof zt ? g.add($) : Array.isArray(g) && g.push($), $
        }
    }
    e.fromObservableLight = Os
})(ct || (ct = {}));
var Pi = class ar {
        static {
            this.all = new Set
    ...
    Mi = class ks {
        ...
        constructor(t, r, n = (ks._idPool++).toString(16).padStart(3, "0")) {
        ...
        getMostFrequentStack() {
            ...
            let t, r = 0;
            for (const [n, i] of this._stacks)(!t || r < i) && (t = [n, i], r = i);
            return t
        }
    },
    Ft = class Cs {
...
`))
    ...
    ht = class {
        constructor(e) {
            this.value = e, this.id = Ui++
        }
    },
    $i = 2,
    ji = (e, t) => {
        if (e instanceof ht) t(e);
        else
            for (let r = 0; r < e.length; r++) {
                const n = e[r];
                n && t(n)
    ...
    K = class {
        constructor(e) {
            this._size = 0, this._options = e, this._leakageMon = Fr > 0 || this._options?.leakWarningThreshold ? new Mi(e?.onListenerError ?? ce, this._options?.leakWarningThreshold ?? Fr) : void 0, this._perfMon = this._options?._profName ? new Pi(this._options._profName) : void 0, this._deliveryQueue = this._options?.deliveryQueue
        }
        dispose() {
            if (!this._disposed) {
            ...
            return this._event ??= (e, t, r) => {
                if (this._leakageMon && this._size > this._leakageMon.threshold ** 2) {
                    ...
                    const u = this._leakageMon.getMostFrequentStack() ?? ["UNKNOWN stack", -1],
                        c = new Fi(`${l}. HINT: Stack shows most frequent listener (${u[1]}-times)`, u[0]);
                    return (this._options?.onListenerError || ce)(c), ie.None
                }
                if (this._disposed) return ie.None;
                t && (e = e.bind(t));
                const n = new ht(e);
                let i, o;
                this._leakageMon && this._size >= Math.ceil(this._leakageMon.threshold * .2) && (n.stack = Ft.create(), i = this._leakageMon.check(n.stack, this._size + 1)), zr && (n.stack = o ?? Ft.create()), this._listeners ? this._listeners instanceof ht ? (this._deliveryQueue ??= new Bi, this._listeners = [this._listeners, n]) : this._listeners.push(n) : (this._options?.onWillAddFirstListener?.(this), this._listeners = n, this._options?.onDidAddFirstListener?.(this)), this._options?.onDidAddListener?.(this), this._size++;
                const a = De(() => {
        ...
        _removeListener(e) {
            ...
            if (this._size * $i <= t.length) {
                let i = 0;
                for (let o = 0; o < t.length; o++) t[o] ? t[i++] = t[o] : n && i < this._deliveryQueue.end && (this._deliveryQueue.end--, i < this._deliveryQueue.i && this._deliveryQueue.i--);
                t.length = i
            }
        }
        _deliver(e, t) {
        ...
        fire(e) {
            if (this._deliveryQueue?.current && (this._deliverQueue(this._deliveryQueue), this._perfMon?.stop()), this._perfMon?.start(this._size), this._listeners)
                if (this._listeners instanceof ht) this._deliver(this._listeners, e);
                else {
...
(function(e) {
    function t(r) {
        return r === e.None || r === e.Cancelled || r instanceof qi ? !0 : !r || typeof r != "object" ? !1 : typeof r.isCancellationRequested == "boolean" && typeof r.onCancellationRequested == "function"
    }
...
var qi = class {
    ...
    get onCancellationRequested() {
        return this._isCancelled ? Ur : (this._emitter || (this._emitter = new K), this._emitter.event)
    }
    dispose() {
...
var Wi = class {
        constructor(e, t) {
            this.lastCache = void 0, this.lastArgKey = void 0, typeof e == "function" ? (this._fn = e, this._computeKey = Vi) : (this._fn = t, this._computeKey = e.getCacheKey)
        }
        get(e) {
...
function Qi(e, t, r = 0, n = e.length, i = 0, o = t.length) {
    for (; r < n && i < o; r++, i++) {
...
function jr(e, t, r = 0, n = e.length, i = 0, o = t.length) {
    for (; r < n && i < o; r++, i++) {
        let u = e.charCodeAt(r),
            c = t.charCodeAt(i);
        if (u === c) continue;
        if (u >= 128 || c >= 128) return Qi(e.toLowerCase(), t.toLowerCase(), r, n, i, o);
        Br(u) && (u -= 32), Br(c) && (c -= 32);
        const d = u - c;
        if (d !== 0) return d
    }
...
function Ji(e, t) {
    return e.length === t.length && jr(e, t) === 0
}

function Yi(e, t) {
    const r = t.length;
    return t.length > e.length ? !1 : jr(e, t, 0, r) === 0
}
var Zi = /(?:\x1b\[|\x9b)[=?>!]?[\d;:]*["$#'* ]?[a-zA-Z@^`{}|~]/,
    Xi = /(?:\x1b\]|\x9d).*?(?:\x1b\\|\x07|\x9c)/,
    Ki = /\x1b(?:[ #%\(\)\*\+\-\.\/]?[a-zA-Z0-9\|}~@])/,
    oa = new RegExp("(?:" + [Zi.source, Xi.source, Ki.source].join("|") + ")", "g"),
    aa = "\uFEFF",
    Vr;
(function(e) {
...
var ua = class He {
        ...
        static {
            this.cache = new Wi({
                ...
                function r(d) {
                    const h = new Map;
                    for (let m = 0; m < d.length; m += 2) h.set(d[m], d[m + 1]);
                    return h
                }

                function n(d, h) {
                    const m = new Map(d);
                    for (const [_, E] of h) m.set(_, E);
                    return m
                }
                ...
                function i(d, h) {
                    if (!d) return h;
                    const m = new Map;
                    for (const [_, E] of d) h.has(_) && m.set(_, E);
                    return m
                }
                const o = this.ambiguousCharacterData.value;
                let a = t.filter(d => !d.startsWith("_") && d in o);
        ...
        static {
            this._locales = new Ut(() => Object.keys(He.ambiguousCharacterData.value).filter(t => !t.startsWith("_")))
        }
        static getLocales() {
    ...
    ca = class Qe {
        ...
        static getData() {
            return this._data || (this._data = new Set([...Object.values(Qe.getRawData())].flat())), this._data
        }
        ...
        static containsInvisibleCharacter(t) {
            for (let r = 0; r < t.length; r++) {
                const n = t.codePointAt(r);
                if (typeof n == "number" && (Qe.isInvisibleCharacter(n) || n === 32)) return !0
            }
            return !1
        }
...
var t1 = "tkn",
    r1 = class {
        ...
        setServerRootPath(e, t) {
            this._serverRootPath = x.join(t ?? "/", s1(e))
        }
        getServerRootPath() {
            return this._serverRootPath
        }
        get _remoteResourcesPath() {
            return x.join(this._serverRootPath, z.vscodeRemoteResource)
        }
        set(e, t, r) {
        ...
        rewrite(e) {
            ...
            return typeof i == "string" && (o += `&${t1}=${encodeURIComponent(i)}`), X.from({
                scheme: _r ? this._preferredWebSchema : z.vscodeRemoteResource,
                authority: `${r}:${n}`,
...
var i1 = "vs/../../node_modules",
    o1 = "vs/../../node_modules.asar",
    Gr = "vscode-app",
    a1 = class wt {
        static {
            this.FALLBACK_AUTHORITY = Gr
        }
        asBrowserUri(t) {
        ...
        uriToBrowserUri(t) {
            return t.scheme === z.vscodeRemote ? n1.rewrite(t) : t.scheme === z.file && (Qs || Ys === `${z.vscodeFileResource}://${wt.FALLBACK_AUTHORITY}`) ? t.with({
        ...
        uriToFileUri(t) {
            return t.scheme === z.vscodeFileResource ? t.with({
                scheme: z.file,
...
(function(e) {
    ...
    function n(o) {
        let a;
        typeof o == "string" ? a = new URL(o).searchParams : o instanceof URL ? a = o.searchParams : X.isUri(o) && (a = new URL(o.toString(!0)).searchParams);
        const l = a?.get(r);
        if (l) return t.get(l)
    }
...
var fa = new Ut(() => new Uint8Array(256));
...
function d1(e, t) {
    ...
    if (e.scheme && !u1.test(e.scheme)) throw new Error("[UriError]: Scheme contains illegal characters.");
    if (e.path) {
        if (e.authority) {
            if (!c1.test(e.path)) throw new Error('[UriError]: If a URI contains an authority component, then the path component must either be empty or begin with a slash ("/") character')
        } else if (h1.test(e.path)) throw new Error('[UriError]: If a URI does not contain an authority component, then the path cannot begin with two slash characters ("//")')
    }
}
...
var O = "",
    ...
    X = class Lt {
        static isUri(t) {
            return t instanceof Lt ? !0 : t ? typeof t.authority == "string" && typeof t.fragment == "string" && typeof t.path == "string" && typeof t.query == "string" && typeof t.scheme == "string" && typeof t.fsPath == "string" && typeof t.with == "function" && typeof t.toString == "function" : !1
        }
        constructor(t, r, n, i, o, a = !1) {
            typeof t == "object" ? (this.scheme = t.scheme || O, this.authority = t.authority || O, this.path = t.path || O, this.query = t.query || O, this.fragment = t.fragment || O) : (this.scheme = f1(t, a), this.authority = r || O, this.path = g1(this.scheme, n || O), this.query = i || O, this.fragment = o || O, d1(this, a))
        }
        get fsPath() {
            return gt(this, !1)
        }
        with(t) {
            ...
            return r === void 0 ? r = this.scheme : r === null && (r = O), n === void 0 ? n = this.authority : n === null && (n = O), i === void 0 ? i = this.path : i === null && (i = O), o === void 0 ? o = this.query : o === null && (o = O), a === void 0 ? a = this.fragment : a === null && (a = O), r === this.scheme && n === this.authority && i === this.path && o === this.query && a === this.fragment ? this : new Pe(r, n, i, o, a)
        }
        static parse(t, r = !1) {
            const n = m1.exec(t);
            return n ? new Pe(n[2] || O, mt(n[4] || O), mt(n[5] || O), mt(n[7] || O), mt(n[9] || O), r) : new Pe(O, O, O, O, O)
        }
        static file(t) {
            let r = O;
            if (Re && (t = t.replace(/\\/g, ne)), t[0] === ne && t[1] === ne) {
                const n = t.indexOf(ne, 2);
                n === -1 ? (r = t.substring(2), t = ne) : (r = t.substring(2, n), t = t.substring(n) || ne)
            }
            return new Pe("file", r, t, O, O)
        }
        static from(t, r) {
            return new Pe(t.scheme, t.authority, t.path, t.query, t.fragment, r)
        }
        static joinPath(t, ...r) {
            if (!t.path) throw new Error("[UriError]: cannot call joinPath on URI without path");
            let n;
            return Re && t.scheme === "file" ? n = Lt.file(M.join(gt(t, !0), ...r)).path : n = x.join(t.path, ...r), t.with({
                path: n
            })
        }
        toString(t = !1) {
        ...
        static revive(t) {
            if (t) {
                ...
                {
                    const r = new Pe(t);
                    return r._formatted = t.external ?? null, r._fsPath = t._sep === Qr ? t.fsPath ?? null : null, r
                }
            } else return t
    ...
    Pe = class extends X {
        ...
        toString(e = !1) {
            return e ? $t(this, !0) : (this._formatted || (this._formatted = $t(this, !1)), this._formatted)
        }
        toJSON() {
            const e = {
                $mid: 1
            };
            return this._fsPath && (e.fsPath = this._fsPath, e._sep = Qr), this._formatted && (e.external = this._formatted), this.path && (e.path = this.path), this.scheme && (e.scheme = this.scheme), this.authority && (e.authority = this.authority), this.query && (e.query = this.query), this.fragment && (e.fragment = this.fragment), e
        }
    },
    Jr = {
        58: "%3A",
...
function Yr(e, t, r) {
    ...
    for (let o = 0; o < e.length; o++) {
        ...
        if (a >= 97 && a <= 122 || a >= 65 && a <= 90 || a >= 48 && a <= 57 || a === 45 || a === 46 || a === 95 || a === 126 || t && a === 47 || r && a === 91 || r && a === 93 || r && a === 58) i !== -1 && (n += encodeURIComponent(e.substring(i, o)), i = -1), n !== void 0 && (n += e.charAt(o));
        else {
            n === void 0 && (n = e.substr(0, o));
            const l = Jr[a];
            l !== void 0 ? (i !== -1 && (n += encodeURIComponent(e.substring(i, o)), i = -1), n += l) : i === -1 && (i = o)
        }
    }
...
function p1(e) {
    ...
    for (let r = 0; r < e.length; r++) {
        ...
        n === 35 || n === 63 ? (t === void 0 && (t = e.substr(0, r)), t += Jr[n]) : t !== void 0 && (t += e[r])
    }
    return t !== void 0 ? t : e
}
...
function gt(e, t) {
    let r;
    return e.authority && e.path.length > 1 && e.scheme === "file" ? r = `//${e.authority}${e.path}` : e.path.charCodeAt(0) === 47 && (e.path.charCodeAt(1) >= 65 && e.path.charCodeAt(1) <= 90 || e.path.charCodeAt(1) >= 97 && e.path.charCodeAt(1) <= 122) && e.path.charCodeAt(2) === 58 ? t ? r = e.path.substr(1) : r = e.path[1].toLowerCase() + e.path.substr(2) : r = e.path, Re && (r = r.replace(/\//g, "\\")), r
}
...
function $t(e, t) {
    ...
    if (i && (n += i, n += ":"), (o || i === "file") && (n += ne, n += ne), o) {
        let c = o.indexOf("@");
        if (c !== -1) {
            const d = o.substr(0, c);
            o = o.substr(c + 1), c = d.lastIndexOf(":"), c === -1 ? n += r(d, !1, !1) : (n += r(d.substr(0, c), !1, !1), n += ":", n += r(d.substr(c + 1), !1, !0)), n += "@"
        }
    ...
    return l && (n += "?", n += r(l, !1, !1)), u && (n += "#", n += t ? u : Yr(u, !1, !1)), n
}
...
var Xr = /(%[0-9A-Za-z][0-9A-Za-z])+/g;

function mt(e) {
    return e.match(Xr) ? e.replace(Xr, t => Zr(t)) : e
}
...
function en(e, t = x.sep) {
    if (!e) return "";
    const r = e.length,
        n = e.charCodeAt(0);
    if (be(n)) {
        if (be(e.charCodeAt(1)) && !be(e.charCodeAt(2))) {
            let o = 3;
            const a = o;
            for (; o < r && !be(e.charCodeAt(o)); o++);
            if (a !== o && !be(e.charCodeAt(o + 1))) {
                for (o += 1; o < r; o++)
                    if (be(e.charCodeAt(o))) return e.slice(0, o + 1).replace(/[\\/]/g, t)
            }
        }
        return t
    } else if (_1(n) && e.charCodeAt(1) === 58) return be(e.charCodeAt(2)) ? e.slice(0, 2) + t : e.slice(0, 2);
    let i = e.indexOf("://");
    if (i !== -1) {
        for (i += 3; i < r; i++)
            if (be(e.charCodeAt(i))) return e.slice(0, i + 1)
    }
    return ""
}

function tn(e, t, r, n = it) {
    if (e === t) return !0;
...
var jt = class {
        ...
        compare(e, t, r = !1) {
            return e === t ? 0 : Hi(this.getComparisonKey(e, r), this.getComparisonKey(t, r))
        }
        isEqual(e, t, r = !1) {
        ...
        isEqualOrParent(e, t, r = !1) {
            if (e.scheme === t.scheme) {
                if (e.scheme === z.file) return tn(he(e), he(t), this._ignorePathCasing(e)) && e.query === t.query && (r || e.fragment === t.fragment);
                if (rn(e.authority, t.authority)) return tn(e.path, t.path, this._ignorePathCasing(e), "/") && e.query === t.query && (r || e.fragment === t.fragment)
            }
            return !1
        }
        joinPath(e, ...t) {
        ...
        dirname(e) {
            ...
            let t;
            return e.scheme === z.file ? t = X.file(di(he(e))).path : (t = x.dirname(e.path), e.authority && t.length && t.charCodeAt(0) !== 47 && (console.error(`dirname("${e.toString})) resulted in a relative path`), t = "/")), e.with({
                path: t
            })
        }
        normalizePath(e) {
            ...
            let t;
            return e.scheme === z.file ? t = X.file(li(he(e))).path : t = x.normalize(e.path), e.with({
                path: t
            })
        }
        relativePath(e, t) {
            if (e.scheme !== t.scheme || !rn(e.authority, t.authority)) return;
            if (e.scheme === z.file) {
                const i = hi(he(e), he(t));
                return Re ? Kr(i) : i
            }
            let r = e.path || "/";
            const n = t.path || "/";
        ...
        resolvePath(e, t) {
            if (e.scheme === z.file) {
                const r = X.file(ci(he(e), t));
                return e.with({
                    authority: r.authority,
                    path: r.path
                })
            }
            return t = b1(t), e.with({
        ...
        isEqualAuthority(e, t) {
            return e === t || e !== void 0 && t !== void 0 && Ji(e, t)
        }
        hasTrailingPathSeparator(e, t = it) {
            if (e.scheme === z.file) {
                const r = he(e);
                return r.length > en(r).length && r[r.length - 1] === t
            } else {
                const r = e.path;
                return r.length > 1 && r.charCodeAt(r.length - 1) === 47 && !/^[a-zA-Z]:(\/$|\\$)/.test(e.fsPath)
            }
        }
        removeTrailingPathSeparator(e, t = it) {
            return nn(e, t) ? e.with({
                path: e.path.substr(0, e.path.length - 1)
            }) : e
        }
        addTrailingPathSeparator(e, t = it) {
            let r = !1;
            if (e.scheme === z.file) {
                const n = he(e);
                r = n !== void 0 && n.length === en(n).length && n[n.length - 1] === t
            } else {
                t = "/";
                const n = e.path;
                r = n.length === 1 && n.charCodeAt(n.length - 1) === 47
            }
            return !r && !nn(e, t) ? e.with({
                path: e.path + "/"
            }) : e
        }
    },
    S = new jt(() => !1),
    ga = new jt(e => e.scheme === z.file ? !Hs : !0),
    ma = new jt(e => !0),
    v1 = S.isEqual.bind(S),
    pa = S.isEqualOrParent.bind(S),
    ba = S.getComparisonKey.bind(S),
    _a = S.basenameOrAuthority.bind(S),
    y1 = S.basename.bind(S),
    va = S.extname.bind(S),
    ya = S.dirname.bind(S),
    wa = S.joinPath.bind(S),
    La = S.normalizePath.bind(S),
    ka = S.relativePath.bind(S),
    Ca = S.resolvePath.bind(S),
    Ea = S.isAbsolutePath.bind(S),
    rn = S.isEqualAuthority.bind(S),
    nn = S.hasTrailingPathSeparator.bind(S),
    Na = S.removeTrailingPathSeparator.bind(S),
    Sa = S.addTrailingPathSeparator.bind(S),
    sn;
(function(e) {
...
var w1 = class {
        ...
        register(e) {
            if (this._scopeNameToLanguageRegistration[e.scopeName]) {
                const t = this._scopeNameToLanguageRegistration[e.scopeName];
                v1(t.location, e.location) || console.warn(`Overwriting grammar scope name to file mapping for scope ${e.scopeName}.
...
New grammar file: ${e.location.toString()}`)
    ...
    L1 = class extends ie {
        constructor(e, t, r, n) {
            super(), this._host = e, this._initialState = r.INITIAL, this._scopeRegistry = new w1, this._injections = {}, this._injectedEmbeddedLanguages = {}, this._languageToScope = new Map, this._grammarRegistry = this._register(new r.Registry({
                onigLib: n,
                loadGrammar: async i => {
        ...
        async createGrammar(e, t) {
            const r = this._languageToScope.get(e);
            ...
            let a;
            try {
                a = await this._grammarRegistry.loadGrammarWithConfiguration(r, t, {
                    embeddedLanguages: i,
    ...
    q = [];
for (let e = 0; e < 256; e++) q.push(e.toString(16).padStart(2, "0"));
var k1 = (function() {
        ...
        return function() {
            ...
            let r = 0,
                n = "";
            return n += q[e[r++]], n += q[e[r++]], n += q[e[r++]], n += q[e[r++]], n += "-", n += q[e[r++]], n += q[e[r++]], n += "-", n += q[e[r++]], n += q[e[r++]], n += "-", n += q[e[r++]], n += q[e[r++]], n += "-", n += q[e[r++]], n += q[e[r++]], n += q[e[r++]], n += q[e[r++]], n += q[e[r++]], n += q[e[r++]], n
        }
    })(),
    C1 = !1,
    E1 = class {
...
var N1 = class Es {
        ...
        constructor() {
            this._isWebWorker = typeof self == "object" && self.constructor && self.constructor.name === "DedicatedWorkerGlobalScope", this._isRenderer = typeof document == "object", this._defineCalls = [], this._state = we.Uninitialized
        }
        _initialize() {
            if (this._state === we.Uninitialized) {
                if (globalThis.define) {
                    this._state = we.InitializedExternal;
                    return
                }
            } else return;
            this._state = we.InitializedInternal, globalThis.define = (t, r, n) => {
                typeof t != "string" && (n = r, r = t, t = null), (typeof r != "object" || !Array.isArray(r)) && (n = r, r = null), this._defineCalls.push(new E1(t, r, n))
                ...
                createScriptURL(t) {
                    if (t.startsWith(window.location.origin) || t.startsWith(`${z.vscodeFileResource}://${Gr}`)) return t;
        ...
        async load(t) {
            if (this._initialize(), this._state === we.InitializedExternal) return new Promise(a => {
                const l = k1();
                globalThis.define(l, [t], function(u) {
                    a(u)
                })
            });
            const r = await (this._isWebWorker ? this._workerLoadScript(t) : this._isRenderer ? this._rendererLoadScript(t) : this._nodeJSLoadScript(t));
            if (!r) {
            ...
            if (o.length > 0) throw new Error(`Cannot resolve dependencies for script ${t}. The dependencies are: ${o.join(", ")}`);
            return typeof r.callback == "function" ? r.callback(...i) ?? n : r.callback
        }
        _rendererLoadScript(t) {
            return new Promise((r, n) => {
                ...
                i.addEventListener("load", a), i.addEventListener("error", l), this._amdPolicy && (t = this._amdPolicy.createScriptURL(t)), i.setAttribute("src", t), window.document.getElementsByTagName("head")[0].appendChild(i)
            })
        }
        async _workerLoadScript(t) {
            return this._amdPolicy && (t = this._amdPolicy.createScriptURL(t)), await import(t), this._defineCalls.pop()
        }
        async _nodeJSLoadScript(t) {
            try {
...
async function Vt(e, t, r) {
    ...
    if (/^\w[\w\d+.-]*:\/\//.test(n)) i = n;
        ...
        const u = `${C1&&r&&!_r?o1:i1}/${n}`;
        i = l1.asBrowserUri(u).toString(!0)
    }
    const o = N1.INSTANCE.load(i);
    return qt.set(n, o), o
}
var Aa = Symbol("MicrotaskDelay"),
    S1 = class {
        constructor(e, t) {
    ...
    A1, Wt;
(function() {
    typeof globalThis.requestIdleCallback != "function" || typeof globalThis.cancelIdleCallback != "function" ? Wt = (e, t, r) => {
        yr(() => {
            if (n) return;
            const i = Date.now() + 15;
            t(Object.freeze({
...
var xa = class ee {
        ...
        constructor(t, r) {
            this._state = 0, this._results = [], this._error = null, this._onReturn = r, this._onStateChanged = new K, queueMicrotask(async () => {
                const n = {
...
function Jt(e) {
    Le ? Le instanceof fn ? Le.loggers.push(e) : Le = new fn([Le, e]) : Le = e
}
...
var F1 = class {
        ...
        recomputeInitiallyAndOnChange(e, t) {
            return e.add(gn(this, t)), this
        }
        keepObserved(e) {
            return e.add(mn(this)), this
        }
        get debugValue() {
            return this.get()
        }
    ...
    Xt = class extends F1 {
        ...
        addObserver(e) {
            ...
            this._observers.add(e), t === 0 && this.onFirstObserverAdded(), t !== this._observers.size && F()?.handleOnListenerCountChanged(this, this._observers.size)
        }
        removeObserver(e) {
            const t = this._observers.delete(e);
            t && this._observers.size === 0 && this.onLastObserverRemoved(), t && F()?.handleOnListenerCountChanged(this, this._observers.size)
        }
        onFirstObserverAdded() {}
        onLastObserverRemoved() {}
        log() {
            const e = !!F();
            return D1(this), e || F()?.handleObservableCreated(this), this
        }
        debugGetObservers() {
...
var bn = class {
    constructor(e, t) {
        this._fn = e, this._getDebugName = t, this._updatingObservers = [], F()?.handleBeginTransaction(this)
    }
    getDebugName() {
    ...
    updateObserver(e, t) {
        if (!this._updatingObservers) {
            _n("Transaction already finished!"), pn(r => {
    ...
    finish() {
        ...
        if (!e) {
            _n("transaction.finish() has already been called!");
            return
        }
...
function _n(e) {
    ...
    ce(t), console.error("recovered from an error that indicates a bug", t)
}

function $1(e, t) {
    let r;
    return typeof e == "string" ? r = new qe(void 0, e, void 0) : r = new qe(e, void 0, void 0), new Kt(r, t, Qt)
}
var Kt = class extends Xt {
    ...
    constructor(e, t, r) {
        super(), this._debugNameData = e, this._equalityComparator = r, this._value = t, F()?.handleObservableUpdated(this, {
            hadValue: !1,
            newValue: t,
            change: void 0,
            didChange: !0,
    ...
    set(e, t, r) {
        ...
        let n;
        t || (t = n = new bn(() => {}, () => `Setting ${this.debugName}`));
        try {
            const i = this._value;
            this._setValue(e), F()?.handleObservableUpdated(this, {
                oldValue: i,
                newValue: e,
                change: r,
                didChange: !0,
...
function vn(e) {
    return new er(new qe(void 0, void 0, e), e, void 0, void 0)
}
var yn;
(function(e) {
...
var er = class {
    ...
    handleChange(e, t) {
        if (this._isDependency(e)) {
            F()?.handleAutorunDependencyChanged(this, e, t);
            try {
...
function j1(e, t) {
    return new de(new qe(e.owner, e.debugName, e.debugReferenceFn), t, void 0, void 0, e.onLastObserverRemoved, e.equalsFn ?? Qt)
}
z1(j1);
var wn;
(function(e) {
...
var de = class extends Xt {
    ...
    _recompute() {
        ...
        try {
            ...
            n = t && !this._equalityComparator(r, this._value), F()?.handleObservableUpdated(this, {
                oldValue: r,
    ...
    handleChange(e, t) {
        if (this._dependencies.has(e) && !this._dependenciesToBeRemoved.has(e)) {
            F()?.handleDerivedDependencyChanged(this, e, t);
            let r = !1;
            try {
...
function Ln(...e) {
    let t, r, n;
    return e.length === 3 ? [t, r, n] = e : [r, n] = e, new ke(new qe(t, void 0, n), r, n, () => ke.globalTransaction, Qt)
}
var ke = class extends Xt {
    constructor(e, t, r, n, i) {
        super(), this._debugNameData = e, this.event = t, this._getValue = r, this._getTransaction = n, this._equalityComparator = i, this._hasValue = !1, this.handleEvent = o => {
            const a = this._getValue(o),
                l = this._value,
                u = !this._hasValue || !this._equalityComparator(l, a);
            let c = !1;
            u && (this._value = a, this._hasValue && (c = !0, U1(this._getTransaction(), d => {
                ...
                for (const h of this._observers) d.updateObserver(h, this), h.handleChange(this, void 0)
            }, () => {
...
(function(e) {
    ...
    function t(r, n) {
        let i = !1;
        ke.globalTransaction === void 0 && (ke.globalTransaction = r, i = !0);
        try {
            n()
        } finally {
            i && (ke.globalTransaction = void 0)
        }
    }
...
function q1(e) {
    pt || (pt = new En, Jt(pt)), pt.addFilteredObj(e)
}
var En = class {
    constructor() {
    ...
    textToConsoleArgs(e) {
        return V1([Me(H1("|  ", this.indentation)), e])
    }
    formatInfo(e) {
        return e.hadValue ? e.didChange ? [Me(" "), te(fe(e.oldValue, 70), {
            color: "red",
            strikeThrough: !0
        }), Me(" "), te(fe(e.newValue, 60), {
            color: "green"
        })] : [Me(" (unchanged)")] : [Me(" "), te(fe(e.newValue, 60), {
            color: "green"
        }), Me(" (initial)")]
    }
    handleObservableCreated(e) {
        if (e instanceof de) {
            ...
            if (this.changedObservablesSets.set(t, new Set), !1) {
                const n = [];
                t.__debugUpdating = n;
                const i = t.beginUpdate;
                t.beginUpdate = a => (n.push(a), i.apply(t, [a]));
                const o = t.endUpdate;
                t.endUpdate = a => {
                    const l = n.indexOf(a);
    ...
    handleObservableUpdated(e, t) {
        if (this._isIncluded(e)) {
            ...
            console.log(...this.textToConsoleArgs([ze("observable value changed"), te(e.debugName, {
                color: "BlueViolet"
            }), ...this.formatInfo(t)]))
        }
    }
    formatChanges(e) {
        if (e.size !== 0) return te(" (changed deps: " + [...e].map(t => t.debugName).join(", ") + ")", {
            color: "gray"
        })
    }
    handleDerivedDependencyChanged(e, t, r) {
    ...
    _handleDerivedRecomputed(e, t) {
        ...
        r && (console.log(...this.textToConsoleArgs([ze("derived recomputed"), te(e.debugName, {
            color: "BlueViolet"
    ...
    handleDerivedCleared(e) {
        this._isIncluded(e) && console.log(...this.textToConsoleArgs([ze("derived cleared"), te(e.debugName, {
            color: "BlueViolet"
        })]))
    }
    handleFromEventObservableTriggered(e, t) {
        this._isIncluded(e) && console.log(...this.textToConsoleArgs([ze("observable from event triggered"), te(e.debugName, {
            color: "BlueViolet"
        }), ...this.formatInfo(t), {
            data: [{
                fn: e._getValue
    ...
    handleAutorunStarted(e) {
        ...
        t && (this._isIncluded(e) && console.log(...this.textToConsoleArgs([ze("autorun"), te(e.debugName, {
            color: "BlueViolet"
    ...
    handleBeginTransaction(e) {
        ...
        t === void 0 && (t = ""), this._isIncluded(e) && console.log(...this.textToConsoleArgs([ze("transaction"), te(t, {
            color: "BlueViolet"
        }), {
            data: [{
                fn: e._fn
...
function fe(e, t) {
    switch (typeof e) {
        ...
        case "undefined":
            return "undefined";
        case "object":
            return e === null ? "null" : Array.isArray(e) ? W1(e, t) : G1(e, t);
        case "symbol":
            return e.toString();
        case "function":
...
function Sn(e, t) {
    for (const r in t) e[r] && typeof e[r] == "object" && t[r] && typeof t[r] == "object" ? Sn(e[r], t[r]) : e[r] = t[r]
}

function An(e, t) {
    for (const r in t) t[r] === null ? delete e[r] : e[r] && typeof e[r] == "object" && t[r] && typeof t[r] == "object" ? An(e[r], t[r]) : e[r] = t[r]
}
var eo = class Je {
    static {
    ...
    static getInstance() {
        return Je._instance === void 0 && (Je._instance = new Je), Je._instance
    }
    getTransactionState() {
        const t = [],
    ...
    _getInfo(t, r) {
        if (t instanceof de) {
            ...
            const o = t.debugGetState(),
                ...
                l = [...i.changedObservables].map(u => this._instanceInfos.get(u)?.instanceId).filter(Be);
    ...
    constructor() {
        this._declarationId = 0, this._instanceId = 0, this._declarations = new Map, this._instanceInfos = new WeakMap, this._aliveInstances = new Map, this._activeTransactions = new Set, this._channel = Y1("observableDevTools", () => ({
            notifications: {
            ...
            requests: {
                ...
                getObservableValueInfo: t => ({
                    observers: [...this._aliveInstances.get(t).debugGetObservers()].map(n => this._formatObserver(n)).filter(Be)
                }),
                getDerivedInfo: t => {
                    const r = this._aliveInstances.get(t);
                    return {
                        dependencies: [...r.debugGetState().dependencies].map(n => this._formatObservable(n)).filter(Be),
                        observers: [...r.debugGetObservers()].map(n => this._formatObserver(n)).filter(Be)
                    }
                },
                getAutorunInfo: t => ({
                    dependencies: [...this._aliveInstances.get(t).debugGetState().dependencies].map(n => this._formatObservable(n)).filter(Be)
                }),
                getTransactionState: () => this.getTransactionState(),
                setValue: (t, r) => {
                    const n = this._aliveInstances.get(t);
                    if (n instanceof de) n.debugSetValue(r);
                    else if (n instanceof Kt) n.debugSetValue(r);
                    else if (n instanceof ke) n.debugSetValue(r);
                ...
                getValue: t => {
                    const r = this._aliveInstances.get(t);
                    if (r instanceof de) return fe(r.debugGetState().value, 200);
                    if (r instanceof Kt) return fe(r.debugGetState().value, 200)
                }
            }
        })), this._pendingChanges = null, this._changeThrottler = new K1, this._fullState = {}, this._flushUpdates = () => {
            this._pendingChanges !== null && (this._channel.api.notifications.handleChange(this._pendingChanges, !1), this._pendingChanges = null)
        }
    }
    _handleChange(t) {
        An(this._fullState, t), this._pendingChanges === null ? this._pendingChanges = t : Sn(this._pendingChanges, t), this._changeThrottler.throttle(this._flushUpdates, 10)
    }
    _getDeclarationId(t) {
        let r = !0,
            n;
        ...
        for (;;) {
            ...
            i.stackTraceLimit = a;
            let u = Nn(l, /[/\\]observableInternal[/\\]|\.observe|[/\\]util(s)?\./);
            if (!r && !u && (u = Nn(l, /[/\\]observableInternal[/\\]|\.observe/)), u) {
                n = u;
                break
            }
            if (!r) {
    ...
    handleOnListenerCountChanged(t, r) {
        ...
        if (n) {
            if (n.listenerCount === 0 && r > 0) {
                const i = t instanceof de ? "observable/derived" : "observable/value";
...
I1(q1);
var to = !1;
to && Jt(new En), xt && xt.VSCODE_DEV_DEBUG && Jt(eo.getInstance());
var G = class re {
        static fromTo(t, r) {
            return new re(t, r)
        }
        ...
        constructor(t, r) {
            if (this.start = t, this.endExclusive = r, t > r) throw new Z(`Invalid range: ${this.toString()}`)
        }
        get isEmpty() {
            return this.start === this.endExclusive
        }
        delta(t) {
            return new re(this.start + t, this.endExclusive + t)
        }
        deltaStart(t) {
            return new re(this.start + t, this.endExclusive)
        }
        deltaEnd(t) {
            return new re(this.start, this.endExclusive + t)
        }
        get length() {
        ...
        join(t) {
            return new re(Math.min(this.start, t.start), Math.max(this.endExclusive, t.endExclusive))
        }
        intersect(t) {
    ...
    bt = class Se {
        ...
        with(t = this.lineNumber, r = this.column) {
            return t === this.lineNumber && r === this.column ? this : new Se(t, r)
        }
        delta(t = 0, r = 0) {
            return this.with(Math.max(1, this.lineNumber + t), Math.max(1, this.column + r))
        }
        equals(t) {
            return Se.equals(this, t)
        }
        static equals(t, r) {
            return !t && !r ? !0 : !!t && !!r && t.lineNumber === r.lineNumber && t.column === r.column
        }
        isBefore(t) {
            return Se.isBefore(this, t)
        }
        static isBefore(t, r) {
            return t.lineNumber < r.lineNumber ? !0 : r.lineNumber < t.lineNumber ? !1 : t.column < r.column
        }
        isBeforeOrEqual(t) {
            return Se.isBeforeOrEqual(this, t)
        }
        ...
        static lift(t) {
            return new Se(t.lineNumber, t.column)
        }
    ...
    xn = class D {
        ...
        static intersectRanges(t, r) {
            ...
            const l = r.startLineNumber,
                ...
                c = r.endLineNumber,
                d = r.endColumn;
            return n < l ? (n = l, i = u) : n === l && (i = Math.max(i, u)), o > c ? (o = c, a = d) : o === c && (a = Math.min(a, d)), n > o || n === o && i > a ? null : new D(n, i, o, a)
        }
...
`) === -1 ? t.startColumn + r.length : r.length - r.lastIndexOf(`
`)
            }
        }
        whereIs(t) {
        ...
        static rangeAfterEdit(t, r) {
            const n = D.lift(t).whereIs(r.range);
            switch (n) {
                case "overlapping":
...
`).length - 1 - (r.range.endLineNumber - r.range.startLineNumber);
                    if (r.range.endLineNumber < t.startLineNumber) return {
...
`) - 1,
                        ...
                        return {
                            ...
                            endLineNumber: t.endLineNumber + i,
                            endColumn: t.startLineNumber === t.endLineNumber ? t.endColumn + l : t.endColumn
                        }
                    }
                }
                default: {
        ...
        static getEndPosition(t) {
            return new bt(t.endLineNumber, t.endColumn)
        }
        getStartPosition() {
            return D.getStartPosition(this)
        }
        static getStartPosition(t) {
            return new bt(t.startLineNumber, t.startColumn)
        }
        toString() {
            return "[" + this.startLineNumber + "," + this.startColumn + " -> " + this.endLineNumber + "," + this.endColumn + "]"
        }
        setEndPosition(t, r) {
            return new D(this.startLineNumber, this.startColumn, t, r)
        }
        setStartPosition(t, r) {
            return new D(t, r, this.endLineNumber, this.endColumn)
        }
        collapseToStart() {
        ...
        static fromPositions(t, r = t) {
            return new D(t.lineNumber, t.column, r.lineNumber, r.column)
        }
        static lift(t) {
        ...
        static areOnlyIntersecting(t, r) {
            return !(t.endLineNumber < r.startLineNumber - 1 || t.endLineNumber === r.startLineNumber && t.endColumn < r.startColumn - 1 || r.endLineNumber < t.startLineNumber - 1 || r.endLineNumber === t.startLineNumber && r.endColumn < t.startColumn - 1)
        }
    ...
    Ce = class H {
        ...
        static join(t) {
            ...
            for (let i = 1; i < t.length; i++) r = Math.min(r, t[i].startLineNumber), n = Math.max(n, t[i].endLineNumberExclusive);
            return new H(r, n)
        }
        static ofLength(t, r) {
            return new H(t, t + r)
        ...
        constructor(t, r) {
            if (t > r) throw new Z(`startLineNumber ${t} cannot be after endLineNumberExclusive ${r}`);
        ...
        toInclusiveRange() {
            return this.isEmpty ? null : new xn(this.startLineNumber, 1, this.endLineNumberExclusive - 1, Number.MAX_SAFE_INTEGER)
        }
        toExclusiveRange() {
            return new xn(this.startLineNumber, 1, this.endLineNumberExclusive, 1)
        }
        mapToLineArray(t) {
            const r = [];
            for (let n = this.startLineNumber; n < this.endLineNumberExclusive; n++) r.push(t(n));
            return r
        }
        forEach(t) {
            for (let r = this.startLineNumber; r < this.endLineNumberExclusive; r++) t(r)
        }
        serialize() {
            return [this.startLineNumber, this.endLineNumberExclusive]
        }
        ...
        addMargin(t, r) {
            return new H(this.startLineNumber - t, this.endLineNumberExclusive + r)
        }
    },
    Tn = class Ue {
        constructor(t = []) {
        ...
        addRange(t) {
            if (t.length === 0) return;
            const r = Sr(this._normalizedRanges, i => i.endLineNumberExclusive >= t.startLineNumber),
                n = at(this._normalizedRanges, i => i.startLineNumber <= t.endLineNumberExclusive) + 1;
            if (r === n) this._normalizedRanges.splice(r, 0, t);
            else if (r === n - 1) {
                const i = this._normalizedRanges[r];
                this._normalizedRanges[r] = i.join(t)
            } else {
                const i = this._normalizedRanges[r].join(this._normalizedRanges[n - 1]).join(t);
                this._normalizedRanges.splice(r, n - r, i)
            }
        }
        contains(t) {
            const r = Nr(this._normalizedRanges, n => n.startLineNumber <= t);
            return !!r && r.endLineNumberExclusive > t
        }
        intersects(t) {
            const r = Nr(this._normalizedRanges, n => n.startLineNumber < t.endLineNumberExclusive);
        ...
        getUnion(t) {
            ...
            let n = 0,
                i = 0,
                o = null;
            for (; n < this._normalizedRanges.length || i < t._normalizedRanges.length;) {
                let a = null;
                if (n < this._normalizedRanges.length && i < t._normalizedRanges.length) {
                    const l = this._normalizedRanges[n],
                        u = t._normalizedRanges[i];
                    l.startLineNumber < u.startLineNumber ? (a = l, n++) : (a = u, i++)
                } else n < this._normalizedRanges.length ? (a = this._normalizedRanges[n], n++) : (a = t._normalizedRanges[i], i++);
        ...
        subtractFrom(t) {
            const r = Sr(this._normalizedRanges, a => a.endLineNumberExclusive >= t.startLineNumber),
                n = at(this._normalizedRanges, a => a.startLineNumber <= t.endLineNumberExclusive) + 1;
            if (r === n) return new Ue([t]);
            const i = [];
            ...
            return o < t.endLineNumberExclusive && i.push(new Ce(o, t.endLineNumberExclusive)), new Ue(i)
        }
        toString() {
        ...
        getWithDelta(t) {
            return new Ue(this._normalizedRanges.map(r => r.delta(t)))
        }
    },
    On;
(function(e) {
...
var ro = class {
        ...
        insertValues(e, t) {
            ...
            const r = this.values,
                n = this.prefixSum,
                i = t.length;
            return i === 0 ? !1 : (this.values = new Uint32Array(r.length + i), this.values.set(r.subarray(0, e), 0), this.values.set(r.subarray(e), e + i), this.values.set(t, e), e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), this.prefixSum = new Uint32Array(this.values.length), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(n.subarray(0, this.prefixSumValidIndex[0] + 1)), !0)
        }
        setValue(e, t) {
            return e = Fe(e), t = Fe(t), this.values[e] === t ? !1 : (this.values[e] = t, e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), !0)
        }
        removeValues(e, t) {
            e = Fe(e), t = Fe(t);
            const r = this.values,
            ...
            const i = r.length - e;
            return t >= i && (t = i), t === 0 ? !1 : (this.values = new Uint32Array(r.length - t), this.values.set(r.subarray(0, e), 0), this.values.set(r.subarray(e + t), e), this.prefixSum = new Uint32Array(this.values.length), e - 1 < this.prefixSumValidIndex[0] && (this.prefixSumValidIndex[0] = e - 1), this.prefixSumValidIndex[0] >= 0 && this.prefixSum.set(n.subarray(0, this.prefixSumValidIndex[0] + 1)), !0)
        }
        getTotalSum() {
        ...
        _getPrefixSum(e) {
            ...
            for (let r = t; r <= e; r++) this.prefixSum[r] = this.prefixSum[r - 1] + this.values[r];
        ...
        getIndexOf(e) {
            ...
            let t = 0,
                ...
                o = 0;
            for (; t <= r;)
                if (n = t + (r - t) / 2 | 0, i = this.prefixSum[n], o = i - this.values[n], e < o) r = n - 1;
                else if (e >= i) t = n + 1;
            else break;
            return new no(n, e - o)
        }
    ...
    so = class {
        constructor(e, t, r, n) {
            this._uri = e, this._lines = t, this._eol = r, this._versionId = n, this._lineStarts = null, this._cachedTextValue = null
        }
        dispose() {
        ...
        onEvents(e) {
            ...
            const t = e.changes;
            for (const r of t) this._acceptDeleteRange(r.range), this._acceptInsertText(new bt(r.range.startLineNumber, r.range.startColumn), r.text);
        ...
        _ensureLineStarts() {
            if (!this._lineStarts) {
                const e = this._eol.length,
                    ...
                    r = new Uint32Array(t);
                for (let n = 0; n < t; n++) r[n] = this._lines[n].length + e;
                this._lineStarts = new ro(r)
            }
        }
        _setLineText(e, t) {
        ...
        _acceptInsertText(e, t) {
            ...
            for (let i = 1; i < r.length; i++) this._lines.splice(e.lineNumber + i - 1, 0, r[i]), n[i - 1] = r[i].length + this._eol.length;
...
function tr(e) {
    ...
    for (let o = 0, a = e.length; o < a; o++) {
        ...
        l === 13 ? (t === 0 && (r = o), t++, o + 1 < a && e.charCodeAt(o + 1) === 10 ? (i |= 2, o++) : i |= 3, n = o + 1) : l === 10 && (i |= 1, t === 0 && (r = o), t++, n = o + 1)
    }
...
var io = {
    ...
    Dn = class {
        constructor() {
            this._tokenizationSupports = new Map, this._factories = new Map, this._onDidChange = new K, this.onDidChange = this._onDidChange.event, this._colorMap = null
        }
        handleChange(e) {
        ...
        register(e, t) {
            return this._tokenizationSupports.set(e, t), this.handleChange([e]), De(() => {
        ...
        registerFactory(e, t) {
            ...
            const r = new ao(this, e, t);
            this._factories.set(e, r);
            const n = new WeakRef(r);
            return De(() => {
                const i = this._factories.get(e),
                    o = n.deref();
                !i || !o || i !== o || (this._factories.delete(e), i.dispose())
            })
        }
        async getOrCreate(e) {
            const t = this.get(e);
    ...
    ao = class extends ie {
        ...
        constructor(e, t, r) {
            super(), this._registry = e, this._languageId = t, this._factory = r, this._isDisposed = !1, this._resolvePromise = null, this._isResolved = !1
        }
        dispose() {
...
var Oa = class _e {
        static {
            this.Comment = new _e("comment")
        }
        static {
            this.Imports = new _e("imports")
        }
        static {
            this.Region = new _e("region")
        }
        static fromValue(t) {
            switch (t) {
                case "comment":
...
function uo(e, t) {
    ...
    return r[0] = 0, r[1] = (e << 0 | 0 | 0 | 32768 | 2 << 24) >>> 0, new rr(r, t === null ? lo : t)
}
var co = class {
    constructor(e) {
    ...
    replace(e, t, r) {
        ...
        const n = this._store.slice(0, e),
            i = this._store.slice(e + t),
            o = ho(r, this._default);
    ...
    insert(e, t) {
        ...
        const r = [];
        for (let n = 0; n < t; n++) r[n] = this._default;
        this._store = Ar(this._store, e, r)
    }
};
...
var Ee = class {
    ...
    fo = class kt {
        static fromLineTokens(t) {
            const r = [];
            for (let n = 0; n < t.getCount(); n++) r.push(new nr(t.getEndOffset(n) - t.getStartOffset(n), t.getMetadata(n)));
            return kt.create(r)
        }
        static create(t) {
            return new kt(t)
    ...
    go = class {
        ...
        add(e, t) {
            this._tokens.push(new nr(e, t))
        }
        build() {
            return fo.create(this._tokens)
        }
    },
    _t = class Ae {
        static createEmpty(t, r) {
            const n = Ae.defaultTokenMetadata,
                i = new Uint32Array(2);
            return i[0] = t.length, i[1] = n, new Ae(i, t, r)
        }
        static createFromTextAndMetadata(t, r) {
            ...
            for (const {
                ...
                of t) o.push(n + a.length, l), n += a.length, i += a;
            return new Ae(new Uint32Array(o), i, r)
        }
        ...
        constructor(t, r, n) {
            this._lineTokensBrand = void 0, (t.length > 1 ? t[t.length - 2] : 0) !== r.length && ce(new Error("Token length and text length do not match!")), this._tokens = t, this._tokensCount = this._tokens.length >>> 1, this._text = r, this.languageIdCodec = n
        }
        equals(t) {
            return t instanceof Ae ? this.slicedEquals(t, 0, this._tokensCount) : !1
        }
        slicedEquals(t, r, n) {
            ...
            const i = r << 1,
                o = i + (n << 1);
            for (let a = i; a < o; a++)
                if (this._tokens[a] !== t._tokens[a]) return !1;
            return !0
        }
        getLineContent() {
            return this._text
        ...
        getLanguageId(t) {
            const r = this._tokens[(t << 1) + 1],
                n = Ee.getLanguageId(r);
            return this.languageIdCodec.decodeLanguageId(n)
        }
        getStandardTokenType(t) {
            const r = this._tokens[(t << 1) + 1];
            return Ee.getTokenType(r)
        }
        getForeground(t) {
            const r = this._tokens[(t << 1) + 1];
            return Ee.getForeground(r)
        }
        getClassName(t) {
            const r = this._tokens[(t << 1) + 1];
            return Ee.getClassNameFromMetadata(r)
        }
        getInlineStyle(t, r) {
            const n = this._tokens[(t << 1) + 1];
            return Ee.getInlineStyleFromMetadata(n, r)
        }
        getPresentation(t) {
            const r = this._tokens[(t << 1) + 1];
            return Ee.getPresentationFromMetadata(r)
        }
        getEndOffset(t) {
            return this._tokens[t << 1]
        }
        findTokenIndexAtOffset(t) {
            return Ae.findIndexInTokensArray(this._tokens, t)
        }
        inflate() {
            return this
        }
        sliceAndInflate(t, r, n) {
            return new mo(this, t, r, n)
        }
        sliceZeroCopy(t) {
        ...
        withInserted(t) {
            ...
            return new Ae(new Uint32Array(o), i, this.languageIdCodec)
        }
        getTokensInRange(t) {
            const r = new go,
            ...
            for (let o = n; o <= i; o++) {
                const l = new G(this.getStartOffset(o), this.getEndOffset(o)).intersectionLength(t);
    ...
    mo = class Ns {
        constructor(t, r, n, i) {
            this._source = t, this._startOffset = r, this._endOffset = n, this._deltaOffset = i, this._firstTokenIndex = t.findTokenIndexAtOffset(r), this.languageIdCodec = t.languageIdCodec, this._tokensCount = 0;
            for (let o = this._firstTokenIndex, a = t.getCount(); o < a && !(t.getStartOffset(o) >= n); o++) this._tokensCount++
        }
        getMetadata(t) {
        ...
        equals(t) {
            return t instanceof Ns ? this._startOffset === t._startOffset && this._endOffset === t._endOffset && this._deltaOffset === t._deltaOffset && this._source.slicedEquals(t._source, this._firstTokenIndex, this._tokensCount) : !1
        }
        getCount() {
            return this._tokensCount
        }
        ...
        getEndOffset(t) {
            const r = this._source.getEndOffset(this._firstTokenIndex + t);
        ...
        getInlineStyle(t, r) {
            return this._source.getInlineStyle(this._firstTokenIndex + t, r)
        }
        getPresentation(t) {
        ...
        getTokenText(t) {
            const r = this._firstTokenIndex + t,
    ...
    Ne = new Uint32Array(0).buffer,
    ge = class ur {
        static deleteBeginning(t, r) {
            return t === null || t === Ne ? t : ur.delete(t, 0, r)
        }
        static deleteEnding(t, r) {
            if (t === null || t === Ne) return t;
            const n = Ve(t),
                i = n[n.length - 2];
            return ur.delete(t, r, i)
        }
        static delete(t, r, n) {
            if (t === null || t === Ne || r === n) return t;
            const i = Ve(t),
                o = i.length >>> 1;
            if (r === 0 && i[i.length - 2] === n) return Ne;
            const a = _t.findIndexInTokensArray(i, r),
                l = a > 0 ? i[a - 1 << 1] : 0,
                u = i[a << 1];
            if (n < u) {
                const _ = n - r;
                for (let E = a; E < o; E++) i[E << 1] -= _;
                return t
            }
            let c, d;
            l !== r ? (i[a << 1] = r, c = a + 1 << 1, d = r) : (c = a << 1, d = l);
            const h = n - r;
            for (let _ = a + 1; _ < o; _++) {
                const E = i[_ << 1] - h;
                E > d && (i[c++] = E, i[c++] = i[(_ << 1) + 1], d = E)
            }
            if (c === i.length) return t;
            const m = new Uint32Array(c);
            return m.set(i.subarray(0, c), 0), m.buffer
        }
        static append(t, r) {
            if (r === Ne) return t;
            if (t === Ne) return r;
...
var ds = class Ss {
        ...
        constructor(t, r) {
            this._startLineNumber = t, this._tokens = r
        }
        getLineRange() {
        ...
        serialize(t, r) {
            ft(t, this._startLineNumber, r), r += 4, ft(t, this._tokens.length, r), r += 4;
            for (let n = 0; n < this._tokens.length; n++) {
                const i = this._tokens[n];
                if (!(i instanceof Uint32Array)) throw new Error("Not supported!");
                ft(t, i.byteLength, r), r += 4, t.set(new Uint8Array(i.buffer), r), r += i.byteLength
            }
            return r
        }
        applyEdit(t, r) {
            const [n, i] = tr(r);
            this._acceptDeleteRange(t), this._acceptInsertText(new bt(t.startLineNumber, t.startColumn), n, i)
        }
        _acceptDeleteRange(t) {
            if (t.startLineNumber === t.endLineNumber && t.startColumn === t.endColumn) return;
            const r = t.startLineNumber - this._startLineNumber,
                n = t.endLineNumber - this._startLineNumber;
            if (n < 0) {
                const i = n - r;
            ...
            if (!(r >= this._tokens.length)) {
                ...
                if (r === n) {
                    this._tokens[r] = ge.delete(this._tokens[r], t.startColumn - 1, t.endColumn - 1);
                    return
                }
                if (r >= 0)
                    if (this._tokens[r] = ge.deleteEnding(this._tokens[r], t.startColumn - 1), n < this._tokens.length) {
                        const i = ge.deleteBeginning(this._tokens[n], t.endColumn - 1);
                        this._tokens[r] = ge.append(this._tokens[r], i), this._tokens.splice(r + 1, n - r)
                    } else this._tokens[r] = ge.append(this._tokens[r], null), this._tokens = this._tokens.slice(0, r + 1);
                else {
                    const i = -r;
                    this._startLineNumber -= i, this._tokens[n] = ge.deleteBeginning(this._tokens[n], t.endColumn - 1), this._tokens = this._tokens.slice(n)
                }
            }
        }
        _acceptInsertText(t, r, n) {
            if (r === 0 && n === 0) return;
            const i = t.lineNumber - this._startLineNumber;
            if (i < 0) {
            ...
            if (!(i >= this._tokens.length)) {
                if (r === 0) {
                    this._tokens[i] = ge.insert(this._tokens[i], t.column - 1, n);
                    return
                }
                this._tokens[i] = ge.deleteEnding(this._tokens[i], t.column - 1), this._tokens[i] = ge.insert(this._tokens[i], t.column - 1, n), this._insertLines(t.lineNumber, r)
            }
        }
        _insertLines(t, r) {
            if (r === 0) return;
            ...
            this._tokens = Ar(this._tokens, t, n)
        }
    },
    po = class {
        static deserialize(e) {
            ...
            t += 4;
            const n = [];
            for (let i = 0; i < r; i++) t = ds.deserialize(e, t, n);
            return n
        }
        constructor() {
            this._tokens = []
        ...
        add(e, t) {
            ...
            this._tokens.push(new ds(e, [t]))
        }
        finalize() {
            return this._tokens
        }
        serialize() {
            const e = this._serializeSize(),
                t = new Uint8Array(e);
        ...
        _serialize(e) {
            let t = 0;
            ft(e, this._tokens.length, t), t += 4;
            for (let r = 0; r < this._tokens.length; r++) t = this._tokens[r].serialize(e, t)
        }
    },
    fs;
(function(e) {
...
var bo = class {
        constructor(e, t) {
            this.tokenizationSupport = t, this.initialState = this.tokenizationSupport.getInitialState(), this.store = new _o(e)
        }
        getStartState(e) {
    ...
    _o = class {
        constructor(e) {
            this.lineCount = e, this._tokenizationStateStore = new vo, this._invalidEndStatesLineNumbers = new yo, this._invalidEndStatesLineNumbers.addRange(new G(1, e + 1))
        }
        getEndState(e) {
            return this._tokenizationStateStore.getEndState(e)
        }
        setEndState(e, t) {
            if (!t) throw new Z("Cannot set null/undefined state");
            this._invalidEndStatesLineNumbers.delete(e);
            const r = this._tokenizationStateStore.setEndState(e, t);
            return r && e < this.lineCount && this._invalidEndStatesLineNumbers.addRange(new G(e + 1, e + 2)), r
        }
        acceptChange(e, t) {
            this.lineCount += t - e.length, this._tokenizationStateStore.acceptChange(e, t), this._invalidEndStatesLineNumbers.addRangeAndResize(new G(e.startLineNumber, e.endLineNumberExclusive), t)
        }
        acceptChanges(e) {
            for (const t of e) {
                const [r] = tr(t.text);
                this.acceptChange(new Ce(t.range.startLineNumber, t.range.endLineNumber + 1), r + 1)
            }
        }
        invalidateEndStateRange(e) {
            this._invalidEndStatesLineNumbers.addRange(new G(e.startLineNumber, e.endLineNumberExclusive))
        }
    ...
    vo = class {
        ...
        setEndState(e, t) {
            const r = this._lineEndStates.get(e);
            return r && r.equals(t) ? !1 : (this._lineEndStates.set(e, t), !0)
        }
        acceptChange(e, t) {
            let r = e.length;
            t > 0 && r > 0 && (r--, t--), this._lineEndStates.replace(e.startLineNumber, r, t)
        }
        acceptChanges(e) {
            for (const t of e) {
                const [r] = tr(t.text);
    ...
    yo = class {
        ...
        removeMin() {
            ...
            return e.start + 1 === e.endExclusive ? this._ranges.shift() : this._ranges[0] = new G(e.start + 1, e.endExclusive), e.start
        }
        delete(e) {
            const t = this._ranges.findIndex(r => r.contains(e));
            if (t !== -1) {
                const r = this._ranges[t];
                r.start === e ? r.endExclusive === e + 1 ? this._ranges.splice(t, 1) : this._ranges[t] = new G(e + 1, r.endExclusive) : r.endExclusive === e + 1 ? this._ranges[t] = new G(r.start, e) : this._ranges.splice(t, 1, new G(r.start, e), new G(e + 1, r.endExclusive))
            }
        }
        addRange(e) {
            G.addRange(e, this._ranges)
        }
        addRangeAndResize(e, t) {
            let r = 0;
            for (; !(r >= this._ranges.length || e.start <= this._ranges[r].endExclusive);) r++;
            let n = r;
            ...
            if (r === n) {
                const o = new G(e.start, e.start + t);
                o.isEmpty || this._ranges.splice(r, 0, o)
            } else {
                const o = Math.min(e.start, this._ranges[r].start),
                    a = Math.max(e.endExclusive, this._ranges[n - 1].endExclusive),
                    l = new G(o, a + i);
    ...
    wo = class extends ie {
        constructor(e, t, r, n, i, o, a) {
            super(), this._grammar = e, this._initialState = t, this._containsEmbeddedLanguages = r, this._createBackgroundTokenizer = n, this._backgroundTokenizerShouldOnlyVerifyTokens = i, this._reportTokenizationTime = o, this._reportSlowTokenization = a, this._seenLanguages = [], this._onDidEncounterLanguage = this._register(new K), this.onDidEncounterLanguage = this._onDidEncounterLanguage.event
        }
        ...
        tokenizeEncoded(e, t, r) {
            const n = Math.random() * 1e4 < 1,
                ...
                o = i ? new Mr(!0) : void 0,
                a = this._grammar.tokenizeLine2(e, r, 500);
            if (i) {
                const u = o.elapsed();
                (n || u > 32) && this._reportTokenizationTime(u, e.length, n)
            }
            if (a.stoppedEarly) return console.warn(`Time limit reached when tokenizing line: ${e.substring(0,100)}`), new rr(a.tokens, r);
            if (this._containsEmbeddedLanguages) {
                const u = this._seenLanguages,
                    c = a.tokens;
                for (let d = 0, h = c.length >>> 1; d < h; d++) {
                    const m = c[(d << 1) + 1],
                        _ = Ee.getLanguageId(m);
                    u[_] || (u[_] = !0, this._onDidEncounterLanguage.fire(_))
                }
            }
            let l;
    ...
    Lo = class extends ie {
        ...
        constructor(e, t, r, n) {
            super(), this._encodedLanguageId = e, this._actual = t, this._maxTokenizationLineLength = n, this._register(kn(this._maxTokenizationLineLength)), this._register(r)
        }
        getInitialState() {
        ...
        tokenizeEncoded(e, t, r) {
            return e.length >= this._maxTokenizationLineLength.get() ? uo(this._encodedLanguageId, r) : this._actual.tokenizeEncoded(e, t, r)
        }
        createBackgroundTokenizer(e, t) {
    ...
    ko = class extends so {
        constructor(e, t, r, n, i, o, a, l) {
            super(e, t, r, n), this._host = i, this._languageId = o, this._encodedLanguageId = a, this._tokenizerWithStateStore = null, this._isDisposed = !1, this._maxTokenizationLineLength = $1(this, -1), this._tokenizeDebouncer = new S1(() => this._tokenize(), 10), this._maxTokenizationLineLength.set(l, void 0), this._resetTokenization()
        }
        dispose() {
            this._isDisposed = !0, super.dispose()
        }
        ...
        retokenize(e, t) {
            this._tokenizerWithStateStore && (this._tokenizerWithStateStore.store.invalidateEndStateRange(new Ce(e, t)), this._tokenizeDebouncer.schedule())
        }
        async _resetTokenization() {
            this._tokenizerWithStateStore = null;
            const e = this._languageId,
                t = this._encodedLanguageId,
                r = await this._host.getOrCreateGrammar(e, t);
            if (!(this._isDisposed || e !== this._languageId || t !== this._encodedLanguageId || !r)) {
                if (r.grammar) {
                    const n = new Lo(this._encodedLanguageId, new wo(r.grammar, r.initialState, !1, void 0, () => !1, (i, o, a) => {
                        this._host.reportTokenizationTime(i, e, r.sourceExtensionId, o, a)
                    }, !1), ie.None, this._maxTokenizationLineLength);
                    this._tokenizerWithStateStore = new bo(this._lines.length, n)
            ...
            for (;;) {
                ...
                for (;;) {
                    ...
                    if (this._tokenizerWithStateStore.store.setEndState(a.lineNumber, u.endState)) {
                        const d = this._diffStateStacksRefEqFn(a.startState, u.endState);
                        n.setState(a.lineNumber, d)
                    } else n.setState(a.lineNumber, null);
                    if (_t.convertToEndOffset(u.tokens, l.length), r.add(a.lineNumber, u.tokens), new Date().getTime() - e > 20) break
                }
                if (t === 0) break;
                const i = n.getStateDeltas();
                if (this._host.setTokensAndStates(this._versionId, r.serialize(), i), new Date().getTime() - e > 20) {
                    yr(() => this._tokenize());
                    return
                }
            }
    ...
    Eo = class cr {
        ...
        static getChannel(t) {
            return t.getChannel(cr.CHANNEL_NAME)
        }
        static setChannel(t, r) {
            t.setChannel(cr.CHANNEL_NAME, r)
        }
    };
...
var So = class {
        constructor(e) {
            this._models = new Map, this._grammarCache = [], this._grammarFactory = Promise.resolve(null), this._host = Eo.getChannel(e)
        }
        async $init(e) {
            const t = e.grammarDefinitions.map(r => ({
                location: X.revive(r.location),
                language: r.language,
        ...
        $acceptNewModel(e) {
            const t = X.revive(e.uri),
                r = this;
            this._models.set(e.controllerId, new ko(t, e.lines, e.EOL, e.versionId, {
                ...
                setTokensAndStates(n, i, o) {
                    r._host.$setTokensAndStates(e.controllerId, n, i, o)
                },
        ...
        $retokenize(e, t, r) {
            this._models.get(e).retokenize(t, r)
        }
        $acceptModelLanguageChanged(e, t, r) {
            this._models.get(e).onLanguageId(t, r)
        }
...
var xo = class {
        constructor(e, t, r, n, i) {
            this.vsWorker = e, this.req = t, this.channel = r, this.method = n, this.args = i, this.type = 0
        }
    },
    ms = class {
        constructor(e, t, r, n) {
    ...
    To = class {
        constructor(e, t, r, n, i) {
            this.vsWorker = e, this.req = t, this.channel = r, this.eventName = n, this.arg = i, this.type = 2
        }
    },
    Oo = class {
        constructor(e, t, r) {
    ...
    Io = class {
        ...
        sendMessage(e, t, r) {
            ...
            return new Promise((i, o) => {
                this._pendingReplies[n] = {
                    resolve: i,
                    reject: o
                }, this._send(new xo(this._workerId, n, e, t, r))
            })
        }
        listen(e, t, r) {
            let n = null;
            const i = new K({
                onWillAddFirstListener: () => {
                    n = String(++this._lastSentReq), this._pendingEmitters.set(n, i), this._send(new To(this._workerId, n, e, t, r))
                },
                onDidRemoveLastListener: () => {
                    this._pendingEmitters.delete(n), this._send(new Ro(this._workerId, n)), n = null
                }
            });
            return i.event
        }
        ...
        createProxyToRemoteChannel(e, t) {
            const r = {
                get: (n, i) => (typeof i == "string" && !n[i] && (bs(i) ? n[i] = o => this.listen(e, i, o) : ps(i) ? n[i] = this.listen(e, i, void 0) : i.charCodeAt(0) === 36 && (n[i] = async (...o) => (await t?.(), this.sendMessage(e, i, o)))), n[i])
            };
        ...
        _handleReplyMessage(e) {
            ...
            if (delete this._pendingReplies[e.seq], e.err) {
                let r = e.err;
                e.err.$isError && (r = new Error, r.name = e.err.name, r.message = e.err.message, r.stack = e.err.stack), t.reject(r);
                return
            }
            t.resolve(e.res)
        }
        _handleRequestMessage(e) {
            ...
            this._handler.handleMessage(e.channel, e.method, e.args).then(n => {
                this._send(new ms(this._workerId, t, n, void 0))
            }, n => {
                n.detail instanceof Error && (n.detail = Ot(n.detail)), this._send(new ms(this._workerId, t, void 0, Ot(n)))
            })
        }
        _handleSubscribeEventMessage(e) {
            const t = e.req,
                r = this._handler.handleEvent(e.channel, e.eventName, e.arg)(n => {
                    this._send(new Oo(this._workerId, t, n))
                });
            this._pendingEvents.set(t, r)
        }
        ...
        _send(e) {
            const t = [];
            if (e.type === 0)
                for (let r = 0; r < e.args.length; r++) e.args[r] instanceof ArrayBuffer && t.push(e.args[r]);
...
function ps(e) {
    return e[0] === "o" && e[1] === "n" && qr(e.charCodeAt(2))
}

function bs(e) {
    return /^onDynamic/.test(e) && qr(e.charCodeAt(9))
}
var Do = class {
        constructor(e, t) {
        ...
        _handleMessage(e, t, r) {
            if (e === sr && t === Ao) return this.initialize(r[0]);
            const n = e === sr ? this.requestHandler : this._localChannels.get(e);
            if (!n) return Promise.reject(new Error(`Missing channel ${e} on worker thread`));
            if (typeof n[t] != "function") return Promise.reject(new Error(`Missing method ${t} on worker thread channel ${e}`));
            try {
...
function Po(e) {
    ...
    ir = !0;
    const t = new Do(r => globalThis.postMessage(r), r => e(r));
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/48a15759f53cd5fc9b5c20936ad7d79847d914b0/core/vs/workbench/services/textMate/browser/backgroundTokenization/worker/textMateTokenizationWorker.workerMain.js.map

//# debugId=fe785c71-4b94-5f61-84f9-4f2aa7022cff