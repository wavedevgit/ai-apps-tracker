...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "0109c9e3-b244-59eb-a9fa-127dd8fb1874")
    } catch (e) {}
}();
(function() {
    ...
    async function h(s, t) {
        ...
        globalThis._VSCODE_FILE_ROOT = i.toString(), E(), M(o, i);
        try {
            let c;
    ...
    const m = window.MonacoBootstrapWindow,
        {
            result: d,
            configuration: h
        } = await m.load("vs/code/electron-sandbox/processExplorer/processExplorerMain", {
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/46fb7aafe279d7c72346febe68c2e004b7d1de60/core/vs/code/electron-sandbox/processExplorer/processExplorer.js.map
