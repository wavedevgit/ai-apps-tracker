...
! function() {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            n = (new e.Error).stack;
        n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "0e23f178-a89e-5ac8-ae56-2ca0b82e2c5b")
    } catch (e) {}
}();
(function() {
    ...
    async function h(s, t) {
        ...
        t?.beforeImport?.(n);
        const {
            enableDeveloperKeybindings: e,
            removeDeveloperKeybindingsAfterLoad: l,
            developerDeveloperKeybindingsDisposable: i,
            forceDisableShowDevtoolsOnError: a
        } = v(n, t);
        k(n);
        const o = new URL(`${A(n.appRoot,{isWindows:p.platform==="win32",scheme:"vscode-file",fallbackAuthority:"vscode-app"})}/out/`);
        globalThis._VSCODE_FILE_ROOT = o.toString(), S(), D(n, o);
        try {
            let r;
            return r = await import(new URL(`${s}.js`, o).href), i && l && i(), {
                result: r,
                configuration: n
            }
        } catch (r) {
    ...
    async function j() {
        ...
        const t = await d.context.resolveConfiguration();
    ...
    function x(s) {
        const t = d.ipcRenderer,
            n = function(o) {
                return [o.ctrlKey ? "ctrl-" : "", o.metaKey ? "meta-" : "", o.altKey ? "alt-" : "", o.shiftKey ? "shift-" : "", o.keyCode].join("")
            },
            e = p.platform === "darwin" ? "meta-alt-73" : "ctrl-shift-73",
            l = "123",
            i = p.platform === "darwin" ? "meta-82" : "ctrl-82";
        let a = function(o) {
            const r = n(o);
            r === e || r === l ? t.send("vscode:toggleDevTools") : r === i && !s && t.send("vscode:reloadWindow")
        };
    ...
    function w(s, t) {
        t && d.ipcRenderer.send("vscode:openDevTools"), console.error(`[uncaught exception]: ${s}`), s && typeof s != "string" && s.stack && console.error(s.stack)
    }
    ...
    function A(s, t) {
        ...
        let e;
        return t.isWindows && n.startsWith("//") ? e = encodeURI(`${t.scheme||"file"}:${n}`) : e = encodeURI(`${t.scheme||"file"}://${t.fallbackAuthority||""}${n}`), e.replace(/#/g, "%23")
    }

    function S() {
        const s = p.env.NODE_ENV ?? (p.env.VSCODE_DEV ? "development" : "production"),
            t = globalThis;
        if (t.process === void 0) {
            t.process = {
                env: {
    ...
    function D(s, t) {
        ...
        for (const [r, m] of Object.entries(n)) i.imports[r] = new URL(`../node_modules/${m}`, t).href;
        for (const [r, m] of Object.entries(l)) i.imports[r] = new URL(`./external/${m}`, t).href;
        const a = ["api/context", "api/diag", "api/metrics", "api/propagation", "api/trace", "baggage/context-helpers", "baggage/internal/baggage-impl", "baggage/internal/symbol", "baggage/types", "baggage/utils", "common/Attributes", "common/Exception", "common/Time", "context/context", "context/NoopContextManager", "context/types", "diag/ComponentLogger", "diag/consoleLogger", "diag/internal/logLevelLogger", "diag/internal/noopLogger", "diag/types", "experimental/index", "experimental/trace/SugaredOptions", "experimental/trace/SugaredTracer", "internal/global-utils", "internal/semver", "metrics/Meter", "metrics/MeterProvider", "metrics/Metric", "metrics/NoopMeter", "metrics/NoopMeterProvider", "metrics/ObservableResult", "platform/browser/globalThis", "platform/browser/index", "platform/index", "platform/node/globalThis", "platform/node/index", "propagation/NoopTextMapPropagator", "propagation/TextMapPropagator", "trace/attributes", "trace/context-utils", "trace/internal/tracestate-impl", "trace/internal/tracestate-validators", "trace/internal/utils", "trace/invalid-span-constants", "trace/link", "trace/NonRecordingSpan", "trace/NoopTracer", "trace/NoopTracerProvider", "trace/ProxyTracer", "trace/ProxyTracerProvider", "trace/Sampler", "trace/SamplingResult", "trace/span", "trace/span_context", "trace/span_kind", "trace/spancontext-utils", "trace/SpanOptions", "trace/status", "trace/trace_flags", "trace/trace_state", "trace/tracer", "trace/tracer_options", "trace/tracer_provider", "context-api", "diag-api", "index", "metrics-api", "propagation-api", "trace-api", "version"],
            o = new URL("../node_modules/@opentelemetry/api/build/esm/", t).href;
        for (const r of a) i.imports[`${o}${r}`] = `${o}${r}.js`;
        if (i.imports[`${o}platform`] = `${o}platform/index.js`, i.imports[`${o}experimental`] = `${o}experimental/index.js`, i.imports[`${o}platform/node`] = `${o}platform/node/index.js`, i.imports[`${o}platform/browser`] = `${o}platform/browser/index.js`, s.cssModules && s.cssModules.size > 0) {
            ...
            const r = s.cssModules,
                m = new Map(Array.from(r, ([c, y]) => [c, {
                    hash: y,
                    url: new URL(c, t).href
                }])),
                E = `
		...
		`,
            ...
            for (const [c, y] of s.cssModules) {
                const f = new URL(c, t).href;
                i.imports[f] = _ + "#module=" + encodeURIComponent(c)
            }
            const L = window.trustedTypes?.createPolicy("vscode-bootstrapImportMap", {
                ...
                b = JSON.stringify(i, void 0, 2),
                g = document.createElement("script");
            g.type = "importmap", g.setAttribute("nonce", "0c6a828f1297"), g.textContent = L?.createScript(b) ?? b, document.head.appendChild(g), performance.mark("code/didAddCssLoader")
        }
    }
    ...
    const d = window.MonacoBootstrapWindow,
        {
            result: p,
            configuration: h
        } = await d.load("vs/code/electron-sandbox/processExplorer/processExplorerMain", {
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/e48ee6102a199492b0c9964699bf011886708ba0/core/vs/code/electron-sandbox/processExplorer/processExplorer.js.map

//# debugId=0e23f178-a89e-5ac8-ae56-2ca0b82e2c5b