    ...
    var e = {
            192: function(e, t, r) {
                ...
                function s(e, t) {
                    ...
                    let s = !1,
                        l = !1;
                    return "$" === r || "\\" === r || void 0 !== r && !i(r) && a(r) || (s = !0), "$" === o || null != o && !i(o) && a(o) || (l = !0), {
                        can_open: s,
                        can_close: l
                    }
                }
                ...
                function c(e, t) {
                    ...
                    const r = e.tokens.at(-1);
                    if ("html_inline" === r?.type && /^<\w+.+[^/]>$/.test(r.content)) return !1;
                    let n = s(e, e.pos);
                    if (!n.can_open) return t || (e.pending += "$"), e.pos += 1, !0;
                    let o, i = e.pos + 1,
                        a = i;
                    ...
                    if (-1 === a) return t || (e.pending += "$"), e.pos = i, !0;
                    if (a - i === 0) return t || (e.pending += "$$"), e.pos = i + 1, !0;
                    if (n = s(e, a), !n.can_close) return t || (e.pending += "$"), e.pos = i, !0;
                    if (!t) {
                        const t = e.push("math_inline", "math", 0);
                        t.markup = "$", t.content = e.src.slice(i, a)
                    }
                    return e.pos = a + 1, !0
                }
                ...
                function h(e, t) {
                    ...
                    if (!l(e, e.pos).can_open) return t || (e.pending += "$$"), e.pos += 2, !0;
                    for (n = r = e.pos + 2; - 1 !== (n = e.src.indexOf("$$", n));) {
                        for (s = n - 1;
                            "\\" === e.src[s];) s -= 1;
                        if ((n - s) % 2 == 1) break;
                        n += 2
                    }
                    return -1 === n ? (t || (e.pending += "$$"), e.pos = r, !0) : n - r === 0 ? (t || (e.pending += "$$$$"), e.pos = r + 2, !0) : l(e, n).can_close ? (t || ((o = e.push("math_block", "math", 0)).block = !0, o.markup = "$$", o.content = e.src.slice(r, n)), e.pos = n + 2, !0) : (t || (e.pending += "$$"), e.pos = r, !0)
                }

                function m(e, t) {
                    const r = e.src.slice(e.pos);
                    ...
                    const a = n.slice(0, o + 1).reduce((e, t) => e + t.length, 0) + o + 1,
                        l = e.push("math_inline_bare_block", "math", 0);
                    return l.block = !0, l.markup = "$$", l.content = r.slice(1, a), e.pos = e.pos + a, !0
                }
                ...
                function p(e, t, r, n) {
                    ...
                    for (let e = o.length - 1; e >= 0; e--) {
                        ...
                        const a = s.content;
                        for (const e of a.matchAll(n)) {
                            if (!e.groups) continue;
                            const n = e.groups.html_before_math,
                                o = e.groups.math,
                ...
                t.default = function(e, t) {
                    const r = t?.katex ?? o.default,
                        n = t?.enableBareBlocks,
                        s = t?.enableMathBlockInHtml,
                        i = t?.enableMathInlineInHtml,
                        a = t?.enableFencedBlocks;
                    e.inline.ruler.after("escape", "math_inline", c), e.inline.ruler.after("escape", "math_inline_block", h), n && e.inline.ruler.before("text", "math_inline_bare_block", m), e.block.ruler.after("blockquote", "math_block", (e, t, r, o) => !(!n || ! function(e, t, r, n) {
                        const o = e.bMarks[t] + e.tShift[t],
                            s = e.eMarks[t];
                        if (!e.src.slice(o, s).match(/^\s*\\begin\s*\{([^{}]+)\}/)) return !1;
                        if (t > 0) {
                            const r = e.bMarks[t - 1] + e.tShift[t - 1],
                                n = e.eMarks[t - 1],
                                o = e.src.slice(r, n);
                        ...
                        let a, l = t,
                            c = !1;
                        e: for (; !(c || l >= r); l++) {
                            const t = e.bMarks[l] + e.tShift[l],
                                r = e.eMarks[l];
                            if (t < r && e.tShift[l] < e.blkIndent) break;
                            const n = e.src.slice(t, r);
                            for (const o of n.matchAll(/(\\begin|\\end)\s*\{([^{}]+)\}/g))
                                if ("\\begin" === o[1]) i.push(o[2].trim());
                                else if ("\\end" === o[1] && (i.pop(), !i.length)) {
                                a = e.src.slice(t, r), c = !0;
                                break e
                            }
                        }
                        e.line = l + 1;
                        const h = e.push("math_block", "math", 0);
                        return h.block = !0, h.content = (e.getLines(t, l, e.tShift[t], !0) + (a ?? "")).trim(), h.map = [t, e.line], h.markup = "$$", !0
                    }(e, t, r, o)) || function(e, t, r, n) {
                        var o, s, i, a, l = !1,
                            c = e.bMarks[t] + e.tShift[t],
                            h = e.eMarks[t];
                        if (c + 2 > h) return !1;
                        if ("$$" !== e.src.slice(c, c + 2)) return !1;
                        c += 2;
                        let m = e.src.slice(c, h);
                        if (n) return !0;
                        for ("$$" === m.trim().slice(-2) && (m = m.trim().slice(0, -2), l = !0), s = t; !(l || ++s >= r || (c = e.bMarks[s] + e.tShift[s]) < (h = e.eMarks[s]) && e.tShift[s] < e.blkIndent);) "$$" === e.src.slice(c, h).trim().slice(-2) ? (i = e.src.slice(0, h).lastIndexOf("$$"), o = e.src.slice(c, i), l = !0) : e.src.slice(c, h).trim().includes("$$") && (i = e.src.slice(0, h).trim().indexOf("$$"), o = e.src.slice(c, i), l = !0);
                        return e.line = s + 1, (a = e.push("math_block", "math", 0)).block = !0, a.content = (m && m.trim() ? m + "\n" : "") + e.getLines(t + 1, s, e.tShift[t], !0) + (o && o.trim() ? o : ""), a.map = [t, e.line], a.markup = "$$", !0
                    }(e, t, r, o), {
                        alt: ["paragraph", "reference", "blockquote", "list"]
                    });
                    const l = /(?<html_before_math>[\s\S]*?)\$\$(?<math>[\s\S]+?)\$\$(?<html_after_math>(?:(?!\$\$[\s\S]+?\$\$)[\s\S])*)/gm,
                        d = /(?<html_before_math>[\s\S]*?)\$(?<math>.*?)\$(?<html_after_math>(?:(?!\$.*?\$)[\s\S])*)/gm;
                    s && e.core.ruler.push("math_block_in_html_block", e => p(e, "math_block", "$$", l)), i && e.core.ruler.push("math_inline_in_html_block", e => p(e, "math_inline", "$", d));
                    const g = e => {
                            try {
                                return `<p class="katex-block">${r.renderToString(e,{...t,displayMode:!0})}</p>`
                            } catch (r) {
                                return t?.throwOnError && console.log(r), `<p class="katex-block katex-error" title="${u(e)}">${u(r+"")}</p>`
                            }
                        },
                        f = (e, t) => g(e[t].content) + "\n";
                    if (e.renderer.rules.math_inline = (e, n) => {
                            const o = e[n].content;
                            return (e => {
                                const n = /\\begin\{(align|equation|gather|cd|alignat)\}/gi.test(e);
                                try {
                                    return r.renderToString(e, {
                                        ...t,
                                        displayMode: n
                                    })
                                } catch (r) {
                                    return t?.throwOnError && console.log(r), `<span class="katex-error" title="${u(e)}">${u(r+"")}</span>`
                                }
                            })(o.length > 2 && "`" === o[0] && "`" === o[o.length - 1] ? o.slice(1, -1) : o)
                        }, e.renderer.rules.math_inline_block = f, e.renderer.rules.math_inline_bare_block = f, e.renderer.rules.math_block = f, a) {
                        const t = "math",
                            r = e.renderer.rules.fence;
                        e.renderer.rules.fence = function(e, n, o, s, i) {
                            const l = e[n];
                            return l.info.trim().toLowerCase() === t && a ? g(l.content) + "\n" : r?.call(this, e, n, o, s, i) || ""
                        }
                    }
                }
            },
            256: function(e, t, r) {
                ...
                var n, o = this && this.__createBinding || (Object.create ? function(e, t, r, n) {
                    ...
                    i = this && this.__importStar || (n = function(e) {
                        ...
                        var t = {};
                        if (null != e)
                            for (var r = n(e), i = 0; i < r.length; i++) "default" !== r[i] && o(t, e, r[i]);
                        return s(t, e), t
                    });
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.activate = function(e) {
                    return a.workspace.onDidChangeConfiguration(e => {
                        e.affectsConfiguration(l) && a.commands.executeCommand("markdown.api.reloadPlugins")
                    }, void 0, e.subscriptions), {
                        extendMarkdownIt(e) {
                            if (a.workspace.getConfiguration("markdown").get("math.enabled", !0)) {
                                const t = r(192).default,
                                    n = a.workspace.getConfiguration("markdown").get("math.macros", {}),
                                    o = {
                                ...
                                return e.core.ruler.push("reset-katex-macros", () => {
                                    o.macros = {
                                        ...n
                                    }
                                }), e.use(t, o)
            ...
            890: function(e) {
                ...
                "undefined" != typeof self && self, t = function() {
                    return function() {
                        ...
                        class R {
                            constructor(e) {
                                this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = e.style, this.color = e.color, this.size = e.size || R.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = I[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0
                            }
                            extend(e) {
                                const t = {
                                    style: this.style,
                            ...
                            U = function(e) {
                                ...
                                for (const e in this.attributes)
                                    if (this.attributes.hasOwnProperty(e)) {
                                        if (G.test(e)) throw new n("Invalid attribute name '" + e + "'");
                        ...
                        class Y {
                            constructor(e, t, r, n) {
                                this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, _.call(this, e, r, n), this.children = t || []
                            }
                            setAttribute(e, t) {
                                this.attributes[e] = t
                            }
                        ...
                        class X {
                            constructor(e, t, r, n) {
                                this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, _.call(this, t, n), this.children = r || [], this.setAttribute("href", e)
                            }
                            setAttribute(e, t) {
                                this.attributes[e] = t
                            }
                        ...
                        se(ae, le, we, "–", "--", !0), se(ae, le, we, "–", "\\textendash"), se(ae, le, we, "—", "---", !0), se(ae, le, we, "—", "\\textemdash"), se(ae, le, we, "‘", "`", !0), se(ae, le, we, "‘", "\\textquoteleft"), se(ae, le, we, "’", "'", !0), se(ae, le, we, "’", "\\textquoteright"), se(ae, le, we, "“", "``", !0), se(ae, le, we, "“", "\\textquotedblleft"), se(ae, le, we, "”", "''", !0), se(ae, le, we, "”", "\\textquotedblright"), se(ie, le, we, "°", "\\degree", !0), se(ae, le, we, "°", "\\degree"), se(ae, le, we, "°", "\\textdegree", !0), se(ie, le, we, "£", "\\pounds"), se(ie, le, we, "£", "\\mathsterling", !0), se(ae, le, we, "£", "\\pounds"), se(ae, le, we, "£", "\\textsterling", !0), se(ie, ce, we, "✠", "\\maltese"), se(ae, ce, we, "✠", "\\maltese");
                        for (let e = 0; e < 14; e++) {
                        ...
                        se(ie, ce, we, "C", "ℂ"), se(ae, ce, we, "C", "ℂ"), se(ie, ce, we, "H", "ℍ"), se(ae, ce, we, "H", "ℍ"), se(ie, ce, we, "N", "ℕ"), se(ae, ce, we, "N", "ℕ"), se(ie, ce, we, "P", "ℙ"), se(ae, ce, we, "P", "ℙ"), se(ie, ce, we, "Q", "ℚ"), se(ae, ce, we, "Q", "ℚ"), se(ie, ce, we, "R", "ℝ"), se(ae, ce, we, "R", "ℝ"), se(ie, ce, we, "Z", "ℤ"), se(ae, ce, we, "Z", "ℤ"), se(ie, le, de, "h", "ℎ"), se(ae, le, de, "h", "ℎ");
                        let Se = "";
                        for (let e = 0; e < 52; e++) {
                            const t = ke.charAt(e);
                            Se = String.fromCharCode(55349, 56320 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56372 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56424 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56580 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56684 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56736 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56788 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56840 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56944 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), e < 26 && (Se = String.fromCharCode(55349, 56632 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 56476 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se))
                        }
                        Se = String.fromCharCode(55349, 56668), se(ie, le, de, "k", Se), se(ae, le, we, "k", Se);
                        for (let e = 0; e < 10; e++) {
                            const t = e.toString();
                            Se = String.fromCharCode(55349, 57294 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 57314 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 57324 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se), Se = String.fromCharCode(55349, 57334 + e), se(ie, le, de, t, Se), se(ae, le, we, t, Se)
                        }
                        for (let e = 0; e < 3; e++) {
                        ...
                        const Me = [
                            ...
                            qe = function(e, t, r, n) {
                                const o = new Y(e, t, r, n);
                                return Ce(o), o
                            },
                            Ne = (e, t, r, n) => new Y(e, t, r, n),
                            Ie = function(e) {
                                const t = new z(e);
                                return Ce(t), t
                            },
                        ...
                        var Ee = {
                            ...
                            mathsym: function(e, t, r, n) {
                                return void 0 === n && (n = []), "boldsymbol" === r.font && Ae(e, "Main-Bold", t).metrics ? Te(e, "Main-Bold", t, r, n.concat(["mathbf"])) : "\\" === e || "main" === oe[t][e].font ? Te(e, "Main-Regular", t, r, n) : Te(e, "AMS-Regular", t, r, n.concat(["amsrm"]))
                            },
                            makeSpan: qe,
                            makeSvgSpan: Ne,
                            ...
                            wrapFragment: function(e, t) {
                                return e instanceof z ? qe([], [e], t) : e
                            },
                                ...
                                for (let e = 0; e < r.length; e++) {
                                    ...
                                    if ("kern" === t.type) c += t.size;
                                        ...
                                        const e = t.elem,
                                            ...
                                            n = t.wrapperStyle || {},
                                            a = qe(r, [s, e], void 0, n);
                                        a.style.top = V(-o - c - e.depth), t.marginLeft && (a.style.marginLeft = t.marginLeft), t.marginRight && (a.style.marginRight = t.marginRight), i.push(a), c += e.height + e.depth
                                    }
                                    a = Math.min(a, c), l = Math.max(l, c)
                                }
                                const h = qe(["vlist"], i);
                                let m;
                                if (h.style.height = V(l), a < 0) {
                                    const e = qe([], []),
                                        t = qe(["vlist"], [e]);
                                    t.style.height = V(-a);
                                    const r = qe(["vlist-s"], [new Z("​")]);
                                    m = [qe(["vlist-r"], [h, r]), qe(["vlist-r"], [t])]
                                } else m = [qe(["vlist-r"], [h])];
                                const p = qe(["vlist-t"], m);
                            ...
                            makeOrd: function(e, t, r) {
                                ...
                                let c = "",
                                    h = "";
                                if (55349 === s.charCodeAt(0) && ([c, h] = function(e, t) {
                                ...
                                if (l) {
                                    ...
                                    } else a ? (e = Re[l].fontName, n = [l]) : (e = Oe(l, t.fontWeight, t.fontShape), n = [l, t.fontWeight, t.fontShape]);
                                    if (Ae(s, e, o).metrics) return Te(s, e, o, t, i.concat(n));
                                    if (ve.hasOwnProperty(s) && "Typewriter" === e.slice(0, 10)) {
                                        const r = [];
                                        for (let a = 0; a < s.length; a++) r.push(Te(s[a], e, o, t, i.concat(n)));
                                        return Ie(r)
                                    }
                                }
                                if ("mathord" === r) return Te(s, "Math-Italic", o, t, i.concat(["mathnormal"]));
                                if ("textord" === r) {
                                    const e = oe[o][s] && oe[o][s].font;
                                    if ("ams" === e) {
                                        const e = Oe("amsrm", t.fontWeight, t.fontShape);
                                        return Te(s, e, o, t, i.concat("amsrm", t.fontWeight, t.fontShape))
                                    }
                                    if ("main" !== e && e) {
                                        const r = Oe(e, t.fontWeight, t.fontShape);
                                        return Te(s, r, o, t, i.concat(r, t.fontWeight, t.fontShape))
                                    } {
                                        const e = Oe("textrm", t.fontWeight, t.fontShape);
                                        return Te(s, e, o, t, i.concat(t.fontWeight, t.fontShape))
                                    }
                                }
                            ...
                            staticSvg: function(e, t) {
                                const [r, n, o] = He[e], s = new J(r), i = new K([s], {
                                    width: V(n),
                                    height: V(o),
                                    style: "width:" + V(n),
                            ...
                            tryCombineChars: e => {
                                for (let t = 0; t < e.length - 1; t++) {
                                    const r = e[t],
                                        n = e[t + 1];
                                    r instanceof Z && n instanceof Z && Be(r, n) && (r.text += n.text, r.height = Math.max(r.height, n.height), r.depth = Math.max(r.depth, n.depth), r.italic = n.italic, e.splice(t + 1, 1), t--)
                                }
                                return e
                            }
                        };
                        ...
                        function Ue(e) {
                            ...
                            for (let e = 0; e < r.length; ++e) _e[r[e]] = a;
                            t && (s && ($e[t] = s), i && (Ge[t] = i))
                        }
                        ...
                        const Xe = function(e) {
                            ...
                            je = Ee.makeSpan,
                            Ze = ["leftmost", "mbin", "mopen", "mrel", "mop", "mpunct"],
                            Ke = ["rightmost", "mrel", "mclose", "mpunct"],
                            Je = {
                                display: w.DISPLAY,
                                text: w.TEXT,
                                script: w.SCRIPT,
                            ...
                            et = function(e, t, r, n) {
                                ...
                                if (Ee.tryCombineChars(o), !r) return o;
                                let s = t;
                                if (1 === e.length) {
                                    const r = e[0];
                                    "sizing" === r.type ? s = t.havingSize(r.size) : "styling" === r.type && (s = t.havingStyle(Je[r.style]))
                                }
                                ...
                                return tt(o, (e, t) => {
                                    const r = t.classes[0],
                                        n = e.classes[0];
                                    "mbin" === r && l.contains(Ke, n) ? t.classes[0] = "mord" : "mbin" === n && l.contains(Ze, r) && (e.classes[0] = "mord")
                                }, {
                                    node: i
                                }, a, c), tt(o, (e, t) => {
                                    const r = ot(t),
                                        n = ot(e),
                                        o = r && n ? e.hasClass("mtight") ? Fe[r][n] : Ve[r][n] : null;
                                    if (o) return Ee.makeGlue(o, s)
                                }, {
                                    node: i
                                }, a, c), o
                            },
                            ...
                            nt = function(e, t) {
                                ...
                                if (r) {
                                    const e = r.children;
                                    if (e.length) {
                                        if ("right" === t) return nt(e[e.length - 1], "right");
                                        if ("left" === t) return nt(e[0], "left")
                                    }
                                }
                                return e
                            },
                            ot = function(e, t) {
                                return e ? (t && (e = nt(e, t)), Qe[e.classes[0]] || null) : null
                            },
                            st = function(e, t) {
                        ...
                        function lt(e, t) {
                            ...
                            for (let e = 0; e < n.length; e++)
                                if (a.push(n[e]), n[e].hasClass("mbin") || n[e].hasClass("mrel") || n[e].hasClass("allowbreak")) {
                                    ...
                                    r || (s.push(at(a, t)), a = [])
                                } else n[e].hasClass("newline") && (a.pop(), a.length > 0 && (s.push(at(a, t)), a = []), s.push(n[e]));
                            a.length > 0 && s.push(at(a, t)), r ? (i = at(et(r, t, !0)), i.classes = ["tag"], s.push(i)) : o && s.push(o);
                        ...
                        class ht {
                            ...
                            toNode() {
                                ...
                                for (let t = 0; t < this.children.length; t++)
                                    if (this.children[t] instanceof mt && this.children[t + 1] instanceof mt) {
                                        let r = this.children[t].toText() + this.children[++t].toText();
                                        for (; this.children[t + 1] instanceof mt;) r += this.children[++t].toText();
                                        e.appendChild(new mt(r).toNode())
                        ...
                        const ut = function(e, t, r) {
                                return !oe[t][e] || !oe[t][e].replace || 55349 === e.charCodeAt(0) || ve.hasOwnProperty(e) && r && (r.fontFamily && "tt" === r.fontFamily.slice(4, 6) || r.font && "tt" === r.font.slice(4, 6)) || (e = oe[t][e].replace), new pt.TextNode(e)
                            },
                            dt = function(e) {
                            ...
                            gt = function(e, t) {
                                ...
                                let o = e.text;
                                return l.contains(["\\imath", "\\jmath"], o) ? null : (oe[n][o] && oe[n][o].replace && (o = oe[n][o].replace), C(o, Ee.fontMap[r].fontName, n) ? Ee.fontMap[r].variant : null)
                            };
                        ...
                        const bt = function(e, t, r) {
                                ...
                                for (let r = 0; r < e.length; r++) {
                                    ...
                                    if (s instanceof ht && o instanceof ht) {
                                        ...
                                        if ("mn" === s.type && ft(o)) s.children = [...o.children, ...s.children], n.pop();
                                        else if (("msup" === s.type || "msub" === s.type) && s.children.length >= 1 && ("mn" === o.type || ft(o))) {
                                            const e = s.children[0];
                                            e instanceof ht && "mn" === e.type && (e.children = [...o.children, ...e.children], n.pop())
                                        } else if ("mi" === o.type && 1 === o.children.length) {
                                            const e = o.children[0];
                                            if (e instanceof mt && "̸" === e.text && ("mo" === s.type || "mi" === s.type || "mn" === s.type)) {
                                                const e = s.children[0];
                                                e instanceof mt && e.text.length > 0 && (e.text = e.text.slice(0, 1) + "̸" + e.text.slice(1), n.pop())
                                            }
                                        }
                                    }
                                    n.push(s), o = s
                            ...
                            xt = function(e, t) {
                                ...
                                if (Ge[e.type]) return Ge[e.type](e, t);
                                throw new n("Got group of unknown type: '" + e.type + "'")
                            };
                        ...
                        function wt(e, t, r, n, o) {
                            const s = bt(e, r);
                            let i;
                            i = 1 === s.length && s[0] instanceof ht && l.contains(["mrow", "mtable"], s[0].type) ? s[0] : new pt.MathNode("mrow", s);
                            const a = new pt.MathNode("annotation", [new pt.TextNode(t)]);
                            a.setAttribute("encoding", "application/x-tex");
                            const c = new pt.MathNode("semantics", [i, a]),
                                h = new pt.MathNode("math", [c]);
                            h.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), n && h.setAttribute("display", "block");
                            return Ee.makeSpan([o ? "katex" : "katex-mathml"], [h])
                        }
                        const vt = function(e) {
                                return new H({
                            ...
                            kt = function(e, t) {
                                if (t.displayMode) {
                                    ...
                                    t.leqno && r.push("leqno"), t.fleqn && r.push("fleqn"), e = Ee.makeSpan(r, [e])
                                }
                                return e
                            },
                            St = {
                        ...
                        var zt = function(e) {
                                const t = new pt.MathNode("mo", [new pt.TextNode(St[e.replace(/^\\/, "")])]);
                                ...
                                const {
                                    ...
                                    if (l.contains(["widehat", "widecheck", "widetilde", "utilde"], n)) {
                                        ...
                                        const e = [],
                                            ...
                                            c = s.length;
                                        let h, m;
                                        if (1 === c) h = ["hide-tail"], m = [o[3]];
                                        else if (2 === c) h = ["halfarrow-left", "halfarrow-right"], m = ["xMinYMin", "xMaxYMin"];
                                        else {
                        ...
                        const qt = (e, t) => {
                                let r, n, o;
                                e && "supsub" === e.type ? (n = Tt(e.base, "accent"), r = n.base, e.base = r, o = function(e) {
                                    if (e instanceof Y) return e;
                                    throw new Error("Expected span<HtmlDomNode> but got " + String(e) + ".")
                                }(it(e, t)), e.base = n) : (n = Tt(e, "accent"), r = n.base);
                                const s = it(r, t.havingCrampedStyle());
                                let i = 0;
                                if (n.isShifty && l.isCharacterBox(r)) {
                                    const e = l.getBaseElem(r);
                                    i = ee(it(e, t.havingCrampedStyle())).skew
                                }
                                const a = "\\c" === n.label;
                                let c, h = a ? s.height + s.depth : Math.min(s.height, t.fontMetrics().xHeight);
                                if (n.isStretchy) c = At(n, t), c = Ee.makeVList({
                                    ...
                                    let e, r;
                                    "\\vec" === n.label ? (e = Ee.staticSvg("vec", t), r = Ee.svgData.vec[1]) : (e = Ee.makeOrd({
                                        mode: n.mode,
                                        text: n.label
                                    }, t, "textord"), e = ee(e), e.italic = 0, r = e.width, a && (h += e.depth)), c = Ee.makeSpan(["accent-body"], [e]);
                                    const o = "\\textcircled" === n.label;
                                    o && (c.classes.push("accent-full"), h = s.height);
                                    let l = i;
                                    o || (l -= r / 2), c.style.left = V(l), "\\textcircled" === n.label && (c.style.top = ".2em"), c = Ee.makeVList({
                                        positionType: "firstBaseline",
                                        children: [{
                                            type: "elem",
                                            elem: s
                                ...
                                const m = Ee.makeSpan(["mord", "accent"], [c], t);
                                return o ? (o.children[0] = m, o.height = Math.max(m.height, o.height), o.classes[0] = "mord", o) : m
                            },
                            Nt = (e, t) => {
                                const r = e.isStretchy ? zt(e.label) : new pt.MathNode("mo", [ut(e.label, e.mode)]),
                                    n = new pt.MathNode("mover", [xt(e.base, t), r]);
                                return n.setAttribute("accent", "true"), n
                            },
                            It = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(e => "\\" + e).join("|"));
                        Ue({
                            type: "accent",
                            ...
                            htmlBuilder: (e, t) => {
                                ...
                                return Ee.makeSpan(["mord", "accentunder"], [s], t)
                            },
                            mathmlBuilder: (e, t) => {
                                const r = zt(e.label),
                                    n = new pt.MathNode("munder", [xt(e.base, t), r]);
                                return n.setAttribute("accentunder", "true"), n
                            }
                        });
                        const Ot = e => {
                            const t = new pt.MathNode("mpadded", e ? [e] : []);
                        ...
                        Ue({
                            ...
                            htmlBuilder(e, t) {
                                ...
                                const o = Ee.wrapFragment(it(e.body, n, t), t),
                                    s = "\\x" === e.label.slice(0, 2) ? "x" : "cd";
                                let i;
                                o.classes.push(s + "-arrow-pad"), e.below && (n = t.havingStyle(r.sub()), i = Ee.wrapFragment(it(e.below, n, t), t), i.classes.push(s + "-arrow-pad"));
                                const a = At(e, t),
                                    l = -t.fontMetrics().axisHeight + .5 * a.height;
                                let c, h = -t.fontMetrics().axisHeight - .5 * a.height - .111;
                                ...
                                return c.children[0].children[0].children[1].classes.push("svg-align"), Ee.makeSpan(["mrel", "x-arrow"], [c], t)
                            },
                            mathmlBuilder(e, t) {
                                const r = zt(e.label);
                                let n;
                                if (r.setAttribute("minsize", "x" === e.label.charAt(0) ? "1.75em" : "3.0em"), e.body) {
                                    const o = Ot(xt(e.body, t));
                                    if (e.below) {
                                        const s = Ot(xt(e.below, t));
                                        n = new pt.MathNode("munderover", [r, s, o])
                                    } else n = new pt.MathNode("mover", [r, o])
                                } else if (e.below) {
                                    const o = Ot(xt(e.below, t));
                                    n = new pt.MathNode("munder", [r, o])
                                } else n = Ot(), n = new pt.MathNode("mover", [r, n]);
                                return n
                            }
                        });
                        const Rt = Ee.makeSpan;

                        function Ht(e, t) {
                            const r = et(e.body, t, !0);
                        ...
                        Ue({
                            ...
                            handler(e, t) {
                                ...
                                return {
                                    ...
                                    mclass: i,
                                    body: [c],
                                    isCharacterBox: l.isCharacterBox(c)
                                }
                            },
                            htmlBuilder: Ht,
                            mathmlBuilder: Et
                        ...
                        const Dt = {
                            ...
                            Vt = e => "textord" === e.type && "@" === e.text,
                            Ft = (e, t) => ("mathord" === e.type || "atom" === e.type) && e.text === t;
                        ...
                        Ue({
                            ...
                            htmlBuilder(e, t) {
                                const r = t.havingStyle(t.style.sup()),
                                    n = Ee.wrapFragment(it(e.label, r, t), t);
                                return n.classes.push("cd-label-" + e.side), n.style.bottom = V(.8 - n.depth), n.height = 0, n.depth = 0, n
                            },
                            mathmlBuilder(e, t) {
                                let r = new pt.MathNode("mrow", [xt(e.label, t)]);
                                return r = new pt.MathNode("mpadded", [r]), r.setAttribute("width", "0"), "left" === e.side && r.setAttribute("lspace", "-1width"), r.setAttribute("voffset", "0.7em"), r = new pt.MathNode("mstyle", [r]), r.setAttribute("displaystyle", "false"), r.setAttribute("scriptlevel", "1"), r
                            }
                        }), Ue({
                            type: "cdlabelparent",
                            names: ["\\\\cdparent"],
                            ...
                            htmlBuilder(e, t) {
                                const r = Ee.wrapFragment(it(e.fragment, t), t);
                                return r.classes.push("cd-vert-arrow"), r
                            },
                            mathmlBuilder: (e, t) => new pt.MathNode("mrow", [xt(e.fragment, t)])
                        }), Ue({
                            type: "textord",
                            names: ["\\@char"],
                            props: {
                            ...
                            handler(e, t) {
                                ...
                                const o = Tt(t[0], "ordgroup").body;
                                let s = "";
                                for (let e = 0; e < o.length; e++) s += Tt(o[e], "textord").text;
                                let i, a = parseInt(s);
                        ...
                        const $t = (e, t) => {
                                const r = et(e.body, t.withColor(e.color), !1);
                                return Ee.makeFragment(r)
                            },
                            Gt = (e, t) => {
                                const r = bt(e.body, t.withColor(e.color)),
                                    n = new pt.MathNode("mstyle", r);
                        ...
                        Ue({
                            ...
                            handler(e, t) {
                                ...
                                const n = Tt(t[0], "color-token").color,
                                    o = t[1];
                                return {
                                    type: "color",
                                    mode: r.mode,
                            ...
                            handler(e, t) {
                                ...
                                const o = Tt(t[0], "color-token").color;
                            ...
                            handler(e, t, r) {
                                ...
                                return {
                                    ...
                                    mode: n.mode,
                                    newLine: s,
                                    size: o && Tt(o, "size").value
                                }
                            },
                            htmlBuilder(e, t) {
                                const r = Ee.makeSpan(["mspace"], [], t);
                                return e.newLine && (r.classes.push("newline"), e.size && (r.style.marginTop = V(P(e.size, t)))), r
                            },
                            mathmlBuilder(e, t) {
                                const r = new pt.MathNode("mspace");
                        ...
                        Ue({
                            ...
                            handler(e) {
                                ...
                                t.consumeSpaces();
                                const o = t.fetch();
                                if (Ut[o.text]) return "\\global" !== r && "\\\\globallong" !== r || (o.text = Ut[o.text]), Tt(t.parseFunction(), "internal");
                            ...
                            handler(e) {
                                ...
                                const n = Yt(t.gullet.popToken()),
                                    o = t.gullet.popToken(),
                                    s = t.gullet.popToken();
                                return Xt(t, n, s, "\\\\globalfuture" === r), t.gullet.pushToken(s), t.gullet.pushToken(o), {
                                    type: "internal",
                                    mode: t.mode
                                }
                            }
                        ...
                        const Wt = function(e, t, r) {
                            ...
                            jt = function(e, t, r, n) {
                                const o = r.havingBaseStyle(t),
                                    s = Ee.makeSpan(n.concat(o.sizingClasses(r)), [e], r),
                            ...
                            Kt = function(e, t, r, n, o, s) {
                                const i = function(e, t, r, n) {
                                        return Ee.makeSymbol(e, "Size" + t + "-Regular", r, n)
                                    }(e, t, o, n),
                                    a = jt(Ee.makeSpan(["delimsizing", "size" + t], [i], n), w.TEXT, n, s);
                                return r && Zt(a, n, w.TEXT), a
                            },
                            Jt = function(e, t, r) {
                                let n;
                                return n = "Size1-Regular" === t ? "delim-size1" : "delim-size4", {
                                    type: "elem",
                                    elem: Ee.makeSpan(["delimsizinginner", n], [Ee.makeSpan([], [Ee.makeSymbol(e, t, r)])])
                                }
                            },
                            Qt = function(e, t, r) {
                            ...
                            tr = ["|", "\\lvert", "\\rvert", "\\vert"],
                            rr = ["\\|", "\\lVert", "\\rVert", "\\Vert"],
                            nr = function(e, t, r, n, o, s) {
                                let i, a, c, h, m = "",
                                    p = 0;
                                i = c = h = e, a = null;
                                let u = "Size1-Regular";
                                "\\uparrow" === e ? c = h = "⏐" : "\\Uparrow" === e ? c = h = "‖" : "\\downarrow" === e ? i = c = "⏐" : "\\Downarrow" === e ? i = c = "‖" : "\\updownarrow" === e ? (i = "\\uparrow", c = "⏐", h = "\\downarrow") : "\\Updownarrow" === e ? (i = "\\Uparrow", c = "‖", h = "\\Downarrow") : l.contains(tr, e) ? (c = "∣", m = "vert", p = 333) : l.contains(rr, e) ? (c = "∥", m = "doublevert", p = 556) : "[" === e || "\\lbrack" === e ? (i = "⎡", c = "⎢", h = "⎣", u = "Size4-Regular", m = "lbrack", p = 667) : "]" === e || "\\rbrack" === e ? (i = "⎤", c = "⎥", h = "⎦", u = "Size4-Regular", m = "rbrack", p = 667) : "\\lfloor" === e || "⌊" === e ? (c = i = "⎢", h = "⎣", u = "Size4-Regular", m = "lfloor", p = 667) : "\\lceil" === e || "⌈" === e ? (i = "⎡", c = h = "⎢", u = "Size4-Regular", m = "lceil", p = 667) : "\\rfloor" === e || "⌋" === e ? (c = i = "⎥", h = "⎦", u = "Size4-Regular", m = "rfloor", p = 667) : "\\rceil" === e || "⌉" === e ? (i = "⎤", c = h = "⎥", u = "Size4-Regular", m = "rceil", p = 667) : "(" === e || "\\lparen" === e ? (i = "⎛", c = "⎜", h = "⎝", u = "Size4-Regular", m = "lparen", p = 875) : ")" === e || "\\rparen" === e ? (i = "⎞", c = "⎟", h = "⎠", u = "Size4-Regular", m = "rparen", p = 875) : "\\{" === e || "\\lbrace" === e ? (i = "⎧", a = "⎨", h = "⎩", c = "⎪", u = "Size4-Regular") : "\\}" === e || "\\rbrace" === e ? (i = "⎫", a = "⎬", h = "⎭", c = "⎪", u = "Size4-Regular") : "\\lgroup" === e || "⟮" === e ? (i = "⎧", h = "⎩", c = "⎪", u = "Size4-Regular") : "\\rgroup" === e || "⟯" === e ? (i = "⎫", h = "⎭", c = "⎪", u = "Size4-Regular") : "\\lmoustache" === e || "⎰" === e ? (i = "⎧", h = "⎭", c = "⎪", u = "Size4-Regular") : "\\rmoustache" !== e && "⎱" !== e || (i = "⎫", h = "⎩", c = "⎪", u = "Size4-Regular");
                                const d = Wt(i, u, o),
                                    g = d.height + d.depth,
                                    f = Wt(c, u, o),
                                    b = f.height + f.depth,
                                ...
                                if (m.length > 0) {
                                    const e = M - g - x,
                                        ...
                                        l = Ee.makeSvgSpan([], [a], n);
                                    l.height = t / 1e3, l.style.width = s, l.style.height = i, T.push({
                                        type: "elem",
                                        elem: l
                                    })
                                } else {
                                    if (T.push(Jt(h, u, o)), T.push(er), null === a) {
                                        const e = M - g - x + .016;
                                        T.push(Qt(c, e, n))
                                    } else {
                                        const e = (M - g - x - v) / 2 + .016;
                                        T.push(Qt(c, e, n)), T.push(er), T.push(Jt(a, u, o)), T.push(er), T.push(Qt(c, e, n))
                                    }
                                    T.push(er), T.push(Jt(i, u, o))
                                }
                                ...
                                return jt(Ee.makeSpan(["delimsizing", "mult"], [C], B), w.TEXT, n, s)
                            },
                            or = .08,
                            sr = function(e, t, r, n, o) {
                                ...
                                return Ee.makeSvgSpan(["hide-tail"], [a], o)
                            },
                            ir = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "\\surd"],
                            ...
                            gr = function(e, t, r, n, o, s) {
                                let i;
                                "<" === e || "\\lt" === e || "⟨" === e ? e = "\\langle" : ">" !== e && "\\gt" !== e && "⟩" !== e || (e = "\\rangle"), i = l.contains(lr, e) ? hr : l.contains(ir, e) ? pr : mr;
                                const a = dr(e, t, i, n);
                                return "small" === a.type ? function(e, t, r, n, o, s) {
                                    const i = Ee.makeSymbol(e, "Main-Regular", o, n),
                                        a = jt(i, t, n, s);
                                    return r && Zt(a, n, t), a
                                }(e, a.style, r, n, o, s) : "large" === a.type ? Kt(e, a.size, r, n, o, s) : nr(e, t, r, n, o, s)
                            };
                        var fr = {
                            sqrtImage: function(e, t) {
                                const r = t.havingBaseSizing(),
                                    n = dr("\\surd", e * r.sizeMultiplier, pr, r);
                                let o = r.sizeMultiplier;
                                const s = Math.max(0, t.minRuleThickness - t.fontMetrics().sqrtRuleThickness);
                                let i, a, l = 0,
                                    c = 0,
                                    h = 0;
                                return "small" === n.type ? (h = 1e3 + 1e3 * s + 80, e < 1 ? o = 1 : e < 1.4 && (o = .7), l = (1 + s + or) / o, c = (1 + s) / o, i = sr("sqrtMain", l, h, s, t), i.style.minWidth = "0.853em", a = .833 / o) : "large" === n.type ? (h = 1080 * cr[n.size], c = (cr[n.size] + s) / o, l = (cr[n.size] + s + or) / o, i = sr("sqrtSize" + n.size, l, h, s, t), i.style.minWidth = "1.02em", a = 1 / o) : (l = e + s + or, c = e + s, h = Math.floor(1e3 * e + s) + 80, i = sr("sqrtTall", l, h, s, t), i.style.minWidth = "0.742em", a = 1.056), i.height = c, i.style.height = V(l), {
                                    span: i,
                                    advanceWidth: a,
                            ...
                            sizedDelim: function(e, t, r, o, s) {
                                if ("<" === e || "\\lt" === e || "⟨" === e ? e = "\\langle" : ">" !== e && "\\gt" !== e && "⟩" !== e || (e = "\\rangle"), l.contains(ir, e) || l.contains(lr, e)) return Kt(e, t, !1, r, o, s);
                                if (l.contains(ar, e)) return nr(e, cr[t], !1, r, o, s);
                        ...
                        const br = {
                            ...
                            yr = ["(", "\\lparen", ")", "\\rparen", "[", "\\lbrack", "]", "\\rbrack", "\\{", "\\lbrace", "\\}", "\\rbrace", "\\lfloor", "\\rfloor", "⌊", "⌋", "\\lceil", "\\rceil", "⌈", "⌉", "<", ">", "\\langle", "⟨", "\\rangle", "⟩", "\\lt", "\\gt", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "⟮", "⟯", "\\lmoustache", "\\rmoustache", "⎰", "⎱", "/", "\\backslash", "|", "\\vert", "\\|", "\\Vert", "\\uparrow", "\\Uparrow", "\\downarrow", "\\Downarrow", "\\updownarrow", "\\Updownarrow", "."];

                        function xr(e, t) {
                            const r = Ct(e);
                            if (r && l.contains(yr, r.text)) return r;
                        ...
                        Ue({
                            ...
                            htmlBuilder: (e, t) => "." === e.delim ? Ee.makeSpan([e.mclass]) : fr.sizedDelim(e.delim, e.size, t, e.mode, [e.mclass]),
                            mathmlBuilder: e => {
                                const t = [];
                                "." !== e.delim && t.push(ut(e.delim, e.mode));
                                const r = new pt.MathNode("mo", t);
                                "mopen" === e.mclass || "mclose" === e.mclass ? r.setAttribute("fence", "true") : r.setAttribute("fence", "false"), r.setAttribute("stretchy", "true");
                                const n = V(fr.sizeToMaxHeight[e.size]);
                            ...
                            handler: (e, t) => {
                                ...
                                const s = Tt(n.parseFunction(), "leftright-right");
                                return {
                                    type: "leftright",
                                    mode: n.mode,
                                    body: o,
                            ...
                            htmlBuilder: (e, t) => {
                                wr(e);
                                const r = et(e.body, t, !0, ["mopen", "mclose"]);
                                let n, o, s = 0,
                                    i = 0,
                                    a = !1;
                                for (let e = 0; e < r.length; e++) r[e].isMiddle ? a = !0 : (s = Math.max(r[e].height, s), i = Math.max(r[e].depth, i));
                                if (s *= t.sizeMultiplier, i *= t.sizeMultiplier, n = "." === e.left ? st(t, ["mopen"]) : fr.leftRightDelim(e.left, s, i, t, e.mode, ["mopen"]), r.unshift(n), a)
                                    for (let t = 1; t < r.length; t++) {
                                        const n = r[t].isMiddle;
                                        n && (r[t] = fr.leftRightDelim(n.delim, s, i, n.options, e.mode, []))
                                    }
                                if ("." === e.right) o = st(t, ["mclose"]);
                                else {
                                    const r = e.rightColor ? t.withColor(e.rightColor) : t;
                                    o = fr.leftRightDelim(e.right, s, i, r, e.mode, ["mclose"])
                                }
                                return r.push(o), Ee.makeSpan(["minner"], r, t)
                            },
                            mathmlBuilder: (e, t) => {
                                wr(e);
                                const r = bt(e.body, t);
                                if ("." !== e.left) {
                                    const t = new pt.MathNode("mo", [ut(e.left, e.mode)]);
                                    t.setAttribute("fence", "true"), r.unshift(t)
                                }
                                if ("." !== e.right) {
                                    const t = new pt.MathNode("mo", [ut(e.right, e.mode)]);
                            ...
                            htmlBuilder: (e, t) => {
                                ...
                                if ("." === e.delim) r = st(t, []);
                                    ...
                                    r = fr.sizedDelim(e.delim, 1, t, e.mode, []);
                                    const n = {
                                        delim: e.delim,
                                        options: t
                                    };
                            ...
                            mathmlBuilder: (e, t) => {
                                const r = "\\vert" === e.delim || "|" === e.delim ? ut("|", "text") : ut(e.delim, e.mode),
                                    n = new pt.MathNode("mo", [r]);
                                return n.setAttribute("fence", "true"), n.setAttribute("lspace", "0.05em"), n.setAttribute("rspace", "0.05em"), n
                            }
                        });
                        const vr = (e, t) => {
                                const r = Ee.wrapFragment(it(e.body, t), t),
                                    n = e.label.slice(1);
                                let o, s = t.sizeMultiplier,
                                    i = 0;
                                const a = l.isCharacterBox(e.body);
                                if ("sout" === n) o = Ee.makeSpan(["stretchy", "sout"]), o.height = t.fontMetrics().defaultRuleThickness / s, i = -.5 * t.fontMetrics().xHeight;
                                else if ("phase" === n) {
                                    const e = P({
                                            number: .6,
                                            unit: "pt"
                                    ...
                                    const l = Math.floor(1e3 * a * s),
                                        h = "M400000 " + (c = l) + " H0 L" + c / 2 + " 0 l65 45 L145 " + (c - 80) + " H400000z",
                                        m = new K([new J("phase", h)], {
                                            width: "400em",
                                            height: V(l / 1e3),
                                            viewBox: "0 0 400000 " + l,
                                            preserveAspectRatio: "xMinYMin slice"
                                        });
                                    o = Ee.makeSvgSpan(["hide-tail"], [m], t), o.style.height = V(a), i = r.depth + e + n
                                } else {
                                    /cancel/.test(n) ? a || r.classes.push("cancel-pad") : "angl" === n ? r.classes.push("anglpad") : r.classes.push("boxpad");
                                    let s = 0,
                                        l = 0,
                                        c = 0;
                                    /box/.test(n) ? (c = Math.max(t.fontMetrics().fboxrule, t.minRuleThickness), s = t.fontMetrics().fboxsep + ("colorbox" === n ? 0 : c), l = s) : "angl" === n ? (c = Math.max(t.fontMetrics().defaultRuleThickness, t.minRuleThickness), s = 4 * c, l = Math.max(0, .25 - r.depth)) : (s = a ? .2 : 0, l = s), o = function(e, t, r, n, o) {
                                        let s;
                                        const i = e.height + e.depth + r + n;
                                        if (/fbox|color|angl/.test(t)) {
                                            if (s = Ee.makeSpan(["stretchy", t], [], o), "fbox" === t) {
                                            ...
                                            s = Ee.makeSvgSpan([], [r], o)
                                        }
                                        return s.height = i, s.style.height = V(i), s
                                    }(r, n, s, l, t), /fbox|boxed|fcolorbox/.test(n) ? (o.style.borderStyle = "solid", o.style.borderWidth = V(c)) : "angl" === n && .049 !== c && (o.style.borderTopWidth = V(c), o.style.borderRightWidth = V(c)), i = r.depth + l, e.backgroundColor && (o.style.backgroundColor = e.backgroundColor, e.borderColor && (o.style.borderColor = e.borderColor))
                                }
                                var c;
                                let h;
                                if (e.backgroundColor) h = Ee.makeVList({
                                    positionType: "individualShift",
                                    children: [{
                                        type: "elem",
                                        elem: o,
                                ...
                                return /cancel/.test(n) && (h.height = r.height, h.depth = r.depth), /cancel/.test(n) && !a ? Ee.makeSpan(["mord", "cancel-lap"], [h], t) : Ee.makeSpan(["mord"], [h], t)
                            },
                            kr = (e, t) => {
                                let r = 0;
                                const n = new pt.MathNode(e.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [xt(e.body, t)]);
                                switch (e.label) {
                                    case "\\cancel":
                        ...
                        Ue({
                            ...
                            handler(e, t, r) {
                                ...
                                const s = Tt(t[0], "color-token").color,
                                    i = t[1];
                                return {
                                    type: "enclose",
                                    mode: n.mode,
                        ...
                        function Mr(e) {
                            ...
                            for (let e = 0; e < r.length; ++e) Sr[r[e]] = a;
                            s && ($e[t] = s), i && (Ge[t] = i)
                        }
                        const zr = {};
                        ...
                        class Tr {
                            ...
                            static range(e, t) {
                                return t ? e && e.loc && t.loc && e.loc.lexer === t.loc.lexer ? new Tr(e.loc.lexer, e.loc.start, t.loc.end) : null : e && e.loc
                            }
                        }
                        class Br {
                            constructor(e, t) {
                            ...
                            range(e, t) {
                                return new Br(t, Tr.range(this, e))
                            }
                        }
                        ...
                        function Ir(e, t, r) {
                            ...
                            if (e.gullet.beginGroup(), h || e.gullet.macros.set("\\cr", "\\\\\\relax"), !a) {
                            ...
                            function w() {
                                y && (e.gullet.macros.get("\\df@tag") ? (y.push(e.subparse([new Br("\\df@tag")])), e.gullet.macros.set("\\df@tag", void 0, !0)) : y.push(Boolean(c) && "1" === e.gullet.macros.get("\\@eqnsw")))
                            }
                            for (x(), b.push(Cr(e));;) {
                                let t = e.parseExpression(!1, h ? "\\end" : "\\\\");
                                ...
                                if ("&" === o) {
                                    if (p && d.length === p) {
                                        if (h || l) throw new n("Too many tab characters: &", e.nextToken);
                                    ...
                                    {
                                        let t;
                                        e.consume(), " " !== e.gullet.future().text && (t = e.parseSizeGroup(!0)), f.push(t ? t.value : null), w(), b.push(Cr(e)), d = [], g.push(d), x()
                                    }
                                }
                            }
                        ...
                        const Rr = function(e, t) {
                                ...
                                for (v(i[0]), r = 0; r < e.body.length; ++r) {
                                    ...
                                    for (o = 0; o < n.length; ++o) {
                                        const e = it(n[o], t);
                                        l < e.depth && (l = e.depth), s < e.height && (s = e.height), h[o] = e
                                    }
                                    const m = e.rowGaps[r];
                                    let p = 0;
                                    m && (p = P(m, t), p > 0 && (p += y, l < p && (l = p), p = 0)), e.addJot && (l += g), h.height = s, h.depth = l, x += s, h.pos = x, x += l + p, c[r] = h, v(i[r + 1])
                                }
                                ...
                                if (e.tags && e.tags.some(e => e))
                                    for (r = 0; r < s; ++r) {
                                        const n = c[r],
                                            ...
                                            s = e.tags[r];
                                        let i;
                                        i = !0 === s ? Ee.makeSpan(["eqn-num"], [], t) : Ee.makeSpan([], !1 === s ? [] : et(s, t, !0), t), i.depth = n.depth, i.height = n.height, T.push({
                                            type: "elem",
                                            elem: i,
                                            shift: o
                                        })
                                ...
                                for (o = 0, A = 0; o < a || A < S.length; ++o, ++A) {
                                    ...
                                    for (;
                                        "separator" === h.type;) {
                                        if (p || (z = Ee.makeSpan(["arraycolsep"], []), z.style.width = V(t.fontMetrics().doubleRuleSep), M.push(z)), "|" !== h.separator && ":" !== h.separator) throw new n("Invalid separator type: " + h.separator);
                                        {
                                            const e = "|" === h.separator ? "solid" : "dashed",
                                                r = Ee.makeSpan(["vertical-separator"], [], t);
                                    ...
                                    if (o >= a) continue;
                                    (o > 0 || e.hskipBeforeAndAfter) && (i = l.deflt(h.pregap, u), 0 !== i && (z = Ee.makeSpan(["arraycolsep"], []), z.style.width = V(i), M.push(z)));
                                    let d = [];
                                    for (r = 0; r < s; ++r) {
                                        const e = c[r],
                                            t = e[o];
                                    ...
                                    d = Ee.makeVList({
                                        positionType: "individualShift",
                                        children: d
                                    }, t), d = Ee.makeSpan(["col-align-" + (h.align || "c")], [d]), M.push(d), (o < a - 1 || e.hskipBeforeAndAfter) && (i = l.deflt(h.postgap, u), 0 !== i && (z = Ee.makeSpan(["arraycolsep"], []), z.style.width = V(i), M.push(z)))
                                }
                                if (c = Ee.makeSpan(["mtable"], M), h.length > 0) {
                                    const e = Ee.makeLineSpan("hline", t, m),
                                        r = Ee.makeLineSpan("hdashline", t, m),
                                        n = [{
                                            type: "elem",
                                            elem: c,
                                            shift: 0
                                ...
                                if (0 === T.length) return Ee.makeSpan(["mord"], [c], t);
                                {
                                    let e = Ee.makeVList({
                                        positionType: "individualShift",
                                        children: T
                                    }, t);
                                    return e = Ee.makeSpan(["tag"], [e], t), Ee.makeFragment([c, e])
                                }
                            },
                            Hr = {
                                c: "center ",
                            ...
                            Er = function(e, t) {
                                const r = [],
                                    n = new pt.MathNode("mtd", [], ["mtr-glue"]),
                                    o = new pt.MathNode("mtd", [], ["mml-eqn-num"]);
                                for (let s = 0; s < e.body.length; s++) {
                                    const i = e.body[s],
                                        a = [];
                                    for (let e = 0; e < i.length; e++) a.push(new pt.MathNode("mtd", [xt(i[e], t)]));
                                    e.tags && e.tags[s] && (a.unshift(n), a.push(n), e.leqno ? a.unshift(o) : a.push(o)), r.push(new pt.MathNode("mtr", a))
                                }
                                let s = new pt.MathNode("mtable", r);
                                ...
                                if (e.cols && e.cols.length > 0) {
                                    ...
                                    for (let e = o; e < i; e++) "align" === t[e].type ? (l += Hr[t[e].align], n && (r += "none "), n = !0) : "separator" === t[e].type && n && (r += "|" === t[e].separator ? "solid " : "dashed ", n = !1);
                                ...
                                a += h[0].length > 0 ? "left " : "", a += h[h.length - 1].length > 0 ? "right " : "";
                                for (let e = 1; e < h.length - 1; e++) c += 0 === h[e].length ? "none " : h[e][0] ? "dashed " : "solid ";
                                return /[sd]/.test(c) && s.setAttribute("rowlines", c.trim()), "" !== a && (s = new pt.MathNode("menclose", [s]), s.setAttribute("notation", a.trim())), e.arraystretch && e.arraystretch < 1 && (s = new pt.MathNode("mstyle", [s]), s.setAttribute("scriptlevel", "1")), s
                            },
                            Lr = function(e, t) {
                                -1 === e.envName.indexOf("ed") && qr(e);
                                const r = [],
                                ...
                                if (t[0] && "ordgroup" === t[0].type) {
                                    let e = "";
                                    for (let r = 0; r < t[0].body.length; r++) e += Tt(t[0].body[r], "textord").text;
                                    a = Number(e), l = 2 * a
                                }
                                const h = !l;
                                i.body.forEach(function(e) {
                                    for (let t = 1; t < e.length; t += 2) {
                                        const r = Tt(e[t], "styling");
                                        Tt(r.body[0], "ordgroup").body.unshift(c)
                                    }
                        ...
                        Mr({
                            ...
                            handler(e, t) {
                                const r = (Ct(t[0]) ? [t[0]] : Tt(t[0], "ordgroup").body).map(function(e) {
                                        const t = Bt(e).text;
                                ...
                                return Ir(e.parser, o, Or(e.envName))
                            },
                            htmlBuilder: Rr,
                            mathmlBuilder: Er
                        }), Mr({
                            ...
                            handler(e) {
                                ...
                                const s = Ir(e.parser, o, Or(e.envName)),
                            ...
                            handler(e, t) {
                                ...
                                if (o = Ir(e.parser, o, "script"), o.body.length > 0 && o.body[0].length > 1) throw new n("{subarray} can contain only one column");
                                return o
                            },
                            htmlBuilder: Rr,
                            mathmlBuilder: Er
                            ...
                            handler(e) {
                                l.contains(["gather", "gather*"], e.envName) && qr(e);
                                const t = {
                                    cols: [{
                                        type: "align",
                                        align: "c"
                                    ...
                                    autoTag: Nr(e.envName),
                                    emptySingleRow: !0,
                                    leqno: e.parser.settings.leqno
                                };
                                return Ir(e.parser, t, "display")
                            },
                            htmlBuilder: Rr,
                            mathmlBuilder: Er
                        }), Mr({
                            ...
                            handler: e => (qr(e), function(e) {
                                ...
                                for (let s = 0; s < t.length; s++) {
                                    ...
                                    for (let t = 0; t < i.length; t++)
                                        if (Vt(i[t])) {
                                            ...
                                            if (s[0] = {
                                                ...
                                                if (!("<>AV".indexOf(o) > -1)) throw new n('Expected one of "<>AV=|." after @', i[t]);
                                                for (let e = 0; e < 2; e++) {
                                                    let r = !0;
                                                    for (let a = t + 1; a < i.length; a++) {
                                                        ...
                                                        if (Vt(i[a])) throw new n("Missing a " + o + " character to complete a CD arrow.", i[a]);
                                                        s[e].body.push(i[a])
                                                    }
                                    ...
                                    s % 2 == 0 ? r.push(a) : r.shift(), r = [], o.push(r)
                                }
                                return e.gullet.endGroup(), e.gullet.endGroup(), {
                                    type: "array",
                                    mode: "math",
                        ...
                        Ue({
                            ...
                            handler(e, t) {
                                ...
                                let i = "";
                                for (let e = 0; e < s.body.length; ++e) i += Tt(s.body[e], "textord").text;
                                if ("\\begin" === o) {
                                    if (!Dr.hasOwnProperty(i)) throw new n("No such environment: " + i, s);
                                    const e = Dr[i],
                                        {
                                            args: t,
                                            optArgs: o
                                    ...
                                    r.expect("\\end", !1);
                                    const c = r.nextToken,
                                        h = Tt(r.parseFunction(), "environment");
                        ...
                        const _r = (e, t) => {
                            ...
                            $r = (e, t) => {
                                const r = _r(e.size, t.style),
                                    n = r.fracNum(),
                                    o = r.fracDen();
                                let s;
                                s = t.havingStyle(n);
                                const i = it(e.numer, s, t);
                                if (e.continued) {
                                ...
                                s = t.havingStyle(o);
                                const a = it(e.denom, s, t);
                                let l, c, h, m, p, u, d, g, f, b;
                                if (e.hasBarLine ? (e.barSize ? (c = P(e.barSize, t), l = Ee.makeLineSpan("frac-line", t, c)) : l = Ee.makeLineSpan("frac-line", t), c = l.height, h = l.height) : (l = null, c = 0, h = t.fontMetrics().defaultRuleThickness), r.size === w.DISPLAY.size || "display" === e.size ? (m = t.fontMetrics().num1, p = c > 0 ? 3 * h : 7 * h, u = t.fontMetrics().denom1) : (c > 0 ? (m = t.fontMetrics().num2, p = h) : (m = t.fontMetrics().num3, p = 3 * h), u = t.fontMetrics().denom2), l) {
                                    const e = t.fontMetrics().axisHeight;
                                    m - i.depth - (e + .5 * c) < p && (m += p - (m - i.depth - (e + .5 * c))), e - .5 * c - (a.height - u) < p && (u += p - (e - .5 * c - (a.height - u)));
                                    d = Ee.makeVList({
                                        positionType: "individualShift",
                                        children: [{
                                            type: "elem",
                                    ...
                                    e < p && (m += .5 * (p - e), u += .5 * (p - e)), d = Ee.makeVList({
                                        positionType: "individualShift",
                                        children: [{
                                            type: "elem",
                                            elem: a,
                            ...
                            Gr = (e, t) => {
                                let r = new pt.MathNode("mfrac", [xt(e.numer, t), xt(e.denom, t)]);
                                if (e.hasBarLine) {
                                    if (e.barSize) {
                                ...
                                const n = _r(e.size, t.style);
                                if (n.size !== t.style.size) {
                                    r = new pt.MathNode("mstyle", [r]);
                                ...
                                if (null != e.leftDelim || null != e.rightDelim) {
                                    const t = [];
                                    if (null != e.leftDelim) {
                                        const r = new pt.MathNode("mo", [new pt.TextNode(e.leftDelim.replace("\\", ""))]);
                                        r.setAttribute("fence", "true"), t.push(r)
                                    }
                                    if (t.push(r), null != e.rightDelim) {
                                        const r = new pt.MathNode("mo", [new pt.TextNode(e.rightDelim.replace("\\", ""))]);
                                        r.setAttribute("fence", "true"), t.push(r)
                                    }
                                    return dt(t)
                                }
                        ...
                        const Ur = ["display", "text", "script", "scriptscript"],
                            Yr = function(e) {
                                let t = null;
                        ...
                        Ue({
                            ...
                            handler(e, t) {
                                ...
                                const n = t[4],
                                    o = t[5],
                                    s = Xe(t[0]),
                                    i = "atom" === s.type && "open" === s.family ? Yr(s.text) : null,
                                    a = Xe(t[1]),
                                    l = "atom" === a.type && "close" === a.family ? Yr(a.text) : null,
                                    c = Tt(t[2], "size");
                                let h, m = null;
                                ...
                                if ("ordgroup" === u.type) {
                                    if (u.body.length > 0) {
                                        const e = Tt(u.body[0], "textord");
                                        p = Ur[Number(e.text)]
                                    }
                                } else u = Tt(u, "textord"), p = Ur[Number(u.text)];
                                return {
                                    type: "genfrac",
                                    mode: r.mode,
                                    numer: n,
                        ...
                        const Xr = (e, t) => {
                            const r = t.style;
                            let n, o;
                            "supsub" === e.type ? (n = e.sup ? it(e.sup, t.havingStyle(r.sup()), t) : it(e.sub, t.havingStyle(r.sub()), t), o = Tt(e.base, "horizBrace")) : o = Tt(e, "horizBrace");
                            const s = it(o.base, t.havingBaseStyle(w.DISPLAY)),
                                i = At(o, t);
                            let a;
                            if (o.isOver ? (a = Ee.makeVList({
                                    positionType: "firstBaseline",
                                    children: [{
                                        type: "elem",
                                        elem: s
                                ...
                                }, t), a.children[0].children[0].children[1].classes.push("svg-align")) : (a = Ee.makeVList({
                                    positionType: "bottom",
                                ...
                                const e = Ee.makeSpan(["mord", o.isOver ? "mover" : "munder"], [a], t);
                                a = o.isOver ? Ee.makeVList({
                                    positionType: "firstBaseline",
                                    children: [{
                                        type: "elem",
                                        elem: e
                            ...
                            return Ee.makeSpan(["mord", o.isOver ? "mover" : "munder"], [a], t)
                        };
                        Ue({
                            type: "horizBrace",
                            ...
                            mathmlBuilder: (e, t) => {
                                const r = zt(e.label);
                                return new pt.MathNode(e.isOver ? "mover" : "munder", [xt(e.base, t), r])
                            }
                        }), Ue({
                            type: "href",
                            names: ["\\href"],
                            ...
                            htmlBuilder: (e, t) => {
                                const r = et(e.body, t, !1);
                                return Ee.makeAnchor(e.href, [], r, t)
                            },
                            mathmlBuilder: (e, t) => {
                                let r = yt(e.body, t);
                            ...
                            mathmlBuilder: (e, t) => new pt.MathNode("mrow", bt(e.body, t))
                        }), Ue({
                            type: "html",
                            ...
                            htmlBuilder: (e, t) => {
                                const r = et(e.html, t, !1);
                                return Ee.makeFragment(r)
                            },
                            mathmlBuilder: (e, t) => yt(e.mathml, t)
                        });
                        const Wr = function(e) {
                        ...
                        Ue({
                            ...
                            handler: (e, t, r) => {
                                ...
                                if (r[0]) {
                                    const e = Tt(r[0], "raw").string.split(",");
                                    for (let t = 0; t < e.length; t++) {
                                        const r = e[t].split("=");
                                        if (2 === r.length) {
                                            const e = r[1].trim();
                                ...
                                const c = Tt(t[0], "url").url;
                                return "" === l && (l = c, l = l.replace(/^.*[\\/]/, ""), l = l.substring(0, l.lastIndexOf("."))), o.settings.isTrusted({
                            ...
                            htmlBuilder: (e, t) => {
                                ...
                                const i = new W(e.src, e.alt, s);
                                return i.height = r, i.depth = n, i
                            },
                            mathmlBuilder: (e, t) => {
                                const r = new pt.MathNode("mglyph", []);
                            ...
                            htmlBuilder: (e, t) => Ee.makeGlue(e.dimension, t),
                            mathmlBuilder(e, t) {
                            ...
                            htmlBuilder: (e, t) => {
                                let r;
                                "clap" === e.alignment ? (r = Ee.makeSpan([], [it(e.body, t)]), r = Ee.makeSpan(["inner"], [r], t)) : r = Ee.makeSpan(["inner"], [it(e.body, t)]);
                                const n = Ee.makeSpan(["fix"], []);
                                let o = Ee.makeSpan([e.alignment], [r, n], t);
                                const s = Ee.makeSpan(["strut"]);
                                return s.style.height = V(o.height + o.depth), o.depth && (s.style.verticalAlign = V(-o.depth)), o.children.unshift(s), o = Ee.makeSpan(["thinbox"], [o], t), Ee.makeSpan(["mord", "vbox"], [o], t)
                            },
                            mathmlBuilder: (e, t) => {
                                const r = new pt.MathNode("mpadded", [xt(e.body, t)]);
                                if ("rlap" !== e.alignment) {
                        ...
                        const Zr = (e, t, r, n, o, s, i) => {
                                e = Ee.makeSpan([], [e]);
                                const a = r && l.isCharacterBox(r);
                                let c, h, m;
                                if (t) {
                                    const e = it(t, n.havingStyle(o.sup()), n);
                                    h = {
                                        elem: e,
                                ...
                                if (r) {
                                    const e = it(r, n.havingStyle(o.sub()), n);
                                    c = {
                                        elem: e,
                                ...
                                if (h && c) {
                                    const t = n.fontMetrics().bigOpSpacing5 + c.elem.height + c.elem.depth + c.kern + e.depth + i;
                                    m = Ee.makeVList({
                                        positionType: "bottom",
                                        positionData: t,
                                        children: [{
                                ...
                                const p = [m];
                                if (c && 0 !== s && !a) {
                                    const e = Ee.makeSpan(["mspace"], [], n);
                                    e.style.marginRight = V(s), p.unshift(e)
                                }
                                return Ee.makeSpan(["mop", "op-limits"], p, n)
                            },
                            Kr = ["\\smallint"],
                            Jr = (e, t) => {
                                let r, n, o, s = !1;
                                "supsub" === e.type ? (r = e.sup, n = e.sub, o = Tt(e.base, "op"), s = !0) : o = Tt(e, "op");
                                const i = t.style;
                                let a, c = !1;
                                if (i.size === w.DISPLAY.size && o.symbol && !l.contains(Kr, o.name) && (c = !0), o.symbol) {
                                    const e = c ? "Size2-Regular" : "Size1-Regular";
                                    let r = "";
                                    if ("\\oiint" !== o.name && "\\oiiint" !== o.name || (r = o.name.slice(1), o.name = "oiint" === r ? "\\iint" : "\\iiint"), a = Ee.makeSymbol(o.name, e, "math", t, ["mop", "op-symbol", c ? "large-op" : "small-op"]), r.length > 0) {
                                        const e = a.italic,
                                            n = Ee.staticSvg(r + "Size" + (c ? "2" : "1"), t);
                                        a = Ee.makeVList({
                                            positionType: "individualShift",
                                            children: [{
                                                type: "elem",
                                    ...
                                    const e = et(o.body, t, !0);
                                    1 === e.length && e[0] instanceof Z ? (a = e[0], a.classes[0] = "mop") : a = Ee.makeSpan(["mop"], e, t)
                                } else {
                                    const e = [];
                                    for (let r = 1; r < o.name.length; r++) e.push(Ee.mathsym(o.name[r], o.mode, t));
                                    a = Ee.makeSpan(["mop"], e, t)
                                }
                                let h = 0,
                                    m = 0;
                                return (a instanceof Z || "\\oiint" === o.name || "\\oiiint" === o.name) && !o.suppressBaseShift && (h = (a.height - a.depth) / 2 - t.fontMetrics().axisHeight, m = a.italic), s ? Zr(a, r, n, t, i, m, h) : (h && (a.style.position = "relative", a.style.top = V(h)), a)
                            },
                            Qr = (e, t) => {
                                let r;
                                if (e.symbol) r = new ht("mo", [ut(e.name, e.mode)]), l.contains(Kr, e.name) && r.setAttribute("largeop", "false");
                                else if (e.body) r = new ht("mo", bt(e.body, t));
                                else {
                                    r = new ht("mi", [new mt(e.name.slice(1))]);
                                    const t = new ht("mo", [ut("⁡", "text")]);
                                    r = e.parentIsSupSub ? new ht("mrow", [r, t]) : ct([r, t])
                                }
                                return r
                            },
                            en = {
                        ...
                        const rn = (e, t) => {
                            let r, n, o, s, i = !1;
                            if ("supsub" === e.type ? (r = e.sup, n = e.sub, o = Tt(e.base, "operatorname"), i = !0) : o = Tt(e, "operatorname"), o.body.length > 0) {
                                const e = o.body.map(e => {
                                    ...
                                    r = et(e, t.withFont("mathrm"), !0);
                                for (let e = 0; e < r.length; e++) {
                                    const t = r[e];
                                    t instanceof Z && (t.text = t.text.replace(/\u2212/, "-").replace(/\u2217/, "*"))
                                }
                                s = Ee.makeSpan(["mop"], r, t)
                            } else s = Ee.makeSpan(["mop"], [], t);
                            return i ? Zr(s, r, n, t, t.style, 0, 0) : s
                        };
                        ...
                        Ue({
                            ...
                            htmlBuilder: rn,
                            mathmlBuilder: (e, t) => {
                                let r = bt(e.body, t.withFont("mathrm")),
                                    n = !0;
                                for (let e = 0; e < r.length; e++) {
                                    const t = r[e];
                                    if (t instanceof pt.SpaceNode);
                                    else if (t instanceof pt.MathNode) switch (t.type) {
                                        case "mi":
                                        case "mn":
                                        case "ms":
                                        case "mspace":
                                        ...
                                        case "mo": {
                                            ...
                                            1 === t.children.length && e instanceof pt.TextNode ? e.text = e.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : n = !1;
                                            break
                                        }
                                        default:
                                            n = !1
                                ...
                                const o = new pt.MathNode("mi", r);
                                o.setAttribute("mathvariant", "normal");
                                const s = new pt.MathNode("mo", [ut("⁡", "text")]);
                                return e.parentIsSupSub ? new pt.MathNode("mrow", [o, s]) : pt.newDocumentFragment([o, s])
                            }
                        }), Ar("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"), Ye({
                            type: "ordgroup",
                            htmlBuilder: (e, t) => e.semisimple ? Ee.makeFragment(et(e.body, t, !1)) : Ee.makeSpan(["mord"], et(e.body, t, !0), t),
                            mathmlBuilder: (e, t) => yt(e.body, t, !0)
                        }), Ue({
                            type: "overline",
                            names: ["\\overline"],
                            props: {
                            ...
                            htmlBuilder(e, t) {
                                const r = it(e.body, t.havingCrampedStyle()),
                                    n = Ee.makeLineSpan("overline-line", t),
                                ...
                                return Ee.makeSpan(["mord", "overline"], [s], t)
                            },
                            mathmlBuilder(e, t) {
                                const r = new pt.MathNode("mo", [new pt.TextNode("‾")]);
                                r.setAttribute("stretchy", "true");
                                const n = new pt.MathNode("mover", [xt(e.body, t), r]);
                                return n.setAttribute("accent", "true"), n
                            }
                        }), Ue({
                            type: "phantom",
                            ...
                            htmlBuilder: (e, t) => {
                                const r = et(e.body, t.withPhantom(), !1);
                                return Ee.makeFragment(r)
                            },
                            mathmlBuilder: (e, t) => {
                                const r = bt(e.body, t);
                            ...
                            htmlBuilder: (e, t) => {
                                const r = Ee.makeSpan(["inner"], [it(e.body, t.withPhantom())]),
                                    n = Ee.makeSpan(["fix"], []);
                                return Ee.makeSpan(["mord", "rlap"], [r, n], t)
                            },
                            mathmlBuilder: (e, t) => {
                                const r = bt(We(e.body), t),
                                    n = new pt.MathNode("mphantom", r),
                            ...
                            handler(e, t, r) {
                                ...
                                return {
                                    type: "rule",
                                    mode: n.mode,
                                    shift: o && Tt(o, "size").value,
                                    width: s.value,
                                    height: i.value
                                }
                            },
                            htmlBuilder(e, t) {
                                const r = Ee.makeSpan(["mord", "rule"], [], t),
                                    n = P(e.width, t),
                                    o = P(e.height, t),
                        ...
                        Ue({
                            ...
                            htmlBuilder: (e, t) => {
                                const r = Ee.makeSpan([], [it(e.body, t)]);
                            ...
                            htmlBuilder(e, t) {
                                let r = it(e.body, t.havingCrampedStyle());
                                0 === r.height && (r.height = t.fontMetrics().xHeight), r = Ee.wrapFragment(r, t);
                                ...
                                r.style.paddingLeft = V(c);
                                const p = Ee.makeVList({
                                    positionType: "firstBaseline",
                                    children: [{
                                        type: "elem",
                                        elem: r,
                                ...
                                if (e.index) {
                                    const r = t.havingStyle(w.SCRIPTSCRIPT),
                                        ...
                                        i = Ee.makeSpan(["root"], [s]);
                                    return Ee.makeSpan(["mord", "sqrt"], [i, p], t)
                                }
                                return Ee.makeSpan(["mord", "sqrt"], [p], t)
                            },
                            mathmlBuilder(e, t) {
                                const {
                                    body: r,
                                ...
                                return n ? new pt.MathNode("mroot", [xt(r, t), xt(n, t)]) : new pt.MathNode("msqrt", [xt(r, t)])
                            }
                        });
                        const sn = {
                            display: w.DISPLAY,
                        ...
                        Ue({
                            ...
                            htmlBuilder(e, t) {
                                const r = function(e, t) {
                                    const r = e.base;
                                    return r ? "op" === r.type ? r.limits && (t.style.size === w.DISPLAY.size || r.alwaysHandleSupSub) ? Jr : null : "operatorname" === r.type ? r.alwaysHandleSupSub && (t.style.size === w.DISPLAY.size || r.limits) ? rn : null : "accent" === r.type ? l.isCharacterBox(r.base) ? qt : null : "horizBrace" === r.type && !e.sub === r.isOver ? Xr : null : null
                                }(e, t);
                                if (r) return r(e, t);
                                const {
                                    base: n,
                                ...
                                if (o) {
                                    ...
                                    a = it(o, e, t), u || (m = i.height - e.fontMetrics().supDrop * e.sizeMultiplier / t.sizeMultiplier)
                                }
                                if (s) {
                                    const e = t.havingStyle(t.style.sub());
                                    c = it(s, e, t), u || (p = i.depth + e.fontMetrics().subDrop * e.sizeMultiplier / t.sizeMultiplier)
                                }
                                let d;
                                d = t.style === w.DISPLAY ? h.sup1 : t.style.cramped ? h.sup3 : h.sup2;
                                const g = t.sizeMultiplier,
                                    f = V(.5 / h.ptPerEm / g);
                                let b, y = null;
                                if (c) {
                                    const t = e.base && "op" === e.base.type && e.base.name && ("\\oiint" === e.base.name || "\\oiiint" === e.base.name);
                                    (i instanceof Z || t) && (y = V(-i.italic))
                                }
                                if (a && c) {
                                    m = Math.max(m, d, a.depth + .25 * h.xHeight), p = Math.max(p, h.sub2);
                                    const e = 4 * h.defaultRuleThickness;
                                    if (m - a.depth - (c.height - p) < e) {
                                        p = e - (m - a.depth) + c.height;
                                        const t = .8 * h.xHeight - (m - a.depth);
                                        t > 0 && (m += t, p -= t)
                                    }
                                    b = Ee.makeVList({
                                        positionType: "individualShift",
                                    ...
                                    p = Math.max(p, h.sub1, c.height - .8 * h.xHeight);
                                    b = Ee.makeVList({
                                        positionType: "shift",
                                        positionData: p,
                                        children: [{
                                    ...
                                    m = Math.max(m, d, a.depth + .25 * h.xHeight), b = Ee.makeVList({
                                        positionType: "shift",
                                        positionData: -m,
                                        children: [{
                                            type: "elem",
                                ...
                                const x = ot(i, "right") || "mord";
                                return Ee.makeSpan([x], [i, Ee.makeSpan(["msupsub"], [b])], t)
                            },
                            mathmlBuilder(e, t) {
                                let r, n, o = !1;
                                ...
                                const s = [xt(e.base, t)];
                                let i;
                                if (e.sub && s.push(xt(e.sub, t)), e.sup && s.push(xt(e.sup, t)), o) i = r ? "mover" : "munder";
                                else if (e.sub)
                                    if (e.sup) {
                                        const r = e.base;
                                ...
                                return new pt.MathNode(i, s)
                            }
                        }), Ye({
                            type: "atom",
                            htmlBuilder: (e, t) => Ee.mathsym(e.text, e.mode, t, ["m" + e.family]),
                            mathmlBuilder(e, t) {
                                const r = new pt.MathNode("mo", [ut(e.text, e.mode)]);
                                if ("bin" === e.family) {
                                    const n = gt(e, t);
                        ...
                        Ye({
                            type: "mathord",
                            htmlBuilder: (e, t) => Ee.makeOrd(e, t, "mathord"),
                            mathmlBuilder(e, t) {
                                const r = new pt.MathNode("mi", [ut(e.text, e.mode, t)]),
                                    n = gt(e, t) || "italic";
                                return n !== an[r.type] && r.setAttribute("mathvariant", n), r
                            }
                        }), Ye({
                            type: "textord",
                            htmlBuilder: (e, t) => Ee.makeOrd(e, t, "textord"),
                            mathmlBuilder(e, t) {
                                const r = ut(e.text, e.mode, t),
                                    n = gt(e, t) || "normal";
                                let o;
                                return o = "text" === e.mode ? new pt.MathNode("mtext", [r]) : /[0-9]/.test(e.text) ? new pt.MathNode("mn", [r]) : "\\prime" === e.text ? new pt.MathNode("mo", [r]) : new pt.MathNode("mi", [r]), n !== an[o.type] && o.setAttribute("mathvariant", n), o
                            }
                        });
                        const ln = {
                                "\\nobreak": "nobreak",
                        ...
                        Ye({
                            ...
                            htmlBuilder(e, t) {
                                if (cn.hasOwnProperty(e.text)) {
                                    const r = cn[e.text].className || "";
                                    if ("text" === e.mode) {
                                        const n = Ee.makeOrd(e, t, "textord");
                                        return n.classes.push(r), n
                                    }
                                    return Ee.makeSpan(["mspace", r], [Ee.mathsym(e.text, e.mode, t)], t)
                                }
                                if (ln.hasOwnProperty(e.text)) return Ee.makeSpan(["mspace", ln[e.text]], [], t);
                                throw new n('Unknown type of space "' + e.text + '"')
                            },
                            mathmlBuilder(e, t) {
                                let r;
                                if (!cn.hasOwnProperty(e.text)) {
                                    if (ln.hasOwnProperty(e.text)) return new pt.MathNode("mspace");
                                    throw new n('Unknown type of space "' + e.text + '"')
                                }
                                return r = new pt.MathNode("mtext", [new pt.TextNode(" ")]), r
                            }
                        });
                        const hn = () => {
                            const e = new pt.MathNode("mtd", []);
                            return e.setAttribute("width", "50%"), e
                        };
                        Ye({
                            type: "tag",
                            mathmlBuilder(e, t) {
                                const r = new pt.MathNode("mtable", [new pt.MathNode("mtr", [hn(), new pt.MathNode("mtd", [yt(e.body, t)]), hn(), new pt.MathNode("mtd", [yt(e.tag, t)])])]);
                        ...
                        const mn = {
                            ...
                            dn = (e, t) => {
                                const r = e.font;
                                return r ? mn[r] ? t.withTextFontFamily(mn[r]) : pn[r] ? t.withTextFontWeight(pn[r]) : "\\emph" === r ? "textit" === t.fontShape ? t.withTextFontShape("textup") : t.withTextFontShape("textit") : t.withTextFontShape(un[r]) : t
                            };
                        Ue({
                            type: "text",
                            ...
                            htmlBuilder(e, t) {
                                const r = dn(e, t),
                                    n = et(e.body, r, !0);
                                return Ee.makeSpan(["mord", "text"], n, r)
                            },
                            mathmlBuilder(e, t) {
                                const r = dn(e, t);
                                return yt(e.body, r)
                            ...
                            htmlBuilder(e, t) {
                                const r = it(e.body, t),
                                    n = Ee.makeLineSpan("underline-line", t),
                                    o = t.fontMetrics().defaultRuleThickness,
                                    s = Ee.makeVList({
                                        positionType: "top",
                                        positionData: r.height,
                                ...
                                return Ee.makeSpan(["mord", "underline"], [s], t)
                            },
                            mathmlBuilder(e, t) {
                                const r = new pt.MathNode("mo", [new pt.TextNode("‾")]);
                                r.setAttribute("stretchy", "true");
                                const n = new pt.MathNode("munder", [xt(e.body, t), r]);
                                return n.setAttribute("accentunder", "true"), n
                            }
                        }), Ue({
                            type: "vcenter",
                            ...
                            mathmlBuilder: (e, t) => new pt.MathNode("mpadded", [xt(e.body, t)], ["vcenter"])
                        }), Ue({
                            type: "verb",
                            names: ["\\verb"],
                            props: {
                            ...
                            htmlBuilder(e, t) {
                                ...
                                for (let t = 0; t < r.length; t++) {
                                    let s = r[t];
                                    "~" === s && (s = "\\textasciitilde"), n.push(Ee.makeSymbol(s, "Typewriter-Regular", e.mode, o, ["mord", "texttt"]))
                                }
                                return Ee.makeSpan(["mord", "text"].concat(o.sizingClasses(t)), Ee.tryCombineChars(n), o)
                            },
                            mathmlBuilder(e, t) {
                                const r = new pt.TextNode(gn(e)),
                                    n = new pt.MathNode("mtext", [r]);
                                return n.setAttribute("mathvariant", "monospace"), n
                            }
                        });
                        const gn = e => e.body.replace(/ /g, e.star ? "␣" : " ");
                        var fn = _e;
                        const bn = "[ \r\n\t]",
                            yn = "(\\\\[a-zA-Z@]+)" + bn + "*",
                            xn = "[̀-ͯ]",
                            wn = new RegExp(xn + "+$"),
                            vn = "(" + bn + "+)|\\\\(\n|[ \r\t]+\n?)[ \r\t]*|([!-\\[\\]-‧‪-퟿豈-￿]" + xn + "*|[\ud800-\udbff][\udc00-\udfff]" + xn + "*|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5|" + yn + "|\\\\[^\ud800-\udfff])";
                        class kn {
                            constructor(e, t) {
                                this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = t, this.tokenRegex = new RegExp(vn, "g"), this.catcodes = {
                                    "%": 14,
                                    "~": 13
                                }
                            }
                            ...
                            lex() {
                                ...
                                if (t === e.length) return new Br("EOF", new Tr(this, t, t));
                                const r = this.tokenRegex.exec(e);
                                if (null === r || r.index !== t) throw new n("Unexpected character: '" + e[t] + "'", new Br(e[t], new Tr(this, t, t + 1)));
                                const o = r[6] || r[3] || (r[2] ? "\\ " : " ");
                                ...
                                return new Br(o, new Tr(this, t, this.tokenRegex.lastIndex))
                            }
                        }
                        class Sn {
                            constructor(e, t) {
                        ...
                        }), Ar("\\expandafter", function(e) {
                            const t = e.popToken();
                            return e.expandOnce(!0), {
                                tokens: [t],
                                numArgs: 0
                            }
                        }), Ar("\\@firstoftwo", function(e) {
                            return {
                                tokens: e.consumeArgs(2)[0],
                                numArgs: 0
                            }
                        }), Ar("\\@secondoftwo", function(e) {
                            return {
                                tokens: e.consumeArgs(2)[1],
                                numArgs: 0
                            }
                        }), Ar("\\@ifnextchar", function(e) {
                        ...
                        }), Ar("\\@ifstar", "\\@ifnextchar *{\\@firstoftwo{#1}}"), Ar("\\TextOrMath", function(e) {
                        ...
                        Ar("\\char", function(e) {
                            ...
                            if (t) {
                                if (o = zn[r.text], null == o || o >= t) throw new n("Invalid base-" + t + " digit " + r.text);
                                let s;
                                for (; null != (s = zn[e.future().text]) && s < t;) o *= t, o += s, e.popToken()
                            }
                            return "\\@char{" + o + "}"
                        });
                        const An = (e, t, r, o) => {
                        ...
                        Ar("\\newcommand", e => An(e, !1, !0, !1)), Ar("\\renewcommand", e => An(e, !0, !1, !1)), Ar("\\providecommand", e => An(e, !0, !0, !0)), Ar("\\message", e => {
                        ...
                        class In {
                            constructor(e, t, r) {
                                this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = t, this.expansionCount = 0, this.feed(e), this.macros = new Sn(Mn, t.macros), this.mode = r, this.stack = []
                            }
                            feed(e) {
                            ...
                            scanArgument(e) {
                                ...
                                return this.pushToken(new Br("EOF", r.loc)), this.pushTokens(n), t.range(r, "")
                            }
                            consumeSpaces() {
                                for (;
                            ...
                            expandMacro(e) {
                                return this.macros.has(e) ? this.expandTokens([new Br(e)]) : void 0
                            }
                            expandTokens(e) {
                                const t = [],
                                    r = this.stack.length;
                            ...
                            _getExpansion(e) {
                                ...
                                if ("string" == typeof r) {
                                    ...
                                    const t = new kn(r, this.settings),
                                        n = [];
                                    let o = t.lex();
                                    for (;
                            ...
                            isDefined(e) {
                                return this.macros.has(e) || fn.hasOwnProperty(e) || oe.math.hasOwnProperty(e) || oe.text.hasOwnProperty(e) || Nn.hasOwnProperty(e)
                            }
                            isExpandable(e) {
                                const t = this.macros.get(e);
                                return null != t ? "string" == typeof t || "function" == typeof t || !t.unexpandable : fn.hasOwnProperty(e) && !fn[e].primitive
                            }
                        }
                        ...
                        class Ln {
                            constructor(e, t) {
                                this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new In(e, t, this.mode), this.settings = t, this.leftrightDepth = 0
                            }
                            expect(e, t) {
                            ...
                            subparse(e) {
                                ...
                                this.consume(), this.gullet.pushToken(new Br("}")), this.gullet.pushTokens(e);
                            ...
                            parseExpression(e, t) {
                                ...
                                for (;;) {
                                    ...
                                    const n = this.fetch();
                                    if (-1 !== Ln.endOfExpression.indexOf(n.text)) break;
                                    if (t && n.text === t) break;
                                    if (e && fn[n.text] && fn[n.text].infix) break;
                                    ...
                                    if ("\\limits" === e.text || "\\nolimits" === e.text) {
                                        ...
                                        if (!Rn[e.text]) break;
                                        {
                                            const t = On.test(e.text),
                                                n = [];
                                            for (n.push(new Br(Rn[e.text])), this.consume();;) {
                                                const e = this.fetch().text;
                                                if (!Rn[e]) break;
                                                if (On.test(e) !== t) break;
                                                n.unshift(new Br(Rn[e])), this.consume()
                                            }
                            ...
                            parseGroup(e, t) {
                                ...
                                } else if (s = this.parseFunction(t, e) || this.parseSymbol(), null == s && "\\" === o[0] && !Nn.hasOwnProperty(o)) {
                            ...
                            formLigatures(e) {
                                ...
                                for (let r = 0; r < t; ++r) {
                                    ...
                                    "-" === o && "-" === e[r + 1].text && (r + 1 < t && "-" === e[r + 2].text ? (e.splice(r, 3, {
                                        type: "textord",
                                        mode: "text",
                                        loc: Tr.range(n, e[r + 2]),
                                        text: "---"
                                    }), t -= 2) : (e.splice(r, 2, {
                                        type: "textord",
                                        mode: "text",
                                        loc: Tr.range(n, e[r + 1]),
                                        text: "--"
                            ...
                            parseSymbol() {
                                ...
                                En.hasOwnProperty(t[0]) && !oe[this.mode][t[0]] && (this.settings.strict && "math" === this.mode && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + t[0] + '" used in math mode', e), t = En[t[0]] + t.slice(1));
                                const r = wn.exec(t);
                                let o;
                                ...
                                if (this.consume(), r)
                                    for (let t = 0; t < r[0].length; t++) {
                                        const s = r[0][t];
                                        if (!Hn[s]) throw new n("Unknown accent ' " + s + "'", e);
                                        const i = Hn[s][this.mode] || Hn[s].text;
                        ...
                        var Dn = function(e, t) {
                            ...
                            if (delete r.gullet.macros.current["\\current@color"], delete r.gullet.macros.current["\\color"], r.gullet.macros.get("\\df@tag")) {
                                ...
                                o = [{
                                    ...
                                    mode: "text",
                                    body: o,
                                    tag: r.subparse([new Br("\\df@tag")])
                                }]
                            }
                            return o
                        };
                        let Pn = function(e, t, r) {
                            t.textContent = "";
                            const n = Fn(e, r).toNode();
                            t.appendChild(n)
                        };
                        "undefined" != typeof document && "CSS1Compat" !== document.compatMode && ("undefined" != typeof console && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), Pn = function() {
                            throw new n("KaTeX doesn't work in quirks mode.")
                        });
                        const Vn = function(e, t, r) {
                                if (r.throwOnError || !(e instanceof n)) throw e;
                                const o = Ee.makeSpan(["katex-error"], [new Z(t)]);
                            ...
                            Fn = function(e, t) {
                                ...
                                try {
                                    return function(e, t, r) {
                                        const n = vt(r);
                                        let o;
                                        if ("mathml" === r.output) return wt(e, t, n, r.displayMode, !0);
                                        if ("html" === r.output) {
                                            const t = lt(e, n);
                                            o = Ee.makeSpan(["katex"], [t])
                                        } else {
                                            const s = wt(e, t, n, r.displayMode, !1),
                                                i = lt(e, n);
                                            o = Ee.makeSpan(["katex"], [s, i])
                                        }
                                        return kt(o, r)
                                    }(Dn(e, r), e, r)
                                } catch (t) {
                        ...
                        var _n = {
                            ...
                            __renderToDomTree: Fn,
                            __renderToHTMLTree: function(e, t) {
                                const r = new m(t);
                                try {
                                    return function(e, t, r) {
                                        const n = lt(e, vt(r)),
                                            o = Ee.makeSpan(["katex"], [n]);
                                        return kt(o, r)
                                    }(Dn(e, r), 0, r)
                                } catch (t) {
                                    return Vn(t, e, r)
...
//# sourceMappingURL=http://go/sourcemap/sourcemaps/475871d112608994deb2e3065dfb7c6b0baa0c50/extensions/markdown-math/dist/extension.js.map