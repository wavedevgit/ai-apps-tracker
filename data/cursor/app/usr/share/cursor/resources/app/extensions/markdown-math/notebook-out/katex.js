...
var rn = tn((ge, Tt) => {
    (function(N, H) {
        typeof ge == "object" && typeof Tt == "object" ? Tt.exports = H() : typeof define == "function" && define.amd ? define([], H) : typeof ge == "object" ? ge.katex = H() : N.katex = H()
        ...
        return (function() {
            ...
            (function() {
                k.d = function(t, e) {
                    for (var r in e) k.o(e, r) && !k.o(t, r) && Object.defineProperty(t, r, {
                        enumerable: !0,
                        get: e[r]
                    })
                }
            ...
            class H {
                constructor(e, r) {
                    ...
                    if (o && o.start <= o.end) {
                        let m = o.lexer.input;
                        s = o.start, a = o.end, s === m.length ? n += " at end of input: " : n += " at position " + (s + 1) + ": ";
                        let f = m.slice(s, a).replace(/[^]/g, "$&\u0332"),
                            b;
                        s > 15 ? b = "\u2026" + m.slice(s - 15, s) : b = m.slice(0, s);
                        let y;
                        a + 15 < m.length ? y = m.slice(a, a + 15) + "\u2026" : y = m.slice(a), n += b + f + y
                    }
                    let u = new Error(n);
                    return u.name = "ParseError", u.__proto__ = H.prototype, u.position = s, s != null && a != null && (u.length = a - s), u.rawMessage = e, u
                }
            }
            ...
            let c0 = function(t) {
                    return t.type === "ordgroup" || t.type === "color" ? t.body.length === 1 ? c0(t.body[0]) : t : t.type === "font" ? c0(t.body) : t
                },
                k0 = function(t) {
                    let e = c0(t);
                ...
                constructor(e) {
                    ...
                    for (let r in f0)
                        if (f0.hasOwnProperty(r)) {
                            let n = f0[r];
                            this[r] = e[r] !== void 0 ? n.processor ? n.processor(e[r]) : e[r] : le(n)
                        }
                }
                reportNonstrict(e, r, n) {
                    let s = this.strict;
                    if (typeof s == "function" && (s = s(e, r, n)), !(!s || s === "ignore")) {
                        if (s === !0 || s === "error") throw new v("LaTeX-incompatible input and strict mode is set to 'error': " + (r + " [" + e + "]"), n);
            ...
            let ee = 0,
                ...
                re = 6,
                g0 = 7,
                E0 = [new q0(ee, 0, !1), new q0(ye, 0, !0), new q0(te, 1, !1), new q0(F0, 1, !0), new q0(ce, 2, !1), new q0(z0, 2, !0), new q0(re, 3, !1), new q0(g0, 3, !0)],
...
-470,-1265c-4.7,-6,-9.7,-11.7,-15,-17c-0.7,-0.7,-6.7,-1,-18,-1z`;
            ...
            class ue {
                ...
                toNode() {
                    ...
                    for (let r = 0; r < this.children.length; r++) e.appendChild(this.children[r].toNode());
                    return e
                }
                toMarkup() {
                    let e = "";
                    for (let r = 0; r < this.children.length; r++) e += this.children[r].toMarkup();
                    return e
                }
                toText() {
                    let e = r => r.toText();
            ...
            function Ve(t, e, r) {
                if (!I0[e]) throw new Error("Font metrics not found for font: " + e + ".");
                let n = t.charCodeAt(0),
                    s = I0[e][n];
                if (!s && t[0] in Ct && (n = Ct[t[0]].charCodeAt(0), s = I0[e][n]), !s && r === "text" && Bt(n) && (s = I0[e][77]), s) return {
                    depth: s[0],
                    height: s[1],
                    italic: s[2],
                    skew: s[3],
            ...
            let Cn = [
                ...
                Dt = [.5, .6, .7, .8, .9, 1, 1.2, 1.44, 1.728, 2.074, 2.488],
                qt = function(t, e) {
                    return e.size < 2 ? t : Cn[t - 1][e.size - 1]
                };
            class _0 {
                constructor(e) {
                    this.style = void 0, this.color = void 0, this.size = void 0, this.textSize = void 0, this.phantom = void 0, this.font = void 0, this.fontFamily = void 0, this.fontWeight = void 0, this.fontShape = void 0, this.sizeMultiplier = void 0, this.maxSize = void 0, this.minRuleThickness = void 0, this._fontMetrics = void 0, this.style = e.style, this.color = e.color, this.size = e.size || _0.BASESIZE, this.textSize = e.textSize || this.size, this.phantom = !!e.phantom, this.font = e.font || "", this.fontFamily = e.fontFamily || "", this.fontWeight = e.fontWeight || "", this.fontShape = e.fontShape || "", this.sizeMultiplier = Dt[this.size - 1], this.maxSize = e.maxSize, this.minRuleThickness = e.minRuleThickness, this._fontMetrics = void 0
                }
                extend(e) {
                    let r = {
                        style: this.style,
                ...
                fontMetrics() {
                    return this._fontMetrics || (this._fontMetrics = Nn(this.size)), this._fontMetrics
                }
                getColor() {
            ...
            let $e = {
                ...
                Et = function(t) {
                    return typeof t != "string" && (t = t.unit), t in $e || t in qn || t === "ex"
                },
                n0 = function(t, e) {
                    let r;
                    if (t.unit in $e) r = $e[t.unit] / e.fontMetrics().ptPerEm / e.sizeMultiplier;
                    else if (t.unit === "mu") r = e.fontMetrics().cssEmPerMu;
                    else {
                        let n;
                        if (e.style.isTight() ? n = e.havingStyle(e.style.text()) : n = e, t.unit === "ex") r = n.fontMetrics().xHeight;
                ...
                Rt = function(t) {
                    ...
                    for (let r in this.style) this.style.hasOwnProperty(r) && (e.style[r] = this.style[r]);
                    for (let r in this.attributes) this.attributes.hasOwnProperty(r) && e.setAttribute(r, this.attributes[r]);
                    for (let r = 0; r < this.children.length; r++) e.appendChild(this.children[r].toNode());
                    return e
                },
                En = /[\s"'>/=\x00-\x1f]/,
                Ot = function(t) {
                    let e = "<" + t;
                    this.classes.length && (e += ' class="' + T.escape(Y0(this.classes)) + '"');
                    let r = "";
                    for (let n in this.style) this.style.hasOwnProperty(n) && (r += T.hyphenate(n) + ":" + this.style[n] + ";");
                    ...
                    for (let n = 0; n < this.children.length; n++) e += this.children[n].toMarkup();
                    return e += "</" + t + ">", e
                };
            class he {
                constructor(e, r, n, s) {
                    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.width = void 0, this.maxFontSize = void 0, this.style = void 0, It.call(this, e, n, s), this.children = r || []
                }
                setAttribute(e, r) {
                    this.attributes[e] = r
                }
            ...
            class Ue {
                constructor(e, r, n, s) {
                    this.children = void 0, this.attributes = void 0, this.classes = void 0, this.height = void 0, this.depth = void 0, this.maxFontSize = void 0, this.style = void 0, It.call(this, r, s), this.children = n || [], this.setAttribute("href", e)
                }
                setAttribute(e, r) {
                    this.attributes[e] = r
                }
            ...
            class In {
                ...
                toMarkup() {
                    let e = '<img src="' + T.escape(this.src) + '"' + (' alt="' + T.escape(this.alt) + '"'),
                        r = "";
                    for (let n in this.style) this.style.hasOwnProperty(n) && (r += T.hyphenate(n) + ":" + this.style[n] + ";");
            ...
            class A0 {
                constructor(e, r, n, s, a, o, u, m) {
                    this.text = void 0, this.height = void 0, this.depth = void 0, this.italic = void 0, this.skew = void 0, this.width = void 0, this.maxFontSize = void 0, this.classes = void 0, this.style = void 0, this.text = e, this.height = r || 0, this.depth = n || 0, this.italic = s || 0, this.skew = a || 0, this.width = o || 0, this.classes = u || [], this.style = m || {}, this.maxFontSize = 0;
                    let f = bn(this.text.charCodeAt(0));
                    f && this.classes.push(f + "_fallback"), /[îïíì]/.test(this.text) && (this.text = Rn[this.text])
                }
                hasClass(e) {
                    return T.contains(this.classes, e)
                }
                toNode() {
                    let e = document.createTextNode(this.text),
                        r = null;
                    this.italic > 0 && (r = document.createElement("span"), r.style.marginRight = A(this.italic)), this.classes.length > 0 && (r = r || document.createElement("span"), r.className = Y0(this.classes));
                    for (let n in this.style) this.style.hasOwnProperty(n) && (r = r || document.createElement("span"), r.style[n] = this.style[n]);
                    return r ? (r.appendChild(e), r) : e
                }
                toMarkup() {
                    let e = !1,
                        r = "<span";
                    this.classes.length && (e = !0, r += ' class="', r += T.escape(Y0(this.classes)), r += '"');
                    let n = "";
                    this.italic > 0 && (n += "margin-right:" + this.italic + "em;");
                    for (let a in this.style) this.style.hasOwnProperty(a) && (n += T.hyphenate(a) + ":" + this.style[a] + ";");
            ...
            class P0 {
                ...
                toNode() {
                    ...
                    for (let n in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, n) && r.setAttribute(n, this.attributes[n]);
                    for (let n = 0; n < this.children.length; n++) r.appendChild(this.children[n].toNode());
                    return r
                }
                toMarkup() {
                    let e = '<svg xmlns="http://www.w3.org/2000/svg"';
                    for (let r in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, r) && (e += " " + r + '="' + T.escape(this.attributes[r]) + '"');
                    e += ">";
                    for (let r = 0; r < this.children.length; r++) e += this.children[r].toMarkup();
                    return e += "</svg>", e
                }
            ...
            class X0 {
                ...
                toNode() {
                    ...
                    return this.alternate ? r.setAttribute("d", this.alternate) : r.setAttribute("d", Nt[this.pathName]), r
                }
                toMarkup() {
                    return this.alternate ? '<path d="' + T.escape(this.alternate) + '"/>' : '<path d="' + T.escape(Nt[this.pathName]) + '"/>'
                }
            }
            class We {
                constructor(e) {
            ...
            i(M, c, g, "\u2013", "--", !0), i(M, c, g, "\u2013", "\\textendash"), i(M, c, g, "\u2014", "---", !0), i(M, c, g, "\u2014", "\\textemdash"), i(M, c, g, "\u2018", "`", !0), i(M, c, g, "\u2018", "\\textquoteleft"), i(M, c, g, "\u2019", "'", !0), i(M, c, g, "\u2019", "\\textquoteright"), i(M, c, g, "\u201C", "``", !0), i(M, c, g, "\u201C", "\\textquotedblleft"), i(M, c, g, "\u201D", "''", !0), i(M, c, g, "\u201D", "\\textquotedblright"), i(l, c, g, "\xB0", "\\degree", !0), i(M, c, g, "\xB0", "\\degree"), i(M, c, g, "\xB0", "\\textdegree", !0), i(l, c, g, "\xA3", "\\pounds"), i(l, c, g, "\xA3", "\\mathsterling", !0), i(M, c, g, "\xA3", "\\pounds"), i(M, c, g, "\xA3", "\\textsterling", !0), i(l, d, g, "\u2720", "\\maltese"), i(M, d, g, "\u2720", "\\maltese");
            let Ft = '0123456789/@."';
            ...
            i(l, d, g, "C", "\u2102"), i(M, d, g, "C", "\u2102"), i(l, d, g, "H", "\u210D"), i(M, d, g, "H", "\u210D"), i(l, d, g, "N", "\u2115"), i(M, d, g, "N", "\u2115"), i(l, d, g, "P", "\u2119"), i(M, d, g, "P", "\u2119"), i(l, d, g, "Q", "\u211A"), i(M, d, g, "Q", "\u211A"), i(l, d, g, "R", "\u211D"), i(M, d, g, "R", "\u211D"), i(l, d, g, "Z", "\u2124"), i(M, d, g, "Z", "\u2124"), i(l, c, I, "h", "\u210E"), i(M, c, I, "h", "\u210E");
            let O = "";
            for (let t = 0; t < Se.length; t++) {
                let e = Se.charAt(t);
                O = String.fromCharCode(55349, 56320 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56372 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56424 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56580 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56684 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56736 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56788 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56840 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56944 + t), i(l, c, I, e, O), i(M, c, g, e, O), t < 26 && (O = String.fromCharCode(55349, 56632 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 56476 + t), i(l, c, I, e, O), i(M, c, g, e, O))
            }
            O = "\u{1D55C}", i(l, c, I, "k", O), i(M, c, g, "k", O);
            for (let t = 0; t < 10; t++) {
                let e = t.toString();
                O = String.fromCharCode(55349, 57294 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 57314 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 57324 + t), i(l, c, I, e, O), i(M, c, g, e, O), O = String.fromCharCode(55349, 57334 + t), i(l, c, I, e, O), i(M, c, g, e, O)
            }
            let Ye = "\xD0\xDE\xFE";
            ...
            let Me = [
                ...
                ze = function(t, e, r) {
                    return s0[r][t] && s0[r][t].replace && (t = s0[r][t].replace), {
                        value: t,
                        metrics: Ve(t, e, r)
                    }
                },
                D0 = function(t, e, r, n, s) {
                    ...
                    if (o) {
                        let m = o.italic;
                        (r === "text" || n && n.font === "mathit") && (m = 0), u = new A0(t, o.height, o.depth, m, o.skew, o.width, s)
                    } else typeof console < "u" && console.warn("No character metrics " + ("for '" + t + "' in style '" + e + "' and mode '" + r + "'")), u = new A0(t, 0, 0, 0, 0, 0, s);
                    if (n) {
                ...
                _n = function(t, e, r, n) {
                    return n === void 0 && (n = []), r.font === "boldsymbol" && ze(t, "Main-Bold", e).metrics ? D0(t, "Main-Bold", e, r, n.concat(["mathbf"])) : t === "\\" || s0[e][t].font === "main" ? D0(t, "Main-Regular", e, r, n) : D0(t, "AMS-Regular", e, r, n.concat(["amsrm"]))
                },
                ...
                Vn = function(t, e, r) {
                    let n = t.mode,
                        ...
                        m = "",
                        f = "";
                    if (s.charCodeAt(0) === 55349 && ([m, f] = Fn(s, n)), m.length > 0) return D0(s, m, n, e, a.concat(f));
                    if (u) {
                        let b, y;
                        if (u === "boldsymbol") {
                            let w = Pn(s, n, e, a, r);
                            b = w.fontName, y = [w.fontClass]
                        } else o ? (b = $t[u].fontName, y = [u]) : (b = Ae(u, e.fontWeight, e.fontShape), y = [u, e.fontWeight, e.fontShape]);
                        if (ze(s, b, n).metrics) return D0(s, b, n, e, a.concat(y));
                        if (Lt.hasOwnProperty(s) && b.slice(0, 10) === "Typewriter") {
                            let w = [];
                            for (let S = 0; S < s.length; S++) w.push(D0(s[S], b, n, e, a.concat(y)));
                            return Gt(w)
                        }
                    }
                    if (r === "mathord") return D0(s, "Math-Italic", n, e, a.concat(["mathnormal"]));
                    if (r === "textord") {
                        let b = s0[n][s] && s0[n][s].font;
                        if (b === "ams") {
                            let y = Ae("amsrm", e.fontWeight, e.fontShape);
                            return D0(s, y, n, e, a.concat("amsrm", e.fontWeight, e.fontShape))
                        } else if (b === "main" || !b) {
                ...
                Gn = (t, e) => {
                    if (Y0(t.classes) !== Y0(e.classes) || t.skew !== e.skew || t.maxFontSize !== e.maxFontSize) return !1;
                    ...
                    for (let r in e.style)
                        if (e.style.hasOwnProperty(r) && t.style[r] !== e.style[r]) return !1;
                    return !0
                },
                $n = t => {
                    for (let e = 0; e < t.length - 1; e++) {
                        let r = t[e],
                            n = t[e + 1];
                        r instanceof A0 && n instanceof A0 && Gn(r, n) && (r.text += n.text, r.height = Math.max(r.height, n.height), r.depth = Math.max(r.depth, n.depth), r.italic = n.italic, t.splice(e + 1, 1), e--)
                    }
                    return t
                },
                Xe = function(t) {
                ...
                Un = function(t, e, r) {
                    let n = x0([t], [], e);
                    return n.height = Math.max(r || e.fontMetrics().defaultRuleThickness, e.minRuleThickness), n.style.borderBottomWidth = A(n.height), n.maxFontSize = 1, n
                },
                Wn = function(t, e, r, n) {
                ...
                Xn = function(t) {
                    ...
                    if (t.positionType === "top") {
                        ...
                        let r = t.children[0];
                        if (r.type !== "elem") throw new Error('First child must have type "elem".');
                ...
                jn = function(t, e) {
                    ...
                    for (let S = 0; S < r.length; S++) {
                        ...
                        if (D.type === "kern") f += D.size;
                            ...
                            let q = D.elem,
                                ...
                                _ = D.wrapperStyle || {},
                                G = x0(V, [a, q], void 0, _);
                            G.style.top = A(-s - f - q.depth), D.marginLeft && (G.style.marginLeft = D.marginLeft), D.marginRight && (G.style.marginRight = D.marginRight), o.push(G), f += q.height + q.depth
                        }
                    ...
                    let w = x0(["vlist-t"], y);
                    return y.length === 2 && w.classes.push("vlist-t2"), w.height = m, w.depth = -u, w
                },
                Zn = (t, e) => {
                    let r = x0(["mspace"], [], e),
                        n = n0(t, e);
            ...
            var x = {
                ...
                staticSvg: function(t, e) {
                    let [r, n, s] = Ut[t], a = new X0(r), o = new P0([a], {
                        width: A(n),
                        height: A(s),
                        style: "width:" + A(n),
                    ...
                    return u.height = s, u.style.height = A(s), u.style.width = A(n), u
                },
                svgData: Ut,
                tryCombineChars: $n
            };
            ...
            let Ne = function(t) {
                ...
                d0 = function(t, e, r, n) {
                    ...
                    if (t.length === 1) {
                        let f = t[0];
                        f.type === "sizing" ? a = e.havingSize(f.size) : f.type === "styling" && (a = e.havingStyle(t1[f.style]))
                    }
                    ...
                    return je(s, (f, b) => {
                        let y = b.classes[0],
                            w = f.classes[0];
                        y === "mbin" && T.contains(e1, w) ? b.classes[0] = "mord" : w === "mbin" && T.contains(Qn, y) && (f.classes[0] = "mord")
                    }, {
                        node: o
                    }, u, m), je(s, (f, b) => {
                        let y = Ke(b),
                            w = Ke(f),
                            S = y && w ? f.hasClass("mtight") ? Jn[y][w] : Kn[y][w] : null;
                ...
                je = function(t, e, r, n, s) {
                    ...
                    for (; a < t.length; a++) {
                        ...
                        m ? r.node = o : s && o.hasClass("newline") && (r.node = $0(["leftmost"])), r.insertAfter = (f => b => {
                            t.splice(f + 1, 0, b), a++
                        })(a)
                    }
                    n && t.pop()
                ...
                Yt = function(t) {
                    return t instanceof ue || t instanceof Ue || t instanceof he && t.hasClass("enclosing") ? t : null
                },
                Ze = function(t, e) {
                    let r = Yt(t);
                    if (r) {
            ...
            function Ce(t, e) {
                let r = $0(["base"], t, e),
                    n = $0(["strut"]);
                return n.style.height = A(r.height + r.depth), r.depth && (n.style.verticalAlign = A(-r.depth)), r.children.unshift(n), r
            }
            ...
            function Je(t, e) {
                ...
                for (let f = 0; f < n.length; f++)
                    if (o.push(n[f]), n[f].hasClass("mbin") || n[f].hasClass("mrel") || n[f].hasClass("allowbreak")) {
                        let b = !1;
                        for (; f < n.length - 1 && n[f + 1].hasClass("mspace") && !n[f + 1].hasClass("newline");) f++, o.push(n[f]), n[f].hasClass("nobreak") && (b = !0);
                        b || (a.push(Ce(o, e)), o = [])
                    } else n[f].hasClass("newline") && (o.pop(), o.length > 0 && (a.push(Ce(o, e)), o = []), a.push(n[f]));
                o.length > 0 && a.push(Ce(o, e));
                let u;
                r ? (u = Ce(d0(r, e, !0)), u.classes = ["tag"], a.push(u)) : s && a.push(s);
                let m = $0(["katex-html"], a);
                if (m.setAttribute("aria-hidden", "true"), u) {
                    let f = u.children[0];
                    f.style.height = A(m.height + m.depth), m.depth && (f.style.verticalAlign = A(-m.depth))
                }
                return m
            }
            ...
            class S0 {
                ...
                toNode() {
                    ...
                    for (let r in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, r) && e.setAttribute(r, this.attributes[r]);
                    this.classes.length > 0 && (e.className = Y0(this.classes));
                    for (let r = 0; r < this.children.length; r++)
                        if (this.children[r] instanceof R0 && this.children[r + 1] instanceof R0) {
                            let n = this.children[r].toText() + this.children[++r].toText();
                            for (; this.children[r + 1] instanceof R0;) n += this.children[++r].toText();
                ...
                toMarkup() {
                    let e = "<" + this.type;
                    for (let r in this.attributes) Object.prototype.hasOwnProperty.call(this.attributes, r) && (e += " " + r + '="', e += T.escape(this.attributes[r]), e += '"');
                    this.classes.length > 0 && (e += ' class ="' + T.escape(Y0(this.classes)) + '"'), e += ">";
                    for (let r = 0; r < this.children.length; r++) e += this.children[r].toMarkup();
            ...
            let T0 = function(t, e, r) {
                    return s0[e][t] && s0[e][t].replace && t.charCodeAt(0) !== 55349 && !(Lt.hasOwnProperty(t) && r && (r.fontFamily && r.fontFamily.slice(4, 6) === "tt" || r.font && r.font.slice(4, 6) === "tt")) && (t = s0[e][t].replace), new z.TextNode(t)
                },
                Qe = function(t) {
            ...
            let w0 = function(t, e, r) {
                    if (t.length === 1) {
                        let a = Z(t[0], e);
                        return r && a instanceof S0 && a.type === "mo" && (a.setAttribute("lspace", "0em"), a.setAttribute("rspace", "0em")), [a]
                    }
                    let n = [],
                        s;
                    for (let a = 0; a < t.length; a++) {
                        ...
                        if (o instanceof S0 && s instanceof S0) {
                            if (o.type === "mtext" && s.type === "mtext" && o.getAttribute("mathvariant") === s.getAttribute("mathvariant")) {
                                ...
                                s.children.push(...o.children);
                                continue
                            } else if (o.type === "mn" && tt(s)) o.children = [...s.children, ...o.children], n.pop();
                            else if ((o.type === "msup" || o.type === "msub") && o.children.length >= 1 && (s.type === "mn" || tt(s))) {
                                let u = o.children[0];
                                u instanceof S0 && u.type === "mn" && (u.children = [...s.children, ...u.children], n.pop())
                            } else if (s.type === "mi" && s.children.length === 1) {
                                let u = s.children[0];
                                if (u instanceof R0 && u.text === "\u0338" && (o.type === "mo" || o.type === "mi" || o.type === "mn")) {
                                    let m = o.children[0];
                                    m instanceof R0 && m.text.length > 0 && (m.text = m.text.slice(0, 1) + "\u0338" + m.text.slice(1), n.pop())
                                }
                            }
                        }
                        n.push(o), s = o
            ...
            function jt(t, e, r, n, s) {
                let a = w0(t, r),
                    o;
                a.length === 1 && a[0] instanceof S0 && T.contains(["mrow", "mtable"], a[0].type) ? o = a[0] : o = new z.MathNode("mrow", a);
                ...
                f.setAttribute("xmlns", "http://www.w3.org/1998/Math/MathML"), n && f.setAttribute("display", "block");
            ...
            let Zt = function(t) {
                ...
                Kt = function(t, e) {
                    if (e.displayMode) {
                        let r = ["katex-display"];
                        e.leqno && r.push("leqno"), e.fleqn && r.push("fleqn"), t = x.makeSpan(r, [t])
                    }
                    return t
                },
                s1 = function(t, e, r) {
            ...
            let a1 = {
                ...
                l1 = function(t) {
                    let e = new z.MathNode("mo", [new z.TextNode(a1[t.replace(/^\\/, "")])]);
            ...
            var U0 = {
                encloseSpan: function(t, e, r, n, s) {
                    ...
                    if (/fbox|color|angl/.test(e)) {
                        ...
                        let u = [];
                        /^[bx]cancel$/.test(e) && u.push(new We({
                            x1: "0",
                            y1: "0",
                            x2: "100%",
                            y2: "100%",
                            "stroke-width": "0.046em"
                        })), /^x?cancel$/.test(e) && u.push(new We({
                            x1: "0",
                            y1: "100%",
                            x2: "100%",
                            y2: "0",
                ...
                svgSpan: function(t, e) {
                    function r() {
                        let o = 4e5,
                            u = t.label.slice(1);
                        if (T.contains(["widehat", "widecheck", "widetilde", "utilde"], u)) {
                            let f = c1(t.base),
                                b, y, w;
                            if (f > 5) u === "widehat" || u === "widecheck" ? (b = 420, o = 2364, w = .42, y = u + "4") : (b = 312, o = 2340, w = .34, y = "tilde4");
                            else {
                                let q = [1, 1, 2, 2, 3, 3][f];
                                u === "widehat" || u === "widecheck" ? (o = [0, 1062, 2364, 2364, 2364][q], b = [0, 239, 300, 360, 420][q], w = [0, .24, .3, .3, .36, .42][q], y = u + q) : (o = [0, 600, 1033, 2339, 2340][q], b = [0, 260, 286, 306, 312][q], w = [0, .26, .286, .3, .306, .34][q], y = "tilde" + q)
                            }
                            let S = new X0(y),
                                D = new P0([S], {
                                    width: "100%",
                            ...
                            if (D === 1) {
                                let _ = f[3];
                                q = ["hide-tail"], V = [_]
                            } else if (D === 2) q = ["halfarrow-left", "halfarrow-right"], V = ["xMinYMin", "xMaxYMin"];
                            else if (D === 3) q = ["brace-left", "brace-center", "brace-right"], V = ["xMinYMin", "xMidYMin", "xMaxYMin"];
                    ...
                    return n.height = a, n.style.height = A(a), s > 0 && (n.style.minWidth = A(s)), n
                }
            };
            ...
            let nt = (t, e) => {
                    let r, n, s;
                    t && t.type === "supsub" ? (n = F(t.base, "accent"), r = n.base, t.base = r, s = On(U(t, e)), t.base = n) : (n = F(t, "accent"), r = n.base);
                    ...
                    let m = n.label === "\\c",
                        f = m ? a.height + a.depth : Math.min(a.height, e.fontMetrics().xHeight),
                        b;
                    if (n.isStretchy) b = U0.svgSpan(n, e), b = x.makeVList({
                        ...
                        let w, S;
                        n.label === "\\vec" ? (w = x.staticSvg("vec", e), S = x.svgData.vec[1]) : (w = x.makeOrd({
                            mode: n.mode,
                            text: n.label
                        }, e, "textord"), w = Ht(w), w.italic = 0, S = w.width, m && (f += w.depth)), b = x.makeSpan(["accent-body"], [w]);
                        let D = n.label === "\\textcircled";
                        D && (b.classes.push("accent-full"), f = a.height);
                        let q = u;
                        D || (q -= S / 2), b.style.left = A(q), n.label === "\\textcircled" && (b.style.top = ".2em"), b = x.makeVList({
                            positionType: "firstBaseline",
                            children: [{
                                type: "elem",
                                elem: a
                ...
                Jt = (t, e) => {
                    let r = t.isStretchy ? U0.mathMLnode(t.label) : new z.MathNode("mo", [T0(t.label, t.mode)]),
                        n = new z.MathNode("mover", [Z(t.base, e), r]);
                    return n.setAttribute("accent", "true"), n
                },
                u1 = new RegExp(["\\acute", "\\grave", "\\ddot", "\\tilde", "\\bar", "\\breve", "\\check", "\\hat", "\\vec", "\\dot", "\\mathring"].map(t => "\\" + t).join("|"));
            B({
                type: "accent",
                ...
                handler: (t, e) => {
                    let r = Ne(e[0]),
                        ...
                        s = !n || t.funcName === "\\widehat" || t.funcName === "\\widetilde" || t.funcName === "\\widecheck";
                    return {
                        type: "accent",
                        mode: t.parser.mode,
                        label: t.funcName,
            ...
            B({
                ...
                htmlBuilder(t, e) {
                    ...
                    let o;
                    t.below && (n = e.havingStyle(r.sub()), o = x.wrapFragment(U(t.below, n, e), e), o.classes.push(a + "-arrow-pad"));
                    let u = U0.svgSpan(t, e),
                        m = -e.fontMetrics().axisHeight + .5 * u.height,
                        f = -e.fontMetrics().axisHeight - .5 * u.height - .111;
                    (s.depth > .25 || t.label === "\\xleftequilibrium") && (f -= s.depth);
                    let b;
                    if (o) {
                        let y = -e.fontMetrics().axisHeight + o.height + .5 * u.height + .111;
                        b = x.makeVList({
                    ...
                    return b.children[0].children[0].children[1].classes.push("svg-align"), x.makeSpan(["mrel", "x-arrow"], [b], e)
                },
                mathmlBuilder(t, e) {
                    let r = U0.mathMLnode(t.label);
            ...
            let m1 = {
                ...
                d1 = (t, e) => (t.type === "mathord" || t.type === "atom") && t.text === e;
                                ...
                                if ("<>AV".indexOf(f) > -1)
                                    for (let S = 0; S < 2; S++) {
                                        ...
                                        for (let q = m + 1; q < o.length; q++) {
                                            ...
                                            if (rr(o[q])) throw new v("Missing a " + f + " character to complete a CD arrow.", o[q]);
                                            b[S].body.push(o[q])
                                        }
                                        if (D) throw new v("Missing a " + f + " character to complete a CD arrow.", o[m])
            ...
            B({
                ...
                htmlBuilder(t, e) {
                    ...
                    return n.classes.push("cd-label-" + t.side), n.style.bottom = A(.8 - n.depth), n.height = 0, n.depth = 0, n
                },
                mathmlBuilder(t, e) {
                ...
                handler(t, e) {
                    ...
                    if (o < 0 || o >= 1114111) throw new v("\\@char with invalid code point " + a);
            ...
            B({
                ...
                handler(t, e) {
                    let {
                        parser: r
                    } = t, n = F(e[0], "color-token").color, s = e[1];
                    return {
                        type: "color",
                        mode: r.mode,
                        color: n,
                ...
                handler(t, e, r) {
                    let {
                        parser: n
                    } = t, s = n.gullet.future().text === "[" ? n.parseSizeGroup(!0) : null, a = !n.settings.displayMode || !n.settings.useStrictBehavior("newLineInDisplayMode", "In LaTeX, \\\\ or \\newline does nothing in display mode");
                    return {
                        type: "cr",
                        mode: n.mode,
                        newLine: a,
                ...
                htmlBuilder(t, e) {
                    ...
                    return t.newLine && (r.classes.push("newline"), t.size && (r.style.marginTop = A(n0(t.size, e)))), r
                },
                mathmlBuilder(t, e) {
                    let r = new z.MathNode("mspace");
                    return t.newLine && (r.setAttribute("linebreak", "newline"), t.size && r.setAttribute("height", A(n0(t.size, e)))), r
                }
            });
            let st = {
                    "\\global": "\\global",
                ...
                ir = t => {
                    let e = t.text;
                    if (/^(?:[\\{}$&#^_]|EOF)$/.test(e)) throw new v("Expected a control sequence", t);
                    return e
                },
                g1 = t => {
            ...
            B({
                ...
                handler(t) {
                    ...
                    e.consumeSpaces();
                    let n = e.fetch();
                    if (st[n.text]) return (r === "\\global" || r === "\\\\globallong") && (n.text = st[n.text]), F(e.parseFunction(), "internal");
                ...
                handler(t) {
                    let {
                        parser: e,
                        funcName: r
                    } = t, n = e.gullet.popToken(), s = n.text;
                    if (/^(?:[\\{}$&#^_]|EOF)$/.test(s)) throw new v("Expected a control sequence", n);
                    let a = 0,
                        o, u = [
                            []
                        ];
                    for (; e.gullet.future().text !== "{";)
                        if (n = e.gullet.popToken(), n.text === "#") {
                            ...
                            if (n = e.gullet.popToken(), !/^[1-9]$/.test(n.text)) throw new v('Invalid argument number "' + n.text + '"');
                            if (parseInt(n.text) !== a + 1) throw new v('Argument number "' + n.text + '" out of order');
                            a++, u.push([])
                        } else {
                            if (n.text === "EOF") throw new v("Expected a macro definition");
                            u[a].push(n.text)
                        } let {
                        tokens: m
                    } = e.gullet.consumeArg();
                    return o && m.unshift(o), (r === "\\edef" || r === "\\xdef") && (m = e.gullet.expandTokens(m), m.reverse()), e.gullet.macros.set(s, {
                        tokens: m,
                        numArgs: a,
                        delimiters: u
                    }, r === st[r]), {
                ...
                handler(t) {
                    let {
                        parser: e,
                        funcName: r
                    } = t, n = ir(e.gullet.popToken());
                    e.gullet.consumeSpaces();
                    let s = g1(e);
                    return ar(e, n, s, r === "\\\\globallet"), {
                        type: "internal",
                        mode: e.mode
                    }
                }
                ...
                handler(t) {
                    let {
                        parser: e,
                        funcName: r
                    } = t, n = ir(e.gullet.popToken()), s = e.gullet.popToken(), a = e.gullet.popToken();
                    return ar(e, n, a, r === "\\\\globalfuture"), e.gullet.pushToken(a), e.gullet.pushToken(s), {
                        type: "internal",
                        mode: e.mode
                    }
                }
            ...
            let de = function(t, e, r) {
                    let n = s0.math[t] && s0.math[t].replace,
                        s = Ve(n || t, e, r);
                    if (!s) throw new Error("Unsupported symbol " + t + " and font size " + e + ".");
                    return s
                },
                it = function(t, e, r, n) {
                ...
                lr = function(t, e, r) {
                    let n = e.havingBaseStyle(r),
                        s = (1 - e.sizeMultiplier / n.sizeMultiplier) * e.fontMetrics().axisHeight;
                    t.classes.push("delimcenter"), t.style.top = A(s), t.height -= s, t.depth += s
                },
                ...
                or = function(t, e, r, n, s, a) {
                    let o = y1(t, e, s, n),
                        u = it(x.makeSpan(["delimsizing", "size" + e], [o], n), E.TEXT, n, a);
                ...
                at = function(t, e, r) {
                    ...
                    return e === "Size1-Regular" ? n = "delim-size1" : n = "delim-size4", {
                        type: "elem",
                        elem: x.makeSpan(["delimsizinginner", n], [x.makeSpan([], [x.makeSymbol(t, e, r)])])
                    }
                },
                lt = function(t, e, r) {
                    let n = I0["Size4-Regular"][t.charCodeAt(0)] ? I0["Size4-Regular"][t.charCodeAt(0)][4] : I0["Size1-Regular"][t.charCodeAt(0)][4],
                        ...
                        o = x.makeSvgSpan([], [a], r);
                    return o.height = e, o.style.height = A(e), o.style.width = A(n), {
                        type: "elem",
                        elem: o
                    }
                },
                ...
                cr = function(t, e, r, n, s, a) {
                    ...
                    o = m = f = t, u = null;
                    let w = "Size1-Regular";
                    t === "\\uparrow" ? m = f = "\u23D0" : t === "\\Uparrow" ? m = f = "\u2016" : t === "\\downarrow" ? o = m = "\u23D0" : t === "\\Downarrow" ? o = m = "\u2016" : t === "\\updownarrow" ? (o = "\\uparrow", m = "\u23D0", f = "\\downarrow") : t === "\\Updownarrow" ? (o = "\\Uparrow", m = "\u2016", f = "\\Downarrow") : T.contains(x1, t) ? (m = "\u2223", b = "vert", y = 333) : T.contains(w1, t) ? (m = "\u2225", b = "doublevert", y = 556) : t === "[" || t === "\\lbrack" ? (o = "\u23A1", m = "\u23A2", f = "\u23A3", w = "Size4-Regular", b = "lbrack", y = 667) : t === "]" || t === "\\rbrack" ? (o = "\u23A4", m = "\u23A5", f = "\u23A6", w = "Size4-Regular", b = "rbrack", y = 667) : t === "\\lfloor" || t === "\u230A" ? (m = o = "\u23A2", f = "\u23A3", w = "Size4-Regular", b = "lfloor", y = 667) : t === "\\lceil" || t === "\u2308" ? (o = "\u23A1", m = f = "\u23A2", w = "Size4-Regular", b = "lceil", y = 667) : t === "\\rfloor" || t === "\u230B" ? (m = o = "\u23A5", f = "\u23A6", w = "Size4-Regular", b = "rfloor", y = 667) : t === "\\rceil" || t === "\u2309" ? (o = "\u23A4", m = f = "\u23A5", w = "Size4-Regular", b = "rceil", y = 667) : t === "(" || t === "\\lparen" ? (o = "\u239B", m = "\u239C", f = "\u239D", w = "Size4-Regular", b = "lparen", y = 875) : t === ")" || t === "\\rparen" ? (o = "\u239E", m = "\u239F", f = "\u23A0", w = "Size4-Regular", b = "rparen", y = 875) : t === "\\{" || t === "\\lbrace" ? (o = "\u23A7", u = "\u23A8", f = "\u23A9", m = "\u23AA", w = "Size4-Regular") : t === "\\}" || t === "\\rbrace" ? (o = "\u23AB", u = "\u23AC", f = "\u23AD", m = "\u23AA", w = "Size4-Regular") : t === "\\lgroup" || t === "\u27EE" ? (o = "\u23A7", f = "\u23A9", m = "\u23AA", w = "Size4-Regular") : t === "\\rgroup" || t === "\u27EF" ? (o = "\u23AB", f = "\u23AD", m = "\u23AA", w = "Size4-Regular") : t === "\\lmoustache" || t === "\u23B0" ? (o = "\u23A7", f = "\u23AD", m = "\u23AA", w = "Size4-Regular") : (t === "\\rmoustache" || t === "\u23B1") && (o = "\u23AB", f = "\u23A9", m = "\u23AA", w = "Size4-Regular");
                    let S = de(o, w, s),
                        D = S.height + S.depth,
                        q = de(m, w, s),
                        V = q.height + q.depth,
                    ...
                    if (b.length > 0) {
                        ...
                        Fe.height = a0 / 1e3, Fe.style.width = Qr, Fe.style.height = en, X.push({
                            type: "elem",
                            elem: Fe
                        })
                    } else {
                        if (X.push(at(f, w, s)), X.push(Ie), u === null) {
                            ...
                            X.push(lt(m, l0, n)), X.push(Ie), X.push(at(u, w, s)), X.push(Ie), X.push(lt(m, l0, n))
                        }
                ...
                k1 = function(t, e) {
                    let r = e.havingBaseSizing(),
                        ...
                        s = r.sizeMultiplier,
                        a = Math.max(0, e.minRuleThickness - e.fontMetrics().sqrtRuleThickness),
                        o, u = 0,
                        m = 0,
                        f = 0,
                        b;
                    return n.type === "small" ? (f = 1e3 + 1e3 * a + ct, t < 1 ? s = 1 : t < 1.4 && (s = .7), u = (1 + a + ut) / s, m = (1 + a) / s, o = ht("sqrtMain", u, f, a, e), o.style.minWidth = "0.853em", b = .833 / s) : n.type === "large" ? (f = (1e3 + ct) * pe[n.size], m = (pe[n.size] + a) / s, u = (pe[n.size] + a + ut) / s, o = ht("sqrtSize" + n.size, u, f, a, e), o.style.minWidth = "1.02em", b = 1 / s) : (u = t + a + ut, m = t + a, f = Math.floor(1e3 * t + a) + ct, o = ht("sqrtTall", u, f, a, e), o.style.minWidth = "0.742em", b = 1.056), o.height = m, o.style.height = A(u), {
                        span: o,
                        advanceWidth: b,
                ...
                v1 = ["\\uparrow", "\\downarrow", "\\updownarrow", "\\Uparrow", "\\Downarrow", "\\Updownarrow", "|", "\\|", "\\vert", "\\Vert", "\\lvert", "\\rvert", "\\lVert", "\\rVert", "\\lgroup", "\\rgroup", "\u27EE", "\u27EF", "\\lmoustache", "\\rmoustache", "\u23B0", "\u23B1"],
                hr = ["<", ">", "\\langle", "\\rangle", "/", "\\backslash", "\\lt", "\\gt"],
                pe = [0, 1.2, 1.8, 2.4, 3],
                S1 = function(t, e, r, n, s) {
                    if (t === "<" || t === "\\lt" || t === "\u27E8" ? t = "\\langle" : (t === ">" || t === "\\gt" || t === "\u27E9") && (t = "\\rangle"), T.contains(ur, t) || T.contains(hr, t)) return or(t, e, !1, r, n, s);
                ...
                pr = function(t, e, r, n, s, a) {
                    ...
                    let o;
                    T.contains(hr, t) ? o = M1 : T.contains(ur, t) ? o = mr : o = z1;
                    let u = dr(t, e, o, n);
                    return u.type === "small" ? b1(t, u.style, r, n, s, a) : u.type === "large" ? or(t, u.size, r, n, s, a) : cr(t, e, r, n, s, a)
                };
            var W0 = {
                sqrtImage: k1,
                sizedDelim: S1,
            ...
            function Re(t, e) {
                ...
                throw r ? new v("Invalid delimiter '" + r.text + "' after '" + e.funcName + "'", t) : new v("Invalid delimiter type '" + t.type + "'", t)
            }
            B({
                type: "delimsizing",
                ...
                htmlBuilder: (t, e) => t.delim === "." ? x.makeSpan([t.mclass]) : W0.sizedDelim(t.delim, t.size, e, t.mode, [t.mclass]),
                mathmlBuilder: t => {
                    let e = [];
            ...
            B({
                ...
                handler: (t, e) => {
                    ...
                    if (r && typeof r != "string") throw new v("\\current@color set to non-string in \\right");
                    return {
                        type: "leftright-right",
                        mode: t.parser.mode,
                        delim: Re(e[0], t).text,
                ...
                htmlBuilder: (t, e) => {
                    ...
                    let r = d0(t.body, e, !0, ["mopen", "mclose"]),
                        ...
                        s = 0,
                        a = !1;
                    for (let m = 0; m < r.length; m++) r[m].isMiddle ? a = !0 : (n = Math.max(r[m].height, n), s = Math.max(r[m].depth, s));
                    n *= e.sizeMultiplier, s *= e.sizeMultiplier;
                    let o;
                    if (t.left === "." ? o = me(e, ["mopen"]) : o = W0.leftRightDelim(t.left, n, s, e, t.mode, ["mopen"]), r.unshift(o), a)
                        for (let m = 1; m < r.length; m++) {
                            let b = r[m].isMiddle;
                            b && (r[m] = W0.leftRightDelim(b.delim, n, s, b.options, t.mode, []))
                        }
                    let u;
                ...
                handler: (t, e) => {
                    let r = Re(e[0], t);
                    if (!t.parser.leftrightDepth) throw new v("\\middle without preceding \\left", r);
                    return {
                        type: "middle",
                        mode: t.parser.mode,
                        delim: r.text
                ...
                mathmlBuilder: (t, e) => {
                    let r = t.delim === "\\vert" || t.delim === "|" ? T0("|", "text") : T0(t.delim, t.mode),
            ...
            let mt = (t, e) => {
                    ...
                    if (n === "sout") a = x.makeSpan(["stretchy", "sout"]), a.height = e.fontMetrics().defaultRuleThickness / s, o = -.5 * e.fontMetrics().xHeight;
                    else if (n === "phase") {
                        let f = n0({
                                number: .6,
                                unit: "pt"
                    ...
                    return /cancel/.test(n) && (m.height = r.height, m.depth = r.depth), /cancel/.test(n) && !u ? x.makeSpan(["mord", "cancel-lap"], [m], e) : x.makeSpan(["mord"], [m], e)
                },
                dt = (t, e) => {
                    let r = 0,
                        n = new z.MathNode(t.label.indexOf("colorbox") > -1 ? "mpadded" : "menclose", [Z(t.body, e)]);
                    switch (t.label) {
                        case "\\cancel":
            ...
            B({
                ...
                handler(t, e, r) {
                    let {
                        parser: n,
                        funcName: s
                    } = t, a = F(e[0], "color-token").color, o = e[1];
                    return {
                        type: "enclose",
                        mode: n.mode,
                        label: s,
                ...
                handler(t, e, r) {
                    let {
                        parser: n,
                        funcName: s
                    } = t, a = F(e[0], "color-token").color, o = F(e[1], "color-token").color, u = e[2];
                    return {
                        type: "enclose",
                        mode: n.mode,
                        label: s,
            ...
            class M0 {
                ...
                static range(e, r) {
                    return r ? !e || !e.loc || !r.loc || e.loc.lexer !== r.loc.lexer ? null : new M0(e.loc.lexer, e.loc.start, r.loc.end) : e && e.loc
                }
            }
            class B0 {
                constructor(e, r) {
            ...
            function xr(t) {
                ...
                t.consumeSpaces();
                let r = t.fetch().text;
                for (r === "\\relax" && (t.consume(), t.consumeSpaces(), r = t.fetch().text); r === "\\hline" || r === "\\hdashline";) t.consume(), e.push(r === "\\hdashline"), t.consumeSpaces(), r = t.fetch().text;
                return e
            }
            let Oe = t => {
                if (!t.parser.settings.displayMode) throw new v("{" + t.envName + "} can be used only in display mode.")
            };
            ...
            function Z0(t, e, r) {
                ...
                if (t.gullet.beginGroup(), f || t.gullet.macros.set("\\cr", "\\\\\\relax"), !o) {
                    let K = t.gullet.expandMacroAsText("\\arraystretch");
                    if (K == null) o = 1;
                    else if (o = parseFloat(K), !o || o < 0) throw new v("Invalid \\arraystretch: " + K)
                }
                t.gullet.beginGroup();
                let S = [],
                    D = [S],
                ...
                function Y() {
                    _ && (t.gullet.macros.get("\\df@tag") ? (_.push(t.subparse([new B0("\\df@tag")])), t.gullet.macros.set("\\df@tag", void 0, !0)) : _.push(!!m && t.gullet.macros.get("\\@eqnsw") === "1"))
                }
                for (G(), V.push(xr(t));;) {
                    ...
                    if (y0 === "&") {
                        if (y && S.length === y) {
                            if (f || u) throw new v("Too many tab characters: &", t.nextToken);
                            t.settings.reportNonstrict("textEnv", "Too few columns specified in the {array} column argument.")
                        }
                        t.consume()
                    } else if (y0 === "\\end") {
                        Y(), S.length === 1 && K.type === "styling" && K.body[0].body.length === 0 && (D.length > 1 || !b) && D.pop(), V.length < D.length + 1 && V.push([]);
                        break
                    } else if (y0 === "\\\\") {
                        t.consume();
                        let p0;
                        t.gullet.future().text !== " " && (p0 = t.parseSizeGroup(!0)), q.push(p0 ? p0.value : null), Y(), V.push(xr(t)), S = [], D.push(S), G()
                    } else throw new v("Expected & or \\\\ or \\cr or \\end", t.nextToken)
                }
            ...
            let H0 = function(t, e) {
                    let r, n, s = t.body.length,
                        ...
                        y = 5 * b;
                    t.colSeparationType && t.colSeparationType === "small" && (y = .2778 * (e.havingStyle(E.SCRIPT).sizeMultiplier / e.sizeMultiplier));
                    let w = t.colSeparationType === "CD" ? n0({
                            number: 3,
                            unit: "ex"
                        }, e) : 12 * b,
                        S = 3 * b,
                    ...
                    function G(W) {
                        for (let X = 0; X < W.length; ++X) X > 0 && (_ += .25), m.push({
                            pos: _,
                            isDashed: W[X]
                        })
                    }
                    for (G(a[0]), r = 0; r < t.body.length; ++r) {
                        ...
                        for (n = 0; n < W.length; ++n) {
                            let C0 = U(W[n], e);
                            J < C0.depth && (J = C0.depth), X < C0.height && (X = C0.height), t0[n] = C0
                        }
                        let l0 = t.rowGaps[r],
                            a0 = 0;
                        l0 && (a0 = n0(l0, e), a0 > 0 && (a0 += V, J < a0 && (J = a0), a0 = 0)), t.addJot && (J += S), t0.height = X, t0.depth = J, _ += X, t0.pos = _, _ += J + a0, u[r] = t0, G(a[r + 1])
                    }
                    ...
                    if (t.tags && t.tags.some(W => W))
                        for (r = 0; r < s; ++r) {
                            let W = u[r],
                                ...
                                J = t.tags[r],
                                t0;
                            J === !0 ? t0 = x.makeSpan(["eqn-num"], [], e) : J === !1 ? t0 = x.makeSpan([], [], e) : t0 = x.makeSpan([], d0(J, e, !0), e), t0.depth = W.depth, t0.height = W.height, ae.push({
                                type: "elem",
                                elem: t0,
                                shift: X
                            })
                    ...
                    for (n = 0, N0 = 0; n < o || N0 < K.length; ++n, ++N0) {
                        ...
                        for (; W.type === "separator";) {
                            if (X || (p0 = x.makeSpan(["arraycolsep"], []), p0.style.width = A(e.fontMetrics().doubleRuleSep), y0.push(p0)), W.separator === "|" || W.separator === ":") {
                                let l0 = W.separator === "|" ? "solid" : "dashed",
                                    a0 = x.makeSpan(["vertical-separator"], [], e);
                                a0.style.height = A(_), a0.style.borderRightWidth = A(f), a0.style.borderRightStyle = l0, a0.style.margin = "0 " + A(-f / 2);
                                let C0 = _ - Y;
                        ...
                        if (n >= o) continue;
                        let J;
                        (n > 0 || t.hskipBeforeAndAfter) && (J = T.deflt(W.pregap, y), J !== 0 && (p0 = x.makeSpan(["arraycolsep"], []), p0.style.width = A(J), y0.push(p0)));
                        let t0 = [];
                        for (r = 0; r < s; ++r) {
                            let l0 = u[r],
                                a0 = l0[n];
                            if (!a0) continue;
                            let C0 = l0.pos - Y;
                            a0.depth = l0.depth, a0.height = l0.height, t0.push({
                                type: "elem",
                                elem: a0,
                                shift: C0
                            })
                        ...
                        t0 = x.makeVList({
                            positionType: "individualShift",
                            children: t0
                        }, e), t0 = x.makeSpan(["col-align-" + (W.align || "c")], [t0]), y0.push(t0), (n < o - 1 || t.hskipBeforeAndAfter) && (J = T.deflt(W.postgap, y), J !== 0 && (p0 = x.makeSpan(["arraycolsep"], []), p0.style.width = A(J), y0.push(p0)))
                    }
                ...
                L0 = function(t, e) {
                    ...
                    for (let y = 0; y < t.body.length; y++) {
                        let w = t.body[y],
                            S = [];
                        for (let D = 0; D < w.length; D++) S.push(new z.MathNode("mtd", [Z(w[D], e)]));
                        t.tags && t.tags[y] && (S.unshift(n), S.push(n), t.leqno ? S.unshift(s) : S.push(s)), r.push(new z.MathNode("mtr", S))
                    }
                    let a = new z.MathNode("mtable", r),
                        o = t.arraystretch === .5 ? .1 : .16 + t.arraystretch - 1 + (t.addJot ? .09 : 0);
                    ...
                    if (t.cols && t.cols.length > 0) {
                        let y = t.cols,
                            ...
                            D = 0,
                            q = y.length;
                        y[0].type === "separator" && (u += "top ", D = 1), y[y.length - 1].type === "separator" && (u += "bottom ", q -= 1);
                        for (let V = D; V < q; V++) y[V].type === "align" ? (m += B1[y[V].align], S && (w += "none "), S = !0) : y[V].type === "separator" && S && (w += y[V].separator === "|" ? "solid " : "dashed ", S = !1);
                        a.setAttribute("columnalign", m.trim()), /[sd]/.test(w) && a.setAttribute("columnlines", w.trim())
                    }
                    ...
                    let f = "",
                        b = t.hLinesBeforeRow;
                    u += b[0].length > 0 ? "left " : "", u += b[b.length - 1].length > 0 ? "right " : "";
                    for (let y = 1; y < b.length - 1; y++) f += b[y].length === 0 ? "none " : b[y][0] ? "dashed " : "solid ";
                    return /[sd]/.test(f) && a.setAttribute("rowlines", f.trim()), u !== "" && (a = new z.MathNode("menclose", [a]), a.setAttribute("notation", u.trim())), t.arraystretch && t.arraystretch < 1 && (a = new z.MathNode("mstyle", [a]), a.setAttribute("scriptlevel", "1")), a
                },
                wr = function(t, e) {
                    ...
                    a.body.forEach(function(b) {
                        ...
                        if (f) u < b.length && (u = b.length);
                            ...
                            let y = b.length / 2;
                            if (o < y) throw new v("Too many math in a row: " + ("expected " + o + ", but got " + y), b[0])
                        }
                    });
                    for (let b = 0; b < u; ++b) {
                        let y = "r",
                            w = 0;
                        b % 2 === 1 ? y = "l" : b > 0 && f && (w = 1), r[b] = {
                            type: "align",
                            align: y,
                            pregap: w,
                            postgap: 0
            ...
            O0({
                ...
                handler(t, e) {
                    let s = (De(e[0]) ? [e[0]] : F(e[0], "ordgroup").body).map(function(o) {
                            let m = rt(o).text;
                ...
                handler(t) {
                    ...
                    if (t.envName.charAt(t.envName.length - 1) === "*") {
                        ...
                        if (o.consumeSpaces(), o.fetch().text === "[") {
                            if (o.consume(), o.consumeSpaces(), r = o.fetch().text, "lcr".indexOf(r) === -1) throw new v("Expected l or c or r", o.nextToken);
                            o.consume(), o.consumeSpaces(), o.expect("]"), o.consume(), n.cols = [{
                                type: "align",
                                align: r
                            }]
                        }
                ...
                handler(t, e) {
                    ...
                    if (s.length > 1) throw new v("{subarray} can contain only one column");
                    let a = {
                        cols: s,
                        hskipBeforeAndAfter: !1,
                        arraystretch: .5
                    };
                    if (a = Z0(t.parser, a, "script"), a.body.length > 0 && a.body[0].length > 1) throw new v("{subarray} can contain only one column");
                    return a
                },
                htmlBuilder: H0,
                mathmlBuilder: L0
            ...
            B({
                ...
                handler(t, e) {
                    ...
                    let a = "";
                    for (let o = 0; o < s.body.length; ++o) a += F(s.body[o], "textord").text;
                    if (n === "\\begin") {
                        if (!kr.hasOwnProperty(a)) throw new v("No such environment: " + a, s);
                        let o = kr[a],
                            {
                                args: u,
                                optArgs: m
                            } = r.parseArguments("\\begin{" + a + "}", o),
                            f = {
                                mode: r.mode,
                                envName: a,
                                parser: r
                        ...
                        if (w.name !== a) throw new v("Mismatch: \\begin{" + a + "} matched by \\end{" + w.name + "}", y);
                        return b
                    }
                    return {
                        type: "environment",
            ...
            B({
                ...
                handler: (t, e) => {
                    let {
                        ...
                        mode: a
                    } = r, o = r.parseExpression(!0, s), u = "math" + n.slice(1);
                    return {
                        type: "font",
                        mode: a,
                        font: u,
            ...
            let zr = (t, e) => {
                    let r = e;
                    return t === "display" ? r = r.id >= E.SCRIPT.id ? r.text() : E.DISPLAY : t === "text" && r.size === E.DISPLAY.size ? r = E.TEXT : t === "script" ? r = E.SCRIPT : t === "scriptscript" && (r = E.SCRIPTSCRIPT), r
                },
                gt = (t, e) => {
                    ...
                    if (t.continued) {
                        ...
                        o.height = o.height < G ? G : o.height, o.depth = o.depth < Y ? Y : o.depth
                    }
                    a = e.havingStyle(s);
                    let u = U(t.denom, a, e),
                        m, f, b;
                    t.hasBarLine ? (t.barSize ? (f = n0(t.barSize, e), m = x.makeLineSpan("frac-line", e, f)) : m = x.makeLineSpan("frac-line", e), f = m.height, b = m.height) : (m = null, f = 0, b = e.fontMetrics().defaultRuleThickness);
                    let y, w, S;
                    r.size === E.DISPLAY.size || t.size === "display" ? (y = e.fontMetrics().num1, f > 0 ? w = 3 * b : w = 7 * b, S = e.fontMetrics().denom1) : (f > 0 ? (y = e.fontMetrics().num2, w = b) : (y = e.fontMetrics().num3, w = 3 * b), S = e.fontMetrics().denom2);
                    let D;
                    if (m) {
                        let G = e.fontMetrics().axisHeight;
                        y - o.depth - (G + .5 * f) < w && (y += w - (y - o.depth - (G + .5 * f))), G - .5 * f - (u.height - S) < w && (S += w - (G - .5 * f - (u.height - S)));
                        let Y = -(G - .5 * f);
                        D = x.makeVList({
                            positionType: "individualShift",
                            children: [{
                        ...
                        G < w && (y += .5 * (w - G), S += .5 * (w - G)), D = x.makeVList({
                            positionType: "individualShift",
                            children: [{
                                type: "elem",
                                elem: u,
                    ...
                    a = e.havingStyle(r), D.height *= a.sizeMultiplier / e.sizeMultiplier, D.depth *= a.sizeMultiplier / e.sizeMultiplier;
                    let q;
                    r.size === E.DISPLAY.size ? q = e.fontMetrics().delim1 : r.size === E.SCRIPTSCRIPT.size ? q = e.havingStyle(E.SCRIPT).fontMetrics().delim2 : q = e.fontMetrics().delim2;
                    let V, _;
                    return t.leftDelim == null ? V = me(e, ["mopen"]) : V = W0.customSizedDelim(t.leftDelim, q, !0, e.havingStyle(r), t.mode, ["mopen"]), t.continued ? _ = x.makeSpan([]) : t.rightDelim == null ? _ = me(e, ["mclose"]) : _ = W0.customSizedDelim(t.rightDelim, q, !0, e.havingStyle(r), t.mode, ["mclose"]), x.makeSpan(["mord"].concat(a.sizingClasses(e)), [V, x.makeSpan(["mfrac"], [D]), _], e)
                },
                bt = (t, e) => {
                    ...
                    if (t.leftDelim != null || t.rightDelim != null) {
                        ...
                        if (s.push(r), t.rightDelim != null) {
                            let a = new z.MathNode("mo", [new z.TextNode(t.rightDelim.replace("\\", ""))]);
                            a.setAttribute("fence", "true"), s.push(a)
                        }
                        return Qe(s)
                    }
            ...
            B({
                ...
                handler: (t, e) => {
                    let {
                        parser: r,
                        funcName: n
                    } = t, s = e[0], a = e[1], o, u = null, m = null, f = "auto";
                    switch (n) {
                        case "\\dfrac":
                        case "\\frac":
                        case "\\tfrac":
            ...
            B({
                ...
                handler(t, e) {
                    let {
                        parser: r
                    } = t, n = e[4], s = e[5], a = Ne(e[0]), o = a.type === "atom" && a.family === "open" ? Tr(a.text) : null, u = Ne(e[1]), m = u.type === "atom" && u.family === "close" ? Tr(u.text) : null, f = F(e[2], "size"), b, y = null;
                ...
                handler: (t, e) => {
                    let {
                        parser: r,
                        funcName: n
                    } = t, s = e[0], a = j(F(e[1], "infix").size), o = e[2], u = a.number > 0;
                    return {
                        type: "genfrac",
                        mode: r.mode,
                        numer: s,
            ...
            let Br = (t, e) => {
                let r = e.style,
                    n, s;
                t.type === "supsub" ? (n = t.sup ? U(t.sup, e.havingStyle(r.sup()), e) : U(t.sub, e.havingStyle(r.sub()), e), s = F(t.base, "horizBrace")) : s = F(t, "horizBrace");
                let a = U(s.base, e.havingBaseStyle(E.DISPLAY)),
                    o = U0.svgSpan(s, e),
                    u;
                if (s.isOver ? (u = x.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                            elem: a
                    ...
                    }, e), u.children[0].children[0].children[1].classes.push("svg-align")) : (u = x.makeVList({
                        positionType: "bottom",
                    ...
                    s.isOver ? u = x.makeVList({
                        ...
                        positionType: "bottom",
                        positionData: m.depth + .2 + n.height + n.depth,
                        children: [{
                            type: "elem",
                            elem: n
                        }, {
            ...
            B({
                ...
                mathmlBuilder: (t, e) => {
                    let r = U0.mathMLnode(t.label);
                    return new z.MathNode(t.isOver ? "mover" : "munder", [Z(t.base, e), r])
                }
            }), B({
                type: "href",
                names: ["\\href"],
                ...
                mathmlBuilder: (t, e) => {
                    let r = j0(t.body, e);
                    return r instanceof S0 || (r = new S0("mrow", [r])), r.setAttribute("href", t.href), r
                }
            }), B({
                type: "href",
                names: ["\\url"],
                    ...
                    switch (n) {
                        ...
                        case "\\htmlData": {
                            ...
                            for (let b = 0; b < f.length; b++) {
                                let y = f[b].split("=");
                                if (y.length !== 2) throw new v("Error parsing key-value for \\htmlData");
                ...
                htmlBuilder: (t, e) => {
                    ...
                    for (let a in t.attributes) a !== "class" && t.attributes.hasOwnProperty(a) && s.setAttribute(a, t.attributes[a]);
                    return s
                },
            ...
            let yt = function(t) {
                ...
                };
                {
                    ...
                    if (!Et(r)) throw new v("Invalid unit: '" + r.unit + "' in \\includegraphics.");
                    return r
                }
            };
            B({
                            ...
                            if (w.length === 2) {
                                ...
                                switch (w[0].trim()) {
                                    ...
                                    case "totalheight":
                                        ...
                                        break;
                                    default:
                                        throw new v("Invalid key: '" + w[0] + "' in \\includegraphics.")
                                }
                            }
                        }
                    }
                    let m = F(e[0], "url").url;
                    return u === "" && (u = m, u = u.replace(/^.*[\\/]/, ""), u = u.substring(0, u.lastIndexOf("."))), n.settings.isTrusted({
                ...
                mathmlBuilder: (t, e) => {
                    ...
                    let n = n0(t.height, e),
                        s = 0;
                    if (t.totalheight.number > 0 && (s = n0(t.totalheight, e) - n, r.setAttribute("valign", A(-s))), r.setAttribute("height", A(n + s)), t.width.number > 0) {
                        let a = n0(t.width, e);
                ...
                handler(t, e) {
                    ...
                    if (r.settings.strict) {
                        let a = n[1] === "m",
                            o = s.value.unit === "mu";
                        a ? (o || r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " supports only mu units, " + ("not " + s.value.unit + " units")), r.mode !== "math" && r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " works only in math mode")) : o && r.settings.reportNonstrict("mathVsTextUnits", "LaTeX's " + n + " doesn't support mu units")
                    }
                    return {
                        type: "kern",
                        mode: r.mode,
                ...
                htmlBuilder: (t, e) => {
                    let r;
                    t.alignment === "clap" ? (r = x.makeSpan([], [U(t.body, e)]), r = x.makeSpan(["inner"], [r], e)) : r = x.makeSpan(["inner"], [U(t.body, e)]);
                    let n = x.makeSpan(["fix"], []),
                        s = x.makeSpan([t.alignment], [r, n], e),
                        a = x.makeSpan(["strut"]);
                    return a.style.height = A(s.height + s.depth), s.depth && (a.style.verticalAlign = A(-s.depth)), s.children.unshift(a), s = x.makeSpan(["thinbox"], [s], e), x.makeSpan(["mord", "vbox"], [s], e)
                },
                mathmlBuilder: (t, e) => {
            ...
            let Cr = (t, e, r, n, s, a, o) => {
                    ...
                    if (e) {
                        ...
                        f = {
                            elem: w,
                            kern: Math.max(n.fontMetrics().bigOpSpacing1, n.fontMetrics().bigOpSpacing3 - w.depth)
                        }
                    }
                    if (r) {
                        ...
                        m = {
                            elem: w,
                            kern: Math.max(n.fontMetrics().bigOpSpacing2, n.fontMetrics().bigOpSpacing4 - w.height)
                        }
                    }
                    let b;
                    if (f && m) {
                        let w = n.fontMetrics().bigOpSpacing5 + m.elem.height + m.elem.depth + m.kern + t.depth + o;
                        b = x.makeVList({
                            positionType: "bottom",
                            positionData: w,
                            children: [{
                ...
                ie = (t, e) => {
                    let r, n, s = !1,
                        a;
                    t.type === "supsub" ? (r = t.sup, n = t.sub, a = F(t.base, "op"), s = !0) : a = F(t, "op");
                    let o = e.style,
                        u = !1;
                    o.size === E.DISPLAY.size && a.symbol && !T.contains(Dr, a.name) && (u = !0);
                    let m;
                    if (a.symbol) {
                        let y = u ? "Size2-Regular" : "Size1-Regular",
                            w = "";
                        if ((a.name === "\\oiint" || a.name === "\\oiiint") && (w = a.name.slice(1), a.name = w === "oiint" ? "\\iint" : "\\iiint"), m = x.makeSymbol(a.name, y, "math", e, ["mop", "op-symbol", u ? "large-op" : "small-op"]), w.length > 0) {
                            let S = m.italic,
                            ...
                            }, e), a.name = "\\" + w, m.classes.unshift("mop"), m.italic = S
                        }
                    } else if (a.body) {
                        let y = d0(a.body, e, !0);
                        y.length === 1 && y[0] instanceof A0 ? (m = y[0], m.classes[0] = "mop") : m = x.makeSpan(["mop"], y, e)
                    } else {
                        let y = [];
                        for (let w = 1; w < a.name.length; w++) y.push(x.mathsym(a.name[w], a.mode, e));
                        m = x.makeSpan(["mop"], y, e)
                    }
                    let f = 0,
                        b = 0;
                    return (m instanceof A0 || a.name === "\\oiint" || a.name === "\\oiiint") && !a.suppressBaseShift && (f = (m.height - m.depth) / 2 - e.fontMetrics().axisHeight, b = m.italic), s ? Cr(m, r, n, e, o, b, f) : (f && (m.style.position = "relative", m.style.top = A(f)), m)
                },
                fe = (t, e) => {
                    let r;
                    if (t.symbol) r = new S0("mo", [T0(t.name, t.mode)]), T.contains(Dr, t.name) && r.setAttribute("largeop", "false");
            ...
            let qr = (t, e) => {
                let r, n, s = !1,
                    a;
                t.type === "supsub" ? (r = t.sup, n = t.sub, a = F(t.base, "operatorname"), s = !0) : a = F(t, "operatorname");
                let o;
                if (a.body.length > 0) {
                    let u = a.body.map(f => {
                            let b = f.text;
                    ...
                    for (let f = 0; f < m.length; f++) {
                        let b = m[f];
                        b instanceof A0 && (b.text = b.text.replace(/\u2212/, "-").replace(/\u2217/, "*"))
                    }
            ...
            B({
                ...
                mathmlBuilder: (t, e) => {
                    ...
                    for (let o = 0; o < r.length; o++) {
                        ...
                        if (!(u instanceof z.SpaceNode))
                            if (u instanceof z.MathNode) switch (u.type) {
                                case "mi":
                                case "mn":
                                case "ms":
                                case "mspace":
                                ...
                                case "mo": {
                                    let m = u.children[0];
                                    u.children.length === 1 && m instanceof z.TextNode ? m.text = m.text.replace(/\u2212/, "-").replace(/\u2217/, "*") : n = !1;
                                    break
                                }
                                default:
                                    n = !1
                    ...
                    return t.parentIsSupSub ? new z.MathNode("mrow", [s, a]) : z.newDocumentFragment([s, a])
                }
            }), h("\\operatorname", "\\@ifstar\\operatornamewithlimits\\operatorname@"), Q0({
                type: "ordgroup",
                htmlBuilder(t, e) {
                    return t.semisimple ? x.makeFragment(d0(t.body, e, !1)) : x.makeSpan(["mord"], d0(t.body, e, !0), e)
                },
                mathmlBuilder(t, e) {
                ...
                htmlBuilder: (t, e) => {
                    ...
                    if (r.height = 0, r.depth = 0, r.children)
                        for (let n = 0; n < r.children.length; n++) r.children[n].height = 0, r.children[n].depth = 0;
                    return r = x.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                            elem: r
                        }]
                    }, e), x.makeSpan(["mord"], [r], e)
                },
                mathmlBuilder: (t, e) => {
                ...
                handler(t, e, r) {
                    let {
                        parser: n
                    } = t, s = r[0], a = F(e[0], "size"), o = F(e[1], "size");
                    return {
                        type: "rule",
                        mode: n.mode,
                ...
                htmlBuilder(t, e) {
                    ...
                    return r.style.borderRightWidth = A(n), r.style.borderTopWidth = A(s), r.style.bottom = A(a), r.width = n, r.height = s + a, r.depth = -a, r.maxFontSize = s * 1.125 * e.sizeMultiplier, r
                },
                mathmlBuilder(t, e) {
                    let r = n0(t.width, e),
                        n = n0(t.height, e),
                    ...
                    o.setAttribute("mathbackground", a), o.setAttribute("width", A(r)), o.setAttribute("height", A(n));
                    let u = new z.MathNode("mpadded", [o]);
                    return s >= 0 ? u.setAttribute("height", A(s)) : (u.setAttribute("height", A(s)), u.setAttribute("depth", A(-s))), u.setAttribute("voffset", A(s)), u
                }
            });
            ...
            function Er(t, e, r) {
                ...
                for (let a = 0; a < n.length; a++) {
                    ...
                    o < 0 ? Array.prototype.push.apply(n[a].classes, e.sizingClasses(r)) : n[a].classes[o + 1] === "reset-size" + e.size && (n[a].classes[o + 1] = "reset-size" + r.size), n[a].height *= s, n[a].depth *= s
                }
                return x.makeFragment(n)
            }
            let Ir = ["\\tiny", "\\sixptsize", "\\scriptsize", "\\footnotesize", "\\small", "\\normalsize", "\\large", "\\Large", "\\LARGE", "\\huge", "\\Huge"];
            B({
                type: "sizing",
                names: Ir,
                props: {
                ...
                handler: (t, e, r) => {
                    let {
                        parser: n
                    } = t, s = !1, a = !1, o = r[0] && F(r[0], "ordgroup");
                    if (o) {
                        let m = "";
                ...
                htmlBuilder: (t, e) => {
                    ...
                    if (t.smashHeight && (r.height = 0, r.children))
                        for (let s = 0; s < r.children.length; s++) r.children[s].height = 0;
                    if (t.smashDepth && (r.depth = 0, r.children))
                        for (let s = 0; s < r.children.length; s++) r.children[s].depth = 0;
                    let n = x.makeVList({
                        positionType: "firstBaseline",
                        children: [{
                            type: "elem",
                ...
                htmlBuilder(t, e) {
                    let r = U(t.body, e.havingCrampedStyle());
                    r.height === 0 && (r.height = e.fontMetrics().xHeight), r = x.wrapFragment(r, e);
                    ...
                    let o = s + a / 4,
                        ...
                        y = m.height - f;
                    y > r.height + r.depth + o && (o = (o + y - r.height - r.depth) / 2);
                ...
                mathmlBuilder(t, e) {
                    ...
                    return n ? new z.MathNode("mroot", [Z(r, e), Z(n, e)]) : new z.MathNode("msqrt", [Z(r, e)])
                }
            });
            let Rr = {
                display: E.DISPLAY,
            ...
            B({
                ...
                handler(t, e) {
                    let {
                        ...
                        funcName: n,
                        parser: s
                    } = t, a = s.parseExpression(!0, r), o = n.slice(1, n.length - 5);
                    return {
                        type: "styling",
                        mode: s.mode,
                        style: o,
                ...
                mathmlBuilder(t, e) {
                    ...
                    return a.setAttribute("scriptlevel", u[0]), a.setAttribute("displaystyle", u[1]), a
                }
            });
            let D1 = function(t, e) {
                let r = t.base;
                return r ? r.type === "op" ? r.limits && (e.style.size === E.DISPLAY.size || r.alwaysHandleSupSub) ? ie : null : r.type === "operatorname" ? r.alwaysHandleSupSub && (e.style.size === E.DISPLAY.size || r.limits) ? qr : null : r.type === "accent" ? T.isCharacterBox(r.base) ? nt : null : r.type === "horizBrace" && !t.sub === r.isOver ? Br : null : null
            };
            Q0({
                type: "supsub",
                htmlBuilder(t, e) {
                    ...
                    let {
                        ...
                        sup: s,
                        sub: a
                    } = t, o = U(n, e), u, m, f = e.fontMetrics(), b = 0, y = 0, w = n && T.isCharacterBox(n);
                    if (s) {
                        let Y = e.havingStyle(e.style.sup());
                        u = U(s, Y, e), w || (b = o.height - Y.fontMetrics().supDrop * Y.sizeMultiplier / e.sizeMultiplier)
                    }
                    if (a) {
                        let Y = e.havingStyle(e.style.sub());
                        m = U(a, Y, e), w || (y = o.depth + Y.fontMetrics().subDrop * Y.sizeMultiplier / e.sizeMultiplier)
                    }
                    let S;
                    e.style === E.DISPLAY ? S = f.sup1 : e.style.cramped ? S = f.sup3 : S = f.sup2;
                    let D = e.sizeMultiplier,
                        q = A(.5 / f.ptPerEm / D),
                        V = null;
                    if (m) {
                        let Y = t.base && t.base.type === "op" && t.base.name && (t.base.name === "\\oiint" || t.base.name === "\\oiiint");
                        (o instanceof A0 || Y) && (V = A(-o.italic))
                    }
                    let _;
                    if (u && m) {
                        b = Math.max(b, S, u.depth + .25 * f.xHeight), y = Math.max(y, f.sub2);
                        let K = 4 * f.defaultRuleThickness;
                        if (b - u.depth - (m.height - y) < K) {
                            y = K - (b - u.depth) + m.height;
                            let p0 = .8 * f.xHeight - (b - u.depth);
                            p0 > 0 && (b += p0, y -= p0)
                        }
                        let y0 = [{
                            type: "elem",
                        ...
                        y = Math.max(y, f.sub1, m.height - .8 * f.xHeight);
                        let Y = [{
                            type: "elem",
                            elem: m,
                            marginLeft: V,
                    ...
                    } else if (u) b = Math.max(b, S, u.depth + .25 * f.xHeight), _ = x.makeVList({
                        positionType: "shift",
                        positionData: -b,
                        children: [{
                            type: "elem",
                ...
                mathmlBuilder(t, e) {
                    ...
                    if (r) o = n ? "mover" : "munder";
                        ...
                        if (t.sup) {
                            let u = t.base;
                            u && u.type === "op" && u.limits && e.style === E.DISPLAY || u && u.type === "operatorname" && u.alwaysHandleSupSub && (e.style === E.DISPLAY || u.limits) ? o = "munderover" : o = "msubsup"
                        } else {
                            let u = t.base;
                            u && u.type === "op" && u.limits && (e.style === E.DISPLAY || u.alwaysHandleSupSub) || u && u.type === "operatorname" && u.alwaysHandleSupSub && (u.limits || e.style === E.DISPLAY) ? o = "munder" : o = "msub"
                        }
                    else {
                        let u = t.base;
                        u && u.type === "op" && u.limits && (e.style === E.DISPLAY || u.alwaysHandleSupSub) || u && u.type === "operatorname" && u.alwaysHandleSupSub && (u.limits || e.style === E.DISPLAY) ? o = "mover" : o = "msup"
                    }
            ...
            Q0({
                ...
                mathmlBuilder(t, e) {
                    let r = T0(t.text, t.mode, e),
                        n = et(t, e) || "normal",
                        s;
                    return t.mode === "text" ? s = new z.MathNode("mtext", [r]) : /[0-9]/.test(t.text) ? s = new z.MathNode("mn", [r]) : t.text === "\\prime" ? s = new z.MathNode("mo", [r]) : s = new z.MathNode("mi", [r]), n !== Or[s.type] && s.setAttribute("mathvariant", n), s
                }
            });
            let xt = {
                    "\\nobreak": "nobreak",
            ...
            Q0({
                ...
                htmlBuilder(t, e) {
                    if (wt.hasOwnProperty(t.text)) {
                        ...
                        } else return x.makeSpan(["mspace", r], [x.mathsym(t.text, t.mode, e)], e)
                    } else {
                        if (xt.hasOwnProperty(t.text)) return x.makeSpan(["mspace", xt[t.text]], [], e);
                        throw new v('Unknown type of space "' + t.text + '"')
                    }
                },
                mathmlBuilder(t, e) {
                    let r;
                    if (wt.hasOwnProperty(t.text)) r = new z.MathNode("mtext", [new z.TextNode("\xA0")]);
                    else {
            ...
            Q0({
                type: "tag",
                mathmlBuilder(t, e) {
                    let r = new z.MathNode("mtable", [new z.MathNode("mtr", [Hr(), new z.MathNode("mtd", [j0(t.body, e)]), Hr(), new z.MathNode("mtd", [j0(t.tag, e)])])]);
            ...
            let Lr = {
                ...
                _r = (t, e) => {
                    ...
                    if (r) {
                        ...
                        if (r === "\\emph") return e.fontShape === "textit" ? e.withTextFontShape("textup") : e.withTextFontShape("textit")
                    } else return e;
            ...
            B({
                ...
                handler(t, e, r) {
                    throw new v("\\verb ended by end of line instead of matching delimiter")
                },
                htmlBuilder(t, e) {
                    let r = Pr(t),
                        n = [],
                    ...
                    for (let a = 0; a < r.length; a++) {
                        let o = r[a];
                        o === "~" && (o = "\\textasciitilde"), n.push(x.makeSymbol(o, "Typewriter-Regular", t.mode, s, ["mord", "texttt"]))
                    }
                    return x.makeSpan(["mord", "text"].concat(s.sizingClasses(e)), x.tryCombineChars(n), s)
                },
                mathmlBuilder(t, e) {
...
?)[ \r	]*`,
                kt = "[\u0300-\u036F]",
                H1 = new RegExp(kt + "+$"),
                L1 = "(" + Vr + "+)|" + (O1 + "|") + "([!-\\[\\]-\u2027\u202A-\uD7FF\uF900-\uFFFF]" + (kt + "*") + "|[\uD800-\uDBFF][\uDC00-\uDFFF]" + (kt + "*") + "|\\\\verb\\*([^]).*?\\4|\\\\verb([^*a-zA-Z]).*?\\5" + ("|" + R1) + ("|" + I1 + ")");
            class Gr {
                constructor(e, r) {
                    this.input = void 0, this.settings = void 0, this.tokenRegex = void 0, this.catcodes = void 0, this.input = e, this.settings = r, this.tokenRegex = new RegExp(L1, "g"), this.catcodes = {
                        "%": 14,
                        "~": 13
                    }
                }
                ...
                lex() {
                    ...
                    if (n === null || n.index !== r) throw new v("Unexpected character: '" + e[r] + "'", new B0(e[r], new M0(this, r, r + 1)));
                    let s = n[6] || n[3] || (n[2] ? "\\ " : " ");
...
`, this.tokenRegex.lastIndex);
            ...
            class F1 {
                ...
                endGroup() {
                    if (this.undefStack.length === 0) throw new v("Unbalanced namespace destruction: attempt to pop global namespace; please report this as a bug");
                    let e = this.undefStack.pop();
                    for (let r in e) e.hasOwnProperty(r) && (e[r] == null ? delete this.current[r] : this.current[r] = e[r])
                }
                endGroups() {
                ...
                set(e, r, n) {
                    if (n === void 0 && (n = !1), n) {
                        for (let s = 0; s < this.undefStack.length; s++) delete this.undefStack[s][e];
            ...
            }), h("\\@ifstar", "\\@ifnextchar *{\\@firstoftwo{#1}}"), h("\\TextOrMath", function(t) {
            ...
            h("\\char", function(t) {
                ...
                if (r) {
                    if (n = $r[e.text], n == null || n >= r) throw new v("Invalid base-" + r + " digit " + e.text);
                    let s;
                    for (;
                        (s = $r[t.future().text]) != null && s < r;) n *= r, n += s, t.popToken()
                }
                return "\\@char{" + n + "}"
            });
            let vt = (t, e, r, n) => {
                let s = t.consumeArg().tokens;
                if (s.length !== 1) throw new v("\\newcommand's first argument must be a macro name");
                let a = s[0].text,
                    o = t.isDefined(a);
                if (o && !e) throw new v("\\newcommand{" + a + "} attempting to redefine " + (a + "; use \\renewcommand"));
                if (!o && !r) throw new v("\\renewcommand{" + a + "} when command " + a + " does not yet exist; use \\newcommand");
                let u = 0;
                if (s = t.consumeArg().tokens, s.length === 1 && s[0].text === "[") {
                    let m = "",
                        f = t.expandNextToken();
                    for (; f.text !== "]" && f.text !== "EOF";) m += f.text, f = t.expandNextToken();
                    if (!m.match(/^\s*[0-9]+\s*$/)) throw new v("Invalid number of arguments: " + m);
                    u = parseInt(m), s = t.consumeArg().tokens
                }
                return o && n || t.macros.set(a, {
                    tokens: s,
                    numArgs: u
                }), ""
            };
            h("\\newcommand", t => vt(t, !1, !0, !1)), h("\\renewcommand", t => vt(t, !0, !1, !1)), h("\\providecommand", t => vt(t, !0, !0, !0)), h("\\message", t => {
                ...
                let e = t.popToken(),
                    r = e.text;
                return console.log(e, t.macros.get(r), K0[r], s0.math[r], s0.text[r]), ""
            ...
            h("\\dots", function(t) {
                ...
                return r in Ur ? e = Ur[r] : (r.slice(0, 4) === "\\not" || r in s0.math && T.contains(["bin", "rel"], s0.math[r].group)) && (e = "\\dotsb"), e
            });
            let St = {
                ")": !0,
                "]": !0,
            ...
            let Yr = t => e => {
                ...
                let m = y => w => {
                    ...
                    let S = y;
                    return !y && s.length && w.future().text === "|" && (w.popToken(), S = !0), {
                        tokens: S ? s : n,
                        numArgs: 0
                    }
                };
            ...
            class P1 {
                constructor(e, r, n) {
                    this.settings = void 0, this.expansionCount = void 0, this.lexer = void 0, this.macros = void 0, this.stack = void 0, this.mode = void 0, this.settings = r, this.expansionCount = 0, this.feed(e), this.macros = new F1(_1, r.macros), this.mode = n, this.stack = []
                }
                feed(e) {
                ...
                scanArgument(e) {
                    ...
                    return this.pushToken(new B0("EOF", n.loc)), this.pushTokens(s), r.range(n, "")
                }
                consumeSpaces() {
                ...
                consumeArg(e) {
                    ...
                    do {
                        ...
                        } else if (a.text === "EOF") throw new v("Unexpected end of input in a macro argument, expected '" + (e && n ? e[u] : "}") + "'", a);
                        if (e && n)
                ...
                consumeArgs(e, r) {
                    if (r) {
                        if (r.length !== e + 1) throw new v("The length of delimiters doesn't match the number of args!");
                        let s = r[0];
                        for (let a = 0; a < s.length; a++) {
                            let o = this.popToken();
                            if (s[a] !== o.text) throw new v("Use of the macro doesn't match its definition", o)
                        }
                    }
                    let n = [];
                    for (let s = 0; s < e; s++) n.push(this.consumeArg(r && r[s + 1]).tokens);
                    return n
                }
                countExpansion(e) {
                    if (this.expansionCount += e, this.expansionCount > this.settings.maxExpand) throw new v("Too many expansions: infinite loop or need to increase maxExpand setting")
                }
                expandOnce(e) {
                    let r = this.popToken(),
                        n = r.text,
                    ...
                    if (s == null || e && s.unexpandable) {
                        if (e && s == null && n[0] === "\\" && !this.isDefined(n)) throw new v("Undefined control sequence: " + n);
                    ...
                    if (s.numArgs) {
                        ...
                        for (let u = a.length - 1; u >= 0; --u) {
                            let m = a[u];
                            if (m.text === "#") {
                                if (u === 0) throw new v("Incomplete placeholder at end of macro body", m);
                                if (m = a[--u], m.text === "#") a.splice(u + 1, 1);
                                else if (/^[1-9]$/.test(m.text)) a.splice(u, 2, ...o[+m.text - 1]);
                ...
                isDefined(e) {
                    return this.macros.has(e) || K0.hasOwnProperty(e) || s0.math.hasOwnProperty(e) || s0.text.hasOwnProperty(e) || Xr.hasOwnProperty(e)
                }
                isExpandable(e) {
                    let r = this.macros.get(e);
                    return r != null ? typeof r == "string" || typeof r == "function" || !r.unexpandable : K0.hasOwnProperty(e) && !K0[e].primitive
                }
            }
            ...
            class Le {
                constructor(e, r) {
                    this.mode = void 0, this.gullet = void 0, this.settings = void 0, this.leftrightDepth = void 0, this.nextToken = void 0, this.mode = "math", this.gullet = new P1(e, r, this.mode), this.settings = r, this.leftrightDepth = 0
                }
                expect(e, r) {
                    if (r === void 0 && (r = !0), this.fetch().text !== e) throw new v("Expected '" + e + "', got '" + this.fetch().text + "'", this.fetch());
                    r && this.consume()
                }
                consume() {
                    this.nextToken = null
                ...
                parseExpression(e, r) {
                    ...
                    for (;;) {
                        ...
                        let s = this.fetch();
                        if (Le.endOfExpression.indexOf(s.text) !== -1 || r && s.text === r || e && K0[s.text] && K0[s.text].infix) break;
                ...
                handleInfixNodes(e) {
                    ...
                    for (let s = 0; s < e.length; s++)
                        if (e[s].type === "infix") {
                            if (r !== -1) throw new v("only one infix operator per group", e[s].token);
                            r = s, n = e[s].replaceWith
                        } if (r !== -1 && n) {
                        let s, a, o = e.slice(0, r),
                            u = e.slice(r + 1);
                        o.length === 1 && o[0].type === "ordgroup" ? s = o[0] : s = {
                            type: "ordgroup",
                            mode: this.mode,
                            body: o
                        }, u.length === 1 && u[0].type === "ordgroup" ? a = u[0] : a = {
                            type: "ordgroup",
                            mode: this.mode,
                            body: u
                        };
                ...
                formatUnsupportedCmd(e) {
                    let r = [];
                    for (let a = 0; a < e.length; a++) r.push({
                        type: "textord",
                        mode: "text",
                        text: e[a]
                    });
                ...
                parseAtom(e) {
                    ...
                    for (;;) {
                        ...
                        if (a.text === "\\limits" || a.text === "\\nolimits") {
                            ...
                            } else if (r && r.type === "operatorname") r.alwaysHandleSupSub && (r.limits = a.text === "\\limits");
                ...
                parseFunction(e, r) {
                    let n = this.fetch(),
                        ...
                        a = K0[s];
                    if (!a) return null;
                    if (this.consume(), r && r !== "atom" && !a.allowedInArgument) throw new v("Got function '" + s + "' with no arguments" + (r ? " as " + r : ""), n);
                    if (this.mode === "text" && !a.allowedInText) throw new v("Can't use function '" + s + "' in text mode", n);
                    if (this.mode === "math" && a.allowedInMath === !1) throw new v("Can't use function '" + s + "' in math mode", n);
                    let {
                        args: o,
                        optArgs: u
                ...
                parseArguments(e, r) {
                    ...
                    for (let o = 0; o < n; o++) {
                        ...
                        (r.primitive && u == null || r.type === "sqrt" && o === 1 && a[0] == null) && (u = "primitive");
                ...
                parseGroupOfType(e, r, n) {
                    switch (r) {
                        ...
                        case "primitive": {
                            ...
                            let s = this.parseGroup(e);
                            if (s == null) throw new v("Expected group as " + e, this.fetch());
                            return s
                        }
                        case "original":
                        case null:
                ...
                parseStringGroup(e, r) {
                    ...
                    let s = "",
                        a;
                    for (;
                        (a = this.fetch()).text !== "EOF";) s += a.text, this.consume();
                ...
                parseRegexGroup(e, r) {
                    let n = this.fetch(),
                        ...
                        o;
                    for (;
                        (o = this.fetch()).text !== "EOF" && e.test(a + o.text);) s = o, a += s.text, this.consume();
                ...
                parseSizeGroup(e) {
                    let r, n = !1;
                    if (this.gullet.consumeSpaces(), !e && this.gullet.future().text !== "{" ? r = this.parseRegexGroup(/^[-+]? *(?:$|\d+|\d+\.\d*|\.\d*) *[a-z]{0,2} *$/, "size") : r = this.parseStringGroup("size", e), !r) return null;
                ...
                parseGroup(e, r) {
                    ...
                    } else if (a = this.parseFunction(r, e) || this.parseSymbol(), a == null && s[0] === "\\" && !Xr.hasOwnProperty(s)) {
                        if (this.settings.throwOnError) throw new v("Undefined control sequence: " + s, n);
                ...
                parseSymbol() {
                    ...
                    if (/^\\verb[^a-zA-Z]/.test(r)) {
                        ...
                        let a = r.slice(5),
                            o = a.charAt(0) === "*";
                        if (o && (a = a.slice(1)), a.length < 2 || a.charAt(0) !== a.slice(-1)) throw new v(`\\verb assertion failed --
                    ...
                    Zr.hasOwnProperty(r[0]) && !s0[this.mode][r[0]] && (this.settings.strict && this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Accented Unicode text character "' + r[0] + '" used in math mode', e), r = Zr[r[0]] + r.slice(1));
                    let n = H1.exec(r);
                    n && (r = r.substring(0, n.index), r === "i" ? r = "\u0131" : r === "j" && (r = "\u0237"));
                    let s;
                    if (s0[this.mode][r]) {
                        this.settings.strict && this.mode === "math" && Ye.indexOf(r) >= 0 && this.settings.reportNonstrict("unicodeTextInMathMode", 'Latin-1/Unicode text character "' + r[0] + '" used in math mode', e);
                        ...
                        s = u
                    } else if (r.charCodeAt(0) >= 128) this.settings.strict && (Bt(r.charCodeAt(0)) ? this.mode === "math" && this.settings.reportNonstrict("unicodeTextInMathMode", 'Unicode text character "' + r[0] + '" used in math mode', e) : this.settings.reportNonstrict("unknownSymbol", 'Unrecognized Unicode character "' + r[0] + '"' + (" (" + r.charCodeAt(0) + ")"), e)), s = {
                        type: "textord",
                        mode: "text",
                        loc: M0.range(e),
                        text: r
                    ...
                    if (this.consume(), n)
                        for (let a = 0; a < n[0].length; a++) {
                            ...
                            if (!u) throw new v("Accent " + o + " unsupported in " + this.mode + " mode", e);
                            s = {
                                type: "accent",
                                mode: this.mode,
                                loc: M0.range(e),
            ...
            var zt = function(t, e) {
                ...
                if (delete r.gullet.macros.current["\\current@color"], delete r.gullet.macros.current["\\color"], r.gullet.macros.get("\\df@tag")) {
                    if (!e.displayMode) throw new v("\\tag works only in display equations");
                    n = [{
                        type: "tag",
                        mode: "text",
                        body: n,
            ...
            typeof document < "u" && document.compatMode !== "CSS1Compat" && (typeof console < "u" && console.warn("Warning: KaTeX doesn't work in quirks mode. Make sure your website has a suitable doctype."), Kr = function() {
...
var cn = tn(be => {
    "use strict";
    var X1 = be && be.__importDefault || function(k) {
    ...
    function nn(k, N) {
        ...
        let R = !1,
            P = !1;
        return H !== "$" && H !== "\\" && (H === void 0 || sn(H) || !an(H)) && (R = !0), L !== "$" && (L == null || sn(L) || !an(L)) && (P = !0), {
            can_open: R,
            can_close: P
        }
    }
    ...
    function Z1(k, N) {
        ...
        if (v = nn(k, R), !v.can_close) return N || (k.pending += "$"), k.pos = L, !0;
        if (!N) {
    ...
    function K1(k, N, H, v) {
        var L, R, P, r0 = !1,
            o0, $ = k.bMarks[N] + k.tShift[N],
            Q = k.eMarks[N];
        if ($ + 2 > Q || k.src.slice($, $ + 2) !== "$$") return !1;
        $ += 2;
        let c0 = k.src.slice($, Q);
        if (v) return !0;
        for (c0.trim().slice(-2) === "$$" && (c0 = c0.trim().slice(0, -2), r0 = !0), R = N; !r0 && (R++, !(R >= H || ($ = k.bMarks[R] + k.tShift[R], Q = k.eMarks[R], $ < Q && k.tShift[R] < k.blkIndent)));) k.src.slice($, Q).trim().slice(-2) === "$$" ? (P = k.src.slice(0, Q).lastIndexOf("$$"), L = k.src.slice($, P), r0 = !0) : k.src.slice($, Q).trim().includes("$$") && (P = k.src.slice(0, Q).trim().indexOf("$$"), L = k.src.slice($, P), r0 = !0);
        return k.line = R + 1, o0 = k.push("math_block", "math", 0), o0.block = !0, o0.content = (c0 && c0.trim() ? c0 + `
` : "") + k.getLines(N + 1, R, k.tShift[N], !0) + (L && L.trim() ? L : ""), o0.map = [N, k.line], o0.markup = "$$", !0
    }
    ...
    function J1(k, N, H, v) {
        ...
        return k0.block = !0, k0.content = (k.getLines(N, $, k.tShift[N], !0) + (Q ?? "")).trim(), k0.map = [N, k.line], k0.markup = "$$", !0
    }

    function Q1(k, N) {
        var H, v, L, R, P;
        if (k.src.slice(k.pos, k.pos + 2) !== "$$") return !1;
        if (R = ln(k, k.pos), !R.can_open) return N || (k.pending += "$$"), k.pos += 2, !0;
        for (H = k.pos + 2, v = H;
            (v = k.src.indexOf("$$", v)) !== -1;) {
        ...
        return v === -1 ? (N || (k.pending += "$$"), k.pos = H, !0) : v - H === 0 ? (N || (k.pending += "$$$$"), k.pos = H + 2, !0) : (R = ln(k, v), R.can_close ? (N || (L = k.push("math_block", "math", 0), L.block = !0, L.markup = "$$", L.content = k.src.slice(H, v)), k.pos = v + 2, !0) : (N || (k.pending += "$$"), k.pos = H, !0))
    }
    ...
    function es(k, N) {
        ...
        return o0.block = !0, o0.markup = "$$", o0.content = H.slice(1, r0), k.pos = k.pos + r0, !0
    }
    ...
    function ts(k, N) {
        ...
        k.inline.ruler.after("escape", "math_inline", Z1), k.inline.ruler.after("escape", "math_inline_block", Q1), v && k.inline.ruler.before("text", "math_inline_bare_block", es), k.block.ruler.after("blockquote", "math_block", (j, h0, T, f0) => v && J1(j, h0, T, f0) ? !0 : K1(j, h0, T, f0), {
            alt: ["paragraph", "reference", "blockquote", "list"]
        });
        let r0 = /(?<html_before_math>[\s\S]*?)\$\$(?<math>[\s\S]+?)\$\$(?<html_after_math>(?:(?!\$\$[\s\S]+?\$\$)[\s\S])*)/gm,
            o0 = /(?<html_before_math>[\s\S]*?)\$(?<math>.*?)\$(?<html_after_math>(?:(?!\$.*?\$)[\s\S])*)/gm;
        L && k.core.ruler.push("math_block_in_html_block", j => on(j, "math_block", "$$", r0)), R && k.core.ruler.push("math_inline_in_html_block", j => on(j, "math_inline", "$", o0));
        let $ = j => {
                let h0 = /\\begin\{(align|equation|gather|cd|alignat)\}/ig.test(j);
                try {
                    return H.renderToString(j, {
                        ...N,
                        displayMode: h0
                    })
                } catch (T) {
                    return N?.throwOnError && console.log(T), `<span class="katex-error" title="${_e(j)}">${_e(T+"")}</span>`
                }
            },
            Q = (j, h0) => {
                let T = j[h0].content,
                    le = T.length > 2 && T[0] === "`" && T[T.length - 1] === "`" ? T.slice(1, -1) : T;
                return $(le)
            },
            c0 = j => {
                try {
                    ...
                    return N?.throwOnError && console.log(h0), `<p class="katex-block katex-error" title="${_e(j)}">${_e(h0+"")}</p>`
                }
            },
            k0 = (j, h0) => c0(j[h0].content) + `
`;
        if (k.renderer.rules.math_inline = Q, k.renderer.rules.math_inline_block = k0, k.renderer.rules.math_inline_bare_block = k0, k.renderer.rules.math_block = k0, P) {
            let j = "math",
                h0 = k.renderer.rules.fence;
            k.renderer.rules.fence = function(T, f0, le, oe, q0) {
                let ee = T[f0];
                return ee.info.trim().toLowerCase() === j && P ? c0(ee.content) + `
...
async function xs(k) {
    ...
    R.classList.add("markdown-style"), R.content.appendChild(L), R.content.appendChild(H), document.head.appendChild(R);
    let P = cn().default,
        r0 = {};
    N.extendMarkdownIt(o0 => o0.use(P, {
        globalGroup: !0,
        enableBareBlocks: !0,
